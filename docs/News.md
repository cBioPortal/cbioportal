...
*   **Data Improvement**
    ...
    * Pan-can studies TBL score addition: Tumor Break Load (TBL) score is added to all 32 TCGA Pan-Can studies,to clinical sample data file. Data source: [Lakbir et al., Eur J Cancer 2024](https://pubmed.ncbi.nlm.nih.gov/36334560/)
