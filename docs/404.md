...
window.redirectMap = {
    ...
    "2.1.2-deploy-without-docker/deploying":"legacy/deploying",
    "2.2-authorization-and-authentication/authenticating-users-via-tokens":"deployment/authorization-and-authentication/authenticating-users-via-tokens",
    "1.-general/news":"news",
    ...
    "2.1.1-deploy-with-docker-recommended/using-keycloak":"legacy/using-keycloak",
    "2.1.2-deploy-without-docker/software-requirements":"legacy/software-requirements",
    "2.1.2-deploy-without-docker/pre-build-steps":"legacy/pre-build-steps",
    "2.1.2-deploy-without-docker/build-from-source":"legacy/build-from-source",
    "2.1.2-deploy-without-docker/import-the-seed-database":"legacy/import-the-seed-database",
    "2.1.2-deploy-without-docker/deploying":"legacy/deploying",
    "2.1.2-deploy-without-docker/load-sample-cancer-study":"legacy/load-sample-cancer-study",
    ...
    "4.-development/cbioportal-er-diagram":"legacy/cbioportal-er-diagram",
    ...
    "4.-development/deployment-procedure":"legacy/deployment-procedure",
    ...
    "/deployment/deploy-without-docker/software-requirements":"legacy/software-requirements",
    "/deployment/deploy-without-docker/pre-build-steps":"legacy/pre-build-steps",
    "/deployment/deploy-without-docker/build-from-source":"legacy/build-from-source",
    "/deployment/deploy-without-docker/import-the-seed-database":"legacy/import-the-seed-database",
    "/deployment/deploy-without-docker/deploying":"legacy/deploying",
    "/deployment/deploy-without-docker/load-sample-cancer-study":"legacy/load-sample-cancer-study",
    "/deployment/deploy-without-docker":"legacy/deploy-without-docker-readme",
    "/deployment/docker/using-keycloak":"legacy/using-keycloak",
    "/deployment/standalone":"legacy/standalone-readme",
    "/development/deployment-procedure":"legacy/deployment-procedure",
    ...
    "/deployment/kubernetes":"legacy/kubernetes-readme",
    "/development/backend-code-organization":"legacy/backend-code-organization",
    "/development/cbioportal-er-diagram":"legacy/cbioportal-er-diagram",
