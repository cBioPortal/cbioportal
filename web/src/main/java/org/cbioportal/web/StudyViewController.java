...
public class StudyViewController {
    ...
    public ResponseEntity<List<AlterationCountByGene>> fetchMutatedGenes(
        ...
        studyViewFilterUtil.extractStudyAndSampleIds(studyViewFilterApplier.apply(interceptedStudyViewFilter), studyIds,
            sampleIds);
        return new ResponseEntity<>(studyViewService.getMutationAlterationCountByGenes(studyIds, sampleIds), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<AlterationCountByGene>> fetchStructuralVariantGenes(
        ...
        studyViewFilterUtil.extractStudyAndSampleIds(studyViewFilterApplier.apply(interceptedStudyViewFilter), studyIds,
            sampleIds);
        return new ResponseEntity<>(studyViewService.getStructuralVariantAlterationCountByGenes(studyIds, sampleIds), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<CopyNumberCountByGene>> fetchCNAGenes(
        ...
        studyViewFilterUtil.extractStudyAndSampleIds(studyViewFilterApplier.apply(interceptedStudyViewFilter), studyIds,
            sampleIds);
        return new ResponseEntity<>(studyViewService.getCNAAlterationCountByGenes(studyIds, sampleIds), HttpStatus.OK);
    }
