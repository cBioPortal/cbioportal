...
public class CNASegmentControllerConfig extends WebMvcConfigurerAdapter {
    @Override
    ...
    @Bean
    public CNASegmentService cNASegmentService() {
        return Mockito.mock(CNASegmentService.class);
    }
}