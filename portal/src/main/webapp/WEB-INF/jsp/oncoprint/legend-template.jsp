<script type="text/template" id="glyph_template">
    <svg height="23" width="6">
        ...
        <path display="{{display_fusion}}" d="M0,-2.672958956142353L3.0864671457232173,2.672958956142353 -3.0864671457232173,2.672958956142353Z" transform="translate(1.8333333333333333,11.5),rotate(-30,-2.75,0)"></path>
