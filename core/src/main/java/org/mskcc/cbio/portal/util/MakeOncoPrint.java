...
public class MakeOncoPrint {
    ...
    static void writeOncoPrint(StringBuffer out,
		...
		out.append("<script type=\"text/javascript\" src=\"js/lib/raphael/raphael.js\"></script>\n");
		out.append("<script type=\"text/javascript\" src=\"js/lib/raphael/raphaeljs-oncoprint.js\"></script>\n");
		out.append("<script type=\"text/javascript\" src=\"js/lib/jquery.qtip.min.js\"></script>\n");
