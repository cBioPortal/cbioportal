...
public class ClinicalDataController {
    ...
    public ResponseEntity<List<ClinicalData>> getAllClinicalDataOfSampleInStudy(
        ...
        @ApiParam("Attribute ID e.g. CANCER_TYPE") @RequestParam(
            required = false
        ) String attributeId,
        ...
        @ApiParam("Page size of the result list") @Max(
            CLINICAL_DATA_MAX_PAGE_SIZE
        ) @Min(PagingConstants.MIN_PAGE_SIZE) @RequestParam(
            defaultValue = CLINICAL_DATA_DEFAULT_PAGE_SIZE
        ) Integer pageSize,
    ...
    public ResponseEntity<List<ClinicalData>> getAllClinicalDataOfPatientInStudy(
        ...
        @ApiParam("Attribute ID e.g. AGE") @RequestParam(
            required = false
        ) String attributeId,
        @ApiParam("Level of detail of the response") @RequestParam(
            defaultValue = "SUMMARY"
    ...
    public ResponseEntity<List<ClinicalData>> getAllClinicalDataInStudy(
        ...
        @ApiParam("Type of the clinical data") @RequestParam(
            defaultValue = "SAMPLE"
    ...
    public ResponseEntity<List<ClinicalData>> fetchAllClinicalDataInStudy(
        ...
        @ApiParam(
            required = true,
            value = "List of patient or sample IDs and attribute IDs"
    ...
    public ResponseEntity<List<ClinicalData>> fetchClinicalData(
        ...
        @ApiIgnore @Valid @RequestAttribute( // prevent reference to this attribute in the swagger-ui interface. this attribute is needed for the @PreAuthorize tag above.
            required = false,
            value = "interceptedClinicalDataMultiStudyFilter"
        ...
        @ApiParam(
            required = true,
            value = "List of patient or sample identifiers and attribute IDs"
        ) @Valid @RequestBody(
            required = false
