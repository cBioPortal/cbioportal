...
public class MolecularDataControllerTest {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(
                    "/api/molecular-profiles/test_molecular_profile_id/molecular-data")
  ...
  public void fetchAllMolecularDataInMolecularProfileSummaryProjection() throws Exception {
    ...
    Mockito.when(
            molecularDataService.fetchMolecularData(
                Mockito.anyString(), Mockito.anyList(), Mockito.anyList(), Mockito.anyString()))
        .thenReturn(geneMolecularDataList);
  ...
  public void fetchMolecularDataInMultipleMolecularProfiles() throws Exception {
    ...
    MolecularDataMultipleStudyFilter molecularDataMultipleStudyFilter =
        new MolecularDataMultipleStudyFilter();
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/molecular-data/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
