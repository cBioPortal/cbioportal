...
public class CopyNumberSegmentMyBatisRepository implements CopyNumberSegmentRepository {
  ...
  @Autowired private CopyNumberSegmentMapper copyNumberSegmentMapper;
  ...
  public BaseMeta getMetaCopyNumberSegmentsInSampleInStudy(
    ...
    return copyNumberSegmentMapper.getMetaCopyNumberSegments(
        Arrays.asList(studyId), Arrays.asList(sampleId), chromosome);
  }
  ...
  public List<CopyNumberSeg> getCopyNumberSegmentsBySampleListId(
    ...
    return copyNumberSegmentMapper.getCopyNumberSegmentsBySampleListId(
