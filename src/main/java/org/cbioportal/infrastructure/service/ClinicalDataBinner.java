...
public class ClinicalDataBinner {
  ...
  public List<ClinicalDataBin> fetchClinicalDataBinCounts(
    ...
    List<String> attributeIds =
        attributes.stream().map(ClinicalDataBinFilter::getAttributeId).toList();
    ...
    List<ClinicalDataCountItem> unfilteredClinicalDataCounts =
        studyViewService.getClinicalDataCounts(partialFilter, attributeIds);
    List<ClinicalDataCountItem> filteredClinicalDataCounts =
        studyViewService.getClinicalDataCounts(studyViewFilter, attributeIds);
