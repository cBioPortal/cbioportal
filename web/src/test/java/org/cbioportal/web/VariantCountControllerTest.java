...
public class VariantCountControllerTest {
    private static final String TEST_MOLECULAR_PROFILE_STABLE_ID =
        "test_molecular_profile_stable_id";
    ...
    public void getVariantCounts() throws Exception {
        ...
        variantCount1.setNumberOfSamplesWithMutationInGene(
            TEST_NUMBER_OF_SAMPLES_WITH_MUTATION_IN_GENE_1
        );
        variantCount1.setNumberOfSamplesWithKeyword(
            TEST_NUMBER_OF_SAMPLES_WITH_KEYWORD_1
        );
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post(
                        "/molecular-profiles/test_molecular_profile_id/variant-counts/fetch"
                    )
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        objectMapper.writeValueAsString(variantCountIdentifiers)
                    )
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].numberOfSamplesWithMutationInGene")
                    .value(TEST_NUMBER_OF_SAMPLES_WITH_MUTATION_IN_GENE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].numberOfSamplesWithKeyword")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].numberOfSamplesWithMutationInGene")
                    .value(TEST_NUMBER_OF_SAMPLES_WITH_MUTATION_IN_GENE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].numberOfSamplesWithKeyword")
