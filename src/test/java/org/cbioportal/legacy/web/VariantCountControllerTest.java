    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(
                    "/api/molecular-profiles/test_molecular_profile_id/variant-counts/fetch")
                .with(csrf())
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].numberOfSamplesWithKeyword")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].numberOfSamplesWithMutationInGene")
                .value(TEST_NUMBER_OF_SAMPLES_WITH_MUTATION_IN_GENE_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].numberOfSamplesWithKeyword")
