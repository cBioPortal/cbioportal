...
public class ClinicalAttributeControllerTest {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    ...
                    .value(TEST_DISPLAY_NAME_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].patientAttribute")
                    .value(TEST_PATIENT_ATTRIBUTE_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    ...
                    .value(TEST_DISPLAY_NAME_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].patientAttribute")
                    .value(TEST_PATIENT_ATTRIBUTE_2)
            )
            .andExpect(
                MockMvcResultMatchers
    ...
    public void getAllClinicalAttributesMetaProjection() throws Exception {
        ...
        Mockito
            .when(clinicalAttributeService.getMetaClinicalAttributes())
            .thenReturn(baseMeta);
    ...
    @Test
    public void getAllClinicalAttributesInStudyDefaultProjection()
        throws Exception {
        List<ClinicalAttribute> clinicalAttributes = createExampleClinicalAttributes();
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/studies/test_study_id/clinical-attributes")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
    ...
    @Test
    public void getAllClinicalAttributesInStudyMetaProjection()
        throws Exception {
        BaseMeta baseMeta = new BaseMeta();
        baseMeta.setTotalCount(2);
        ...
        Mockito
            .when(
                clinicalAttributeService.getMetaClinicalAttributesInStudy(
                    Mockito.anyString()
                )
            )
            .thenReturn(baseMeta);
    ...
    public void getClinicalAttributeInStudyNotFound() throws Exception {
        Mockito
            ...
            .thenThrow(
                new ClinicalAttributeNotFoundException(
                    "test_study_id",
                    "test_clinical_attribute_id"
                )
            );
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get(
                        "/studies/test_study_id/clinical-attributes/test_clinical_attribute_id"
                    )
                    .accept(MediaType.APPLICATION_JSON)
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.message")
                    .value(
                        "Clinical attribute not found in study test_study_id: test_clinical_attribute_id"
                    )
            );
    }
    ...
    public void getClinicalAttributeInStudy() throws Exception {
        ...
        clinicalAttribute.setCancerStudyIdentifier(
    ...
    public void fetchClinicalAttributes() throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/clinical-attributes/fetch")
                    .accept(MediaType.APPLICATION_JSON)
    ...
    public void getClinicalAttributeCountsBySampleIds() throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/clinical-attributes/counts/fetch")
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
    ...
    private List<ClinicalAttribute> createExampleClinicalAttributes() {
        ...
        clinicalAttribute1.setCancerStudyIdentifier(
            TEST_CANCER_STUDY_IDENTIFIER_1
        );
        ...
        clinicalAttribute2.setCancerStudyIdentifier(
