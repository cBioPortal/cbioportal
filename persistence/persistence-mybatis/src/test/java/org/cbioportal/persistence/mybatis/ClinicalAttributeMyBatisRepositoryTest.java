...
public class ClinicalAttributeMyBatisRepositoryTest {
    ...
    public void getAllClinicalAttributesIdProjection() throws Exception {
        List<ClinicalAttribute> result = clinicalAttributeMyBatisRepository.getAllClinicalAttributes(
            "ID",
            null,
            null,
            null,
        ...
        Assert.assertEquals(
            "study_tcga_pub",
            clinicalAttribute.getCancerStudyIdentifier()
        );
    }
    ...
    public void getAllClinicalAttributesSummaryProjection() throws Exception {
        ...
        Assert.assertEquals(
            "Text indicator for the time frame of tissue procurement,indicating that the tissue was " +
            "obtained and stored prior to the initiation of the project.",
            clinicalAttribute.getDescription()
        );
        Assert.assertEquals(
    ...
    @Test
    public void getAllClinicalAttributesSummaryProjection1PageSize()
        throws Exception {
        List<ClinicalAttribute> result = clinicalAttributeMyBatisRepository.getAllClinicalAttributes(
            "SUMMARY",
            1,
    ...
    @Test
    public void getAllClinicalAttributesSummaryProjectionDisplayNameSort()
        throws Exception {
        List<ClinicalAttribute> result = clinicalAttributeMyBatisRepository.getAllClinicalAttributes(
            "SUMMARY",
            null,
        ...
        Assert.assertEquals(
            "Days to Sample Collection.",
            result.get(1).getDisplayName()
        );
        Assert.assertEquals(
            "Disease Free (Months)",
            result.get(2).getDisplayName()
        );
        Assert.assertEquals(
            "Disease Free (Months)",
            result.get(3).getDisplayName()
        );
        Assert.assertEquals(
            "Disease Free Status",
            result.get(4).getDisplayName()
        );
        Assert.assertEquals(
            "Disease Free Status",
            result.get(5).getDisplayName()
        );
    }
    ...
    public void getClinicalAttributeNullResult() throws Exception {
        ClinicalAttribute result = clinicalAttributeMyBatisRepository.getClinicalAttribute(
            "study_tcga_pub",
    ...
    public void getClinicalAttribute() throws Exception {
        ...
        Assert.assertEquals(
            "study_tcga_pub",
            result.getCancerStudyIdentifier()
        );
    ...
    @Test
    public void getAllClinicalAttributesInStudySummaryProjection()
        throws Exception {
    ...
    public void getMetaClinicalAttributesInStudy() throws Exception {
        BaseMeta result = clinicalAttributeMyBatisRepository.getMetaClinicalAttributesInStudy(
            "study_tcga_pub"
        );
    ...
    public void fetchClinicalAttributes() throws Exception {
        List<ClinicalAttribute> result = clinicalAttributeMyBatisRepository.fetchClinicalAttributes(
            Arrays.asList("acc_tcga", "study_tcga_pub"),
            "SUMMARY"
        );
    ...
    public void fetchMetaClinicalAttributes() throws Exception {
        BaseMeta result = clinicalAttributeMyBatisRepository.fetchMetaClinicalAttributes(
            Arrays.asList("acc_tcga", "study_tcga_pub")
        );
    ...
    public void getClinicalAttributeCountsBySampleIds() throws Exception {
        ...
        List<ClinicalAttributeCount> result = clinicalAttributeMyBatisRepository.getClinicalAttributeCountsBySampleIds(
            studyId,
            sampleIds
        );
        ...
        Assert.assertEquals(
            "RETROSPECTIVE_COLLECTION",
            clinicalAttributeCount.getAttrId()
        );
    ...
    public void getClinicalAttributeCountsBySampleListId() throws Exception {
        ...
        sampleIds.add("TCGA-A1-A0SB-01");
        sampleIds.add("TCGA-A1-A0SD-01");
        List<ClinicalAttributeCount> result = clinicalAttributeMyBatisRepository.getClinicalAttributeCountsBySampleListId(
            "study_tcga_pub_all"
        );
