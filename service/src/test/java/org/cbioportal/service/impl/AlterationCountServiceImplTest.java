...
public class AlterationCountServiceImplTest extends BaseServiceImplTest {
    ...
    public void getSampleFusionCounts() {
        ...
        List<AlterationCountByGene> result = alterationCountService.getSampleStructuralVariantCounts(
            caseIdentifiers,
            entrezGeneIds,
            includeFrequency,
            includeMissingAlterationsFromGenePanel,
    ...
    public void getPatientFusionCounts() {
        ...
        List<AlterationCountByGene> result = alterationCountService.getPatientStructuralVariantCounts(
            caseIdentifiers,
            entrezGeneIds,
            includeFrequency,
            includeMissingAlterationsFromGenePanel,
