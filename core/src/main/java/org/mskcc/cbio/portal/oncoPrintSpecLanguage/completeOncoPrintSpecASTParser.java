...
public class completeOncoPrintSpecASTParser extends Parser {
    ...
    public completeOncoPrintSpecASTParser(
        TokenStream input,
    ...
    public String[] getTokenNames() {
        return completeOncoPrintSpecASTParser.tokenNames;
    }

    public String getGrammarFileName() {
        return "../completeOncoPrintSpecAST.g";
    }
    ...
    public void displayRecognitionError(
        ...
        String hdr =
            "Syntax error at char " + normalPos + " of line " + e.line + ": ";
    ...
    public String getErrorMessage(RecognitionException e, String[] tokenNames) {
        ...
        if (e instanceof UnwantedTokenException) {
            ...
            msg =
                "missing " + tokenName + " at " + getTokenErrorDisplay(e.token);
            ...
            msg =
                "found empty list at " + // "required (...)+ loop did not match anything at input "
                getTokenErrorDisplay(e.token);
    ...
    public static class oncoPrintSpecification_return
    ...
    public final completeOncoPrintSpecASTParser.oncoPrintSpecification_return oncoPrintSpecification()
        ...
        RewriteRuleSubtreeStream stream_userGeneList = new RewriteRuleSubtreeStream(
            adaptor,
            "rule userGeneList"
        );
        try {
                ...
                loop1:do {
                    ...
                    switch (alt1) {
                        case 1:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_userGeneList_in_oncoPrintSpecification45
                                );
                                userGeneList1 = userGeneList();

                                state._fsp--;

                                stream_userGeneList.add(
                                    userGeneList1.getTree()
                                );
                            }
                            break;
                        default:
    ...
    public final completeOncoPrintSpecASTParser.userGeneList_return userGeneList()
        throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_21 = new RewriteRuleTokenStream(
            adaptor,
            "token 21"
        );
        RewriteRuleTokenStream stream_22 = new RewriteRuleTokenStream(
            adaptor,
            "token 22"
        );
        ...
        RewriteRuleSubtreeStream stream_geneList = new RewriteRuleSubtreeStream(
            adaptor,
            "rule geneList"
        );
        try {
                                ...
                                // ../completeOncoPrintSpecAST.g:135:4: '{' geneList '}'
                                {
                                    char_literal3 =
                                        (Token) match(
                                            input,
                                            21,
                                            FOLLOW_21_in_userGeneList75
                                        );
                                    stream_21.add(char_literal3);

                                    pushFollow(
                                        FOLLOW_geneList_in_userGeneList77
                                    );
                                    geneList4 = geneList();
                                ...
                                // ../completeOncoPrintSpecAST.g:136:4: STRING '{' geneList '}'
                                {
                                    STRING6 =
                                        (Token) match(
                                            input,
                                            STRING,
                                            FOLLOW_STRING_in_userGeneList85
                                        );
                                    ...
                                    char_literal7 =
                                        (Token) match(
                                            input,
                                            21,
                                            FOLLOW_21_in_userGeneList87
                                        );
                                    stream_21.add(char_literal7);

                                    pushFollow(
                                        FOLLOW_geneList_in_userGeneList89
                                    );
                                    geneList8 = geneList();
    ...
    public final completeOncoPrintSpecASTParser.geneList_return geneList()
        throws RecognitionException {
        ...
        completeOncoPrintSpecASTParser.individualGene_return individualGene10 =
            null;

        completeOncoPrintSpecASTParser.defaultDataTypeSpec_return defaultDataTypeSpec11 =
            null;
                ...
                loop4:do {
                    ...
                    switch (alt4) {
                        case 1:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_individualGene_in_geneList135
                                );
                        ...
                        case 2:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_defaultDataTypeSpec_in_geneList139
                                );
    ...
    public final completeOncoPrintSpecASTParser.individualGene_return individualGene()
        throws RecognitionException {
        ...
        Token ID12 = null;
        completeOncoPrintSpecASTParser.fullDataTypeSpec_return fullDataTypeSpec13 =
            null;
        ...
        RewriteRuleSubtreeStream stream_fullDataTypeSpec = new RewriteRuleSubtreeStream(
            adaptor,
            "rule fullDataTypeSpec"
        );
        try {
            ...
            // ../completeOncoPrintSpecAST.g:152:2: ID ( fullDataTypeSpec )?
            {
                ...
                switch (alt5) {
                    case 1:
                        ...
                        {
                            pushFollow(
                                FOLLOW_fullDataTypeSpec_in_individualGene157
                            );
                            fullDataTypeSpec13 = fullDataTypeSpec();

                            state._fsp--;

                            stream_fullDataTypeSpec.add(
                                fullDataTypeSpec13.getTree()
                            );
                        }
                        break;
                }
                ...
                // 152:23: -> ^( IndividualGene ID ( fullDataTypeSpec )? )
                {
                    // ../completeOncoPrintSpecAST.g:152:26: ^( IndividualGene ID ( fullDataTypeSpec )? )
                    {
                        ...
                        if (stream_fullDataTypeSpec.hasNext()) {
                            adaptor.addChild(
                                root_1,
                                stream_fullDataTypeSpec.nextTree()
                            );
                        }
    ...
    public static class defaultDataTypeSpec_return
        extends ParserRuleReturnScope {
        Object tree;
    ...
    public final completeOncoPrintSpecASTParser.defaultDataTypeSpec_return defaultDataTypeSpec()
        throws RecognitionException {
        ...
        completeOncoPrintSpecASTParser.fullDataTypeSpec_return fullDataTypeSpec15 =
            null;

        Object string_literal14_tree = null;
        RewriteRuleTokenStream stream_23 = new RewriteRuleTokenStream(
            adaptor,
            "token 23"
        );
        RewriteRuleSubtreeStream stream_fullDataTypeSpec = new RewriteRuleSubtreeStream(
            ...
            // ../completeOncoPrintSpecAST.g:159:4: 'DATATYPES' fullDataTypeSpec
            {
                string_literal14 =
                    (Token) match(
                        input,
                        23,
                        FOLLOW_23_in_defaultDataTypeSpec190
                    );
    ...
    public final completeOncoPrintSpecASTParser.fullDataTypeSpec_return fullDataTypeSpec()
        throws RecognitionException {
        ...
        completeOncoPrintSpecASTParser.dataTypeSpec_return dataTypeSpec17 =
            null;

        Object char_literal16_tree = null;
        Object char_literal18_tree = null;
        RewriteRuleTokenStream stream_24 = new RewriteRuleTokenStream(
            adaptor,
            "token 24"
        );
        RewriteRuleTokenStream stream_25 = new RewriteRuleTokenStream(
            adaptor,
            "token 25"
        );
        RewriteRuleSubtreeStream stream_dataTypeSpec = new RewriteRuleSubtreeStream(
            adaptor,
            "rule dataTypeSpec"
        );
        try {
            ...
            {
                char_literal16 =
                    (Token) match(input, 24, FOLLOW_24_in_fullDataTypeSpec222);
                ...
                loop6:do {
                    ...
                    switch (alt6) {
                        case 1:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_dataTypeSpec_in_fullDataTypeSpec226
                                );
                                dataTypeSpec17 = dataTypeSpec();

                                state._fsp--;

                                stream_dataTypeSpec.add(
                                    dataTypeSpec17.getTree()
                                );
                            }
                            break;
                        default:
                ...
                char_literal18 =
                    (Token) match(input, 25, FOLLOW_25_in_fullDataTypeSpec231);
    ...
    public final completeOncoPrintSpecASTParser.dataTypeSpec_return dataTypeSpec()
        throws RecognitionException {
        ...
        Token ID19 = null;
        completeOncoPrintSpecASTParser.discreteDataType_return discreteDataType20 =
            null;

        completeOncoPrintSpecASTParser.continuousDataTypeInequality_return continuousDataTypeInequality21 =
            null;
                    ...
                    case COMPARISON_OP:
                        {
                            ...
                            if ((LA7_2 == ID)) {
                                ...
                                (LA7_2 == SIGNED_INT || LA7_2 == SIGNED_FLOAT)
                            ) {
                                alt7 = 3;
                            } else {
                                NoViableAltException nvae = new NoViableAltException(
            ...
            switch (alt7) {
                ...
                case 3:
                    // ../completeOncoPrintSpecAST.g:176:4: continuousDataTypeInequality
                    {
                        ...
                        pushFollow(
                            FOLLOW_continuousDataTypeInequality_in_dataTypeSpec271
                        );
                        continuousDataTypeInequality21 =
                            continuousDataTypeInequality();
                        ...
                        adaptor.addChild(
                            root_0,
                            continuousDataTypeInequality21.getTree()
                        );
                    }
                    break;
            }
    ...
    public final completeOncoPrintSpecASTParser.discreteDataType_return discreteDataType()
        throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_SIGNED_INT = new RewriteRuleTokenStream(
            adaptor,
            "token SIGNED_INT"
        );
        RewriteRuleTokenStream stream_ID = new RewriteRuleTokenStream(
        ...
        RewriteRuleTokenStream stream_COMPARISON_OP = new RewriteRuleTokenStream(
            adaptor,
            "token COMPARISON_OP"
        );
                        ...
                        // ../completeOncoPrintSpecAST.g:184:4: ID COMPARISON_OP ID
                        {
                            ID22 =
                                (Token) match(
                                    input,
                                    ID,
                                    FOLLOW_ID_in_discreteDataType297
                                );
                            stream_ID.add(ID22);
                            ...
                            COMPARISON_OP23 =
                                (Token) match(
                                    input,
                                    COMPARISON_OP,
                                    FOLLOW_COMPARISON_OP_in_discreteDataType299
                                );
                            ...
                            ID24 =
                                (Token) match(
                                    input,
                                    ID,
                                    FOLLOW_ID_in_discreteDataType301
                                );
                            stream_ID.add(ID24);
                        }
                        ...
                        // ../completeOncoPrintSpecAST.g:185:6: ID SIGNED_INT
                        {
                            ID25 =
                                (Token) match(
                                    input,
                                    ID,
                                    FOLLOW_ID_in_discreteDataType323
                                );
                            stream_ID.add(ID25);
                            ...
                            SIGNED_INT26 =
                                (Token) match(
                                    input,
                                    SIGNED_INT,
                                    FOLLOW_SIGNED_INT_in_discreteDataType325
                                );
    ...
    public static class continuousDataTypeInequality_return
        extends ParserRuleReturnScope {
        Object tree;
    ...
    public final completeOncoPrintSpecASTParser.continuousDataTypeInequality_return continuousDataTypeInequality()
        throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_floatOrInt = new RewriteRuleSubtreeStream(
            adaptor,
            "rule floatOrInt"
        );
        try {
                ...
                // ../completeOncoPrintSpecAST.g:192:4: ID COMPARISON_OP floatOrInt
                {
                    ID27 =
                        (Token) match(
                            input,
                            ID,
                            FOLLOW_ID_in_continuousDataTypeInequality366
                        );
                    stream_ID.add(ID27);
                    ...
                    COMPARISON_OP28 =
                        (Token) match(
                            input,
                            COMPARISON_OP,
                            FOLLOW_COMPARISON_OP_in_continuousDataTypeInequality368
                        );
                    stream_COMPARISON_OP.add(COMPARISON_OP28);

                    pushFollow(
                        FOLLOW_floatOrInt_in_continuousDataTypeInequality370
                    );
    ...
    public final completeOncoPrintSpecASTParser.floatOrInt_return floatOrInt()
        throws RecognitionException {
    ...
    public static final BitSet FOLLOW_userGeneList_in_oncoPrintSpecification45 = new BitSet(
        new long[] { 0x0000000000A00052L }
    );
    public static final BitSet FOLLOW_geneList_in_userGeneList65 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_21_in_userGeneList75 = new BitSet(
        new long[] { 0x0000000000800040L }
    );
    public static final BitSet FOLLOW_geneList_in_userGeneList77 = new BitSet(
        new long[] { 0x0000000000400000L }
    );
    public static final BitSet FOLLOW_22_in_userGeneList79 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_STRING_in_userGeneList85 = new BitSet(
        new long[] { 0x0000000000200000L }
    );
    public static final BitSet FOLLOW_21_in_userGeneList87 = new BitSet(
        new long[] { 0x0000000000800040L }
    );
    public static final BitSet FOLLOW_geneList_in_userGeneList89 = new BitSet(
        new long[] { 0x0000000000400000L }
    );
    public static final BitSet FOLLOW_22_in_userGeneList91 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_individualGene_in_geneList135 = new BitSet(
        new long[] { 0x0000000000800042L }
    );
    public static final BitSet FOLLOW_defaultDataTypeSpec_in_geneList139 = new BitSet(
        new long[] { 0x0000000000800042L }
    );
    public static final BitSet FOLLOW_ID_in_individualGene155 = new BitSet(
        new long[] { 0x0000000001000002L }
    );
    public static final BitSet FOLLOW_fullDataTypeSpec_in_individualGene157 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_23_in_defaultDataTypeSpec190 = new BitSet(
        new long[] { 0x0000000001000000L }
    );
    public static final BitSet FOLLOW_fullDataTypeSpec_in_defaultDataTypeSpec194 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_24_in_fullDataTypeSpec222 = new BitSet(
        new long[] { 0x0000000000000040L }
    );
    public static final BitSet FOLLOW_dataTypeSpec_in_fullDataTypeSpec226 = new BitSet(
        new long[] { 0x0000000002000040L }
    );
    public static final BitSet FOLLOW_25_in_fullDataTypeSpec231 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_ID_in_dataTypeSpec251 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_discreteDataType_in_dataTypeSpec265 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_continuousDataTypeInequality_in_dataTypeSpec271 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_ID_in_discreteDataType297 = new BitSet(
        new long[] { 0x0000000000000400L }
    );
    public static final BitSet FOLLOW_COMPARISON_OP_in_discreteDataType299 = new BitSet(
        new long[] { 0x0000000000000040L }
    );
    public static final BitSet FOLLOW_ID_in_discreteDataType301 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_ID_in_discreteDataType323 = new BitSet(
        new long[] { 0x0000000000000800L }
    );
    public static final BitSet FOLLOW_SIGNED_INT_in_discreteDataType325 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_ID_in_continuousDataTypeInequality366 = new BitSet(
        new long[] { 0x0000000000000400L }
    );
    public static final BitSet FOLLOW_COMPARISON_OP_in_continuousDataTypeInequality368 = new BitSet(
        new long[] { 0x0000000000002800L }
    );
    public static final BitSet FOLLOW_floatOrInt_in_continuousDataTypeInequality370 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_set_in_floatOrInt0 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
}
