...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleUnsupportedOperation() {
    return new ResponseEntity<>(
        new ErrorResponse("Requested API is not implemented yet"), HttpStatus.NOT_IMPLEMENTED);
  }

  @ExceptionHandler(StudyNotFoundException.class)
  public ResponseEntity<ErrorResponse> handleStudyNotFound(StudyNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Study not found: " + ex.getStudyId()), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handlePatientNotFound(PatientNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse(
            "Patient not found in study " + ex.getStudyId() + ": " + ex.getPatientId()),
  ...
  public ResponseEntity<ErrorResponse> handleCancerTypeNotFound(CancerTypeNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Cancer type not found: " + ex.getCancerTypeId()), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleMolecularProfileNotFound(
    ...
    return new ResponseEntity<>(
        new ErrorResponse("Molecular profile not found: " + ex.getMolecularProfileId()),
        HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleSampleNotFound(SampleNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Sample not found in study " + ex.getStudyId() + ": " + ex.getSampleId()),
        HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleGeneNotFound(GeneNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Gene not found: " + ex.getGeneId()), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleGenesetNotFound(GenesetNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Gene set not found: " + ex.getGenesetId()), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleSampleListNotFound(SampleListNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Sample list not found: " + ex.getSampleListId()), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleDataAccessTokenNoUserIdentityException() {
    ErrorResponse response =
        new ErrorResponse("No authenticated identity found while processing request");
  ...
  public ResponseEntity<ErrorResponse> handleCacheNotFoundException(CacheNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("No cache found with name " + ex.getCacheName()), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<ErrorResponse> handleGenericAssayNotFound(
    ...
    return new ResponseEntity<>(
        new ErrorResponse("stableId not found: " + ex.getStableId()), HttpStatus.NOT_FOUND);
  }

  @ExceptionHandler(ResourceDefinitionNotFoundException.class)
  public ResponseEntity<ErrorResponse> handleResourceDefinitionNotFound(
      ResourceDefinitionNotFoundException ex) {
    return new ResponseEntity<>(
        new ErrorResponse("Resource not found: " + ex.getResourceId()), HttpStatus.NOT_FOUND);
  }
