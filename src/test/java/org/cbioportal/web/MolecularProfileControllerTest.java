...
public class MolecularProfileControllerTest {
  ...
  public void getAllMolecularProfilesDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/molecular-profiles")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].showProfileInAnalysisTab")
                .value(TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].pivotThreshold")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].showProfileInAnalysisTab")
                .value(TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].pivotThreshold")
  ...
  public void getAllMolecularProfilesMetaProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/molecular-profiles").param("projection", "META"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  public void getMolecularProfileNotFound() throws Exception {
    ...
    Mockito.when(molecularProfileService.getMolecularProfile(Mockito.anyString()))
        .thenThrow(new MolecularProfileNotFoundException("test_molecular_profile_id"));

    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/molecular-profiles/test_molecular_profile_id")
                .accept(MediaType.APPLICATION_JSON))
  ...
  public void getMolecularProfile() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.molecularAlterationType")
                .value(TEST_MOLECULAR_ALTERATION_TYPE_1.toString()))
        .andExpect(MockMvcResultMatchers.jsonPath("$.datatype").value(TEST_DATATYPE_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.genericAssayType").value(TEST_GENERIC_ASSAY_TYPE_1))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.showProfileInAnalysisTab")
                .value(TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.pivotThreshold").value(TEST_STUDY_PIVOT_THRESHOLD_1))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.study.studyId").value(TEST_CANCER_STUDY_IDENTIFIER_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.study.description").value(TEST_STUDY_DESCRIPTION_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$.study.name").value(TEST_STUDY_NAME_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.study.cancerTypeId").value(TEST_TYPE_OF_CANCER_ID_1));
  }
  ...
  public void getAllMolecularProfilesInStudyDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/studies/test_study_id/molecular-profiles")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(
            MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
  ...
  public void getAllMolecularProfilesInStudyMetaProjection() throws Exception {
    ...
    Mockito.when(molecularProfileService.getMetaMolecularProfilesInStudy(Mockito.anyString()))
        .thenReturn(baseMeta);
  ...
  public void fetchMolecularProfiles() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/molecular-profiles/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
