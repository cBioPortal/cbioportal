...
@Import({
  ...
  ClinicalEventMyBatisRepository.class,
...
public class ClinicalEventMyBatisRepositoryTest {
  ...
  @Autowired private ClinicalEventMyBatisRepository clinicalEventMyBatisRepository;

  @Test
  public void getAllClinicalEventsOfPatientInStudyIdProjection() throws Exception {

    List<ClinicalEvent> result =
        clinicalEventMyBatisRepository.getAllClinicalEventsOfPatientInStudy(
  ...
  @Test
  public void getAllClinicalEventsOfPatientInStudySummaryProjectionEventTypeSort()
      throws Exception {
  ...
  public void getMetaPatientClinicalEvents() throws Exception {
    ...
    BaseMeta result =
        clinicalEventMyBatisRepository.getMetaPatientClinicalEvents(
            "study_tcga_pub", "TCGA-A1-A0SB");
  ...
  public void getDataOfClinicalEvents() throws Exception {
    ...
    List<ClinicalEventData> result =
        clinicalEventMyBatisRepository.getDataOfClinicalEvents(clinicalEventIds);
  ...
  public void getAllClinicalEventsInStudyIdProjection() throws Exception {
    List<ClinicalEvent> result =
        clinicalEventMyBatisRepository.getAllClinicalEventsInStudy(
  ...
  public void getSamplesOfPatientsPerEventTypeInStudy() {
    ...
    Map<String, Set<String>> result =
        clinicalEventMyBatisRepository.getSamplesOfPatientsPerEventTypeInStudy(
            studyList, sampleList);
  ...
  public void getPatientsDistinctClinicalEventInStudies() {
    ...
    List<ClinicalEvent> result =
        clinicalEventMyBatisRepository.getPatientsDistinctClinicalEventInStudies(
            studyList, patientList);

    List<String> eventTypes =
        result.stream().map(ClinicalEvent::getEventType).collect(Collectors.toList());
    Assert.assertEquals(2, result.size());
  ...
  public void getTimelineEvents() {
    ...
    List<ClinicalEvent> result =
        clinicalEventMyBatisRepository.getTimelineEvents(
            studyList, patientList, List.of(requestClinicalEvent));
  ...
  public void getClinicalEventsMeta() {
    ...
    requestClinicalEvent.setAttributes(Arrays.asList(clinicalEventData1, clinicalEventData2));
    List<ClinicalEvent> result =
        clinicalEventMyBatisRepository.getClinicalEventsMeta(
            studyList, patientList, List.of(requestClinicalEvent));
