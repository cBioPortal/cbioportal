...
ALTER TABLE `mutation_event` CHANGE COLUMN `ONCOTATOR_REFSEQ_MRNA_ID` `MUTATION_REFSEQ_MRNA_ID` varchar(64);
ALTER TABLE `mutation_event` CHANGE COLUMN `ONCOTATOR_CODON_CHANGE` `MUTATION_CODON_CHANGE` varchar(255);
