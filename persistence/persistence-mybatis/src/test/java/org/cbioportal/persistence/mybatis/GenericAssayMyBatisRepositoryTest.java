...
public class GenericAssayMyBatisRepositoryTest {
    ...
    public void getGenericAssayMeta() {
        ...
        List<GenericAssayMeta> result = genericAssayMyBatisRepository.getGenericAssayMeta(
            stableIds
        );
    ...
    public void getGeneticEntityIdByStableId() {
        int result = genericAssayMyBatisRepository.getGeneticEntityIdByStableId(
            "Nmut"
        );
    ...
    public void getGenericAssayMetaPropertiesMap() {
        List<HashMap<String, String>> result = genericAssayMyBatisRepository.getGenericAssayMetaPropertiesMap(
            28
        );
        Assert.assertNotNull(result);
        Assert.assertEquals(2, result.size());
