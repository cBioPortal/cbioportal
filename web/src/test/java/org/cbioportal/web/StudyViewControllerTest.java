...
public class StudyViewControllerTest {
    ...
    public void fetchClinicalDataCounts() throws Exception {
        ...
        Mockito.when(studyViewFilterApplier.apply(Mockito.anyObject(), Matchers.any(FilterType.class))).thenReturn(filteredSampleIdentifiers);
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/attributes/test_attribute_id/clinical-data-counts/fetch")
