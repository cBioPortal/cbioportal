...
public class VSAwareClinicalDataRepository implements ClinicalDataRepository {
    ...
    @Override
    public List<ClinicalData> fetchClinicalData(List<String> studyIds, List<String> ids, List<String> attributeIds, String clinicalDataType, String projection) {
        return List.of();
    }
    ...
    @Override
    public List<ClinicalDataCount> fetchClinicalDataCounts(List<String> studyIds, List<String> sampleIds, List<String> attributeIds, String clinicalDataType, String projection) {
        return List.of();
    }

    @Override
    public List<ClinicalData> getPatientClinicalDataDetailedToSample(List<String> studyIds, List<String> patientIds, List<String> attributeIds) {
        return List.of();
    }

    @Override
    public List<Integer> getVisibleSampleInternalIdsForClinicalTable(List<String> studyIds, List<String> sampleIds, Integer pageSize, Integer pageNumber, String searchTerm, String sortBy, String direction) {
        return List.of();
    }

    @Override
    public List<ClinicalData> getSampleClinicalDataBySampleInternalIds(List<Integer> visibleSampleInternalIds) {
        return List.of();
    }

    @Override
    public List<ClinicalData> getPatientClinicalDataBySampleInternalIds(List<Integer> visibleSampleInternalIds) {
        return List.of();
    }
}
