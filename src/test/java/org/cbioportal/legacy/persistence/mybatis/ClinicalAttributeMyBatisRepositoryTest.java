...
public class ClinicalAttributeMyBatisRepositoryTest {
  ...
  public void getAllClinicalAttributesIdProjection() throws Exception {
    ...
    List<ClinicalAttribute> result =
        clinicalAttributeMyBatisRepository.getAllClinicalAttributes("ID", null, null, null, null);
  ...
  public void getAllClinicalAttributesSummaryProjection() throws Exception {
    ...
    Assert.assertEquals(
        "Tissue Retrospective Collection Indicator", clinicalAttribute.getDisplayName());
  ...
  public void getAllClinicalAttributesSummaryProjection1PageSize() throws Exception {
    ...
    List<ClinicalAttribute> result =
        clinicalAttributeMyBatisRepository.getAllClinicalAttributes("SUMMARY", 1, 0, null, null);
  ...
  public void getAllClinicalAttributesSummaryProjectionDisplayNameSort() throws Exception {
    ...
    List<ClinicalAttribute> result =
        clinicalAttributeMyBatisRepository.getAllClinicalAttributes(
            "SUMMARY", null, null, "displayName", "ASC");
  ...
  public void getClinicalAttributeNullResult() throws Exception {
    ...
    ClinicalAttribute result =
        clinicalAttributeMyBatisRepository.getClinicalAttribute(
            "study_tcga_pub", "invalid_clinical_attribute");
  ...
  public void getClinicalAttribute() throws Exception {
    ...
    ClinicalAttribute result =
        clinicalAttributeMyBatisRepository.getClinicalAttribute(
            "study_tcga_pub", "RETROSPECTIVE_COLLECTION");
  ...
  public void getAllClinicalAttributesInStudySummaryProjection() throws Exception {
    ...
    List<ClinicalAttribute> result =
        clinicalAttributeMyBatisRepository.getAllClinicalAttributesInStudy(
  ...
  public void getMetaClinicalAttributesInStudy() throws Exception {
    ...
    BaseMeta result =
        clinicalAttributeMyBatisRepository.getMetaClinicalAttributesInStudy("study_tcga_pub");
  ...
  public void fetchMetaClinicalAttributes() throws Exception {
    ...
    BaseMeta result =
        clinicalAttributeMyBatisRepository.fetchMetaClinicalAttributes(
  ...
  public void getClinicalAttributeCountsBySampleIds() throws Exception {
    ...
    List<ClinicalAttributeCount> result =
        clinicalAttributeMyBatisRepository.getClinicalAttributeCountsBySampleIds(
            studyId, sampleIds);
  ...
  public void getClinicalAttributeCountsBySampleListId() throws Exception {
    ...
    sampleIds.add("TCGA-A1-A0SD-01");
    List<ClinicalAttributeCount> result =
        clinicalAttributeMyBatisRepository.getClinicalAttributeCountsBySampleListId(
            "study_tcga_pub_all");
