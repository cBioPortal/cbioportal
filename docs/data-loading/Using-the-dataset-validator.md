...
cBioPortal is gradually introducing support for mouse. If you want to load mouse studies and you have to [set up your database for mouse](/legacy/Import-the-Seed-Database.md#download-the-cbioportal-seed-database).
