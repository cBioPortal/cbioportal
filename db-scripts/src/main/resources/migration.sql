...
ALTER TABLE `mutation_event` DROP COLUMN `ONCOTATOR_REFSEQ_MRNA_ID`;
ALTER TABLE `mutation_event` DROP COLUMN `ONCOTATOR_DBSNP_RS`;
ALTER TABLE `mutation_event` DROP COLUMN `ONCOTATOR_CODON_CHANGE`;
ALTER TABLE `mutation_event` DROP COLUMN `ONCOTATOR_UNIPROT_ENTRY_NAME`;
ALTER TABLE `mutation_event` DROP COLUMN `ONCOTATOR_UNIPROT_ACCESSION`;
