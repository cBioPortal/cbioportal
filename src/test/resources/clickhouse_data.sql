...
insert into resource_definition (resource_id, cancer_study_id, resource_type, display_name, description, open_by_default, priority, custom_metadata) values ('RADIOLOGY', 1, 'SAMPLE', 'Radiology', 'Radiology images', 1, 4, '{"version":1,"fields":[{"key":"dose_id","type":"string"},{"key":"score","type":"number"}]}');

insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (1, 'HE_SLIDE', 1, 'SAMPLE', 'tcga-a1-a0sb', 'tcga-a1-a0sb-01', 'https://example.com/he1.jpg', 'H&E Sample 1', 'IMAGE', '{"stain":"HE","magnification":"20x"}', 1);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (2, 'HE_SLIDE', 1, 'SAMPLE', 'tcga-a1-a0sd', 'tcga-a1-a0sd-01', 'https://example.com/he2.jpg', 'H&E Sample 2', 'IMAGE', '{"stain":"HE","magnification":"40x"}', 1);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (3, 'CT_SCAN', 1, 'PATIENT', 'tcga-a1-a0sb', NULL, 'https://example.com/ct1.dcm', 'CT Scan Patient 1', 'LINK', NULL, 2);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (4, 'FIGURES', 1, 'STUDY', NULL, NULL, 'https://example.com/fig1.pdf', 'Study Figure', 'PDF', '{"pages":10}', 3);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (5, 'FIGURES', 1, 'STUDY', NULL, NULL, 'https://example.com/fig2.pdf', 'Study Figure 2', 'PDF', '{"pages":25}', 3);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (6, 'RADIOLOGY', 1, 'SAMPLE', 'tcga-a1-a0se', 'tcga-a1-a0se-01', 'https://example.com/rad1.dcm', 'Radiology 1', 'IMAGE', '{"dose_id":"1001","score":"85"}', 4);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (7, 'RADIOLOGY', 1, 'SAMPLE', 'tcga-a1-a0sf', 'tcga-a1-a0sf-01', 'https://example.com/rad2.dcm', 'Radiology 2', 'IMAGE', '{"dose_id":"1002","score":"42"}', 4);
