...
@Repository
public class ClinicalAttributeMyBatisRepository
    implements ClinicalAttributeRepository {
    @Autowired
    ...
    public BaseMeta getMetaClinicalAttributesInStudy(String studyId) {
        return clinicalAttributeMapper.getMetaClinicalAttributes(
            Arrays.asList(studyId)
        );
    }
    ...
    public List<ClinicalAttributeCount> getClinicalAttributeCountsBySampleIds(
        ...
        return clinicalAttributeMapper.getClinicalAttributeCountsBySampleIds(
            studyIds,
            sampleIds
        );
    }
    ...
    public List<ClinicalAttributeCount> getClinicalAttributeCountsBySampleListId(
        ...
        return clinicalAttributeMapper.getClinicalAttributeCountsBySampleListId(
            sampleListId
        );
    }
