...
public class TestOncoPrintSpecificationInParser {
    ...
    public void testContinuousDataTypeInequalityInParser() {
        tryAcontinuousDataTypeInequality(
        ...
        tryErroneousProduction(
            ...
            "barf < 1.3",
            "Error at char 1 of line 1: " +
            "'barf' is not a valid genetic data type."
        );
    }

    private void tryAcontinuousDataTypeInequality(
        GeneticDataTypes aGeneticDataTypes,
        ComparisonOp aComparisonOp,
        float t,
        String testLangFragment
    ) {
        try {
            ...
            Assert.assertEquals(
                ...
                (ContinuousDataTypeSpec) parseMethod(
                    "continuousDataTypeInequality",
                    testLangFragment
                )
            );
            ...
            System.out.println(
                "testcontinuousDataTypeInequality: RecognitionException: " +
                e.getMessage()
            );
            e.printStackTrace();
        } catch (Throwable e) {
    ...
    public void testDiscreteDataTypeInParser() {
        ...
        tryErroneousProduction(
            "discreteDataType",
            "Foo <= blah",
            "Error at char 1 of line 1: 'Foo <= blah' " +
            "is not a valid discrete genetic data type and discrete genetic data level."
        );
        tryErroneousProduction(
            "discreteDataType",
            "\nExp <= blah",
            "Error at char 1 of line 2: 'Exp <= blah' " +
            "is not a valid discrete genetic data type and discrete genetic data level."
        );
        tryErroneousProduction(
            "discreteDataType",
            "CNA 5",
            "Error at char 1 of line 1: 'CNA 5' is " +
        ...
        try {
            ...
            Assert.assertTrue(
                aDiscreteDataTypeSpec.equals(
                    (DiscreteDataTypeSpec) parseMethod(
                        "discreteDataType",
                        testLangFragment
                    )
                )
            ...
            System.out.println(
                "testDiscreteDataType: RecognitionException: " + e.getMessage()
            );
            e.printStackTrace();
        } catch (Throwable e) {
            e.printStackTrace();
        ...
        try {
            ...
            Assert.assertTrue(
                aDiscreteDataTypeSetSpec.equals(
                    (DiscreteDataTypeSetSpec) parseMethod(
                        "discreteDataType",
                        testLangFragment
                    )
                )
        ...
        try {
            Assert.assertTrue(
                aConcreteDataTypeSpec.equals(
                    (ConcreteDataTypeSpec) parseMethod(
                        "dataTypeSpec",
                        testLangFragment
                    )
                )
    ...
    public void testFullDataTypeSpecInParser() {
        try {
            ...
            theResultFullDataTypeSpec =
                (OncoPrintGeneDisplaySpec) parseMethod(
                    "fullDataTypeSpec",
                    ": C ; "
                );
            Assert.assertTrue(
    ...
    public void testGeneListInParser() {
        try {
            GeneSet theGeneSet = (GeneSet) parseMethod(
                "userGeneList",
            ...
            Assert.assertTrue(
                aGeneWithSpec
                    ...
                    .satisfy(GeneticDataTypes.Methylation)
            );
            Assert.assertTrue(
                aGeneWithSpec
                    .getTheOncoPrintGeneDisplaySpec()
    ...
    public void testIndividualGeneInParser() {
        try {
            GeneWithSpec aGeneWithSpec = (GeneWithSpec) parseMethod(
                "individualGene",
                "amazin : " + "CNA Mutation C -2 Expression<-2; "
            );
            checkAgeneWithSpec(aGeneWithSpec);

            aGeneWithSpec =
                (GeneWithSpec) parseMethod(
                    "individualGene",
    ...
    public void testOncoPrintSpecificationInParser() {
        try {
            ...
            for (GeneSet gs : theParserOutput
    ...
    private void tryOncoPrintSpecification(
        String testLangFragment,
        String[] errorMsgs
    ) {
        OncoPrintGeneDisplaySpec theOncoPrintGeneDisplaySpec = new OncoPrintGeneDisplaySpec();
     ...
     */
    private void tryErroneousProduction(
        String production,
        String testLangFragment,
        String errorMsg
    ) {
     ...
     * loads of reflection
     */
    public static Object parseMethod(String method, String prog)
        throws Throwable {
