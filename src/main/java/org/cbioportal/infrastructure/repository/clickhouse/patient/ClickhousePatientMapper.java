...
/**
 * Mapper interface for retrieving patient data from ClickHouse. This interface provides methods for
 * fetching patient counts and case list data counts.
 */
public interface ClickhousePatientMapper {
   ...
   */
  List<CaseListDataCount> getCaseListDataCounts(
      @Param("studyViewFilterContext") StudyViewFilterContext studyViewFilterContext);
}
