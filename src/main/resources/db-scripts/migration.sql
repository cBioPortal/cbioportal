...
UPDATE `info` SET `DB_SCHEMA_VERSION`="2.14.1";
...
UPDATE `info` SET `DERIVED_TABLE_SCHEMA_VERSION`="1.0.6";
UPDATE `info` SET `DB_SCHEMA_VERSION`="2.14.5";

##version: 2.15.0
ALTER TABLE `type_of_cancer` ADD COLUMN `VERSION` varchar(31) DEFAULT NULL;
ALTER TABLE `type_of_cancer` ADD COLUMN `STATUS` varchar(31) DEFAULT NULL;
ALTER TABLE `type_of_cancer` ADD COLUMN `HISTORY` text DEFAULT NULL;
ALTER TABLE `type_of_cancer` ADD COLUMN `URI` varchar(255) DEFAULT NULL;
