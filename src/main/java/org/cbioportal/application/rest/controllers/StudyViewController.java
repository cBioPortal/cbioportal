package org.cbioportal.application.rest.controllers;
...
@RestController("v2StudyViewController")
...
public class StudyViewController {
    ...
    public StudyViewController(StudyViewService studyViewService, BasicDataBinner basicDataBinner, ClinicalDataBinner clinicalDataBinner, ClinicalDataDensityPlotService clinicalDataDensityPlotService, ViolinPlotService violinPlotService, CustomDataService customDataService, CustomDataFilterUtil customDataFilterUtil) {
    ...
    @PreAuthorize("hasPermission(#studyViewFilter, 'StudyViewFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/molecular-profile-sample-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/cna-genes/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasPermission(#studyViewFilter, 'StudyViewFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/structuralvariant-genes/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/clinical-data-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasPermission(#clinicalDataCountFilter, 'ClinicalDataCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
            ...
            @RequestBody(required = false) ClinicalDataCountFilter clinicalDataCountFilter)
    {
        ...
        List<ClinicalDataCountItem> result = studyViewService.getClinicalDataCounts(
                studyViewFilter,
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/sample-lists-counts/fetch", 
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/clinical-data-bin-counts/fetch", 
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasPermission(#clinicalDataBinCountFilter, 'DataBinCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/clinical-data-density-plot/fetch",
    ...
    public ResponseEntity<DensityPlotData> fetchClinicalDataDensityPlot(
        ...
        List<ClinicalData> combinedClinicalDataList = studyViewService.getClinicalDataForXyPlot(
                studyViewFilter,
    ...
    @Hidden // should unhide when we remove legacy controller
    @PreAuthorize("hasPermission(#studyViewFilter, 'StudyViewFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    @PostMapping(value = "/clinical-data-violin-plots/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/genomic-data-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PreAuthorize("hasPermission(#genomicDataCountFilter, 'GenomicDataCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    public ResponseEntity<List<GenomicDataCountItem>> fetchGenomicDataCounts(
            ...
            GenomicDataCountFilter genomicDataCountFilter) throws StudyNotFoundException {
        ...
        List<GenomicDataCountItem> result = studyViewService.getCNACountsByGeneSpecific(studyViewFilter, genomicDataFilters);

        return new ResponseEntity<>(result, HttpStatus.OK);
    }

    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/generic-assay-data-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PreAuthorize("hasPermission(#genericAssayDataCountFilter, 'GenericAssayDataCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    public ResponseEntity<List<GenericAssayDataCountItem>> fetchGenericAssayDataCounts(
        ...
        List<GenericAssayDataFilter> gaFilters = genericAssayDataCountFilter.getGenericAssayDataFilters();
        ...
        if (gaFilters.size() == 1) {
            NewStudyViewFilterUtil.removeSelfFromGenericAssayFilter(gaFilters.getFirst().getStableId(), studyViewFilter);
        }

        return ResponseEntity.ok(studyViewService.getGenericAssayDataCounts(studyViewFilter, gaFilters));
    }

    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/mutation-data-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<List<GenomicDataCountItem>> fetchMutationDataCounts(
        ...
        List<GenomicDataCountItem> result = projection == Projection.SUMMARY ?
                ...
                studyViewService.getMutationTypeCountsByGeneSpecific(studyViewFilter, genomicDataFilters);

        return ResponseEntity.ok(result);
    }

    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/clinical-event-type-counts/fetch",
    ...
    @PostMapping(value = "/treatments/patient-counts/fetch",
    ...
    @PostMapping(value = "/treatments/sample-counts/fetch",
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/custom-data-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PreAuthorize("hasPermission(#clinicalDataCountFilter, 'DataCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    public ResponseEntity<List<ClinicalDataCountItem>> fetchCustomDataCounts(
            @Parameter(required = true, description = "Custom data count filter") @Valid @RequestBody(required =
                    false) ClinicalDataCountFilter clinicalDataCountFilter){
        ...
        List <SampleIdentifier> filteredSampleIdentifiers =
                studyViewService.getFilteredSamples(studyViewFilter)
                        .stream()
                        .map(sample -> NewStudyViewFilterUtil.buildSampleIdentifier(sample.cancerStudyIdentifier(), sample.stableId()))
                        .toList();
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/custom-data-bin-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/genomic-data-bin-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE,  produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponse(responseCode = "200", description = "OK",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = GenomicDataBin.class))))
    @PreAuthorize("hasPermission(#genomicDataBinCountFilter, 'DataBinCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
    ...
    @Hidden // should unhide when we remove legacy controller
    @PostMapping(value = "/generic-assay-data-bin-counts/fetch",
            consumes = MediaType.APPLICATION_JSON_VALUE,  produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponse(responseCode = "200", description = "OK",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = GenericAssayDataBin.class))))
    @PreAuthorize("hasPermission(#genericAssayDataBinCountFilter, 'DataBinCountFilter', T(org.cbioportal.legacy.utils.security.AccessLevel).READ)")
