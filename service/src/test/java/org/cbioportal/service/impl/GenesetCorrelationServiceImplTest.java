...
public class GenesetCorrelationServiceImplTest extends BaseServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito
            .when(
                geneticProfileService.getMolecularProfilesReferredBy(
                    MOLECULAR_PROFILE_ID
                )
            )
    ...
    public void fetchCorrelatedGenes() throws Exception {
        List<GenesetCorrelation> result = genesetCorrelationService.fetchCorrelatedGenes(
            GENESET_ID1,
            MOLECULAR_PROFILE_ID,
            Arrays.asList(SAMPLE_ID1, SAMPLE_ID2),
            0.3
        ...
        Assert.assertEquals(
            (Double) (-1.0),
            result.get(1).getCorrelationValue()
        );
