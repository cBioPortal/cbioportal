...
public class StudyViewControllerTest {
  ...
  public void fetchClinicalDataDensityPlot() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/clinical-data-density-plot/fetch")
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(studyViewFilter))
                .param("xAxisAttributeId", "FRACTION_GENOME_ALTERED")
  ...
  public void fetchClinicalDataClinicalTable() throws Exception {
    ...
    when(clinicalDataService.fetchSampleClinicalTable(
        ...
        .thenReturn(clinicalData);
    when(clinicalDataService.fetchClinicalData(
            anyList(), anyList(), any(), anyString(), anyString()))
        .thenReturn(clinicalData);
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.sampleClinicalData[0].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.sampleClinicalData[0].sampleId")
                .value(TEST_SAMPLE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.sampleClinicalData[1].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.sampleClinicalData[1].sampleId")
                .value(TEST_SAMPLE_ID_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.sampleClinicalData[2].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.sampleClinicalData[2].sampleId")
                .value(TEST_SAMPLE_ID_3))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientClinicalData[0].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientClinicalData[0].sampleId")
                .value(TEST_SAMPLE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientClinicalData[1].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientClinicalData[1].sampleId")
                .value(TEST_SAMPLE_ID_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientClinicalData[2].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientClinicalData[2].sampleId")
                .value(TEST_SAMPLE_ID_3));
  }
