...
public class PatientServiceImpl implements PatientService {
    ...
    public List<Patient> getAllPatients(
        ...
        return (AUTHENTICATE.equals("false"))
            ? patients
            : new ArrayList<Patient>(patients);
    }
    ...
    public Patient getPatientInStudy(String studyId, String patientId)
        ...
        Patient patient = patientRepository.getPatientInStudy(
            studyId,
            patientId
        );
    ...
    @Override
    public BaseMeta fetchMetaPatients(
        List<String> studyIds,
        List<String> patientIds
    ) {
    ...
    @Override
    public List<Patient> getPatientsOfSamples(
        List<String> studyIds,
