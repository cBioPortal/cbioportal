...
public class PatientServiceImplTest extends BaseServiceImplTest {
    ...
    public void getMetaPatients() throws Exception {
        ...
        Mockito
            .when(patientRepository.getMetaPatients(KEYWORD))
    ...
    public void getAllPatientsInStudy() throws Exception {
        ...
        List<Patient> result = patientService.getAllPatientsInStudy(
            STUDY_ID,
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
    ...
    public void getMetaPatientsInStudy() throws Exception {
        BaseMeta expectedBaseMeta = new BaseMeta();
        Mockito
            .when(patientRepository.getMetaPatientsInStudy(STUDY_ID))
            .thenReturn(expectedBaseMeta);
    ...
    public void getPatientInStudyPatientNotFound() throws Exception {
        Mockito
            .when(patientRepository.getPatientInStudy(STUDY_ID, PATIENT_ID_1))
            .thenReturn(null);
    ...
    public void getPatientInStudy() throws Exception {
        ...
        Patient result = patientService.getPatientInStudy(
            STUDY_ID,
            PATIENT_ID_1
        );
    ...
    public void fetchPatients() throws Exception {
        ...
        List<Patient> result = patientService.fetchPatients(
            Arrays.asList(STUDY_ID),
            Arrays.asList(PATIENT_ID_1),
            PROJECTION
        );
    ...
    public void fetchMetaPatients() throws Exception {
        ...
        Mockito
            ...
            .thenReturn(expectedBaseMeta);
        BaseMeta result = patientService.fetchMetaPatients(
            Arrays.asList(STUDY_ID),
            Arrays.asList(PATIENT_ID_1)
        );
    ...
    public void getPatientsOfSamples() throws Exception {
        ...
        List<Patient> result = patientService.getPatientsOfSamples(
            Arrays.asList(STUDY_ID),
            Arrays.asList(SAMPLE_ID1)
        );
