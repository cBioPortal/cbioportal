...
public class TestGeneticEventImpl {
    ...
    public void testGeneticEventImplIntIntBoolean() {
        GeneticEventImpl aGeneticEventImpl = new GeneticEventImpl(
            2,
            1,
            1,
            true
        ...
        Assert.assertEquals(
            false,
            aGeneticEventImpl.isCnaHeterozygousDeleted()
        );
        Assert.assertEquals(
            false,
            aGeneticEventImpl.isCnaHomozygouslyDeleted()
        );
        ...
        Assert.assertEquals(
            mutations.MUTATED,
            aGeneticEventImpl.getMutationValue()
        );
