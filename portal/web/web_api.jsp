...
<div id="main">
    <table cellspacing="2px">
        <tr>
            ...
            <h1>Web Interface</h1>
            <div class="markdown">
            <% if (!cgdsUrl.startsWith("http://cbio.mskcc.org/cgds-public/")) { %>
                    <div class="url_warning">
                    <B>Please note:  All Web API calls for this portal are available at:
                    <a href="<%= cgdsUrl %>"><%= cgdsUrl %></a>.  The examples below point to our
                    public portal available at
                    <a href="http://cbio.mskcc.org/cgds-public/webservice.do">http://cbio.mskcc.org/cgds-public/webservice.do</a>.</B>
                    </div>
                <% } %>
