...
public class HttpHelper {
  ...
  public static HttpResponse sendGetRequest(String url, String bearerToken, String cookie)
      throws IOException {
  ...
  public static HttpResponse sendPostRequest(
      String url, String bearerToken, String cookie, String body) throws IOException {
    HttpURLConnection.setFollowRedirects(false);
    HttpURLConnection connection = (HttpURLConnection) new URL(url).openConnection();
    if (bearerToken != null) {
      connection.setRequestProperty("Authorization", "Bearer " + bearerToken);
