...
* [Data Questions](/user-guide/faq.md#data-questions)
    ...
    * [TCGA](/user-guide/faq.md#tcga)
        ...
        * [How do the TCGA-GDC studies compare to the TCGA PanCancer / Firehose Legacy studies?](#how-do-the-tcga-gdc-studies-compare-to-the-tcga-pancancer--firehose-legacy-studies)
...
#### How do the TCGA-GDC studies compare to the TCGA PanCancer / Firehose Legacy studies?
The TCGA-GDC studies are updated frequently as new GDC releases come out, as opposed to the older TCGA datasets which are largely frozen. Also, the GDC studies use a newer version of the human reference genome, GRCh38 instead of GRCh37.
