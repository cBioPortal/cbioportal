...
public class NamespaceAttributeCountController {
    ...
    @PostMapping(path = "/namespace-attributes/counts/fetch", consumes = MediaType.APPLICATION_JSON_VALUE,
    ...
    public ResponseEntity<List<NamespaceAttributeCount>> getNamespaceAttributeCounts(
        ...
        List<NamespaceAttributeCount> namespaceAttributeCountList;
            ...
            List<NamespaceAttribute> namespaceAttributes = interceptedNamespaceAttributeCountFilter.getNamespaceAttributes();
            ...
            namespaceAttributeCountList = namespaceAttributeService.fetchNamespaceAttributeCountsBySampleIds(studyIds, sampleIds, namespaceAttributes);
