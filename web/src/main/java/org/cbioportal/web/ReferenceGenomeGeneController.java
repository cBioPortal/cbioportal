...
public class ReferenceGenomeGeneController {
    ...
    public ResponseEntity<List<ReferenceGenomeGene>> getAllRefGenes(
    ...
    public ResponseEntity<ReferenceGenomeGene> getGene(
        @ApiParam(required = true, value = "Name of Reference Genome hg19")
        @PathVariable String genomeName,
    ...
    public ResponseEntity<List<ReferenceGenomeGene>> fetchGenes(
        @ApiParam(required = true, value = "Name of Reference Genome hg19")
        @PathVariable String genomeName,
