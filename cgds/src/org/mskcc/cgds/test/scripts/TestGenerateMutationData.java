...
public class TestGenerateMutationData extends TestCase {
    ...
    public void testGenerateMutationData() throws Exception {
        ...
        File allCasesFile = new File ("testData/all_cases.txt");
        File sequencedGeneFile = new File ("testData/sequenced_genes.txt");
        File sequencedCasesFile = new File ("testData/sequenced_cases.txt");
        File mutationDataFile = new File ("testData/mutations.txt");
