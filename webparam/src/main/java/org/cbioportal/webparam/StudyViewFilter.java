...
public class StudyViewFilter implements Serializable {
    ...
    private List<StudyViewGeneFilter> geneFilters;
    ...
    public List<StudyViewGeneFilter> getGeneFilters() {
        return geneFilters;
    }

    public void setGeneFilters(List<StudyViewGeneFilter> geneFilters) {
