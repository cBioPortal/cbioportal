...
public class FakeInMemoryRedissonClient implements RedissonClient {
    ...
    public <V> RBucket<V> getBucket(String s) {
        return rBucketMap.computeIfAbsent(s, (key) -> new FakeRBucket(valueMap, key));
    }
    ...
    public RKeys getKeys() {
        return new FakeRKeys(rBucketMap, valueMap);
    }
