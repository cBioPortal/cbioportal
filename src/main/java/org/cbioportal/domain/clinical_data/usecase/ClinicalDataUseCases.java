...
@Profile("clickhouse")
/**
 * A record representing a collection of use cases related to clinical data operations.
 * This record encapsulates instances of various use case classes, providing a centralized
 * way to access and manage clinical data-related operations.
 *
 * @param getClinicalDataCountsUseCase the use case for retrieving and processing clinical data counts
