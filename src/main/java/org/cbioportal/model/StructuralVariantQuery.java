...
public class StructuralVariantQuery implements Serializable {
  ...
  @Valid private StructuralVariantGeneSubQuery gene1;

  @Valid private StructuralVariantGeneSubQuery gene2;

  public StructuralVariantQuery(
      StructuralVariantGeneSubQuery gene1, StructuralVariantGeneSubQuery gene2) {
    this.gene1 = gene1;
    this.gene2 = gene2;
  }
