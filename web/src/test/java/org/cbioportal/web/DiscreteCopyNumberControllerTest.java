...
public class DiscreteCopyNumberControllerTest {
    ...
    public void fetchCopyNumberCounts() throws Exception {
        ...
        copyNumberCount1.setGeneticProfileId(TEST_GENETIC_PROFILE_STABLE_ID_1);
        ...
        copyNumberCount2.setGeneticProfileId(TEST_GENETIC_PROFILE_STABLE_ID_1);
        ...
        mockMvc.perform(MockMvcRequestBuilders
            .post("/genetic-profiles/test_genetic_profile_id/discrete-copy-number-counts/fetch")
            .accept(MediaType.APPLICATION_JSON)
            .contentType(MediaType.APPLICATION_JSON)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$[1].entrezGeneId").value(TEST_ENTREZ_GENE_ID_2))
            .andExpect(MockMvcResultMatchers.jsonPath("$[1].geneticProfileId").value(TEST_GENETIC_PROFILE_STABLE_ID_1))
            .andExpect(MockMvcResultMatchers.jsonPath("$[1].alteration").value(TEST_ALTERATION_2))
