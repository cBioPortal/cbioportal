...
public class OncoPrintGeneDisplaySpec {
    ...
    public OncoPrintGeneDisplaySpec() {
        finalDataTypeSpecs =
            new EnumMap<GeneticDataTypes, ResultDataTypeSpec>(
     ...
     * @return
     */
    public ResultDataTypeSpec createResultDataTypeSpec(
        GeneticDataTypes theGeneticDataType
    ) {
        ResultDataTypeSpec theResultDataTypeSpec = finalDataTypeSpecs.get(
            theGeneticDataType
        );
    ...
    public ResultDataTypeSpec getResultDataTypeSpec(
        GeneticDataTypes theGeneticDataType
    ) {
        return finalDataTypeSpecs.get(theGeneticDataType);
    }

    public void setResultDataTypeSpec(
        GeneticDataTypes theGeneticDataType,
        ResultDataTypeSpec theResultDataTypeSpec
    ) {
        finalDataTypeSpecs.put(theGeneticDataType, theResultDataTypeSpec);
    ...
    public boolean satisfy(GeneticDataTypes theGeneticDataType, float value)
        ...
        if (
            theResultDataTypeSpec.combinedLesserContinuousDataTypeSpec !=
            null &&
            finalDataTypeSpecs
                .get(theGeneticDataType)
                .combinedLesserContinuousDataTypeSpec.satisfy(value)
        ) {
            return true;
        }
        if (
            theResultDataTypeSpec.combinedGreaterContinuousDataTypeSpec !=
            null &&
            finalDataTypeSpecs
                .get(theGeneticDataType)
                .combinedGreaterContinuousDataTypeSpec.satisfy(value)
        ) {
            return true;
        }
        return false;
    ...
    public boolean satisfy(GeneticDataTypes theGeneticDataType, Object level)  //GeneticTypeLevel theGeneticTypeLevel )
        ...
        if (
            theResultDataTypeSpec.theDiscreteDataTypeSetSpec != null &&
     ...
     * @return
     */
    public boolean typeDifference(
        OncoPrintGeneDisplaySpec otherOncoPrintGeneDisplaySpec,
        GeneticDataTypes aGeneticDataType
    ) {
        return (
            (null != this.getResultDataTypeSpec(aGeneticDataType)) &&
            (
                null ==
                otherOncoPrintGeneDisplaySpec.getResultDataTypeSpec(
                    aGeneticDataType
                )
            )
        );
    ...
    public String toString() {
        ...
        for (GeneticDataTypes aGeneticDataTypes : GeneticDataTypes.values()) {
            ...
            ResultDataTypeSpec theResultDataTypeSpec =
                this.finalDataTypeSpecs.get(aGeneticDataTypes);
            if (null != theResultDataTypeSpec) {
