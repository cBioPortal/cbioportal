...
public class TestImportClinicalData {
    ...
    public void setUp() throws DaoException {
        ...
        cancerStudy =
            new CancerStudy("testnew", "testnew", "testnew", "brca", true);
     ...
     */
    @Test
    public void testImportClinicalData_WithDuplInMixedAttrFormat()
        throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small.txt"
        );
        ...
        assertTrue(
            warnings
                .get(0)
                .contains("Sample TCGA-BH-A18K-01 found to be duplicated")
        );
    }
     ...
     */
    @Test
    public void testImportClinicalDataNewStudy_WithWrongNrCols()
        throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_WRONG_NR_COLS.txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
    ...
    public void testImportPatientDataNewStudy_WithDuplError() throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_PATIENT_dupl_error.txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
     ...
     */
    @Test
    public void testImportPatientDataNewStudy_WithDataTypeError()
        throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_PATIENT_datatype_error.txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
    ...
    public void testImportClinicalDataSurvival_SplitMode() throws Exception {
        ...
        File clinicalFile = new File(
            "src/test/resources/clinical_data_SAMPLE.txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
    ...
    public void testImportClinicalDataTwoSampleFiles() throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_SAMPLE.txt"
        );
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        importClinicalData.setFile(
            cancerStudy,
        ...
        clinicalFile =
            new File("src/test/resources/clinical_data_small_SAMPLE2.txt");
        importClinicalData = new ImportClinicalData(null);
        importClinicalData.setFile(
            cancerStudy,
            clinicalFile,
        ...
        List<Patient> clinicalCaseList = DaoClinicalData.getSurvivalData(
    ...
    private void checkSurvivalDataAndSampleCount(CancerStudy cancerStudy)
        throws DaoException {
        LinkedHashSet<String> caseSet = new LinkedHashSet<String>();
        ...
        for (Patient patientData : clinicalCaseList) {
            if (patientData.getStableId().equals("TCGA-A1-A0SB")) {
                assertEquals(
                    new Double(79.04),
                    patientData.getAgeAtDiagnosis()
                );
                assertEquals(
                    "DECEASED",
                    patientData.getOverallSurvivalStatus()
                );
                assertEquals(
                    "Recurred/Progressed",
                    patientData.getDiseaseFreeSurvivalStatus()
                );
                assertEquals(
                    new Double(43.8),
                    patientData.getOverallSurvivalMonths()
                );
                assertEquals(
                    new Double(15.05),
                    patientData.getDiseaseFreeSurvivalMonths()
                );
    ...
    private void checkDataSlice(CancerStudy cancerStudy) throws DaoException {
        List<ClinicalParameterMap> slice = DaoClinicalData.getDataSlice(
            cancerStudy.getInternalId(),
            Arrays.asList("PLATINUMSTATUS")
        );
    ...
    public void testImportClinicalDataParameters() throws Exception {
        ...
        Set<String> paramSet = DaoClinicalData.getDistinctParameters(
            cancerStudy.getInternalId()
        );
    ...
    public void testImportClinicalData_SampleIdError() throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_missing_SAMPLEID.txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
    ...
    public void testImportClinicalData_PatientIdError() throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_missing_PATIENTID.txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
    ...
    private void checkCorrectFileTwice(String type) throws Exception {
        File clinicalFile = new File(
            "src/test/resources/clinical_data_small_" + type + ".txt"
        );
        // initialize an ImportClinicalData instance without args to parse
        ImportClinicalData importClinicalData = new ImportClinicalData(null);
        // set the info usually parsed from args
