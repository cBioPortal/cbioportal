 ...
 */
public class MIRNAConverterImpl implements Converter {

	// our logger
	private static Log LOG = LogFactory.getLog(MIRNAConverterImpl.class);
	 ...
	 */
	public MIRNAConverterImpl(Config config, FileUtils fileUtils,
