        ...
        while (paramEnum.hasMoreElements()) {
            ...
            if (values != null && values.length > 0) {
                for (int i = 0; i < values.length; i++) {
                    ...
                    if (
                        paramName.equals(QueryBuilder.GENE_LIST) ||
            ...
            if (values != null && values.length > 0) {
                for (int i = 0; i < values.length; i++) {
                    ...
                    if (
                        ...
                        if (
                            request.getAttribute(QueryBuilder.CASE_IDS_KEY) !=
                            null
                        ) {
                            currentValue =
                                (String) request.getAttribute(
                                    QueryBuilder.CASE_IDS_KEY
                                );
                        }
                        // if no request attribute found, then use the utility function
                        else {
                            currentValue =
                                SampleSetUtil.shortenSampleIds(currentValue);
                        }
                    }
