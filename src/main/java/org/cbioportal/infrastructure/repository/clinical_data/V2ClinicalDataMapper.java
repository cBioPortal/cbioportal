...
/**
 * Mapper interface for retrieving clinical data from DB.
 * This interface provides methods to fetch clinical data counts and clinical data for samples and patients.
 */
public interface V2ClinicalDataMapper {
