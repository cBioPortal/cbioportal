...
public abstract class OAuth2KeycloakInitializer
  ...
  public void initializeImpl(
    ...
    try {
      ...
      String keycloakUrlForBrowser =
          String.format("http://localhost:%s", keycloakContainer.getHttpPort());

      TestPropertyValues values =
          TestPropertyValues.of(

              // These urls are from the perspective of cBioPortal application (port on host
              // system).
              ...
              String.format(
                  "dat.oauth2.jwkUrl=%s/realms/cbio/protocol/openid-connect/certs",
                  keycloakUrlForBrowser),
