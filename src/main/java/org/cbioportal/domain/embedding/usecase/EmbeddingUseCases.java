...
@Service
/**
 * A record representing a collection of use cases related to embedding data operations. This
 * record encapsulates instances of various use case classes, providing a centralized way to
 * access and utilize the use cases.
 *
