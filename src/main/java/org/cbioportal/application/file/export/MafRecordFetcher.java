...
import org.cbioportal.domain.genomic_data.usecase.GetMutationsUseCase;
...
public class MafRecordFetcher {
    ...
    private final GetMutationsUseCase getMutationsUseCase;

    public MafRecordFetcher(GetMutationsUseCase getMutationsUseCase) {
        this.getMutationsUseCase = getMutationsUseCase;
    }
