...
public class GlobalProperties {
    ...
    private static final String PORTAL_PROPERTIES_FILE_NAME =
        "portal.properties";
    ...
    public static final String UCSC_CANCER_GENOMICS_URL =
        "ucsc_cancer_genomics.url";
    ...
    public static final String DEFAULT_SKIN_TITLE =
        "cBioPortal for Cancer Genomics";
    public static final String SKIN_BLURB = "skin.blurb";
    // blurb default
    public static final String DEFAULT_SKIN_BLURB =
        "The cBioPortal for Cancer Genomics provides " +
    ...
    public static final String DEFAULT_SKIN_TAG_LINE_IMAGE =
        "images/tag_line.png";
    public static final String SKIN_EMAIL_CONTACT = "skin.email_contact";
    public static final String DEFAULT_EMAIL_CONTACT =
        "cbioportal at googlegroups dot com";
    ...
    public static final String SKIN_RIGHT_NAV_SHOW_DATA_SETS =
        "skin.right_nav.show_data_sets";
    public static final String SKIN_RIGHT_NAV_SHOW_EXAMPLES =
        "skin.right_nav.show_examples";
    public static final String SKIN_RIGHT_NAV_SHOW_TESTIMONIALS =
        "skin.right_nav.show_testimonials";
    public static final String SKIN_RIGHT_NAV_SHOW_WHATS_NEW =
    ...
    public void setSkinAuthorizationMessage(String property) {
        skinAuthorizationMessage = property;
    }

    public static final String SKIN_EXAMPLE_STUDY_QUERIES =
    ...
    public static final String DEFAULT_SKIN_DATASETS_HEADER =
        "The portal currently contains data from the following " +
    ...
    public static final String DEFAULT_SKIN_DATASETS_FOOTER =
        "Data sets of TCGA studies were downloaded from Broad " +
    ...
    public static final String PATIENT_VIEW_PLACEHOLDER =
        "patient_view_placeholder";
    public static final String PATIENT_VIEW_DIGITAL_SLIDE_IFRAME_URL =
        "digitalslidearchive.iframe.url";
    public static final String PATIENT_VIEW_DIGITAL_SLIDE_META_URL =
        "digitalslidearchive.meta.url";

    public static final String PATIENT_VIEW_MDACC_HEATMAP_META_URL =
        "mdacc.heatmap.meta.url";
    public static final String PATIENT_VIEW_MDACC_HEATMAP_URL =
        "mdacc.heatmap.patient.url";

    public static final String STUDY_VIEW_MDACC_HEATMAP_URL =
        "mdacc.heatmap.study.url";
    public static final String STUDY_VIEW_MDACC_HEATMAP_META_URL =
    ...
    public static final String SKIN_SHOW_R_MATLAB_TAB =
        "skin.show_r_matlab_tab";
    public static final String SKIN_SHOW_TUTORIALS_TAB =
    ...
    public static final String SKIN_RIGHT_NAV_WHATS_NEW_BLURB =
    ...
    // login contact
    public static final String SKIN_LOGIN_CONTACT_HTML =
        "skin.login.contact_html";
    public static final String DEFAULT_SKIN_LOGIN_CONTACT_HTML =
        "If you think you have received this message in " +
    ...
    public static final String SKIN_LOGIN_SAML_REGISTRATION_HTML =
        "skin.login.saml.registration_html";
    public static final String DEFAULT_SKIN_LOGIN_SAML_REGISTRATION_HTML =
        "Sign in with MSK";

    // property for the saml entityid
    public static final String SAML_IDP_METADATA_ENTITYID =
    ...
    public static final String SKIN_CUSTOM_HEADER_TABS =
    ...
    public static final String DEFAULT_SKIN_BASEURL =
        "https://raw.githubusercontent.com/cBioPortal/cbioportal/master/docs/";
    public static final String SKIN_DOCUMENTATION_MARKDOWN =
    ...
    public static final String SKIN_EXAMPLES_RIGHT_COLUMN_HTML =
        "skin.examples_right_column_html";

    public static final String ALWAYS_SHOW_STUDY_GROUP =
        "always_show_study_group";

    // property for query component
    public static final String SKIN_QUERY_MAX_TREE_DEPTH =
    ...
    public static final String SKIN_STUDY_VIEW_LINK_TEXT =
        "skin.study_view.link_text";
    public static final String DEFAULT_SKIN_STUDY_VIEW_LINK_TEXT =
    ...
    public static final String RECACHE_STUDY_AFTER_UPDATE =
        "recache_study_after_update";
    ...
    public void setSuppressSchemaVersionMismatchErrors(String property) {
        suppressSchemaVersionMismatchErrors = Boolean.parseBoolean(property);
    }
    ...
    public static final String SETSOFGENES_LOCATION =
        "querypage.setsofgenes.location";

    public static final String MSK_WHOLE_SLIDE_VIEWER_SECRET_KEY =
        "msk.whole.slide.viewer.secret.key";

    private static boolean showCivic;

    @Value("${show.civic:false}") // default is false
    public void setShowCivic(String property) {
        showCivic = Boolean.parseBoolean(property);
    }

    private static boolean sitemaps;

    @Value("${sitemaps:false}") // default is false
    public void setSitemaps(String property) {
        sitemaps = Boolean.parseBoolean(property);
    }

    private static boolean showGenomeNexus;

    @Value("${show.genomenexus:true}") // default is true
    public void setShowGenomeNexus(String property) {
        showGenomeNexus = Boolean.parseBoolean(property);
    }

    private static boolean datRevokeOtherTokens;

    @Value("${dat.uuid.revoke_other_tokens:true}") // default is true
    public void setDatRevokeOtherTokens(String property) {
        datRevokeOtherTokens = Boolean.parseBoolean(property);
    }

    private static String datMethod;

    @Value("${dat.method:none}") // default is 'none'
    public void setDatMethod(String property) {
        datMethod = property;
    }
    ...
    public static final String BINARY_CUSTOM_DRIVER_ANNOTATION_MENU_LABEL =
        "oncoprint.custom_driver_annotation.binary.menu_label";
    public static final String TIERS_CUSTOM_DRIVER_ANNOTATION_MENU_LABEL =
        "oncoprint.custom_driver_annotation.tiers.menu_label";
    public static final String ENABLE_DRIVER_ANNOTATIONS =
        "oncoprint.custom_driver_annotation.binary.default";
    public static final String ENABLE_TIERS =
        "oncoprint.custom_driver_annotation.tiers.default";
    public static final String ENABLE_ONCOKB_AND_HOTSPOTS_ANNOTATIONS =
        "oncoprint.oncokb_hotspots.default";
    public static final String HIDE_PASSENGER_MUTATIONS =
    ...
    public void setCivicUrl(String property) {
        civicUrl = parseUrl(property);
    }

    private static String genomeNexusApiUrl;

    @Value("${genomenexus.url:v1.genomenexus.org}") // default
    public void setGenomeNexusApiUrl(String property) {
        genomeNexusApiUrl = parseUrl(property);
    }

    private static String frontendUrl;

    @Value("${frontend.url:}") // default is empty string
    public void setFrontendUrl(String property) {
        frontendUrl = parseUrl(property);
    }
    ...
    public void setFrontendUrlRuntime(String property) {
        frontendUrlRuntime = property;
    }

    private static Log LOG = LogFactory.getLog(GlobalProperties.class);
    private static ConfigPropertyResolver portalProperties = new ConfigPropertyResolver();
    private static Properties mavenProperties = initializeProperties(
    ...
    private static class ConfigPropertyResolver {
        ...
        public ConfigPropertyResolver() {
            configFileProperties =
                initializeProperties(PORTAL_PROPERTIES_FILE_NAME);
        }
        ...
        public String getProperty(String key, String defaultValue) {
            String propertyValue = configFileProperties.getProperty(
                key,
                defaultValue
            );
    ...
    public static String getProperty(String property) {
        return (portalProperties.containsKey(property))
            ? portalProperties.getProperty(property)
            : null;
    }
    ...
    public static Collection<String> getIGVBAMLinkingStudies() {
        String igvBamLinkingStudies = portalProperties.getProperty(
    ...
    public static String getAboutHtml() {
        ...
        return (aboutHtml == null)
            ? DEFAULT_SKIN_ABOUT
            : getContentString(aboutHtml);
    }
    ...
    public static String getNewsHtml() {
        ...
        return (newsHtml == null)
            ? DEFAULT_SKIN_NEWS
            : getContentString(newsHtml);
    }
    ...
    public static boolean isMarkdownDocumentation() {
        String markdownFlag = portalProperties.getProperty(
            SKIN_DOCUMENTATION_MARKDOWN
        );
    ...
    public static Number getMaxTreeDepth() {
        String maxTreeDepth = portalProperties.getProperty(
            SKIN_QUERY_MAX_TREE_DEPTH
        );
        return (maxTreeDepth == null)
            ? DEFAULT_QUERY_MAX_TREE_DEPTH
            : Integer.parseInt(maxTreeDepth);
    }

    // get custom Example Queries for the right column html or the default
    public static String getExamplesRightColumnHtml() {
        String examplesRightColumnHtml = portalProperties.getProperty(
    ...
    private static String getContentString(String contentString) {
        if (getBaseUrl().equalsIgnoreCase("")) return (
    ...
    public static String getLoginContactHtml() {
        String loginContactHtml = portalProperties.getProperty(
            SKIN_LOGIN_CONTACT_HTML
        );
        return (loginContactHtml == null)
            ? DEFAULT_SKIN_LOGIN_CONTACT_HTML
            : loginContactHtml;
    }

    // get the text for the saml login button
    public static String getLoginSamlRegistrationHtml() {
        String loginSamlRegistrationHtml = portalProperties.getProperty(
            SKIN_LOGIN_SAML_REGISTRATION_HTML
        );
        return (loginSamlRegistrationHtml == null)
    ...
    public static String getTagLineImage() {
        ...
        return (tagLineImage == null)
            ? DEFAULT_SKIN_TAG_LINE_IMAGE
            : "images/" + tagLineImage;
    }
    ...
    public static String getRightLogo() {
        ...
        return (rightLogo == null || "".equals(rightLogo))
            ? ""
            : "images/" + rightLogo;
    }
    ...
    public static String getStudyviewLinkText() {
        String studyviewLinkText = portalProperties.getProperty(
            SKIN_STUDY_VIEW_LINK_TEXT
        );
    ...
    public static String getEmailContact() {
        ...
        if (emailAddress == null) emailAddress = DEFAULT_EMAIL_CONTACT;
        return (
    ...
    public static boolean includeNetworks() {
        return Boolean.parseBoolean(
            portalProperties.getProperty(INCLUDE_NETWORKS)
        );
    }
    ...
    public static String getFrontendSentryEndpoint() {
        return (frontendSentryEndpoint == null)
            ? null
            : frontendSentryEndpoint.trim();
    }
    ...
    public static boolean showPlaceholderInPatientView() {
        return Boolean.parseBoolean(
            portalProperties.getProperty(PATIENT_VIEW_PLACEHOLDER)
        );
    }
    ...
    public static String getRightNavWhatsNewBlurb() {
        String whatsNewBlurb = portalProperties.getProperty(
            SKIN_RIGHT_NAV_WHATS_NEW_BLURB
        );
        return (whatsNewBlurb == null)
            ? DEFAULT_SKIN_WHATS_NEW_BLURB
            : whatsNewBlurb;
    }

    public static boolean showRightNavDataSets() {
        String showFlag = portalProperties.getProperty(
    ...
    public static boolean showRightNavTestimonials() {
        String showFlag = portalProperties.getProperty(
            SKIN_RIGHT_NAV_SHOW_TESTIMONIALS
        );
        return showFlag == null || Boolean.parseBoolean(showFlag);
    }
    ...
    public static String getDataSetsHeader() {
        String dataSetsHeader = portalProperties.getProperty(
            SKIN_DATASETS_HEADER
        );
        return dataSetsHeader == null
            ? DEFAULT_SKIN_DATASETS_HEADER
            : dataSetsHeader;
    }

    // added usage of default data sets footer
    public static String getDataSetsFooter() {
        String dataSetsFooter = portalProperties.getProperty(
            SKIN_DATASETS_FOOTER
        );
        return dataSetsFooter == null
            ? DEFAULT_SKIN_DATASETS_FOOTER
            : dataSetsFooter;
    }
    ...
    public static String getLinkToPatientView(
        String caseId,
        String cancerStudyId
    ) {
        return "patient?caseId=" + caseId + "&studyId=" + cancerStudyId;
    }

    public static String getLinkToSampleView(
        String caseId,
        String cancerStudyId
    ) {
        return "patient?sampleId=" + caseId + "&studyId=" + cancerStudyId;
    }
    ...
    public static String getLinkToIGVForBAM(
        String cancerStudyId,
        String caseId,
        String locus
    ) {
    ...
    public static String getDigitalSlideArchiveIframeUrl(String caseId) {
        String url = portalProperties.getProperty(
            PATIENT_VIEW_DIGITAL_SLIDE_IFRAME_URL
        );
        return url + caseId;
    }
    ...
    public static String getDigitalSlideArchiveMetaUrl(String caseId) {
        String url = portalProperties.getProperty(
            PATIENT_VIEW_DIGITAL_SLIDE_META_URL
        );
        return url + caseId;
    }
    ...
    public static String getStudyHeatmapMetaUrl() {
        String url = portalProperties.getProperty(
            STUDY_VIEW_MDACC_HEATMAP_META_URL
        );
        return url;
    }
    ...
    public static String getPatientHeatmapMetaUrl(String caseId) {
        String url = portalProperties.getProperty(
            PATIENT_VIEW_MDACC_HEATMAP_META_URL
        );
    ...
    public static String getPatientHeatmapViewerUrl(String caseId) {
        String url = portalProperties.getProperty(
            PATIENT_VIEW_MDACC_HEATMAP_URL
        );
        if (url == null || url.length() == 0) return null;
        return url + caseId;
    }
    ...
    public static String[] getCustomHeaderTabs() {
        String customPagesString = GlobalProperties.getProperty(
            SKIN_CUSTOM_HEADER_TABS
        );
    ...
    public static String getFrontendUrl() {
        if (frontendUrlRuntime.length() > 0) {
            try {
                String url = parseUrl(
                    new String(
                        Files.readAllBytes(Paths.get(frontendUrlRuntime)),
                ...
                if (LOG.isInfoEnabled()) {
                    LOG.info(
                        "Using frontend from " + frontendUrlRuntime + ": " + url
                    );
                }
                return url;
            } catch (IOException e) {
                ...
                if (LOG.isErrorEnabled()) {
                    LOG.error(
                        "Can't read frontend.url.runtime: " + frontendUrlRuntime
                    );
                }
            }
        }
    ...
    public static boolean getRecacheStudyAfterUpdate() {
        String recacheStudyAfterUpdate = portalProperties.getProperty(
            RECACHE_STUDY_AFTER_UPDATE
        );
        if (
            recacheStudyAfterUpdate == null || recacheStudyAfterUpdate.isEmpty()
        ) {
            return false;
        }
    ...
    public static List<String[]> getPriorityStudies() {
        ...
        try {
            String priorityStudies = portalProperties
                .getProperty(PRIORITY_STUDIES)
                .trim();
    ...
    public static List<String> getDisabledTabs() {
        ...
        return (tabs.length > 0 && disabledTabs.length() > 0)
            ? Arrays.asList(tabs)
            : new ArrayList<String>();
    }

    public static String getDefaultOncoprintView() {
        String defaultOncoprintView = portalProperties.getProperty(
    ...
    public static boolean enableDriverAnnotations() {
        String enableDriverAnnotations = portalProperties.getProperty(
            ENABLE_DRIVER_ANNOTATIONS,
            "true"
        );
    ...
    public static String enableOncoKBandHotspots() {
        String enableOncoKBandHotspots = portalProperties
            .getProperty(ENABLE_ONCOKB_AND_HOTSPOTS_ANNOTATIONS, "true")
            .trim();
    ...
    public static String getBinaryCustomDriverAnnotationMenuLabel() {
        return portalProperties.getProperty(
            BINARY_CUSTOM_DRIVER_ANNOTATION_MENU_LABEL
        );
    }

    public static String getTiersCustomDriverAnnotationMenuLabel() {
        return portalProperties.getProperty(
            TIERS_CUSTOM_DRIVER_ANNOTATION_MENU_LABEL
        );
    }
    ...
    public static boolean showBinaryCustomDriverAnnotation() {
        if (
            getBinaryCustomDriverAnnotationMenuLabel() == null ||
            getBinaryCustomDriverAnnotationMenuLabel().isEmpty()
        ) {
            return false;
        }
        return true;
    ...
    public static boolean showTiersCustomDriverAnnotation() {
        if (
            getTiersCustomDriverAnnotationMenuLabel() == null ||
            getTiersCustomDriverAnnotationMenuLabel().isEmpty()
        ) {
            return false;
        }
        return true;
    ...
    public static boolean hidePassengerMutations() {
        String hidePassenger = portalProperties.getProperty(
            HIDE_PASSENGER_MUTATIONS,
            "false"
        );
        ...
        if (fileName == null || fileName.trim().equals("")) {
            ...
            try {
                BufferedReader br = new BufferedReader(
                    new FileReader(ResourceUtils.getFile(fileName))
                );
                for (
                ...
                if (LOG.isErrorEnabled()) {
                    LOG.error(
                        "frontend config file not found: " + e.getMessage()
                    );
                }
                return null;
            } catch (IOException e) {
                if (LOG.isErrorEnabled()) {
                    LOG.error(
                        "Error reading frontend config file: " + e.getMessage()
                    );
                }
                return null;
            }
    ...
    public static String getQuerySetsOfGenes() {
        String fileName = portalProperties.getProperty(
            SETSOFGENES_LOCATION,
            null
        );
    ...
    public static String getMskWholeSlideViewerToken() {
        ...
        Authentication authentication = SecurityContextHolder
            .getContext()
            .getAuthentication();
        String secretKey = portalProperties.getProperty(
            MSK_WHOLE_SLIDE_VIEWER_SECRET_KEY
        );
