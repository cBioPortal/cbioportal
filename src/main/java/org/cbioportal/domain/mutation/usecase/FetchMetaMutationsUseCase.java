 ...
 *
 * <p>This use case determines the correct input parameters from the provided {@link
 * MutationMultipleStudyFilter} and delegates the query to the {@link MutationRepository}.
 *
 * <p>If molecularProfileIds are available directly in the filter, they are passed straight through
 * to the repository. Otherwise, molecular profile IDs and sample IDs are extracted from the
 * filter’s sample–molecular identifiers.
 */
public class FetchMetaMutationsUseCase {
   ...
   *
   * @param mutationMultipleStudyFilter filter containing study, molecular profile, sample, and gene
   *     identifiers
