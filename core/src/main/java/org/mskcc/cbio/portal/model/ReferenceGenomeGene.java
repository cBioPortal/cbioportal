...
public class ReferenceGenomeGene {
     ...
     */
    public ReferenceGenomeGene(long entrezGeneId, int referenceGenomeId, String chr, String cytoband,
                               int exonicLength, long start, long end) {
        this.entrezGeneId = entrezGeneId;
        this.referenceGenomeId = referenceGenomeId;
        this.chr = chr;
    ...
    public boolean equals(Object obj0) {
        ...
        if (gene0.getEntrezGeneId() == entrezGeneId && gene0.referenceGenomeId == referenceGenomeId) {
            return true;
        }
        return false;
    }
