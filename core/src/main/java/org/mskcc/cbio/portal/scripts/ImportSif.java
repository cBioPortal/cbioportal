    ...
    public void importData() throws IOException, DaoException {
        ...
        while (line != null) {
            ...
            if (!line.startsWith("#")) {
                ...
                CanonicalGene geneA = daoGeneOptimized.getNonAmbiguousGene(geneAId, null, pMonitor);
                CanonicalGene geneB = daoGeneOptimized.getNonAmbiguousGene(geneBId, null, pMonitor);
