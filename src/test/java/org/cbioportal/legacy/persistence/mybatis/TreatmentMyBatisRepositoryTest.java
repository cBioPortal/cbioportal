...
@Import({MyBatisLegacyConfig.class, TreatmentMyBatisRepository.class})
@DataJpaTest
@DirtiesContext
...
public class TreatmentMyBatisRepositoryTest {
  ...
  @Autowired TreatmentMyBatisRepository treatmentRepository;
  ...
  public void getTreatmentsByPatientId() {
    ...
    Map<String, List<Treatment>> actual =
  ...
  public void getSamplesByPatientIdWhenNoMatchingSamples() {
    ...
    Map<String, List<ClinicalEventSample>> actual =
        treatmentRepository.getSamplesByPatientId(
            Collections.singletonList("TCGA-A1-A0SD-01"),
            Collections.singletonList("study_tcga_pub"));
  ...
  public void getShallowSamplesByPatientId() {
    ...
    Map<String, List<ClinicalEventSample>> actual =
        treatmentRepository.getShallowSamplesByPatientId(
            Collections.singletonList("TCGA-A1-A0SD-01"),
            Collections.singletonList("study_tcga_pub"));
