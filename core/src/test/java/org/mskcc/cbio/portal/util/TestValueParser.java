...
public class TestValueParser {
    ...
    public void testValueParser() {
        ValueParser parser = new ValueParser(
            "COPY_NUMBER_ALTERATION:2;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:3;",
            1.0
        );
        ...
        assertTrue(
            parser.isDiscreteTypeAltered(GeneticDataTypes.CopyNumberAlteration)
        );
        ...
        OncoPrintGeneDisplaySpec theOncoPrintGeneDisplaySpec = TestOncoPrintSpecificationLibrary.createTestOncoPrintGeneDisplaySpec();
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:1;MUTATION_EXTENDED:1;MRNA_EXPRESSION:-3;",
                2.0,
                1.0,
                aDefaultOncoPrintGeneDisplaySpec
            );
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:2;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1;",
                0.0,
                1.0,
        ...
        parser =
            new ValueParser("COPY_NUMBER_ALTERATION:2;MRNA_EXPRESSION:1;", 0.5);
        assertFalse(parser.isMutated());
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:2;MRNA_EXPRESSION:blah;MUTATION_EXTENDED:0;",
                0.5
            );
        assertFalse(parser.isMRNAWayUp());
        assertFalse(parser.isMRNAWayDown());
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:;MRNA_EXPRESSION:;MUTATION_EXTENDED:;",
                0.5
            );
        assertFalse(parser.isMRNAWayUp());
        assertFalse(parser.isMRNAWayDown());
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:2;MRNA_EXPRESSION:1;MUTATION_EXTENDED:nan;",
                0.5
            );
        assertFalse(parser.isMutated());
        assertFalse(parser.wasSequenced());
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:2;MRNA_EXPRESSION:1;MUTATION_EXTENDED:0;",
                0.5
            );
        assertFalse(parser.isMutated());
        assertTrue(parser.wasSequenced());
        ...
        parser =
            ValueParser.generateValueParser(
                "P53",
                "COPY_NUMBER_ALTERATION:1;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1;",
                0,
                1.0,
                anOncoPrintSpecification
            );
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:1;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1.5;",
                1.0f
            );
        assertFalse(parser.isCnaAmplified());
        assertTrue(parser.isCnaGained());
        ...
        try {
            parser.isDiscreteTypeThisLevel(
    ...
    public void testIsDiscreteTypeAltered() {
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:0;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1;",
                0.0,
                1.0,
                theOncoPrintGeneDisplaySpec
            );
        ...
        parser =
            new ValueParser(
                "MUTATION:C135F;MRNA_EXPRESSION:1;",
                0.0,
                1.0,
                theOncoPrintGeneDisplaySpec
            );
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:nan;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1;",
                0.0,
                1.0,
                theOncoPrintGeneDisplaySpec
            );
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION: JUNK;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1;",
                0.0,
                1.0,
                theOncoPrintGeneDisplaySpec
            );
        ...
        parser =
            new ValueParser(
                "COPY_NUMBER_ALTERATION:4;MUTATION_EXTENDED:C135F;MRNA_EXPRESSION:1;",
                0.0,
                1.0,
                theOncoPrintGeneDisplaySpec
            );
