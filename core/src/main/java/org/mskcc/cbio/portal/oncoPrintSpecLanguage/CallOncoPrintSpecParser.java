...
public class CallOncoPrintSpecParser {
     ...
     * @return
     */
    public static ParserOutput callOncoPrintSpecParser(
        String specLanguage,
        ...
        try {
            ...
            ByteArrayInputStream bs = new ByteArrayInputStream(
                Utilities.appendSemis(specLanguage).getBytes()
            );
            ...
            completeOncoPrintSpecASTwalker.oncoPrintSpecification_return rv = (completeOncoPrintSpecASTwalker.oncoPrintSpecification_return) walker.oncoPrintSpecification(
                anOncoPrintGeneDisplaySpec
            );
