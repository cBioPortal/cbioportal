...
public class GeneticProfileDatatypeMetadata implements GeneticDatatypeMetadata {
    ...
    public SequencedMap<String, String> toMetadataKeyValues() {
        ...
        metadata.put("show_profile_in_analysis_tab", getShowProfileInAnalysisTab() == null ? null : getShowProfileInAnalysisTab().toString().toLowerCase());
        ...
        metadata.put("pivot_threshold_value", getPivotThreshold() == null ? null : getPivotThreshold().toString());
