...
public class StructuralVariantControllerTest {
  ...
  public void fetchStructuralVariantsMolecularProfileId() throws Exception {
    ...
    Mockito.when(
            structuralVariantService.fetchStructuralVariants(
                Mockito.anyList(), Mockito.anyList(), Mockito.anyList(), Mockito.any()))
        .thenReturn(structuralVariant);

    StructuralVariantFilter structuralVariantFilter =
        createStructuralVariantFilterMolecularProfileId();

    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/structural-variant/fetch")
                .with(csrf())
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].uniqueSampleKey").value(TEST_UNIQUE_SAMPLE_KEY_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].uniquePatientKey")
                .value(TEST_UNIQUE_PATIENT_KEY_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1EntrezGeneId")
                .value((int) TEST_SITE1_ENTREZ_GENE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1HugoSymbol").value(TEST_SITE1_HUGO_SYMBOL_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1EnsemblTranscriptId")
                .value(TEST_SITE1_ENSEMBL_TRANSCRIPT_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1Chromosome").value(TEST_SITE1_CHROMOSOME_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].site1Region").value(TEST_SITE1_REGION))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1RegionNumber")
                .value(TEST_SITE1_REGION_NUMBER))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].site1Contig").value(TEST_SITE1_CONTIG))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1Position").value(TEST_SITE1_POSITION_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site1Description").value(TEST_SITE1_DESCRIPTION_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2EntrezGeneId")
                .value((int) TEST_SITE2_ENTREZ_GENE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2HugoSymbol").value(TEST_SITE2_HUGO_SYMBOL_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2EnsemblTranscriptId")
                .value(TEST_SITE2_ENSEMBL_TRANSCRIPT_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2Chromosome").value(TEST_SITE2_CHROMOSOME_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].site2Region").value(TEST_SITE2_REGION))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2RegionNumber")
                .value(TEST_SITE2_REGION_NUMBER))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].site2Contig").value(TEST_SITE2_CONTIG))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2Position").value(TEST_SITE2_POSITION_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2Description").value(TEST_SITE2_DESCRIPTION_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].site2EffectOnFrame")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].normalReadCount").value(TEST_NORMAL_READ_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].tumorReadCount").value(TEST_TUMOR_READ_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].normalVariantCount")
                .value(TEST_NORMAL_VARIANT_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].tumorVariantCount")
                .value(TEST_TUMOR_VARIANT_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].normalPairedEndReadCount")
                .value(TEST_NORMAL_PAIRED_END_READ_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].tumorPairedEndReadCount")
                .value(TEST_TUMOR_PAIRED_END_READ_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].normalSplitReadCount")
                .value(TEST_NORMAL_SPLIT_READ_COUNT_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].tumorSplitReadCount")
                .value(TEST_TUMOR_SPLIT_READ_COUNT_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].annotation").value(TEST_ANNOTATION_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].breakpointType").value(TEST_BREAKPOINT_TYPE_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].connectionType").value(TEST_CONNECTION_TYPE_1))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].driverFilterAnn").value(TEST_DRIVER_FILTER_ANN_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].driverTiersFilter")
                .value(TEST_DRIVER_TIERS_FILTER_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].driverTiersFilterAnn")
  ...
  @Test
  @WithMockUser
  public void fetchStructuralVariantsWithBothEntrezIdsAndStructVariantIdsReturnsStatusOk()
      throws Exception {
    String structuralVariantFilter =
        createStructuralVariantFilterWithEntrezIdAndStructuralVariantJson();
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/structural-variant/fetch")
                .with(csrf())
  ...
  public void fetchStructuralVariantsWithStructuralVariantSpecialQueryValues() throws Exception {
    ...
    ArgumentCaptor<ArrayList<StructuralVariantQuery>> structVarIdCaptor =
    ...
    String structuralVariantFilterJson =
        createStructuralVariantFilterWithStructuralVariantWildcard();
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/structural-variant/fetch")
                .with(csrf())
    ...
    Mockito.verify(structuralVariantService)
  ...
  @WithMockUser
  public void
      fetchStructuralVariantsWithStructuralVariantIdWithNoIdAndSpecialValueReturnsBadRequest()
          throws Exception {
    ...
    String structuralVariantFilterJson =
        createStructuralVariantFilterWithEmptyStructuralVariantId();
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/structural-variant/fetch")
                .with(csrf())
  ...
  private StructuralVariantFilter
      createStructuralVariantFilterMolecularProfileIdAndSampleMolecularIdentifier() {
