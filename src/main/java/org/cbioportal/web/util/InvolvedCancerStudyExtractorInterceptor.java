...
public class InvolvedCancerStudyExtractorInterceptor implements HandlerInterceptor {
  ...
  @Autowired private UniqueKeyExtractor uniqueKeyExtractor;
  ...
  private boolean extractAttributesFromClinicalAttributeCountFilter(HttpServletRequest request) {
    try {
      ...
      LOG.debug(
          "extracted clinicalAttributeCountFilter: " + clinicalAttributeCountFilter.toString());
      LOG.debug(
  ...
  private Collection<String> extractCancerStudyIdsFromClinicalAttributeCountFilter(
    ...
    if (clinicalAttributeCountFilter.getSampleListId() != null) {
      extractCancerStudyIdsFromSampleListIds(
          Arrays.asList(clinicalAttributeCountFilter.getSampleListId()), studyIdSet);
    } else {
  ...
  private boolean extractAttributesFromClinicalDataMultiStudyFilter(HttpServletRequest request) {
    try {
      ...
      LOG.debug(
          "extracted clinicalDataMultiStudyFilter: " + clinicalDataMultiStudyFilter.toString());
      LOG.debug(
  ...
  private boolean extractAttributesFromGenePanelDataMultipleStudyFilter(
    ...
    try {
      ...
      LOG.debug(
          "extracted genePanelDataMultipleStudyFilter: "
              + genePanelDataMultipleStudyFilter.toString());
      LOG.debug(
  ...
  private boolean extractAttributesFromGenericAssayDataBinCountFilter(HttpServletRequest request) {
    try {
      ...
      LOG.debug(
          "extracted genericAssayDataBinCountFilter: " + genericAssayDataBinCountFilter.toString());
      LOG.debug(
          "setting interceptedGenericAssayDataBinCountFilter to " + genericAssayDataBinCountFilter);
      request.setAttribute(
