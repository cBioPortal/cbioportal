...
./importClinicalData.pl $GDAC_CGDS_STAGING_HOME/ov_tcga/ov_tcga_clinical.txt ov_tcga
...
# Copy number segment
./importCopyNumberSegmentData.pl $GDAC_CGDS_STAGING_HOME/ov_tcga/ov_tcga_scna_minus_germline_cnv_hg19.seg ov_tcga
