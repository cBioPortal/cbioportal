...
public class CnaSegment implements TableRow {
    ...
    private static final LinkedHashMap<String, Function<CnaSegment, String>> ROW = new LinkedHashMap<>();
    ...
    static {
        ...
        ROW.put("num.mark", data -> data.getNumProbes() == null ? null : data.getNumProbes().toString());
        ROW.put("seg.mean", data -> data.getSegmentMean() == null ? null : data.getSegmentMean().toString());
    }
