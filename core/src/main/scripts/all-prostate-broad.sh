...
./importClinicalData.pl $CGDS_DATA_HOME/private-override/prad_broad/prad_broad_clinical.txt prad_broad
...
# Copy number segment
#./importCopyNumberSegmentData.pl $CGDS_DATA_HOME/private-override/prad_broad/prad_broad_scna_hg18.seg prad_broad
