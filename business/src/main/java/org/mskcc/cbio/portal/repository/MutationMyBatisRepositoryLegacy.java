...
@Repository
public class MutationMyBatisRepositoryLegacy implements MutationRepositoryLegacy {
    ...
    public List<Mutation> getMutationsDetailed(List<String> geneticProfileStableIds, List<String> hugoGeneSymbols,
        ...
        return mutationMapperLegacy.getMutationsDetailed(geneticProfileStableIds, hugoGeneSymbols, sampleStableIds,
                sampleListStableId);
    }

    public List<Mutation> getMutations(List<Integer> sampleIds, List<Integer> entrezGeneIds, Integer geneticProfileId) {

        return mutationMapperLegacy.getMutations(sampleIds, entrezGeneIds, geneticProfileId, false);
    }

    public List<Mutation> getMutations(List<Integer> sampleIds, Integer entrezGeneId, Integer geneticProfileId) {

        return mutationMapperLegacy.getMutations(sampleIds, Arrays.asList(entrezGeneId), geneticProfileId, false);
    }

    public List<Mutation> getMutations(Integer entrezGeneId, Integer geneticProfileId) {

        return mutationMapperLegacy.getMutations(null, Arrays.asList(entrezGeneId), geneticProfileId, false);
    }

    public List<Mutation> getMutations(List<Integer> sampleIds, Integer geneticProfileId) {

        return mutationMapperLegacy.getMutations(sampleIds, null, geneticProfileId, false);
    }

    public List<Mutation> getSimplifiedMutations(List<Integer> sampleIds, List<Integer> entrezGeneIds,
                                                 Integer geneticProfileId) {

        return mutationMapperLegacy.getMutations(sampleIds, entrezGeneIds, geneticProfileId, true);
    }

    public Boolean hasAlleleFrequencyData(Integer geneticProfileId, Integer sampleId) {
        return mutationMapperLegacy.hasAlleleFrequencyData(geneticProfileId, sampleId);
    }
    ...
    public List<SignificantlyMutatedGene> getSignificantlyMutatedGenes(Integer geneticProfileId,
        ...
        return mutationMapperLegacy.getSignificantlyMutatedGenes(geneticProfileId, entrezGeneIds, sampleIds,
    ...
    public List<MutationCount> countMutationEvents(Integer geneticProfileId, List<Integer> sampleIds) {
        ...
        return mutationMapperLegacy.countMutationEvents(geneticProfileId, sampleIds);
    }

    public List<MutatedGeneSampleCount> countSamplesWithMutatedGenes(Integer geneticProfileId,
                                                                     List<Integer> entrezGeneIds) {

        return mutationMapperLegacy.countSamplesWithMutatedGenes(geneticProfileId, entrezGeneIds);
    }

    public List<KeywordSampleCount> countSamplesWithKeywords(Integer geneticProfileId, List<String> keywords) {
        return mutationMapperLegacy.countSamplesWithKeywords(geneticProfileId, keywords);
    }
    ...
    public void setMutationMapperLegacy(MutationMapperLegacy mutationMapperLegacy) {
