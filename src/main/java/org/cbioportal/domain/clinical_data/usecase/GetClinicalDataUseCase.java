...
public class GetClinicalDataUseCase {
     ...
     */
    public GetClinicalDataUseCase(GetPatientClinicalDataUseCase getPatientClinicalDataUseCase, GetSampleClinicalDataUseCase getSampleClinicalDataUseCase) {
     ...
     */
    public List<ClinicalData> execute(ClinicalDataMultiStudyFilter clinicalDataMultiStudyFilter, List<String> attributeIds, ClinicalDataType clinicalDataType, ProjectionType projectionType) {
        return switch (clinicalDataType) {
            case SAMPLE -> getSampleClinicalDataUseCase.execute(clinicalDataMultiStudyFilter, attributeIds, projectionType);
            case PATIENT -> getPatientClinicalDataUseCase.execute(clinicalDataMultiStudyFilter, attributeIds, projectionType);
        };
    }
}
