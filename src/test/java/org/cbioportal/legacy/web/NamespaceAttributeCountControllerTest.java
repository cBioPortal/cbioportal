...
public class NamespaceAttributeCountControllerTest {
  ...
  public void getNamespaceAttributeCountsBySampleIds() throws Exception {
    ...
    List<NamespaceAttributeCount> namespaceAttributeCounts =
        createExampleNamespaceAttributeCounts();

    Mockito.when(
            namespaceAttributeService.fetchNamespaceAttributeCountsBySampleIds(
                Mockito.any(), Mockito.any(), Mockito.any()))
        .thenReturn(namespaceAttributeCounts);

    NamespaceAttributeCountFilter namespaceAttributeCountFilter =
        createExampleNamespaceAttributeCountFilter();

    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/namespace-attributes/counts/fetch")
                .with(csrf())
  ...
  private NamespaceAttributeCountFilter createExampleNamespaceAttributeCountFilter() {
    ...
    NamespaceAttributeCountFilter namespaceAttributeCountFilter =
        new NamespaceAttributeCountFilter();
