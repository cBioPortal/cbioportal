...
public class PatientClinicalDataConverterImpl extends ClinicalDataConverterImpl implements Converter {
	...
	public void createStagingFile(PortalMetadata portalMetadata, CancerStudyMetadata cancerStudyMetadata,
        ...
        processPatientMatrix(patientMatrix, followUps);
    ...
    private void processPatientMatrix(DataMatrix patientMatrix, List<DataMatrix> followUps)
    {
        ...
        config.flagMissingClinicalAttributes(removeUnknownColumnsFromMatrix(patientMatrix, clinicalAttributes));
