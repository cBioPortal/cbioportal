...
/**
 * Mapper interface for retrieving alteration-related data from ClickHouse. This interface provides
 * methods for fetching mutated gene counts, copy number alteration counts, structural variant gene
 * counts, and more, based on the provided study view filter context and alteration filters.
 */
public interface ClickhouseAlterationMapper {
  ...
  /**
   * Retrieves copy number alteration (CNA) gene counts based on the study view filter context and
   * alteration filter.
   *
   * @param studyViewFilterContext the context of the study view filter
   * @param alterationFilterHelper the helper for applying alteration filters
  ...
  /**
   * Retrieves structural variant gene counts based on the study view filter context and alteration
   * filter.
   *
   * @param studyViewFilterContext the context of the study view filter
   * @param alterationFilterHelper the helper for applying alteration filters
   ...
   */
  List<SampleToPanel> getEntityToGenePanels(String sampleStableIdsJoined, String field);
