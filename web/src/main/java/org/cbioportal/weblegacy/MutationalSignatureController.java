...
public class MutationalSignatureController {
    ...
    public List<MutationalSignature> getMutationalSignatures(@ApiParam(required = true, value = "Study id")
	...
	if (sample_ids != null) {
		return mutationalSignatureService.getMutationalSignaturesBySampleIds(study_id, sample_ids);
	} else {
		return mutationalSignatureService.getMutationalSignatures(study_id);
	}
    }
}
