 ...
 * CustomRedisCache that doesn't have a ton of dependencies or a long runtime. Believe it or not,
 * this test did catch some bugs; so while it isn't a perfect integration test by any means, I think
 * it is worth something.
 *
 * <p>What I've done is create a hollow implementation of RedissionClient that acts as a _very_
 * primitive in memory cache. This test just runs some basic caching operations, namely set, get,
 * and clear.
 */
