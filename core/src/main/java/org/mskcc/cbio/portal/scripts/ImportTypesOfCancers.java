...
public class ImportTypesOfCancers extends ConsoleRunnable {
    ...
    public static void load(File file, boolean clobber)
        ...
        while (scanner.hasNextLine()) {
            ...
            if (
                !clobber &&
                DaoTypeOfCancer.getTypeOfCancerById(
                    typeOfCancerId.toLowerCase()
                ) !=
                null
            ) {
        ...
        ProgressMonitor.setCurrentMessage(
            " --> Loaded " + numNewCancerTypes + " new cancer types."
        );
