...
<%
      ...
      for( String imageDataTypeAndDesc : imageDataTypes ){
         ...
         ArrayList<GeneticProfile> profileList2 = (ArrayList<GeneticProfile>) request.getAttribute(QueryBuilder.PROFILE_LIST_INTERNAL);
         ...
         for( GeneticProfile theGeneticProfile : profileList2){
            if( theGeneticProfile.getAlterationType() == theGeneticAlterationType && 
                     geneticProfileIdSet2.contains( theGeneticProfile.getId() )){
