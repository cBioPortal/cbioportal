...
@Profile("clickhouse")
/**
 * Use case for retrieving case list data counts. This class interacts with the {@link
 * PatientRepository} to fetch the case list data counts based on the filter criteria specified in
 * the study view filter context.
 */
public class GetCaseListDataCountsUseCase {
  ...
  /**
   * Executes the use case to retrieve the case list data counts based on the given study view
   * filter context.
   *
