...
@Profile("clickhouse")
/**
 * Use case for retrieving the count of filtered patients.
 * This class interacts with the {@link PatientRepository} to fetch the number of patients
...
public class GetFilteredPatientCountUseCase {
    ...
    /**
     * Constructs a {@code GetFilteredPatientCountUseCase} with the provided {@link PatientRepository}.
     *
    ...
    /**
     * Executes the use case to retrieve the count of filtered patients based on the given study view filter context.
     *
