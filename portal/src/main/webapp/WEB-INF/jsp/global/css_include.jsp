...
<link href="css/smoothness/jquery-ui-1.10.3.custom.css?20160703-1926" type="text/css" rel="stylesheet" />
...
<link href="css/oql-editor.css?<%=GlobalProperties.getAppVersion()%>" type="text/css" rel="stylesheet" />
