...
public class ReferenceGenomeGeneControllerTest {
    ...
    public void getAllReferenceGenesFromCache() throws Exception {
        Mockito
            .when(geneMemoizerService.fetchGenes(Mockito.anyString()))
            .thenReturn(Collections.singletonList(gene));
        Mockito
            .when(
                referenceGenomeGeneService.fetchAllReferenceGenomeGenes(
                    Mockito.anyString()
                )
            )
            .thenReturn(Collections.singletonList(gene));
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/reference-genome-genes/hg19")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].referenceGenomeId")
                    .value(REFERENCE_GENOME_ID)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].cytoband")
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].length").value(LENGTH_1)
            )
            .andExpect(
                MockMvcResultMatchers
        ...
        Mockito
            .verify(referenceGenomeGeneService, times(0))
            .fetchAllReferenceGenomeGenes(Mockito.anyString());
        // The cache is not changed
        Mockito
            .verify(geneMemoizerService, times(0))
            .cacheGenes(Mockito.anyList(), Mockito.anyString());
    }
    ...
    public void getAllReferenceGenesNoCache() throws Exception {
        ...
        Mockito
            .verify(referenceGenomeGeneService, times(1))
            .fetchAllReferenceGenomeGenes(Mockito.anyString());
        // The response is added to the cache
        Mockito
            .verify(geneMemoizerService, times(1))
            .cacheGenes(Mockito.anyList(), Mockito.anyString());
    }
    ...
    public void getGene() throws Exception {
        Mockito
            .when(
                referenceGenomeGeneService.getReferenceGenomeGene(
                    Mockito.anyInt(),
                    Mockito.anyString()
                )
            )
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/reference-genome-genes/hg19/1")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.entrezGeneId")
                    .value(ENTREZ_GENE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.referenceGenomeId")
                    .value(REFERENCE_GENOME_ID)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.cytoband").value(CYTOBAND_1)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.length").value(LENGTH_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.chromosome")
    ...
    public void fetchGenesDefaultProjection() throws Exception {
        ...
        Mockito
            .when(
                referenceGenomeGeneService.fetchGenesByGenomeName(
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/reference-genome-genes/hg19/fetch")
                    .accept(MediaType.APPLICATION_JSON)
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].length").value(LENGTH_2)
            )
            .andExpect(
                MockMvcResultMatchers
