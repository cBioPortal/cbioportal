...
public class MolecularDataMyBatisRepositoryTest {
    ...
    @Test
    public void getCommaSeparatedSampleIdsOfMolecularProfile()
        throws Exception {
        String result = molecularDataMyBatisRepository.getCommaSeparatedSampleIdsOfMolecularProfile(
    ...
    @Test
    public void getCommaSeparatedSampleIdsOfMolecularProfiles()
        throws Exception {
        List<String> result = molecularDataMyBatisRepository.getCommaSeparatedSampleIdsOfMolecularProfiles(
            Arrays.asList("study_tcga_pub_mrna", "study_tcga_pub_m_na")
        );
    ...
    public void getGeneMolecularAlterations() throws Exception {
        ...
        List<GeneMolecularAlteration> result = molecularDataMyBatisRepository.getGeneMolecularAlterations(
            "study_tcga_pub_gistic",
            entrezGeneIds,
            "SUMMARY"
        );
    ...
    public void getGeneMolecularAlterationsIterable() throws Exception {
        ...
        Iterable<GeneMolecularAlteration> gmaItr = molecularDataMyBatisRepository.getGeneMolecularAlterationsIterable(
            "study_tcga_pub_gistic",
            entrezGeneIds,
            "SUMMARY"
        );
    ...
    private void getGeneMolecularAlterationsCommonTest(
        ...
        Assert.assertEquals(
            (Integer) 207,
            molecularAlteration1.getEntrezGeneId()
        );
        String[] expected = {
            "-0.4674",
            "-0.6270",
        ...
        Assert.assertArrayEquals(
            expected,
            molecularAlteration1.getSplitValues()
        );
        GeneMolecularAlteration molecularAlteration2 = result.get(1);
        Assert.assertEquals(
            (Integer) 208,
            molecularAlteration2.getEntrezGeneId()
        );
        String[] expected2 = {
            "1.4146",
            "-0.0662",
        ...
        Assert.assertArrayEquals(
            expected2,
            molecularAlteration2.getSplitValues()
        );
    }

    @Test
    public void getGeneMolecularAlterationsInMultipleMolecularProfiles()
        throws Exception {
        List<Integer> entrezGeneIds = new ArrayList<>();
        entrezGeneIds.add(207);
        entrezGeneIds.add(208);

        List<GeneMolecularAlteration> result = molecularDataMyBatisRepository.getGeneMolecularAlterationsInMultipleMolecularProfiles(
        ...
        Assert.assertEquals(
            (Integer) 208,
            molecularAlteration3.getEntrezGeneId()
        );
        String[] expected3 = {
            "-0.8097",
            "0.7360",
        ...
        Assert.assertArrayEquals(
            expected3,
            molecularAlteration3.getSplitValues()
        );
    }
    ...
    public void getGenesetMolecularAlterations() {
        ...
        List<GenesetMolecularAlteration> result = molecularDataMyBatisRepository.getGenesetMolecularAlterations(
