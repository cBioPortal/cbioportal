...
ALTER TABLE `mutation_event` CHANGE COLUMN ONCOTATOR_REFSEQ_MRNA_ID TO MUTATION_REFSEQ_MRNA_ID;
ALTER TABLE `mutation_event` CHANGE COLUMN ONCOTATOR_CODON_CHANGE TO MUTATION_CODON_CHANGE;
ALTER TABLE `mutation_event` CHANGE COLUMN ONCOTATOR_UNIPROT_ACCESSION TO MUTATION_UNIPROT_ACCESSION;
ALTER TABLE `mutation_event` CHANGE COLUMN ONCOTATOR_PROTEIN_POS_START TO MUTATION_PROTEIN_POS_START;
ALTER TABLE `mutation_event` CHANGE COLUMN ONCOTATOR_PROTEIN_POS_END TO MUTATION_PROTEIN_POS_END;
UPDATE `info` SET `DB_SCHEMA_VERSION`="2.12.16";
