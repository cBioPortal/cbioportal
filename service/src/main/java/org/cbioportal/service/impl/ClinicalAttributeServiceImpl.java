...
public class ClinicalAttributeServiceImpl implements ClinicalAttributeService {
    ...
    @Override
    @PostFilter(
        "hasPermission(filterObject.cancerStudyIdentifier, 'CancerStudyId', 'read')"
    )
    public List<ClinicalAttribute> getAllClinicalAttributes(
        ...
        List<ClinicalAttribute> clinicalAttributes = clinicalAttributeRepository.getAllClinicalAttributes(
            projection,
            pageSize,
            pageNumber,
            sortBy,
    ...
    public ClinicalAttribute getClinicalAttribute(
        ...
        ClinicalAttribute clinicalAttribute = clinicalAttributeRepository.getClinicalAttribute(
            studyId,
            clinicalAttributeId
        );

        if (clinicalAttribute == null) {
            throw new ClinicalAttributeNotFoundException(
                studyId,
                clinicalAttributeId
            );
        }
    ...
    public BaseMeta getMetaClinicalAttributesInStudy(String studyId)
        ...
        return clinicalAttributeRepository.getMetaClinicalAttributesInStudy(
            studyId
        );
    }
    ...
    public List<ClinicalAttribute> fetchClinicalAttributes(
        ...
        return clinicalAttributeRepository.fetchClinicalAttributes(
            studyIds,
            projection
        );
    }
    ...
    public BaseMeta fetchMetaClinicalAttributes(List<String> studyIds) {
        return clinicalAttributeRepository.fetchMetaClinicalAttributes(
            studyIds
        );
    }
    ...
    public List<ClinicalAttributeCount> getClinicalAttributeCountsBySampleListId(
        ...
        return clinicalAttributeRepository.getClinicalAttributeCountsBySampleListId(
            sampleListId
        );
    }
