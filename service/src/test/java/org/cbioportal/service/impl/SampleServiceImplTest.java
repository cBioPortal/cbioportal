...
public class SampleServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllSamples() {
        List<Sample> samples = Arrays.asList(
            createSample(SAMPLE_ID1),
            createSample(SAMPLE_ID2),
            createSample(SAMPLE_ID3),
            createSample(SAMPLE_ID4)
        );
        Mockito
            .when(
        ...
        List<Sample> result = sampleService.getAllSamples(
            "sample_id",
            null,
            PROJECTION,
            PAGE_SIZE,
    ...
    public void getAllMetaSamples() {
        ...
        Mockito
            .when(sampleRepository.getMetaSamples("sample_id", null))
            .thenReturn(baseMeta);
    ...
    public void getAllSamplesInStudy() throws Exception {
        ...
        Mockito
            .when(
                sampleListRepository.getAllSampleIdsInSampleList(
                    Mockito.anyString()
                )
            )
        ...
        List<Sample> result = sampleService.getAllSamplesInStudy(
            STUDY_ID,
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
    ...
    public void getMetaSamplesInStudy() throws Exception {
        ...
        Mockito
            .when(sampleRepository.getMetaSamplesInStudy(STUDY_ID))
    ...
    public void getSampleInStudySampleNotFound() throws Exception {
        Mockito
            .when(sampleRepository.getSampleInStudy(STUDY_ID, SAMPLE_ID1))
            .thenReturn(null);
    ...
    public void getAllSamplesOfPatientInStudy() throws Exception {
        ...
        List<Sample> result = sampleService.getAllSamplesOfPatientInStudy(
            STUDY_ID,
            PATIENT_ID_1,
            PROJECTION,
            PAGE_SIZE,
    ...
    public void getAllSamplesOfPatientInStudyPatientNotFound()
        throws Exception {
        Mockito
    ...
    public void getMetaSamplesOfPatientInStudy() throws Exception {
        ...
        Mockito
            .when(
                sampleRepository.getMetaSamplesOfPatientInStudy(
                    STUDY_ID,
                    PATIENT_ID_1
                )
            )
            .thenReturn(expectedBaseMeta);
        BaseMeta result = sampleService.getMetaSamplesOfPatientInStudy(
            STUDY_ID,
            PATIENT_ID_1
        );
    ...
    @Test(expected = PatientNotFoundException.class)
    public void getMetaSamplesOfPatientInStudyPatientNotFound()
        throws Exception {
        Mockito
            .when(patientService.getPatientInStudy(STUDY_ID, PATIENT_ID_1))
            .thenThrow(new PatientNotFoundException(STUDY_ID, PATIENT_ID_1));
    ...
    public void getAllSamplesOfPatientsInStudy() throws Exception {
        ...
        Mockito
            .when(
                sampleRepository.getAllSamplesOfPatientsInStudy(
                    STUDY_ID,
        ...
        List<Sample> result = sampleService.getAllSamplesOfPatientsInStudy(
            STUDY_ID,
            Arrays.asList(PATIENT_ID_1),
            PROJECTION
        );
    ...
    public void fetchSamples() throws Exception {
        ...
        List<Sample> result = sampleService.fetchSamples(
            Arrays.asList(STUDY_ID),
            Arrays.asList(SAMPLE_ID1),
            PROJECTION
        );
    ...
    public void fetchMetaSamples() throws Exception {
        ...
        Mockito
            ...
            .thenReturn(expectedBaseMeta);
        BaseMeta result = sampleService.fetchMetaSamples(
            Arrays.asList(STUDY_ID),
            Arrays.asList(SAMPLE_ID1)
        );
    ...
    public void fetchMetaSamplesBySampleListIds() throws Exception {
        ...
        Mockito
            .when(
                sampleRepository.fetchMetaSamples(Arrays.asList(SAMPLE_LIST_ID))
            )
            .thenReturn(expectedBaseMeta);
        BaseMeta result = sampleService.fetchMetaSamples(
            Arrays.asList(SAMPLE_LIST_ID)
    ...
    public void getSamplesByInternalIds() throws Exception {
        ...
        Mockito
            .when(
                sampleRepository.getSamplesByInternalIds(
                    Arrays.asList(SAMPLE_INTERNAL_ID)
                )
            )
            .thenReturn(expectedSampleList);

        List<Sample> result = sampleService.getSamplesByInternalIds(
            Arrays.asList(SAMPLE_INTERNAL_ID)
        );
