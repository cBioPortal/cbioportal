...
INSERT INTO `reference_genome` VALUES (1, 'human', 'hg19', 'GRCh37', NULL, 'http://hgdownload.cse.ucsc.edu/goldenPath/hg19/bigZips/hg19.chrom.sizes', '2009-02-01 00:00:00');
INSERT INTO `reference_genome` VALUES (2, 'human', 'hg38', 'GRCh38', NULL, 'http://hgdownload.cse.ucsc.edu/goldenPath/hg38/bigZips/hg38.chrom.sizes', '2013-12-01 00:00:00');
INSERT INTO `reference_genome` VALUES (3, 'mouse', 'mm10', 'GRCm38', NULL, 'http://hgdownload.cse.ucsc.edu//goldenPath/mm10/bigZips/mm10.chrom.sizes', '2012-01-01 00:00:00');

INSERT INTO reference_genome_gene (entrez_gene_id,cytoband,exonic_length,gene_start,gene_end,gene_stable_ID,chr,reference_genome_id) VALUES(207,'14q32.33',10838,105235686,105262088,'ENSG00000142208' ,14,1);
INSERT INTO reference_genome_gene (entrez_gene_id,cytoband,exonic_length,gene_start,gene_end,gene_stable_ID,chr,reference_genome_id) VALUES(207,'14q32.33',10838,104769349,104795751,'ENSG00000142208' ,14,2);
INSERT INTO reference_genome_gene (entrez_gene_id,cytoband,exonic_length,gene_start,gene_end,gene_stable_ID,chr,reference_genome_id) VALUES(208,'19q13.2',0, 40736224, 40791443,'ENSG00000105221',19,1);
INSERT INTO reference_genome_gene (entrez_gene_id,cytoband,exonic_length,gene_start,gene_end,gene_stable_ID,chr,reference_genome_id) VALUES(208,'19q13.2',0, 40230317, 40285536,'ENSG00000105221',19,2);

INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(2,'study_tcga_pub_gistic',1,'COPY_NUMBER_ALTERATION','DISCRETE','Putative copy-number alterations from GISTIC','Putative copy-number from GISTIC 2.0. Values: -2 = homozygous deletion; -1 = hemizygous deletion; 0 = neutral / no change; 1 = gain; 2 = high level amplification.',1, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(3,'study_tcga_pub_mrna',1,'MRNA_EXPRESSION','Z-SCORE','mRNA expression (microarray)','Expression levels (Agilent microarray).',0, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(4,'study_tcga_pub_log2CNA',1,'COPY_NUMBER_ALTERATION','LOG2-VALUE','Log2 copy-number values','Log2 copy-number VALUESfor each gene (from Affymetrix SNP6).',0, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(5,'study_tcga_pub_methylation_hm27',1,'METHYLATION','CONTINUOUS','Methylation (HM27)','Methylation beta-VALUES(HM27 platform). For genes with multiple methylation probes, the probe least correlated with expression is selected.',0, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(6,'study_tcga_pub_mutations',1,'MUTATION_EXTENDED','MAF','Mutations','Mutation data from whole exome sequencing.',1, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(7,'study_tcga_pub_sv',1,'STRUCTURAL_VARIANT','SV','Structural Variants','Structural Variants detected by Illumina HiSeq sequencing.',1, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(8,'acc_tcga_mutations',2,'MUTATION_EXTENDED','MAF','Mutations','Mutation data from whole exome sequencing.',1, 1);
INSERT INTO genetic_profile (GENETIC_PROFILE_ID,STABLE_ID,CANCER_STUDY_ID,GENETIC_ALTERATION_TYPE,DATATYPE,NAME,DESCRIPTION,SHOW_PROFILE_IN_ANALYSIS_TAB, REFERENCE_GENOME_ID) VALUES(9,'study_tcga_pub_gsva_scores',1,'GENESET_SCORE','GSVA-SCORE','GSVA scores','GSVA scores for oncogenic signature gene sets from MsigDB calculated with GSVA version 1.22.4, R version 3.3.2.',1, 1);
...
INSERT INTO mutation_event (MUTATION_EVENT_ID,ENTREZ_GENE_ID,REFERENCE_GENOME_ID, CHR,START_POSITION,END_POSITION,REFERENCE_ALLELE,TUMOR_SEQ_ALLELE,PROTEIN_CHANGE,MUTATION_TYPE,FUNCTIONAL_IMPACT_SCORE,FIS_VALUE,LINK_XVAR,LINK_PDB,LINK_MSA,STRAND,VARIANT_TYPE,DB_SNP_RS,DB_SNP_VAL_STATUS,ONCOTATOR_DBSNP_RS,ONCOTATOR_REFSEQ_MRNA_ID,ONCOTATOR_CODON_CHANGE,ONCOTATOR_UNIPROT_ENTRY_NAME,ONCOTATOR_UNIPROT_ACCESSION,ONCOTATOR_PROTEIN_POS_START,ONCOTATOR_PROTEIN_POS_END,CANONICAL_TRANSCRIPT,KEYWORD) VALUES(2038,672,1,'17',41244748,41244748,'G','A','Q934*','Nonsense_Mutation','NA',0,'getma.org/?cm=var&var=hg19,17,41244748,G,A&fts=all','NA','NA','+','SNP','rs80357223','unknown','rs80357223','NM_007294','c.(2800-2802)CAG>TAG','BRCA1_HUMAN','P38398',934,934,1,'BRCA1 truncating');
INSERT INTO mutation_event (MUTATION_EVENT_ID,ENTREZ_GENE_ID,REFERENCE_GENOME_ID, CHR,START_POSITION,END_POSITION,REFERENCE_ALLELE,TUMOR_SEQ_ALLELE,PROTEIN_CHANGE,MUTATION_TYPE,FUNCTIONAL_IMPACT_SCORE,FIS_VALUE,LINK_XVAR,LINK_PDB,LINK_MSA,STRAND,VARIANT_TYPE,DB_SNP_RS,DB_SNP_VAL_STATUS,ONCOTATOR_DBSNP_RS,ONCOTATOR_REFSEQ_MRNA_ID,ONCOTATOR_CODON_CHANGE,ONCOTATOR_UNIPROT_ENTRY_NAME,ONCOTATOR_UNIPROT_ACCESSION,ONCOTATOR_PROTEIN_POS_START,ONCOTATOR_PROTEIN_POS_END,CANONICAL_TRANSCRIPT,KEYWORD) VALUES(22604,672,1,'17',41258504,41258504,'A','C','C61G','Missense_Mutation','H',4.355,'getma.org/?cm=var&var=hg19,17,41258504,A,C&fts=all','getma.org/pdb.php?prot=BRCA1_HUMAN&from=24&to=64&var=C61G','getma.org/?cm=msa&ty=f&p=BRCA1_HUMAN&rb=24&re=64&var=C61G','+','SNP','rs28897672','byCluster','rs28897672','NM_007294','c.(181-183)TGT>GGT','BRCA1_HUMAN','P38398',61,61,1,'BRCA1 C61 missense');
INSERT INTO mutation_event (MUTATION_EVENT_ID,ENTREZ_GENE_ID,REFERENCE_GENOME_ID, CHR,START_POSITION,END_POSITION,REFERENCE_ALLELE,TUMOR_SEQ_ALLELE,PROTEIN_CHANGE,MUTATION_TYPE,FUNCTIONAL_IMPACT_SCORE,FIS_VALUE,LINK_XVAR,LINK_PDB,LINK_MSA,STRAND,VARIANT_TYPE,DB_SNP_RS,DB_SNP_VAL_STATUS,ONCOTATOR_DBSNP_RS,ONCOTATOR_REFSEQ_MRNA_ID,ONCOTATOR_CODON_CHANGE,ONCOTATOR_UNIPROT_ENTRY_NAME,ONCOTATOR_UNIPROT_ACCESSION,ONCOTATOR_PROTEIN_POS_START,ONCOTATOR_PROTEIN_POS_END,CANONICAL_TRANSCRIPT,KEYWORD) VALUES(2039,672,1,'17',41276033,41276033,'C','T','C27_splice','Splice_Site','NA',1.4013e-45,'NA','NA','NA','+','SNP','rs80358010','byCluster','rs80358010','NM_007294','c.e2+1','NA','NA',-1,-1,1,'BRCA1 truncating');
INSERT INTO mutation_event (MUTATION_EVENT_ID,ENTREZ_GENE_ID,REFERENCE_GENOME_ID, CHR,START_POSITION,END_POSITION,REFERENCE_ALLELE,TUMOR_SEQ_ALLELE,PROTEIN_CHANGE,MUTATION_TYPE,FUNCTIONAL_IMPACT_SCORE,FIS_VALUE,LINK_XVAR,LINK_PDB,LINK_MSA,STRAND,VARIANT_TYPE,DB_SNP_RS,DB_SNP_VAL_STATUS,ONCOTATOR_DBSNP_RS,ONCOTATOR_REFSEQ_MRNA_ID,ONCOTATOR_CODON_CHANGE,ONCOTATOR_UNIPROT_ENTRY_NAME,ONCOTATOR_UNIPROT_ACCESSION,ONCOTATOR_PROTEIN_POS_START,ONCOTATOR_PROTEIN_POS_END,CANONICAL_TRANSCRIPT,KEYWORD) VALUES(2040,207,1,'17',41244748,41244748,'G','A','Q934*','Nonsense_Mutation','NA',0,'getma.org/?cm=var&var=hg19,17,41244748,G,A&fts=all','NA','NA','+','SNP','rs80357223','unknown','rs80357223','NM_007294','c.(2800-2802)CAG>TAG','BRCA1_HUMAN','P38398',934,934,1,'BRCA1 truncating');
INSERT INTO mutation_event (MUTATION_EVENT_ID,ENTREZ_GENE_ID,REFERENCE_GENOME_ID, CHR,START_POSITION,END_POSITION,REFERENCE_ALLELE,TUMOR_SEQ_ALLELE,PROTEIN_CHANGE,MUTATION_TYPE,FUNCTIONAL_IMPACT_SCORE,FIS_VALUE,LINK_XVAR,LINK_PDB,LINK_MSA,STRAND,VARIANT_TYPE,DB_SNP_RS,DB_SNP_VAL_STATUS,ONCOTATOR_DBSNP_RS,ONCOTATOR_REFSEQ_MRNA_ID,ONCOTATOR_CODON_CHANGE,ONCOTATOR_UNIPROT_ENTRY_NAME,ONCOTATOR_UNIPROT_ACCESSION,ONCOTATOR_PROTEIN_POS_START,ONCOTATOR_PROTEIN_POS_END,CANONICAL_TRANSCRIPT,KEYWORD) VALUES(2041,207,1,'17',41258504,41258504,'A','C','C61G','Missense_Mutation','H',4.355,'getma.org/?cm=var&var=hg19,17,41258504,A,C&fts=all','getma.org/pdb.php?prot=BRCA1_HUMAN&from=24&to=64&var=C61G','getma.org/?cm=msa&ty=f&p=BRCA1_HUMAN&rb=24&re=64&var=C61G','+','SNP','rs28897672','byCluster','rs28897672','NM_007294','c.(181-183)TGT>GGT','BRCA1_HUMAN','P38398',61,61,1,'BRCA1 C61 missense');
INSERT INTO mutation_event (MUTATION_EVENT_ID,ENTREZ_GENE_ID,REFERENCE_GENOME_ID, CHR,START_POSITION,END_POSITION,REFERENCE_ALLELE,TUMOR_SEQ_ALLELE,PROTEIN_CHANGE,MUTATION_TYPE,FUNCTIONAL_IMPACT_SCORE,FIS_VALUE,LINK_XVAR,LINK_PDB,LINK_MSA,STRAND,VARIANT_TYPE,DB_SNP_RS,DB_SNP_VAL_STATUS,ONCOTATOR_DBSNP_RS,ONCOTATOR_REFSEQ_MRNA_ID,ONCOTATOR_CODON_CHANGE,ONCOTATOR_UNIPROT_ENTRY_NAME,ONCOTATOR_UNIPROT_ACCESSION,ONCOTATOR_PROTEIN_POS_START,ONCOTATOR_PROTEIN_POS_END,CANONICAL_TRANSCRIPT,KEYWORD) VALUES(2042,208,1,'17',41276033,41276033,'C','T','C27_splice','Splice_Site','NA',1.4013e-45,'NA','NA','NA','+','SNP','rs80358010','byCluster','rs80358010','NM_007294','c.e2+1','NA','NA',-1,-1,1,'BRCA1 truncating');
...
INSERT INTO copy_number_seg (SEG_ID,GENETIC_PROFILE_ID,SAMPLE_ID,CHR,START,END,NUM_PROBES,SEGMENT_MEAN) VALUES(50236594,5,2,'1',324556,180057677,291,0.0519);
INSERT INTO copy_number_seg (SEG_ID,GENETIC_PROFILE_ID,SAMPLE_ID,CHR,START,END,NUM_PROBES,SEGMENT_MEAN) VALUES(50236595,5,1,'2',224556,327677,391,0.0219);
INSERT INTO copy_number_seg (SEG_ID,GENETIC_PROFILE_ID,SAMPLE_ID,CHR,START,END,NUM_PROBES,SEGMENT_MEAN) VALUES(50236593,5,2,	'2',1402650,190262486,207,0.0265);
INSERT INTO copy_number_seg (SEG_ID,GENETIC_PROFILE_ID,SAMPLE_ID,CHR,START,END,NUM_PROBES,SEGMENT_MEAN) VALUES(50236592,5,3,	'3',1449872,194238390,341,0.0347);
INSERT INTO copy_number_seg (SEG_ID,GENETIC_PROFILE_ID,SAMPLE_ID,CHR,START,END,NUM_PROBES,SEGMENT_MEAN) VALUES(50236500,3,15,	'2',14492,19423390,41,0.047);
