...
public class SampleListController {
  ...
  @PreAuthorize(
      "hasPermission(#sampleListId, 'SampleListId', T(org.cbioportal.utils.security.AccessLevel).READ)")
  @RequestMapping(
  ...
  @PreAuthorize(
      "hasPermission(#sampleListIds, 'Collection<SampleListId>', T(org.cbioportal.utils.security.AccessLevel).READ)")
  @RequestMapping(
