...
public class StructuralVariantMyBatisRepositoryTest {
  ...
  // <noi>               <noi>   TCGA-A1-A0SB    germline
  //        2     27436-238   EML4-ALK    7   study_tcga_pub_sv   SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SD    somatic
  //        1     57670-673   KIAA..-BRAF 7   study_tcga_pub_sv   SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SB    somatic
  //        2     57670-673   KIAA..-BRAF 7   study_tcga_pub_sv   SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SD    germline
  //        2     57670-673   KIAA..-BRAF 7   study_tcga_pub_sv   SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SD    somatic
  //       15     57670-673   KIAA..-BRAF 13  acc_tcga_sv         SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SD    somatic
  //        1     8031-5979   NCOA4-RET   7   study_tcga_pub_sv   SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SB    somatic
  //       15     8031-5979   NCOA4-RET   13  acc_tcga_sv         SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SB    somatic
  //        1     7113-2078   TMPRSS2-ERG 7   study_tcga_pub_sv   SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SB    somatic
  //       15     8031-NULL   NCOA4-      13  acc_tcga_sv        SV          Fusion
  // <noi>               <noi>   TCGA-A1-A0SB    somatic

  @Autowired StructuralVariantMyBatisRepository structuralVariantMyBatisRepository;
  ...
  public void init() {
    ...
    GeneFilterQuery geneFilterQuery3 =
        new GeneFilterQuery(
            ...
            includeSomatic,
            includeUnknownStatus);
    GeneFilterQuery geneFilterQuery4 =
        new GeneFilterQuery(
            "NCOA4",
            8031,
            null,
            ...
            includeUnknownStatus);
    geneQueries =
        Arrays.asList(geneFilterQuery1, geneFilterQuery2, geneFilterQuery3, geneFilterQuery4);

    // Only search for the KIAA1549-BRAF and EML4-ALK fusions.
    structVarFilterQuery1 =
        new StructuralVariantFilterQuery(
            "KIAA1549",
            57670,
            "BRAF",
            673,
  ...
  public void fetchStructuralVariantsNoSampleIdentifiers() {
    ...
    Assert.assertEquals(
        "ENST00000242365", structuralVariantFirstResult.getSite1EnsemblTranscriptId());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509_1", structuralVariantFirstResult.getSite1Description());
    ...
    Assert.assertEquals(
        "ENST00000288602", structuralVariantFirstResult.getSite2EnsemblTranscriptId());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509_2", structuralVariantFirstResult.getSite2Description());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509", structuralVariantFirstResult.getAnnotation());
    ...
    Assert.assertEquals(
        "Potentially Actionable", structuralVariantFirstResult.getDriverTiersFilterAnn());
    ...
    Assert.assertEquals(
        "ENST00000242365", structuralVariantSecondResult.getSite1EnsemblTranscriptId());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509_1", structuralVariantSecondResult.getSite1Description());
    ...
    Assert.assertEquals(
        "ENST00000288602", structuralVariantSecondResult.getSite2EnsemblTranscriptId());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509_2", structuralVariantSecondResult.getSite2Description());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509", structuralVariantSecondResult.getAnnotation());
    ...
    Assert.assertEquals(
        "ENST00000242365", structuralVariantThirdResult.getSite1EnsemblTranscriptId());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509_1", structuralVariantThirdResult.getSite1Description());
    ...
    Assert.assertEquals(
        "ENST00000288602", structuralVariantThirdResult.getSite2EnsemblTranscriptId());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509_2", structuralVariantThirdResult.getSite2Description());
    ...
    Assert.assertEquals(
        "KIAA1549-BRAF.K16B10.COSF509", structuralVariantThirdResult.getAnnotation());
  ...
  public void fetchStructuralVariantsMultiStudyNoGeneIdentifiers() throws Exception {
    ...
    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariants(
            molecularProfileIds, sampleIds, noEntrezIds, noStructVars);

    Assert.assertEquals(8, result.size());
  }

  @Test
  public void fetchStructuralVariantsMultiStudyByGeneQueriesWithSampleIdentifiers()
      throws Exception {

    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariantsByGeneQueries(
            molecularProfileIds, sampleIds, geneQueries);

    Assert.assertEquals(11, result.size());

    List<String> resultTcgaPubVariants =
        result.stream()
            .filter(s -> "study_tcga_pub_sv".equals(s.getMolecularProfileId()))
            .map(StructuralVariant::getAnnotation)
            .collect(Collectors.toList());
    List<String> resultTcgaVariants =
        result.stream()
    ...
    Assert.assertArrayEquals(
        new String[] {
          ...
          "EML4-ALK.E6bA20.AB374362-2",
          "KIAA1549-BRAF.K16B10.COSF509",
          "KIAA1549-BRAF.K16B10.COSF509",
          "KIAA1549-BRAF.K16B10.COSF509",
          "NCOA4-RET.N7R1",
          "TMPRSS2-ERG.T1E2.COSF23.1"
        },
        resultTcgaPubVariants.toArray());
    Assert.assertArrayEquals(
        new String[] {
          "KIAA1549-BRAF.K16B10.COSF509",
          "NCOA4-NULL",
        ...
        resultTcgaVariants.toArray());
  }

  @Test
  public void fetchStructuralVariantsMultiStudyByGeneQueriesWithSampleIdentifiersExcludePassenger()
      throws Exception {
  ...
  @Test
  public void
      fetchStructuralVariantsMultiStudyByGeneQueriesWithSampleIdentifiersSelectUnknownOncogenicity()
          throws Exception {
  ...
  @Test
  public void
      fetchStructuralVariantsMultiStudyByGeneQueriesWithSampleIdentifiersExcludeUnknownOncogenicity()
          throws Exception {
    ...
    Assert.assertArrayEquals(
        new String[] {"KIAA1549-BRAF.K16B10.COSF509"}, resultTcgaPubVariants.toArray());
  }

  @Test
  public void fetchStructuralVariantsMultiStudyByGeneQueriesWithSampleIdentifiersIncludeTier()
      throws Exception {

    // There is one passenger event that is 'Tier 1 annotated' in 'study_tcga_pub_sv', the rest is
    // unannotated
    geneQueries.stream()
        .forEach(
            q -> {
  ...
  @Test
  public void fetchStructuralVariantsMultiStudyByGeneQueriesWithSampleIdentifiersUnknownTier()
      throws Exception {
  ...
  public void fetchStructuralVariantsWithSingleStructuralVariantQueries() throws Exception {
    ...
    singleStructVarQuery.add(
        new StructuralVariantQuery(
            new StructuralVariantGeneSubQuery(27436), new StructuralVariantGeneSubQuery(238)));

    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariants(
            molecularProfileIds, sampleIds, noEntrezIds, singleStructVarQuery);
  ...
  public void fetchStructuralVariantsWithStructuralVariantQueryAndGeneId() throws Exception {
    ...
    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariants(
            molecularProfileIds, sampleIds, entrezGeneId, singleStructVarQuery);
  ...
  public void fetchStructuralVariantsWithMultipleStructuralVariantQueries() throws Exception {
    ...
    multipleStructVarQueries.add(
        new StructuralVariantQuery(
            new StructuralVariantGeneSubQuery(27436), new StructuralVariantGeneSubQuery(238)));
    multipleStructVarQueries.add(
        new StructuralVariantQuery(
            new StructuralVariantGeneSubQuery(57670), new StructuralVariantGeneSubQuery(673)));

    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariants(
            molecularProfileIds, sampleIds, noEntrezIds, multipleStructVarQueries);

    Assert.assertEquals(5, result.size());

    List<StructuralVariant> structuralVariantFirstResult =
        result.stream()
            .filter(
                sv ->
                    Objects.equals(sv.getSite1EntrezGeneId(), 27436)
                        && Objects.equals(sv.getSite2EntrezGeneId(), 238))
            .collect(Collectors.toList());
    ;
    Assert.assertEquals(2, structuralVariantFirstResult.size());

    List<StructuralVariant> structuralVariantSecondResults =
        result.stream()
            .filter(
                sv ->
                    Objects.equals(sv.getSite1EntrezGeneId(), 57670)
  ...
  public void fetchStructuralVariantsWithMultipleStructuralVariantIdentifierWildcardQueryValue() {
    ...
    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariants(
            molecularProfileIds, sampleIds, noEntrezIds, structVarQueries);
  ...
  public void fetchStructuralVariantsWithMultipleStructuralVariantQueryNullQueryValue() {
    ...
    List<StructuralVariantQuery> structVarQueries = new ArrayList<>();
    StructuralVariantQuery structVarWithNull =
        new StructuralVariantQuery(
  ...
  public void fetchStructuralVariantsMultiStudyByStructVarQueriesAll() throws Exception {
    ...
    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariantsByStructVarQueries(
    ...
    Assert.assertArrayEquals(
        ...
        resultTcgaPubVariants.toArray());
    Assert.assertArrayEquals(
        new String[] {"KIAA1549-BRAF.K16B10.COSF509"}, resultTcgaVariants.toArray());
  }
  ...
  public void fetchStructuralVariantsMultiStudyByStructVarQueriesNoSomatic() throws Exception {
    ...
    Assert.assertArrayEquals(
        new String[] {"EML4-ALK.E6bA20.AB374362", "KIAA1549-BRAF.K16B10.COSF509"},
        resultTcgaPubVariants.toArray());
  ...
  public void fetchStructuralVariantsMultiStudyByStructVarQueriesAnyGene1() throws Exception {
    ...
    structVarFilterQuery1.getGene1Query().setSpecialValue(StructuralVariantSpecialValue.ANY_GENE);
    structVarFilterQuery2.getGene1Query().setSpecialValue(StructuralVariantSpecialValue.ANY_GENE);
  ...
  public void fetchStructuralVariantsMultiStudyByStructVarQueriesAnyGene2() throws Exception {
    ...
    structVarFilterQuery1.getGene2Query().setSpecialValue(StructuralVariantSpecialValue.ANY_GENE);
    structVarFilterQuery2.getGene2Query().setSpecialValue(StructuralVariantSpecialValue.ANY_GENE);
  ...
  public void fetchStructuralVariantsMultiStudyByStructVarQueriesNullGene1() throws Exception {
    ...
    List<StructuralVariant> result =
        structuralVariantMyBatisRepository.fetchStructuralVariantsByStructVarQueries(
            molecularProfileIds, sampleIds, Arrays.asList(structVarFilterQueryNullGene1));
