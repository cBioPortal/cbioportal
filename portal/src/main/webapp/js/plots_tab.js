...
/**
* Fetch Data for generating/updating the side bar
* Using web api getGeneticProfiles
*/
...
/**
* Fetch Data for generating/updating the scatter plots
* Using Web API: getProfileData, getMutationData
*/
...
/**
 * Fetch Axis Titles based on user input
 * @returns {Array}
 */
...
/**
 * Update the scatter plots everytime user click on "Go"
 * based on current user input from the side bar
 */
