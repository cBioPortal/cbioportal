...
public class MutationMyBatisRepository implements MutationRepository {
    ...
    public List<Mutation> fetchMutationsInMolecularProfile(
        ...
        return mutationMapper.getMutationsBySampleIds(
            molecularProfileId,
            sampleIds,
            entrezGeneIds,
            snpOnly,
    ...
    public List<MutationCountByGene> getSampleCountByEntrezGeneIdsAndSampleIds(
        ...
        return mutationMapper.getSampleCountByEntrezGeneIdsAndSampleIds(
            molecularProfileId,
            sampleIds,
            entrezGeneIds,
            null
    ...
    public List<MutationCountByGene> getSampleCountInMultipleMolecularProfiles(
        ...
        return mutationMapper.getSampleCountInMultipleMolecularProfiles(
            molecularProfileIds,
            sampleIds,
            entrezGeneIds,
            null
    ...
    public List<MutationCountByGene> getSampleCountInMultipleMolecularProfilesForFusions(
        ...
        return mutationMapper.getSampleCountInMultipleMolecularProfilesForFusions(
            molecularProfileIds,
            sampleIds,
            entrezGeneIds,
            null
    ...
    public List<MutationCountByGene> getPatientCountInMultipleMolecularProfiles(
        ...
        return mutationMapper.getPatientCountInMultipleMolecularProfiles(
            molecularProfileIds,
            patientIds,
            entrezGeneIds,
            null
    ...
    public MutationCountByPosition getMutationCountByPosition(
        ...
        return mutationMapper.getMutationCountByPosition(
            entrezGeneId,
            proteinPosStart,
            proteinPosEnd
        );
