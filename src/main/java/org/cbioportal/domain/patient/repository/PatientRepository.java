...
/**
 * Repository interface for performing operations related to patient data.
 * This interface defines methods for retrieving filtered patient counts and case list data counts.
 */
