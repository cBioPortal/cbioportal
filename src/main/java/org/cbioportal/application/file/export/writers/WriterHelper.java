...
public class WriterHelper {
     ...
     */
    public static <M extends GeneticDatatypeMetadata> void writeMetadata(FileWriterFactory fileWriterFactory, String metaFilename, M metadata, String dataFilename, ExportDetails exportDetails) {
        try (Writer metaFileWriter = fileWriterFactory.newWriter(metaFilename)) {
            ...
            if (exportDetails.getExportWithStudyId() != null) {
                LOG.debug("Exporting metadata for study {} as study {}",
                    metadata.getCancerStudyIdentifier(), exportDetails.getExportWithStudyId());
     ...
     */
    public static <D extends Iterator<SequencedMap<String, String>>> void writeData(FileWriterFactory fileWriterFactory, String dataFilename, D data) {
