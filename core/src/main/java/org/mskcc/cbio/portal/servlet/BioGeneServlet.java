...
public class BioGeneServlet extends HttpServlet {
    public static final String BIO_GENE_SERVICE =
        "https://biogene.herokuapp.com/retrieve.do";
    public static final String NA = "NA";

    private static String makeRequest(String query, String org, String format)
        throws IOException {
