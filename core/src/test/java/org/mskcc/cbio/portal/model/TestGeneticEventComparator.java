...
public class TestGeneticEventComparator extends TestCase {
    ...
    public void testGeneticEventComparatorArrayListOfEnumSetOfCNAArrayListOfEnumSetOfMRNAArrayListOfEnumSetOfmutations() {
        ...
        CNAsortOrder.add(
            EnumSet.of(CNA.GAINED, CNA.DIPLOID, CNA.HEMIZYGOUSLYDELETED)
        );
        ...
        GeneticEventImpl ge1 = new GeneticEventImpl(
            CNA.AMPLIFIED,
            MRNA.NORMAL,
            RPPA.NORMAL,
            mutations.MUTATED
        ...
        Assert.assertEquals(
            false,
            aGeneticEventComparator.equals(ge1, new Integer(0))
        );

        GeneticEventImpl ge2 = new GeneticEventImpl(
            CNA.AMPLIFIED,
            MRNA.NORMAL,
            RPPA.NORMAL,
            mutations.MUTATED
    ...
    private void testReflexiveCompare(
        GeneticEventComparator aGeneticEventComparator,
        GeneticEventImpl ge1,
        GeneticEventImpl ge2,
        int expected
    ) {
        Assert.assertEquals(
            expected,
            aGeneticEventComparator.compare(ge1, ge2)
        );
        Assert.assertEquals(
            -expected,
            aGeneticEventComparator.compare(ge2, ge1)
        );
    }

    private void testReflexiveEquals(
        GeneticEventComparator aGeneticEventComparator,
        Object ge1,
        Object ge2,
        boolean expected
