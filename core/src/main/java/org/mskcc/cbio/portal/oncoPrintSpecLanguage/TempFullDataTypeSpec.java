...
public class TempFullDataTypeSpec {
    ...
    private void initCollections() {
        ...
        this.theDiscreteDataTypeSetSpecs =
            new ArrayList<DiscreteDataTypeSetSpec>();
        this.theConcreteDataTypeSpecs = new ArrayList<ConcreteDataTypeSpec>();
        this.theContinuousDataTypeSpecs =
            new ArrayList<ContinuousDataTypeSpec>();
    }
    ...
    void cleanUpDataType(
        ...
        for (DataTypeSpec aDataTypeSpec : this.theDataTypeSpecs) {
            if (aDataTypeSpec instanceof ConcreteDataTypeSpec) {
                this.theConcreteDataTypeSpecs.add(
                        (ConcreteDataTypeSpec) aDataTypeSpec
                    );
            } else if (aDataTypeSpec instanceof ContinuousDataTypeSpec) {
                this.theContinuousDataTypeSpecs.add(
                        (ContinuousDataTypeSpec) aDataTypeSpec
                    );
            } else if (aDataTypeSpec instanceof DiscreteDataTypeSetSpec) {
                this.theDiscreteDataTypeSetSpecs.add(
                        (DiscreteDataTypeSetSpec) aDataTypeSpec
                    );
            } else if (aDataTypeSpec instanceof DiscreteDataTypeSpec) {
                this.theDiscreteDataTypeSpecs.add(
                        (DiscreteDataTypeSpec) aDataTypeSpec
                    );
            } else {
         ...
         */
        DiscreteDataTypeSetSpec combinedDiscreteDataTypeSetSpec = new DiscreteDataTypeSetSpec(
            theGeneticDataType
        );
            ...
            switch (
                ...
                case Smaller:
                    if (null == combinedLesserContinuousDataTypeSpec) {
                        ...
                        combinedLesserContinuousDataTypeSpec.combine(
                            aContinuousDataTypeSpec
                        );
                    }
                    break;
                case Bigger:
                    if (null == combinedGreaterContinuousDataTypeSpec) {
                        ...
                        combinedGreaterContinuousDataTypeSpec.combine(
                            aContinuousDataTypeSpec
                        );
                    }
                    break;
        ...
        theResultDataTypeSpec.setCombinedLesserContinuousDataTypeSpec(
            combinedLesserContinuousDataTypeSpec
        );
