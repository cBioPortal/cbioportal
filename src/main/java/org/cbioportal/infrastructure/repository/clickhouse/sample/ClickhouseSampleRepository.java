...
public class ClickhouseSampleRepository implements SampleRepository {
    ...
    public List<Sample> getAllSamplesInStudy(
        ...
        return switch (projection) {
            case ID -> mapper.getSamples(Collections.singletonList(studyId), null, null, null, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sortBy, direction);
            case SUMMARY -> mapper.getSummarySamples(Collections.singletonList(studyId), null, null, null, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sortBy, direction);
            case DETAILED -> mapper.getDetailedSamples(Collections.singletonList(studyId), null, null, null, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sortBy, direction);
            default -> Collections.emptyList();
        };
    }
    ...
    public List<Sample> getAllSamplesOfPatientInStudy(
        ...
        return switch (projection) {
            case ID -> mapper.getSamples(Collections.singletonList(studyId), patientId, null, null, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sortBy, direction);
            case SUMMARY -> mapper.getSummarySamples(Collections.singletonList(studyId), patientId, null, null, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sortBy, direction);
            case DETAILED -> mapper.getDetailedSamples(Collections.singletonList(studyId), patientId, null, null, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sortBy, direction);
            default -> Collections.emptyList();
        };
    }
    ...
    public List<Sample> getAllSamples(
        ...
        return switch (projection) {
            case ID -> mapper.getSamples(studyIds, null, null, keyword, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sort, direction);
            case SUMMARY -> mapper.getSummarySamples(studyIds, null, null, keyword, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sort, direction);
            case DETAILED -> mapper.getDetailedSamples(studyIds, null, null, keyword, pageSize, PaginationCalculator.offset(pageSize, pageNumber), sort, direction);
            default -> Collections.emptyList();
        };
    }
