...
<%
    ...
    <% } %>
<div id="page_wrapper" width="860px">
<center>
<table width="860px" cellpadding="0px" cellspacing="5px" border="0px">
  <tr valign="top">
    ...
    <table width="100%" cellspacing="0px" cellpadding="2px" border="0px">
    	...
    	<tr>
	        <td class="logo" width="250px"><a href="http://www.mskcc.org"><img src="images/msk_logo.png"></a></td>
            <td class="logo" width="330px"><a href="index.do"><img src="<%= siteName %>"></a></td>
        ...
        <tr width="100%">
            <td class="navigation">
               <ul>
                    <li class="selected" class="internal">
