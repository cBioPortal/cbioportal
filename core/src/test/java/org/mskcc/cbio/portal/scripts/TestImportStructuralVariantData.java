...
public class TestImportStructuralVariantData {
     ...
     * @throws DaoException
     */
    private StructuralVariant extractStructuralVariant(ResultSet rs)
        ...
        structuralVariant.setSite1EntrezGeneId(
            rs.getLong("SITE1_ENTREZ_GENE_ID")
        );
        structuralVariant.setSite1EnsemblTranscriptId(
            rs.getString("SITE1_ENSEMBL_TRANSCRIPT_ID")
        );
        ...
        structuralVariant.setSite1Description(
            rs.getString("SITE1_DESCRIPTION")
        );
        structuralVariant.setSite2EntrezGeneId(
            rs.getLong("SITE2_ENTREZ_GENE_ID")
        );
        structuralVariant.setSite2EnsemblTranscriptId(
            rs.getString("SITE2_ENSEMBL_TRANSCRIPT_ID")
        );
        ...
        structuralVariant.setSite2Description(
            rs.getString("SITE2_DESCRIPTION")
        );
        structuralVariant.setSite2EffectOnFrame(
            rs.getString("SITE2_EFFECT_ON_FRAME")
        );
    ...
    public void setUp() throws DaoException {
        ...
        geneticProfileId =
            DaoGeneticProfile
                .getGeneticProfileByStableId(
                    "study_tcga_pub_structural_variants"
                )
                .getGeneticProfileId();
    }

    @Test
    public void testImportStructuralVariantData()
