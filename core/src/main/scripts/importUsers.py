...
GLIOMA_USER_SPREADSHEET = 'Request Access to the Glioma Prostate Cancer Genomics Portal'
ACC_USER_SPREADSHEET = 'Request Access to the ACC Prostate Cancer Genomics Portal'
