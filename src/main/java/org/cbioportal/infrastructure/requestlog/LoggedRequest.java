...
public class LoggedRequest {
  ...
  /**
   * Wall-clock duration of the request in milliseconds, measured from just before the filter chain
   * is invoked to just after it returns. Recorded with {@link System#nanoTime()} and converted to
