...
public class CategoryLabelReader {
     ...
     */
    public static final String CATEGORY_MAP_FILE =
        "/human_readable_categories.txt";
     ...
     * @throws IOException	if an IO error occurs
     */
    public static Map<String, String> readCategoryLabelMap(InputStream in)
        throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (pair.length == 2) {
                categoryLabelMap.put(
                    safeCategoryName(pair[0].trim()),
                    pair[1].trim()
                );
            }
        }
