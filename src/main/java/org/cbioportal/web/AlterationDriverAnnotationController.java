...
public class AlterationDriverAnnotationController {
  ...
  @PreAuthorize(
      "hasPermission(#molecularProfileIds, 'Collection<MolecularProfileId>', T(org.cbioportal.utils.security.AccessLevel).READ)")
  @RequestMapping(
      value = "/custom-driver-annotation-report/fetch",
  ...
  public ResponseEntity<CustomDriverAnnotationReport> fetchAlterationDriverAnnotationReport(
      @Parameter(required = true, description = "List of Molecular Profile Ids") @RequestBody
          List<String> molecularProfileIds) {

    CustomDriverAnnotationReport customDriverAnnotationReport =
