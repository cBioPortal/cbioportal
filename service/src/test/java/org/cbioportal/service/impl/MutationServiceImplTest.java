...
public class MutationServiceImplTest extends BaseServiceImplTest {
    ...
    @Test
    public void getMutationsInMolecularProfileBySampleListId()
        throws Exception {
        ...
        List<Mutation> result = mutationService.getMutationsInMolecularProfileBySampleListId(
            MOLECULAR_PROFILE_ID,
            SAMPLE_LIST_ID,
            Arrays.asList(ENTREZ_GENE_ID_1),
            null,
    ...
    public void getMetaMutationsInMolecularProfileBySampleListId()
        ...
        MutationMeta result = mutationService.getMetaMutationsInMolecularProfileBySampleListId(
            MOLECULAR_PROFILE_ID,
            SAMPLE_LIST_ID,
            Arrays.asList(ENTREZ_GENE_ID_1)
        );
    ...
    public void fetchMutationsInMolecularProfile() throws Exception {
        ...
        List<Mutation> result = mutationService.fetchMutationsInMolecularProfile(
            MOLECULAR_PROFILE_ID,
            Arrays.asList(SAMPLE_ID1),
            Arrays.asList(ENTREZ_GENE_ID_1),
            null,
    ...
    public void fetchMetaMutationsInMolecularProfile() throws Exception {
        ...
        Mockito
            ...
            .thenReturn(expectedMutationMeta);
        MutationMeta result = mutationService.fetchMetaMutationsInMolecularProfile(
            MOLECULAR_PROFILE_ID,
            Arrays.asList(SAMPLE_ID1),
            Arrays.asList(ENTREZ_GENE_ID_1)
        );
    ...
    @Test(expected = MolecularProfileNotFoundException.class)
    public void fetchMetaMutationsInMolecularProfileNotFound()
        throws Exception {
        Mockito
            .when(
                molecularProfileService.getMolecularProfile(
    ...
    public void getSampleCountByEntrezGeneIds() throws Exception {
        ...
        Mockito
            .when(
                mutationRepository.getSampleCountByEntrezGeneIdsAndSampleIds(
                    MOLECULAR_PROFILE_ID,
                    null,
                    Arrays.asList(ENTREZ_GENE_ID_1)
                )
            )
            .thenReturn(expectedMutationSampleCountByGeneList);
    ...
    @Test(expected = MolecularProfileNotFoundException.class)
    public void getSampleCountByEntrezGeneIdsMolecularProfileNotFound()
        throws Exception {
        Mockito
            .when(
                molecularProfileService.getMolecularProfile(
        ...
        mutationService.getSampleCountByEntrezGeneIdsAndSampleIds(
            MOLECULAR_PROFILE_ID,
            null,
            Arrays.asList(ENTREZ_GENE_ID_1)
        );
    ...
    public void getPatientCountInMultipleMolecularProfiles() throws Exception {
        ...
        Mockito
            ...
            .thenReturn(expectedMutationPatientCountByGeneList);
