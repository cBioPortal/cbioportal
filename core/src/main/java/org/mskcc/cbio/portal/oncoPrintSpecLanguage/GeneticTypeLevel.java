...
public enum GeneticTypeLevel {
     ...
     */
    public static GeneticTypeLevel convertCode(
        ...
        throw new IllegalArgumentException(
            code + " is invalid code for levels in " + aGeneticDataType
        );
    }
     ...
     */
    public static GeneticTypeLevel convertCNAcode(int code)
        throws IllegalArgumentException {
     ...
     */
    public static GeneticTypeLevel convertMutationcode(int code)
        throws IllegalArgumentException {
    ...
    public static GeneticTypeLevel findDataTypeLevel(String name)
        throws IllegalArgumentException {
        GeneticTypeLevel aGeneticTypeLevel = (GeneticTypeLevel) UniqueEnumPrefix.findUniqueEnumMatchingPrefix(
            GeneticTypeLevel.class,
            name
        );
        if (aGeneticTypeLevel == null) {
            aGeneticTypeLevel =
                (GeneticTypeLevel) UniqueEnumPrefix.findUniqueEnumWithNicknameMatchingPrefix(
                    GeneticTypeLevel.class,
                    name
                );
        }
