...
public class ClinicalAttributeControllerTest {
  ...
  public void getAllClinicalAttributesDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/clinical-attributes")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].patientAttribute").value(TEST_PATIENT_ATTRIBUTE_1))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].patientAttribute").value(TEST_PATIENT_ATTRIBUTE_2))
  ...
  public void getAllClinicalAttributesMetaProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/clinical-attributes").param("projection", "META"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  public void getAllClinicalAttributesInStudyDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/studies/test_study_id/clinical-attributes")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(
            MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
  ...
  public void getClinicalAttributeInStudyNotFound() throws Exception {
    ...
    Mockito.when(
            clinicalAttributeService.getClinicalAttribute(Mockito.anyString(), Mockito.anyString()))
        .thenThrow(
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(
                    "/api/studies/test_study_id/clinical-attributes/test_clinical_attribute_id")
                .accept(MediaType.APPLICATION_JSON))
  ...
  public void getClinicalAttributeInStudy() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.patientAttribute").value(TEST_PATIENT_ATTRIBUTE_1))
  ...
  public void fetchClinicalAttributes() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/clinical-attributes/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
