...
public class GeneMyBatisRepository implements GeneRepository {
    ...
    public Gene getGeneByEntrezGeneId(Integer entrezGeneId) {
        return geneMapper.getGeneByEntrezGeneId(
            entrezGeneId,
            PersistenceConstants.DETAILED_PROJECTION
        );
    }
    ...
    @Override
    public List<String> getAliasesOfGeneByHugoGeneSymbol(
    ...
    @Override
    public List<Gene> fetchGenesByEntrezGeneIds(
    ...
    @Override
    public List<Gene> fetchGenesByHugoGeneSymbols(
        List<String> hugoGeneSymbols,
        String projection
    ) {
        return geneMapper.getGenesByHugoGeneSymbols(
            hugoGeneSymbols,
            projection
        );
    }
    ...
    @Override
    public BaseMeta fetchMetaGenesByHugoGeneSymbols(
        List<String> hugoGeneSymbols
    ) {
