...
insert into resource_definition (resource_id, cancer_study_id, resource_type, display_name, description, open_by_default, priority, custom_metadata) values ('RADIOLOGY', 1, 'SAMPLE', 'Radiology', 'Radiology images', 1, 4, '{"version":1,"fields":[{"key":"score","type":"number","label":"Dose Score","description":"Radiation dose score"},{"key":"dose_id","type":"string","label":"Dose ID"},{"key":"operator","type":"string","label":"Operator","filterable":false}]}');
...
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (6, 'RADIOLOGY', 1, 'SAMPLE', 'tcga-a1-a0se', 'tcga-a1-a0se-01', 'https://example.com/rad1.dcm', 'Radiology 1', 'IMAGE', '{"dose_id":"1001","score":"85","operator":"tech-a","aperture":"wide"}', 4);
insert into resource_data (RESOURCE_DATA_ID, RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, PATIENT_ID, SAMPLE_ID, URL, DISPLAY_NAME, TYPE, METADATA, PRIORITY) values (7, 'RADIOLOGY', 1, 'SAMPLE', 'tcga-a1-a0sf', 'tcga-a1-a0sf-01', 'https://example.com/rad2.dcm', 'Radiology 2', 'IMAGE', '{"dose_id":"1002","score":"42","operator":"tech-b","aperture":"narrow"}', 4);
