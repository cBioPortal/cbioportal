...
public class PatientMyBatisRepositoryTest {
    ...
    public void getAllPatients() throws Exception {
        List<Patient> result = patientMyBatisRepository.getAllPatients(
            null,
            "ID",
            null,
            null,
    ...
    public void getAllPatientsInStudyIdProjection() throws Exception {
        List<Patient> result = patientMyBatisRepository.getAllPatientsInStudy(
            "study_tcga_pub",
            "ID",
            null,
            null,
    ...
    @Test
    public void getAllPatientsInStudySummaryProjection1PageSize()
        throws Exception {
        List<Patient> result = patientMyBatisRepository.getAllPatientsInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    @Test
    public void getAllPatientsInStudySummaryProjectionStableIdSort()
        throws Exception {
        List<Patient> result = patientMyBatisRepository.getAllPatientsInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    public void getMetaPatientsInStudy() throws Exception {
        BaseMeta result = patientMyBatisRepository.getMetaPatientsInStudy(
            "study_tcga_pub"
        );
    ...
    public void getPatientInStudyNullResult() throws Exception {
        Patient result = patientMyBatisRepository.getPatientInStudy(
            "study_tcga_pub",
            "invalid_patient"
        );
    ...
    public void getPatientInStudy() throws Exception {
        Patient patient = patientMyBatisRepository.getPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SI"
        );
    ...
    public void fetchPatients() throws Exception {
        ...
        List<Patient> result = patientMyBatisRepository.fetchPatients(
            studyIds,
            patientIds,
            "SUMMARY"
        );
    ...
    public void fetchMetaPatients() throws Exception {
        ...
        BaseMeta result = patientMyBatisRepository.fetchMetaPatients(
            studyIds,
            patientIds
        );
    ...
    public void getPatientIdsOfSamples() throws Exception {
        List<Patient> result = patientMyBatisRepository.getPatientsOfSamples(
