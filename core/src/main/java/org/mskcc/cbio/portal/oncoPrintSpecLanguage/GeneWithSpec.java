...
public class GeneWithSpec {
     ...
     */
    public static GeneWithSpec geneWithSpecGenerator(
        String name,
        OncoPrintGeneDisplaySpec theResultFullDataTypeSpec,
        ...
        if (null != name) {
            if (null != theResultFullDataTypeSpec) {
                ...
                if (null != theDefaultResultFullDataTypeSpec) {
                    return new GeneWithSpec(
                        name,
                        theDefaultResultFullDataTypeSpec
                    );
                }
            }
        }
    ...
    public String toString() {
        ...
        if (null != this.theOncoPrintGeneDisplaySpec) {
            sb
                .append(": ")
                .append(this.theOncoPrintGeneDisplaySpec.toString())
                .append("\n");
        }
        return sb.toString();
    }
    ...
    public boolean equals(Object otherGeneWithSpec) {
        ...
        return (
            ...
            EqualsUtil.areEqual(
                ...
                that.theOncoPrintGeneDisplaySpec
            )
        );
    }
