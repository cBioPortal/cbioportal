 ...
 */
public final class PfamGraphicsCacheLoader
    extends CacheLoader<String, List<Sequence>> {
    private static final Logger logger = Logger.getLogger(
        PfamGraphicsCacheLoader.class
    );
    ...
    public List<Sequence> load(final String uniProtId) throws Exception {
        ...
        try {
            ...
            CollectionType sequenceList = typeFactory.constructCollectionType(
                List.class,
                Sequence.class
            );
