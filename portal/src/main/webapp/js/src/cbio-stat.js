...
// mean (µ)
cbio.stat.prototype.mean = function(_inputArr) {
    var _sum = 0;
...
cbio.stat.prototype.stDev = function(_inputArr) {
    var _mean = cbio.stat.prototype.mean(_inputArr);
...
cbio.stat.prototype.zscore = function(_refArr, _inputArr) {
    var _refMean = cbio.stat.prototype.mean(_refArr);
    var _refStDev = cbio.stat.prototype.stDev(_refArr);
