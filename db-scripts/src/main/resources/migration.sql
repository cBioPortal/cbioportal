...
##version: 2.12.14
ALTER TABLE `structural_variant` ADD COLUMN `SV_STATUS` varchar(25) NOT NULL DEFAULT 'SOMATIC';
...
ALTER TABLE `structural_variant` ADD COLUMN `SITE1_REGION` varchar(25);
ALTER TABLE `structural_variant` ADD COLUMN `SITE1_REGION_NUMBER` int(11);
ALTER TABLE `structural_variant` ADD COLUMN `SITE1_CONTIG` varchar(100);
ALTER TABLE `structural_variant` ADD COLUMN `SITE2_REGION` varchar(25);
ALTER TABLE `structural_variant` ADD COLUMN `SITE2_REGION_NUMBER` int(11);
ALTER TABLE `structural_variant` ADD COLUMN `SITE2_CONTIG` varchar(100);
