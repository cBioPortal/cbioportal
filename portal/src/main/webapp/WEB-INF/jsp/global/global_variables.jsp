...
<script>
    ...
    PortalDataCollManager.subscribeOncoprint(function() {
        ...
        var _stat_smry = "<h3 style='color:black;'>Gene Set / Pathway is altered in <b>" + window.PortalGlobals.getNumOfAlteredCases() + " (" + window.PortalGlobals.getPercentageOfAlteredCases() + "%)" + "</b> of all samples</h3>";
