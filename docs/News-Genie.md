# Genie News
## January 29, 2026
*   **Public Release 19.0 of AACR Project GENIE:**
    *  The first set of cancer genomic data aggregated through AACR Project Genomics Evidence Neoplasia Information Exchange (GENIE) was released to the global community in January 2017. The current release, GENIE 19.0-public now contains over 271,837 sequenced samples from over 227,696 patients, making the AACR Project GENIE registry among the largest fully public cancer genomic data sets.
    *  The public release 19.0 version of AACR GENIE has 30 samples retracted that were present in AACR GENIE 18.0-public. 
    *  More detailed information can be found in the [AACR GENIE release notes](https://www.synapse.org/Synapse:syn72370974) and the data releases page from [Sage Bionetworks](https://www.synapse.org/Synapse:syn7222066/wiki/405659).
## July 22, 2025
