    ...
    try {
      if (cacheEnabledConfig.enableCache(cacheType)) {
        ...
        XmlConfiguration xmlConfiguration =
            new XmlConfiguration(getClass().getResource(xmlConfigurationFile));
        ...
        ResourcePoolsBuilder generalRepositoryCacheResourcePoolsBuilder =
            ResourcePoolsBuilder.newResourcePoolsBuilder();
        ResourcePoolsBuilder staticRepositoryCacheOneResourcePoolsBuilder =
            ResourcePoolsBuilder.newResourcePoolsBuilder();
        ...
        if (!cacheType.equalsIgnoreCase(CacheEnabledConfig.EHCACHE_HEAP)) {
          generalRepositoryCacheResourcePoolsBuilder =
              generalRepositoryCacheResourcePoolsBuilder.disk(
                  generalRepositoryCacheMaxMegaBytesLocalDisk, MemoryUnit.MB);
          staticRepositoryCacheOneResourcePoolsBuilder =
              staticRepositoryCacheOneResourcePoolsBuilder.disk(
                  staticRepositoryCacheOneMaxMegaBytesLocalDisk, MemoryUnit.MB);
        }
        ...
        Configuration configuration =
            new DefaultConfiguration(caches, this.getDefaultClassLoader());
