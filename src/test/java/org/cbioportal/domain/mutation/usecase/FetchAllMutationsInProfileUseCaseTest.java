...
public class FetchAllMutationsInProfileUseCaseTest {
  ...
  public void testExecuteWithGetMolecularProfileIdsNotNull() {
    ...
    mutationQueryOptions = new MutationQueryOptions(ProjectionType.META, null, null, null, null);
    ...
    List<Mutation> result =
        fetchAllMutationsInProfileUseCase.execute(
            mutationMultipleStudyFilter, mutationQueryOptions);
