...
public class ClinicalAttributeServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllClinicalAttributes() throws Exception {
        ...
        List<ClinicalAttribute> result = clinicalAttributeService.getAllClinicalAttributes(
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
            SORT,
    ...
    public void getMetaClinicalAttributes() throws Exception {
        ...
        Mockito
            .when(clinicalAttributeRepository.getMetaClinicalAttributes())
    ...
    public void getClinicalAttributeNotFound() throws Exception {
        Mockito
            .when(
                clinicalAttributeRepository.getClinicalAttribute(
                    STUDY_ID,
    ...
    public void getClinicalAttribute() throws Exception {
        ...
        ClinicalAttribute result = clinicalAttributeService.getClinicalAttribute(
            STUDY_ID,
            CLINICAL_ATTRIBUTE_ID_1
        );
    ...
    public void getAllClinicalAttributesInStudy() throws Exception {
        ...
        List<ClinicalAttribute> result = clinicalAttributeService.getAllClinicalAttributesInStudy(
            STUDY_ID,
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
    ...
    public void getMetaClinicalAttributesInStudy() throws Exception {
        ...
        Mockito
            .when(
                clinicalAttributeRepository.getMetaClinicalAttributesInStudy(
                    STUDY_ID
                )
            )
            .thenReturn(expectedBaseMeta);
        BaseMeta result = clinicalAttributeService.getMetaClinicalAttributesInStudy(
            STUDY_ID
        );
    ...
    public void fetchClinicalAttributes() throws Exception {
        ...
        List<ClinicalAttribute> result = clinicalAttributeService.fetchClinicalAttributes(
            Arrays.asList(STUDY_ID),
            PROJECTION
        );
    ...
    public void fetchMetaClinicalAttributes() throws Exception {
        ...
        Mockito
            .when(
                clinicalAttributeRepository.fetchMetaClinicalAttributes(
                    Arrays.asList(STUDY_ID)
                )
            )
            .thenReturn(expectedBaseMeta);
        BaseMeta result = clinicalAttributeService.fetchMetaClinicalAttributes(
            Arrays.asList(STUDY_ID)
        );
    ...
    public void getClinicalAttributeCountsBySampleIds() throws Exception {
        ...
        Mockito
            .when(
                clinicalAttributeRepository.getClinicalAttributeCountsBySampleIds(
                    sampleIds,
                    studyIds
                )
            )
        ...
        List<ClinicalAttributeCount> result = clinicalAttributeService.getClinicalAttributeCountsBySampleIds(
            sampleIds,
            studyIds
        );
    ...
    public void getClinicalAttributeCountsBySampleListId() throws Exception {
        ...
        Mockito
            .when(
                clinicalAttributeRepository.getClinicalAttributeCountsBySampleListId(
                    SAMPLE_LIST_ID
                )
            )
            .thenReturn(expectedClinicalAttributeList);

        List<ClinicalAttributeCount> result = clinicalAttributeService.getClinicalAttributeCountsBySampleListId(
            SAMPLE_LIST_ID
        );
