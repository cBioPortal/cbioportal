...
@Repository
public class DiscreteCopyNumberMyBatisRepository
    implements DiscreteCopyNumberRepository {
    @Autowired
    ...
    public List<CopyNumberCountByGene> getSampleCountInMultipleMolecularProfiles(
        ...
        return discreteCopyNumberMapper.getSampleCountInMultipleMolecularProfiles(
            molecularProfileIds,
            sampleIds,
            entrezGeneIds,
            alterations
    ...
    public List<CopyNumberCountByGene> getPatientCountInMultipleMolecularProfiles(
        ...
        return discreteCopyNumberMapper.getPatientCountInMultipleMolecularProfiles(
            molecularProfileIds,
            patientIds,
            entrezGeneIds,
            alterations
