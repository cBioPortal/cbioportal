...
public class SampleListMyBatisRepositoryTest {
    ...
    public void getAllSampleListsIdProjection() throws Exception {
        List<SampleList> result = sampleListMyBatisRepository.getAllSampleLists(
            "ID",
            null,
            null,
            null,
    ...
    @Test
    public void getAllSampleListsSummaryProjectionStableIdSort()
        throws Exception {
        List<SampleList> result = sampleListMyBatisRepository.getAllSampleLists(
            "SUMMARY",
            null,
    ...
    public void getSampleListNullResult() throws Exception {
        SampleList result = sampleListMyBatisRepository.getSampleList(
            "invalid_sample_list"
        );
    ...
    public void getSampleList() throws Exception {
        SampleList sampleList = sampleListMyBatisRepository.getSampleList(
            "study_tcga_pub_all"
        );
    ...
    public void getSampleLists() throws Exception {
        List<SampleList> result = sampleListMyBatisRepository.getSampleLists(
            Arrays.asList("study_tcga_pub_all", "study_tcga_pub_acgh"),
            "SUMMARY"
        );
    ...
    public void getAllSampleListsInStudySummaryProjection() throws Exception {
        List<SampleList> result = sampleListMyBatisRepository.getAllSampleListsInStudy(
            "study_tcga_pub",
            "SUMMARY",
            null,
            null,
    ...
    public void getMetaSampleListsInStudy() throws Exception {
        BaseMeta result = sampleListMyBatisRepository.getMetaSampleListsInStudy(
            "study_tcga_pub"
        );
    ...
    public void getAllSampleIdsInSampleList() throws Exception {
        List<String> result = sampleListMyBatisRepository.getAllSampleIdsInSampleList(
            "study_tcga_pub_all"
        );
