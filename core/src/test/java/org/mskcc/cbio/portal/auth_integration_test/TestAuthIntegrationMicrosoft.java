...
public class TestAuthIntegrationMicrosoft extends AbstractAuthIntegrationTest {

    private static String cbioUrl;

    @BeforeClass
    public static void setUp() {
        System.out.println("portal starting with social_auth_microsoft ...");
        cbioportal.withEnv("AUTHENTICATE", "social_auth_microsoft");
        cbioportal.start();
