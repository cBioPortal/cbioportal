...
public interface SampleMapper {
    ...
    @Mapping(target = "uniqueSampleKey", expression = "java( Encoder.calculateBase64(sample.stableId()," +
            "sample.cancerStudyIdentifier()) )")
    @Mapping(target = "uniquePatientKey", expression = "java( Encoder.calculateBase64(sample.patientStableId(), " +
            "sample.cancerStudyIdentifier()) )")
