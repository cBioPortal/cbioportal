...
public class TestWebService {
    ...
    public void setUp() throws DaoException {
        ...
        expect(control.isAccessibleCancerStudy(isA(String.class)))
            .andStubReturn(mockTrue);
    ...
    public void testWebServiceGetTypesOfCancer() throws Exception {
        ...
        webService.processClient(
            aNullHttpServletRequest,
            aNullHttpServletResponse
        );
        assertTrue(
            aNullHttpServletResponse
                .getOutput()
                .contains("Error: you must specify a cmd parameter.\n")
        );

        checkRequest(
            mkStringArray(WebService.CMD, "getTypesOfCancer"),
            mkStringArray(
    ...
    public void testWebServiceBadCommand() throws Exception {
        // bad command
        checkRequest(
            mkStringArray(WebService.CMD, "badCommand"),
            "Error: 'badCommand' not a valid command."
        );
    ...
    public void testWebServiceGetGeneticProfilesNoStudy() throws Exception {
        ...
        checkRequest(
            mkStringArray(WebService.CMD, "getGeneticProfiles"),
            mkStringArray(
                "Error: " +
    ...
    public void testWebServiceGetGeneticProfiles() throws Exception {
        checkRequest(
            mkStringArray(
                WebService.CMD,
                "getGeneticProfiles",
                WebService.CANCER_STUDY_ID,
                CancerStudy.NO_SUCH_STUDY + ""
            ),
            mkStringArray(
                "Error: " +
    ...
    private void checkRequest(String[] requestFields, String... responseLines)
    ...
    public void testGetCancerStudyIDNull() throws Exception {
        ...
        NullHttpServletRequest aNullHttpServletRequest = new NullHttpServletRequest();
        studies =
            WebserviceParserUtils.getCancerStudyIDs(aNullHttpServletRequest);
    ...
    public void testGetCancerStudySetIDList() throws Exception {
        ...
        sampleList.setSampleListCategory(
            SampleListCategory.ALL_CASES_WITH_CNA_DATA
        );
    ...
    public void testGetCancerStudySetPrivateProfile() throws Exception {
        ...
        aNullHttpServletRequest.setParameter(
            WebService.GENETIC_PROFILE_ID,
            "study_tcga_pub_gistic,study_tcga_pub_mutations"
        );
        studies =
            WebserviceParserUtils.getCancerStudyIDs(aNullHttpServletRequest);
        assertEquals(1, studies.size());
