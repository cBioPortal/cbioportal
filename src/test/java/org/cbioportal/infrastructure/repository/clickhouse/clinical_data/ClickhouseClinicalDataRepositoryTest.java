...
@Import({MyBatisConfig.class, ClickhouseClinicalDataRepository.class})
@ActiveProfiles("clickhouse")
@DataJpaTest
@DirtiesContext
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@ContextConfiguration(initializers = AbstractTestcontainers.Initializer.class)
public class ClickhouseClinicalDataRepositoryTest {
  private static final String STUDY_ACC_TCGA = "acc_tcga";
  private static final String STUDY_GENIE_PUB = "study_genie_pub";

  @Autowired private ClinicalDataRepository repository;
  ...
  public void getMutationCounts() {
    ...
    var clinicalDataCountItems =
        repository.getClinicalDataCounts(
