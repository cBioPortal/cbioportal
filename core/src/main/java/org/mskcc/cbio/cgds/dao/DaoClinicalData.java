...
public class DaoClinicalData {
    ...
    public ClinicalData getDatum(int cancerStudyId, String caseId, String attrId) throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            ...
            ClinicalData clinicalData = new ClinicalData(rs.getInt("CANCER_STUDY_ID"),
