...
public class MolecularProfileServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllMolecularProfiles() throws Exception {
        ...
        List<MolecularProfile> result = molecularProfileService.getAllMolecularProfiles(
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
            SORT,
    ...
    public void getMetaMolecularProfiles() throws Exception {
        ...
        Mockito
            .when(molecularProfileRepository.getMetaMolecularProfiles())
    ...
    public void getMolecularProfileNotFound() throws Exception {
        Mockito
            .when(
                molecularProfileRepository.getMolecularProfile(
    ...
    public void getMolecularProfile() throws Exception {
        ...
        MolecularProfile result = molecularProfileService.getMolecularProfile(
            MOLECULAR_PROFILE_ID
        );
    ...
    public void getMolecularProfiles() throws Exception {
        ...
        List<MolecularProfile> result = molecularProfileService.getMolecularProfiles(
            Arrays.asList(MOLECULAR_PROFILE_ID),
            PROJECTION
        );
    ...
    public void getAllMolecularProfilesInStudy() throws Exception {
        ...
        List<MolecularProfile> result = molecularProfileService.getAllMolecularProfilesInStudy(
            STUDY_ID,
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
    ...
    public void getMetaMolecularProfilesInStudy() throws Exception {
        ...
        Mockito
            .when(
                molecularProfileRepository.getMetaMolecularProfilesInStudy(
                    STUDY_ID
                )
            )
            .thenReturn(expectedBaseMeta);

        BaseMeta result = molecularProfileService.getMetaMolecularProfilesInStudy(
            STUDY_ID
        );
    ...
    public void getMetaMolecularProfilesInStudies() throws Exception {
        ...
        Mockito
            .when(
                molecularProfileRepository.getMetaMolecularProfilesInStudies(
                    Arrays.asList(STUDY_ID)
                )
            )
            .thenReturn(expectedBaseMeta);

        BaseMeta result = molecularProfileService.getMetaMolecularProfilesInStudies(
            Arrays.asList(STUDY_ID)
        );
