var clinical_data_interpreter = (function() {
    ...
    var translate_to_numeric = function(_arr) {
        var datum = {
            numeric_val: -1,
            real_val: ""
        };
    ...
    return {
        process: function(data, axis) {
            ...
            translate_to_numeric(extract_discretized_vals(_arr));
        },
        convert_to_numeric: function(text_val) {
            var _val = text_val_map[text_val].numeric_val;
