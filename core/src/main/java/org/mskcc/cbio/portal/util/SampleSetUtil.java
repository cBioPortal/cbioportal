...
public class SampleSetUtil {
     ...
     */
    public static List<String> validateSampleSet(String studyId, String sampleIds) throws DaoException {
     ...
     * @throws DaoException
     */
    public static String shortenSampleIds(String sampleIds) throws DaoException {
    ...
    public static String getSampleIds(String sampleIdsKey) throws DaoException {
        DaoTextCache dao = new DaoTextCache();
        return dao.getText(sampleIdsKey);
    }
