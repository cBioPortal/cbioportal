...
public class PatientControllerTest {
  ...
  public void getAllPatientsDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/patients").accept(MediaType.APPLICATION_JSON))
  ...
  public void getAllPatientsMetaProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/patients").param("projection", "META"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  public void getAllPatientsInStudyDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/studies/test_study_id/patients")
  ...
  public void getPatientInStudyNotFound() throws Exception {
    ...
    Mockito.when(patientService.getPatientInStudy(Mockito.anyString(), Mockito.anyString()))
        .thenThrow(new PatientNotFoundException("test_study_id", "test_patient_id"));

    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/studies/test_study_id/patients/test_patient_id")
                .accept(MediaType.APPLICATION_JSON))
  ...
  public void fetchPatientsDefaultProjection() throws Exception {
    ...
    Mockito.when(
            patientService.fetchPatients(Mockito.anyList(), Mockito.anyList(), Mockito.anyString()))
        .thenReturn(patientList);
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/patients/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
  ...
  public void fetchPatientsMetaProjection() throws Exception {
    ...
    Mockito.when(patientService.fetchMetaPatients(Mockito.anyList(), Mockito.anyList()))
        .thenReturn(baseMeta);
