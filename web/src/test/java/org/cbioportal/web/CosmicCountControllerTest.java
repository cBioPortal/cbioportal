...
public class CosmicCountControllerTest {
    private static final String TEST_COSMIC_MUTATION_ID_1 =
    ...
    private static final String TEST_COSMIC_MUTATION_ID_2 =
        "test_cosmic_mutation_id_2";
    ...
    public void fetchCosmicCounts() throws Exception {
        ...
        Mockito
            .when(
                cosmicCountService.fetchCosmicCountsByKeywords(
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].cosmicMutationId")
                    .value(TEST_COSMIC_MUTATION_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].count").value(TEST_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].cosmicMutationId")
                    .value(TEST_COSMIC_MUTATION_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].count").value(TEST_COUNT_2)
            );
    }
}
