...
public class ClinicalDataMyBatisRepository implements ClinicalDataRepository {
  ...
  @Autowired private ClinicalDataMapper clinicalDataMapper;
  ...
  public List<ClinicalData> fetchSampleClinicalTable(
    ...
    return clinicalDataMapper.getSampleClinicalTable(
        studyIds, ids, "SUMMARY", pageSize, offset, searchTerm, sortBy, direction);
  }
  ...
  public Integer fetchSampleClinicalTableCount(
      ...
      String sortBy,
      String direction) {
    return clinicalDataMapper.getSampleClinicalTableCount(
        studyIds, sampleIds, "SUMMARY", searchTerm, sortBy, direction);
  }
  ...
  public List<ClinicalDataCount> fetchClinicalDataCounts(
    ...
    if (clinicalDataType.equals(PersistenceConstants.SAMPLE_CLINICAL_DATA_TYPE)) {
      ...
      return clinicalDataMapper.fetchPatientClinicalDataCounts(
          patientStudyIds,
  ...
  public List<ClinicalData> getPatientClinicalDataDetailedToSample(
    ...
    return clinicalDataMapper.getPatientClinicalDataDetailedToSample(
        studyIds, patientIds, attributeIds, "SUMMARY", 0, 0, null, null);
  }
}
