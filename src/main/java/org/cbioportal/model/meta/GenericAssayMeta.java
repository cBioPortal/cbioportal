...
public class GenericAssayMeta implements Serializable {
   ...
   * @param genericEntityMetaProperties generic entity meta properties are the additional
   *     properties, may differ between different generic assay data
   */
  ...
  public GenericAssayMeta(
      String entityType, String stableId, HashMap<String, String> genericEntityMetaProperties) {
    this.entityType = entityType;
    this.stableId = stableId;
