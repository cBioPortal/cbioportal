...
public class AlterationEnrichmentServiceImplTest extends BaseServiceImplTest {
  ...
  @InjectMocks private AlterationEnrichmentServiceImpl alterationEnrichmentService;
  @Mock private AlterationCountService alterationCountService;
  @Mock private AlterationEnrichmentUtil<MutationCountByGene> alterationEnrichmentUtil;
  ...
  public void getAlterationEnrichments() throws Exception {
    ...
    Pair<List<AlterationCountByGene>, Long> alterationSampleCountByGeneList =
        new Pair<>(new ArrayList<>(), 0L);
    ...
    List<AlterationEnrichment> result =
        alterationEnrichmentService.getAlterationEnrichments(
            groupMolecularProfileCaseSets, EnrichmentType.SAMPLE, alterationFilter);
