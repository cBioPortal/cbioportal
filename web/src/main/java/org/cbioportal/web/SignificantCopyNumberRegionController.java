...
import org.cbioportal.webparam.sort.SignificantCopyNumberRegionSortBy;
    ...
    public ResponseEntity<List<Gistic>> getSignificantCopyNumberRegions(
        ...
        if (projection == Projection.META) {
            ...
            responseHeaders.add(HeaderKeyConstants.TOTAL_COUNT,
                significantCopyNumberRegionService.getMetaSignificantCopyNumberRegions(studyId).getTotalCount()
                    .toString());
            return new ResponseEntity<>(responseHeaders, HttpStatus.OK);
        } else {
            return new ResponseEntity<>(
                significantCopyNumberRegionService.getSignificantCopyNumberRegions(studyId, projection.name(), pageSize,
