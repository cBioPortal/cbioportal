...
public class GenePanelServiceImplLegacy implements GenePanelServiceLegacy {
    ...
    public List<GenePanelWithSamples> getGenePanelDataByProfileAndGenes(
        String profileId,
        List<String> submittedGenes
    ) {
        List<GenePanelWithSamples> genePanels = genePanelRepositoryLegacy.getGenePanelsByProfile(
            profileId
        );
