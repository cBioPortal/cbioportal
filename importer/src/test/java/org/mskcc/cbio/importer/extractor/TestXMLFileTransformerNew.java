...
public class TestXMLFileTransformerNew {

    private final static Logger logger = Logger.getLogger(TestXMLFileTransformerNew.class);

    public TestXMLFileTransformerNew() {}
    ...
    public static void main(String... args) {
        TestXMLFileTransformerNew test = new TestXMLFileTransformerNew();
        test.performTests();
    }
