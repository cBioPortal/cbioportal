...
public class MolecularProfileControllerTest {
    ...
    private static final String TEST_STUDY_IDENTIFIER_1 =
    ...
    private static final String TEST_TYPE_OF_CANCER_ID_1 =
    ...
    private static final String TEST_STUDY_DESCRIPTION_1 =
    ...
    private static final String TEST_GENERIC_ASSAY_TYPE_1 =
    ...
    private static final String TEST_STUDY_IDENTIFIER_2 =
    ...
    private static final String TEST_GENERIC_ASSAY_TYPE_2 =
        "test_generic_assay_type_2";
    ...
    public void getAllMolecularProfilesDefaultProjection() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].stableId").doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].molecularProfileId")
                    .value(TEST_STABLE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].studyId")
                    .value(TEST_STUDY_IDENTIFIER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].molecularAlterationType")
                    .value(TEST_MOLECULAR_ALTERATION_TYPE_1.toString())
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].datatype")
                    .value(TEST_DATATYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].genericAssayType")
                    .value(TEST_GENERIC_ASSAY_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].name").value(TEST_NAME_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].showProfileInAnalysisTab")
                    .value(TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].pivotThreshold")
                    .value(TEST_STUDY_PIVOT_THRESHOLD_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].sortOrder")
                    .value(TEST_STUDY_SORTORDER_1)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].stableId").doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].molecularProfileId")
                    .value(TEST_STABLE_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].studyId")
                    .value(TEST_STUDY_IDENTIFIER_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].molecularAlterationType")
                    .value(TEST_MOLECULAR_ALTERATION_TYPE_2.toString())
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].datatype")
                    .value(TEST_DATATYPE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].genericAssayType")
                    .value(TEST_GENERIC_ASSAY_TYPE_2)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].name").value(TEST_NAME_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].description")
                    .value(TEST_DESCRIPTION_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].showProfileInAnalysisTab")
                    .value(TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].pivotThreshold")
                    .value(TEST_STUDY_PIVOT_THRESHOLD_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].sortOrder")
                    .value(TEST_STUDY_SORTORDER_2)
            );
    }
    ...
    public void getAllMolecularProfilesMetaProjection() throws Exception {
        ...
        Mockito
            .when(molecularProfileService.getMetaMolecularProfiles())
            .thenReturn(baseMeta);
    ...
    public void getMolecularProfileNotFound() throws Exception {
        Mockito
            ...
            .thenThrow(
                new MolecularProfileNotFoundException(
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/molecular-profiles/test_molecular_profile_id")
                    .accept(MediaType.APPLICATION_JSON)
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.message")
                    .value(
                        "Molecular profile not found: test_molecular_profile_id"
                    )
            );
    }
    ...
    public void getMolecularProfile() throws Exception {
        ...
        molecularProfile.setShowProfileInAnalysisTab(
            TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_1
        );
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.stableId").doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.molecularProfileId")
                    .value(TEST_STABLE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.molecularAlterationType")
                    .value(TEST_MOLECULAR_ALTERATION_TYPE_1.toString())
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.genericAssayType")
                    .value(TEST_GENERIC_ASSAY_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.name").value(TEST_NAME_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.showProfileInAnalysisTab")
                    .value(TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.pivotThreshold")
                    .value(TEST_STUDY_PIVOT_THRESHOLD_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.study.cancerStudyId")
                    .doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.study.studyId")
                    .value(TEST_CANCER_STUDY_IDENTIFIER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.study.description")
                    .value(TEST_STUDY_DESCRIPTION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.study.name")
                    .value(TEST_STUDY_NAME_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.study.shortName")
                    .value(TEST_SHORT_NAME_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.study.cancerTypeId")
                    .value(TEST_TYPE_OF_CANCER_ID_1)
            );
    }

    @Test
    public void getAllMolecularProfilesInStudyDefaultProjection()
        throws Exception {
        List<MolecularProfile> molecularProfileList = createExampleMolecularProfiles();
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/studies/test_study_id/molecular-profiles")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
    ...
    @Test
    public void getAllMolecularProfilesInStudyMetaProjection()
        throws Exception {
        BaseMeta baseMeta = new BaseMeta();
        baseMeta.setTotalCount(2);
        ...
        Mockito
            .when(
                molecularProfileService.getMetaMolecularProfilesInStudy(
                    Mockito.anyString()
                )
            )
            .thenReturn(baseMeta);
    ...
    public void fetchMolecularProfiles() throws Exception {
        ...
        molecularProfileFilter.setStudyIds(
            Arrays.asList(TEST_STUDY_IDENTIFIER_1, TEST_STUDY_IDENTIFIER_2)
        );
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    ...
                    .content(
                        objectMapper.writeValueAsString(molecularProfileFilter)
                    )
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
    ...
    private List<MolecularProfile> createExampleMolecularProfiles() {
        ...
        molecularProfile1.setShowProfileInAnalysisTab(
            TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_1
        );
        ...
        molecularProfile2.setMolecularAlterationType(
            TEST_MOLECULAR_ALTERATION_TYPE_2
        );
        ...
        molecularProfile2.setShowProfileInAnalysisTab(
            TEST_SHOW_PROFILE_IN_ANALYSIS_TAB_2
        );
