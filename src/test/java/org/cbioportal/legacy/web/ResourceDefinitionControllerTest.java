...
public class ResourceDefinitionControllerTest {
  ...
  @MockitoBean private ResourceDefinitionService resourceDefinitionService;
  ...
  public void getAllResourceDefinitionsInStudy() throws Exception {
    ...
    List<ResourceDefinition> resourceDefinitions =
        Arrays.asList(objectMapper.readValue(resourceDefinitionsJson, ResourceDefinition[].class));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/studies/test_study_id/resource-definitions")
  ...
  public void getResourceDefinitionInStudy() throws Exception {
    ...
    ResourceDefinition resourceDefinitions =
        objectMapper.readValue(resourceDefinition, ResourceDefinition.class);

    Mockito.when(
            resourceDefinitionService.getResourceDefinition(
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(
                    "/api/studies/test_study_id/resource-definitions/PATHOLOGY_SLIDE")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andExpect(
            MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
