...
public class MolecularProfileSampleCount implements Serializable {
    ...
    public void setNumberOfMutationProfiledSamples(
        Integer numberOfMutationProfiledSamples
    ) {
    ...
    public void setNumberOfMutationUnprofiledSamples(
        Integer numberOfMutationUnprofiledSamples
    ) {
        this.numberOfMutationUnprofiledSamples =
    ...
    public void setNumberOfCNAProfiledSamples(
        Integer numberOfCNAProfiledSamples
    ) {
    ...
    public void setNumberOfCNAUnprofiledSamples(
        Integer numberOfCNAUnprofiledSamples
    ) {
    ...
    public void setNumberOfFusionProfiledSamples(
        Integer numberOfFusionProfiledSamples
    ) {
    ...
    public void setNumberOfFusionUnprofiledSamples(
        Integer numberOfFusionUnprofiledSamples
    ) {
