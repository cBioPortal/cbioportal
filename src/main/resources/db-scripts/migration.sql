...
CALL DROP_FOREIGN_KEY_IF_EXISTS('cancer_study', 'cancer_study_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('cancer_study', 'cancer_study_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('cancer_study_tags', 'cancer_study_tags_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('patient', 'patient_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample', 'sample_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_list', 'sample_list_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_list_list', 'sample_list_list_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gene', 'gene_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gene_alias', 'gene_alias_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('geneset', 'geneset_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('geneset_gene', 'geneset_gene_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('geneset_gene', 'geneset_gene_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('geneset_hierarchy_leaf', 'geneset_hierarchy_leaf_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('geneset_hierarchy_leaf', 'geneset_hierarchy_leaf_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('generic_entity_properties', 'generic_entity_properties_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('genetic_profile', 'genetic_profile_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('genetic_profile_link', 'genetic_profile_link_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('genetic_profile_link', 'genetic_profile_link_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('genetic_alteration', 'genetic_alteration_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('genetic_alteration', 'genetic_alteration_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('genetic_profile_samples', 'genetic_profile_samples_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gene_panel_list', 'gene_panel_list_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gene_panel_list', 'gene_panel_list_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_profile', 'sample_profile_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_profile', 'sample_profile_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_profile', 'sample_profile_ibfk_3');
CALL DROP_FOREIGN_KEY_IF_EXISTS('structural_variant', 'structural_variant_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('structural_variant', 'structural_variant_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('structural_variant', 'structural_variant_ibfk_3');
CALL DROP_FOREIGN_KEY_IF_EXISTS('structural_variant', 'structural_variant_ibfk_4');
CALL DROP_FOREIGN_KEY_IF_EXISTS('alteration_driver_annotation', 'alteration_driver_annotation_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('alteration_driver_annotation', 'alteration_driver_annotation_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation_event', 'mutation_event_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation', 'mutation_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation', 'mutation_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation', 'mutation_ibfk_3');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation', 'mutation_ibfk_4');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation_count_by_keyword', 'mutation_count_by_keyword_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mutation_count_by_keyword', 'mutation_count_by_keyword_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('clinical_patient', 'clinical_patient_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('clinical_sample', 'clinical_sample_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('clinical_attribute_meta', 'clinical_attribute_meta_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mut_sig', 'mut_sig_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('mut_sig', 'mut_sig_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gistic', 'gistic_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gistic_to_gene', 'gistic_to_gene_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('gistic_to_gene', 'gistic_to_gene_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('cna_event', 'cna_event_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_cna_event', 'sample_cna_event_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_cna_event', 'sample_cna_event_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('sample_cna_event', 'sample_cna_event_ibfk_3');
CALL DROP_FOREIGN_KEY_IF_EXISTS('copy_number_seg', 'copy_number_seg_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('copy_number_seg', 'copy_number_seg_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('copy_number_seg_file', 'copy_number_seg_file_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('cosmic_mutation', 'cosmic_mutation_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('clinical_event', 'clinical_event_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('clinical_event_data', 'clinical_event_data_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('reference_genome_gene', 'reference_genome_gene_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('reference_genome_gene', 'reference_genome_gene_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('allele_specific_copy_number', 'allele_specific_copy_number_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('allele_specific_copy_number', 'allele_specific_copy_number_ibfk_2');
CALL DROP_FOREIGN_KEY_IF_EXISTS('allele_specific_copy_number', 'allele_specific_copy_number_ibfk_3');
CALL DROP_FOREIGN_KEY_IF_EXISTS('resource_definition', 'resource_definition_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('resource_sample', 'resource_sample_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('resource_patient', 'resource_patient_ibfk_1');
CALL DROP_FOREIGN_KEY_IF_EXISTS('resource_study', 'resource_study_ibfk_1');
...
ALTER TABLE `clinical_patient` MODIFY COLUMN `INTERNAL_ID` BIGINT NOT NULL;
ALTER TABLE `clinical_sample` MODIFY COLUMN `INTERNAL_ID` BIGINT NOT NULL;
...
ALTER TABLE `sample_profile` MODIFY COLUMN `PANEL_ID` BIGINT DEFAULT NULL;
...
-- ALTER TABLE `gene_alias` MODIFY COLUMN `ENTREZ_GENE_ID` BIGINT NOT NULL;
ALTER TABLE `generic_entity_properties` MODIFY COLUMN `GENETIC_ENTITY_ID` BIGINT NOT NULL;
-- ALTER TABLE `cna_event` MODIFY COLUMN `ENTREZ_GENE_ID` BIGINT NOT NULL;
ALTER TABLE `copy_number_seg_file` MODIFY COLUMN `CANCER_STUDY_ID` BIGINT NOT NULL;

-- Step 4: Re-add foreign key constraints
ALTER TABLE `cancer_study` ADD CONSTRAINT FOREIGN KEY (`TYPE_OF_CANCER_ID`) REFERENCES `type_of_cancer` (`TYPE_OF_CANCER_ID`);
ALTER TABLE `cancer_study` ADD CONSTRAINT FOREIGN KEY (`REFERENCE_GENOME_ID`) REFERENCES `reference_genome` (`REFERENCE_GENOME_ID`) ON DELETE RESTRICT;
ALTER TABLE `cancer_study_tags` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `patient` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `sample` ADD CONSTRAINT FOREIGN KEY (`PATIENT_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `sample_list` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `sample_list_list` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `gene` ADD CONSTRAINT FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`) ON DELETE CASCADE;
ALTER TABLE `gene_alias` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `geneset` ADD CONSTRAINT FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`) ON DELETE CASCADE;
ALTER TABLE `geneset_gene` ADD CONSTRAINT FOREIGN KEY (`GENESET_ID`) REFERENCES `geneset` (`ID`) ON DELETE CASCADE;
ALTER TABLE `geneset_gene` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE;
ALTER TABLE `geneset_hierarchy_leaf` ADD CONSTRAINT FOREIGN KEY (`NODE_ID`) REFERENCES `geneset_hierarchy_node` (`NODE_ID`) ON DELETE CASCADE;
ALTER TABLE `geneset_hierarchy_leaf` ADD CONSTRAINT FOREIGN KEY (`GENESET_ID`) REFERENCES `geneset` (`ID`) ON DELETE CASCADE;
ALTER TABLE `generic_entity_properties` ADD CONSTRAINT FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`) ON DELETE CASCADE;
ALTER TABLE `genetic_profile` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `genetic_profile_link` ADD CONSTRAINT FOREIGN KEY (`REFERRING_GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `genetic_profile_link` ADD CONSTRAINT FOREIGN KEY (`REFERRED_GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE NO ACTION;
ALTER TABLE `genetic_alteration` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `genetic_alteration` ADD CONSTRAINT FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`) ON DELETE CASCADE;
ALTER TABLE `genetic_profile_samples` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `gene_panel_list` ADD CONSTRAINT FOREIGN KEY (`INTERNAL_ID`) REFERENCES `gene_panel` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `gene_panel_list` ADD CONSTRAINT FOREIGN KEY (`GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE;
ALTER TABLE `sample_profile` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `sample_profile` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `sample_profile` ADD CONSTRAINT FOREIGN KEY (`PANEL_ID`) REFERENCES `gene_panel` (`INTERNAL_ID`) ON DELETE RESTRICT;
ALTER TABLE `structural_variant` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `structural_variant` ADD CONSTRAINT FOREIGN KEY (`SITE1_ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE;
ALTER TABLE `structural_variant` ADD CONSTRAINT FOREIGN KEY (`SITE2_ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE;
ALTER TABLE `structural_variant` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `alteration_driver_annotation` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `alteration_driver_annotation` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `mutation_event` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `mutation` ADD CONSTRAINT FOREIGN KEY (`MUTATION_EVENT_ID`) REFERENCES `mutation_event` (`MUTATION_EVENT_ID`);
ALTER TABLE `mutation` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `mutation` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `mutation` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `mutation_count_by_keyword` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `mutation_count_by_keyword` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE;
ALTER TABLE `clinical_patient` ADD CONSTRAINT FOREIGN KEY (`INTERNAL_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `clinical_sample` ADD CONSTRAINT FOREIGN KEY (`INTERNAL_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `mut_sig` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `mut_sig` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `gistic` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `gistic_to_gene` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `gistic_to_gene` ADD CONSTRAINT FOREIGN KEY (`GISTIC_ROI_ID`) REFERENCES `gistic` (`GISTIC_ROI_ID`) ON DELETE CASCADE;
ALTER TABLE `cna_event` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `sample_cna_event` ADD CONSTRAINT FOREIGN KEY (`CNA_EVENT_ID`) REFERENCES `cna_event` (`CNA_EVENT_ID`);
ALTER TABLE `sample_cna_event` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `sample_cna_event` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `copy_number_seg` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `copy_number_seg` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `copy_number_seg_file` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `cosmic_mutation` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`);
ALTER TABLE `clinical_event` ADD CONSTRAINT FOREIGN KEY (`PATIENT_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE;
...
ALTER TABLE `reference_genome_gene` ADD CONSTRAINT FOREIGN KEY (`REFERENCE_GENOME_ID`) REFERENCES `reference_genome` (`REFERENCE_GENOME_ID`) ON DELETE CASCADE;
ALTER TABLE `reference_genome_gene` ADD CONSTRAINT FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE;
ALTER TABLE `allele_specific_copy_number` ADD CONSTRAINT FOREIGN KEY (`MUTATION_EVENT_ID`) REFERENCES `mutation_event` (`MUTATION_EVENT_ID`);
ALTER TABLE `allele_specific_copy_number` ADD CONSTRAINT FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE;
ALTER TABLE `allele_specific_copy_number` ADD CONSTRAINT FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `resource_definition` ADD CONSTRAINT FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;
ALTER TABLE `resource_sample` ADD CONSTRAINT FOREIGN KEY (`INTERNAL_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `resource_patient` ADD CONSTRAINT FOREIGN KEY (`INTERNAL_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE;
ALTER TABLE `resource_study` ADD CONSTRAINT FOREIGN KEY (`INTERNAL_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE;

SET FOREIGN_KEY_CHECKS=1;

UPDATE `info` SET `DB_SCHEMA_VERSION`="2.13.671";
