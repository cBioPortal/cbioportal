...
public class HeatMapLegend {
     ...
     * @return
     */
    public static String outputHeatMapLegend(
        ...
        // CNA colors
        if (
            allPossibleAlterations.satisfy(
        ...
        if (
            ...
            MutationLevels.add(
                "<td valign=top><img src=\"images/bullseye.png\"> = Point Mutation</td>"
            );
        }

        // expression
        // over
        ResultDataTypeSpec theResultDataTypeSpec = allPossibleAlterations.getResultDataTypeSpec(
        ...
        if (
            ...
            ExpressionLevels.add(
                "<td valign=top><img src=\"images/up2.png\"> = mRNA up-Regulation</td>"
            );
        }

        // under
        theResultDataTypeSpec =
            allPossibleAlterations.getResultDataTypeSpec(
                GeneticDataTypes.Expression
            );
        if (
            null != theResultDataTypeSpec &&
            ...
            ExpressionLevels.add(
                "<td valign=top><img src=\"images/down2.png\"> = mRNA down-Regulation</td>"
            );
        }

        // RPPA
        theResultDataTypeSpec =
            allPossibleAlterations.getResultDataTypeSpec(GeneticDataTypes.RPPA);
        if (
            null != theResultDataTypeSpec &&
            (
                null !=
            ...
            RPPALevels.add(
                "<td valign=top><img src=\"images/up-rppa.png\"> = Protein up-Regulation</td>"
            );
        }
        ...
        if (
            ...
            RPPALevels.add(
                "<td valign=top><img src=\"images/down-rppa.png\"> = Protein down-Regulation</td>"
            );
        }
        ...
        Alterations.add(
            "<td valign=top><img src=\"images/altered.gif\"> = At least one gene in set is altered in case</td>"
        );
    ...
    private static boolean[] outputHeadings(
        StringBuffer sb,
        ArrayList<ArrayList<String>> allColumns
    ) {
    ...
    private static boolean levelsRemaining(
        ArrayList<ArrayList<String>> allColumns
    ) {
        for (ArrayList<String> col : allColumns) {
            if (0 < col.size()) {
    ...
    private static void outputNextRow(
        StringBuffer sb,
        ArrayList<ArrayList<String>> allColumns,
        boolean[] columnUsed
    ) {
