...
public class MafDataTypeExporterTests {
  ...
  public void testNotExported() {
    ...
    MutationExtendedDatatypeExporter mafDataTypeExporter =
        new MutationExtendedDatatypeExporter(
            new GeneticProfileService(null) {
              @Override
              public List<GeneticProfileDatatypeMetadata> getGeneticProfiles(
                  String studyId,
  ...
  public void testMafDataTypeExport() {
    ...
    MafDataTypeExporter mafDataTypeExporter =
        new MutationExtendedDatatypeExporter(geneticProfileService, mafRecordService);
    ...
    assertEquals(
        Set.of(
            "meta_mutation_extended_maf_maf_stable_id.txt",
            "data_mutation_extended_maf_maf_stable_id.txt"),
        fileContents.keySet());
  ...
  public void testMafDataTypeExportUnderAlternativeStudyId() {
    ...
    boolean exported =
        mafDataTypeExporter.exportData(
            factory, new ExportDetails("TEST_STUDY_ID", "TEST_STUDY_ID_B"));
