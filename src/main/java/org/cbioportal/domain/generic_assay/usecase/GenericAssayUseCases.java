...
@Profile("clickhouse")
/**
 * A record representing a collection of use cases related to generic assay data operations.
 * This record encapsulates instances of various use case classes, providing a centralized
 * way to access and manage them.
 *
 * @param getFilteredMolecularProfilesByAlterationType the use case for retrieving molecular profiles
 *                                                     filtered by alteration type.
 * @param getGenericAssayDataBinCounts                the use case for retrieving binned counts of generic assay data.
