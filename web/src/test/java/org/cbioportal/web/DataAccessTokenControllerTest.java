...
@ContextConfiguration(
    locations = {
        "/applicationContext-web.xml", "/applicationContext-security-test.xml"
    }
)
@WebAppConfiguration
public class DataAccessTokenControllerTest {
    ...
    public static final DataAccessToken MOCK_TOKEN_INFO = new DataAccessToken(
        VALID_TOKEN_STRING
    );
    ...
    public DataAccessTokenService tokenService() {
        DataAccessTokenService tokenService = Mockito.mock(
            DataAccessTokenService.class
        );
        return tokenService;
    }
    ...
    private HttpSession getSession(String user, String password)
        throws Exception {
        return mockMvc
            .perform(
    ...
    public void getTokenInfoForValidTokenTest() throws Exception {
        Mockito
            .when(tokenService.getDataAccessTokenInfo(VALID_TOKEN_STRING))
            .thenReturn(MOCK_TOKEN_INFO);
        HttpSession session = getSession(MOCK_USER, MOCK_PASSWORD);
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/data-access-tokens/" + VALID_TOKEN_STRING)
    ...
    public void getTokenInfoForNonexistentTokenTest() throws Exception {
        ...
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/data-access-tokens/" + NONEXISTENT_TOKEN_STRING)
                    .session((MockHttpSession) session)
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void revokeValidTokenTest() throws Exception {
        ...
        Answer<Void> tokenServiceRevokeTokenAnswer = new Answer<Void>() {
            ...
            public Void answer(InvocationOnMock revokeTokenInvocation) {
                receivedArgument =
                    (String) revokeTokenInvocation.getArguments()[0];
                return null;
            }
        };
        Mockito
            ...
            .when(tokenService)
            .revokeDataAccessToken(Matchers.anyString());
        HttpSession session = getSession(MOCK_USER, MOCK_PASSWORD);
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .delete("/data-access-tokens/" + VALID_TOKEN_STRING)
                    .session((MockHttpSession) session)
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void revokeNonexistentTokenTest() throws Exception {
        ...
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .delete("/data-access-tokens/" + NONEXISTENT_TOKEN_STRING)
                    .session((MockHttpSession) session)
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void createTokenValidUserTest() throws Exception {
        Mockito
            .when(tokenService.createDataAccessToken(Matchers.anyString()))
            .thenReturn(MOCK_TOKEN_INFO);
        HttpSession session = getSession(MOCK_USER, MOCK_PASSWORD);
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/data-access-tokens")
                    .session((MockHttpSession) session)
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void revokeAllTokensForUserTest() throws Exception {
        ...
        Answer<Void> tokenServiceRevokeAllTokensAnswer = new Answer<Void>() {
            ...
            public Void answer(InvocationOnMock revokeAllTokensInvocation) {
                receivedArgument =
                    (String) revokeAllTokensInvocation.getArguments()[0];
                return null;
            }
        };
        Mockito
            ...
            .when(tokenService)
            .revokeAllDataAccessTokens(Matchers.anyString());
        HttpSession session = getSession(MOCK_USER, MOCK_PASSWORD);
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
                    .delete("/data-access-tokens")
                    .session((MockHttpSession) session)
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void getAllTokensForUserTest() throws Exception {
        ...
        Answer<Void> tokenServiceGetAllTokensAnswer = new Answer<Void>() {
            ...
            public Void answer(InvocationOnMock getAllTokensInvocation) {
                receivedArgument =
                    (String) getAllTokensInvocation.getArguments()[0];
                return null;
            }
        };
        Mockito
            ...
            .when(tokenService)
            .getAllDataAccessTokens(Matchers.anyString());
        HttpSession session = getSession(MOCK_USER, MOCK_PASSWORD);
        MvcResult result = mockMvc
            .perform(
                MockMvcRequestBuilders
