...
public class GeneticDataController {
    ...
    public ResponseEntity<List<? extends GeneticDataSummary>> getAllGeneticDataInSampleInStudy(@PathVariable String studyId,
    ...
    public ResponseEntity<List<? extends GeneticDataSummary>> getAllGeneticDataInPatientInStudy(@PathVariable String studyId,
    ...
    public ResponseEntity<List<? extends GeneticDataSummary>> getAllGeneticDataInGeneticProfile(@PathVariable String geneticProfileId,
                                                                                                @RequestParam(defaultValue = "SUMMARY") Projection projection,
                                                                                                @RequestParam(defaultValue = PagingConstants.DEFAULT_PAGE_SIZE) Integer pageSize,
                                                                                                @RequestParam(defaultValue = PagingConstants.DEFAULT_PAGE_NUMBER) Integer pageNumber) {
    ...
    public ResponseEntity<List<? extends GeneticDataSummary>> queryGeneticDataByExample(@RequestParam(defaultValue = "SUMMARY") Projection projection,
                                                                                        @RequestParam(defaultValue = PagingConstants.DEFAULT_PAGE_SIZE) Integer pageSize,
                                                                                        @RequestParam(defaultValue = PagingConstants.DEFAULT_PAGE_NUMBER) Integer pageNumber,
