...
public class MutationDataServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException
	{
		String geneticProfileId = request.getParameter("geneticProfileId");
		// TODO parse the lists...
		//ArrayList<String> targetGeneList = request.getParameter("targetGeneList");
		//ArrayList<String> targetCaseList = request.getParameter("targetCaseList");
		...
		try
		{
			data = this.getMutationData(geneticProfileId,
				targetGeneList,
				targetCaseList);
		}
