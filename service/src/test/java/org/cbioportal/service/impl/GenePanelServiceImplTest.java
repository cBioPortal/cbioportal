...
public class GenePanelServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllGenePanelsSummaryProjection() throws Exception {
        ...
        Mockito
            .when(
                genePanelRepository.getAllGenePanels(
                    "SUMMARY",
                    PAGE_SIZE,
                    PAGE_NUMBER,
                    SORT,
        ...
        List<GenePanel> result = genePanelService.getAllGenePanels(
            "SUMMARY",
            PAGE_SIZE,
            PAGE_NUMBER,
            SORT,
    ...
    public void getMetaGenePanels() throws Exception {
        ...
        Mockito
            .when(genePanelRepository.getMetaGenePanels())
    ...
    public void getGenePanelNotFound() throws Exception {
        Mockito
            .when(genePanelRepository.getGenePanel(GENE_PANEL_ID))
            .thenReturn(null);
    ...
    public void getGenePanelData() throws Exception {
        ...
        Mockito
            .when(
                sampleListService.fetchSampleLists(
                    Arrays.asList(STUDY_ID + SEQUENCED_LIST_SUFFIX),
                    "DETAILED"
                )
            )
        ...
        Mockito
            .when(
                genePanelRepository.getGenePanelData(
                    MOLECULAR_PROFILE_ID,
                    SAMPLE_LIST_ID
                )
            )
        ...
        List<GenePanelData> result = genePanelService.getGenePanelData(
            MOLECULAR_PROFILE_ID,
            SAMPLE_LIST_ID
        );
        ...
        Assert.assertEquals(
            GENE_PANEL_ID,
            resultGenePanelData1.getGenePanelId()
        );
        Assert.assertEquals(
            MOLECULAR_PROFILE_ID,
            resultGenePanelData1.getMolecularProfileId()
        );
        ...
        Assert.assertEquals(
            MOLECULAR_PROFILE_ID,
            resultGenePanelData2.getMolecularProfileId()
        );
    ...
    public void fetchGenePanelData() throws Exception {
        ...
        List<GenePanelData> result = genePanelService.fetchGenePanelData(
            MOLECULAR_PROFILE_ID,
            Arrays.asList(SAMPLE_ID1, SAMPLE_ID2)
        );
