...
public class completeOncoPrintSpecASTwalker extends TreeParser {
    ...
    public completeOncoPrintSpecASTwalker(
    ...
    public String[] getTokenNames() {
        return completeOncoPrintSpecASTwalker.tokenNames;
    }

    public String getGrammarFileName() {
        return "../completeOncoPrintSpecASTwalker.g";
    }
    ...
    public void generateOncoError(
        ...
        throw new OncoPrintLangException(
            "Error at char " +
            increment(charPos) +
            " of line " +
            line +
    ...
    public void newReportError(OncoPrintLangException e)
        throws OncoPrintLangException {
    ...
    public final completeOncoPrintSpecASTwalker.oncoPrintSpecification_return oncoPrintSpecification(
        OncoPrintGeneDisplaySpec anOncoPrintGeneDisplaySpec
    )
                ...
                loop1:do {
                    ...
                    if (
                        (
                            LA1_0 == UserGeneList ||
                            (
                                LA1_0 >= IndividualGene &&
                                LA1_0 <= DefaultDataTypeSpec
                            )
                        )
                    ) {
                        alt1 = 1;
                    ...
                    switch (alt1) {
                        case 1:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_userGeneList_in_oncoPrintSpecification62
                                );
                                userGeneList1 = userGeneList();

                                state._fsp--;

                                retval.theOncoPrintSpecification.add(
                                    userGeneList1
                                );
                            }
                            break;
    ...
    public final GeneSet userGeneList() throws RecognitionException {
        ...
        try {
            ...
            if ((LA3_0 == UserGeneList)) {
                ...
                ((LA3_0 >= IndividualGene && LA3_0 <= DefaultDataTypeSpec))
            ) {
                alt3 = 2;
            } else {
                ...
                case 1:
                    // ../completeOncoPrintSpecASTwalker.g:91:4: ^( UserGeneList geneList ( STRING )? )
                    {
                        match(
                            input,
                            UserGeneList,
                            FOLLOW_UserGeneList_in_userGeneList91
                        );
                                ...
                                // ../completeOncoPrintSpecASTwalker.g:91:28: STRING
                                {
                                    STRING3 =
                                        (CommonTree) match(
                                            input,
                                            STRING,
                                            FOLLOW_STRING_in_userGeneList95
                                        );
                                }
                                break;
                        }
                        ...
                        geneList2.setUserGeneList(
                            (STRING3 != null ? STRING3.getText() : null)
                        );
                ...
                loop4:do {
                    ...
                    switch (alt4) {
                        case 1:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_individualGene_in_geneList132
                                );
                        ...
                        case 2:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_defaultDataTypeSpec_in_geneList140
                                );
                                defaultDataTypeSpec();
        ...
        try {
            ...
            // ../completeOncoPrintSpecASTwalker.g:118:2: ^( IndividualGene ID ( fullDataTypeSpec )? )
            {
                match(
                    input,
                    IndividualGene,
                    FOLLOW_IndividualGene_in_individualGene161
                );
                ...
                ID6 =
                    (CommonTree) match(
                        input,
                        ID,
                        FOLLOW_ID_in_individualGene163
                    );
                ...
                if (
                    (
                        LA5_0 == DataTypeOrLevel ||
                        LA5_0 == DiscreteDataType ||
                        LA5_0 == ContinuousDataTypeInequality
                    )
                ) {
                    alt5 = 1;
                }
                switch (alt5) {
                    case 1:
                        ...
                        {
                            pushFollow(
                                FOLLOW_fullDataTypeSpec_in_individualGene165
                            );
                ...
                if (!Gene.valid((ID6 != null ? ID6.getText() : null))) {
                    generateOncoError(
                        (ID6 != null ? ID6.getCharPositionInLine() : 0),
                        (ID6 != null ? ID6.getLine() : 0),
                        (ID6 != null ? ID6.getText() : null),
                        " is not a valid gene or microRNA name."
                    );
                }
                theGeneWithSpec =
                    GeneWithSpec.geneWithSpecGenerator(
                        (ID6 != null ? ID6.getText() : null),
                        fullDataTypeSpec7,
        ...
        try {
            ...
            // ../completeOncoPrintSpecASTwalker.g:133:4: ^( DefaultDataTypeSpec fullDataTypeSpec )
            {
                match(
                    input,
                    DefaultDataTypeSpec,
                    FOLLOW_DefaultDataTypeSpec_in_defaultDataTypeSpec185
                );
    ...
    public final OncoPrintGeneDisplaySpec fullDataTypeSpec()
        throws RecognitionException {
        ...
        try {
            ...
            // ../completeOncoPrintSpecASTwalker.g:146:2: ( dataTypeSpec )+
            {
                ...
                loop6:do {
                    ...
                    if (
                        (
                            LA6_0 == DataTypeOrLevel ||
                            LA6_0 == DiscreteDataType ||
                            LA6_0 == ContinuousDataTypeInequality
                        )
                    ) {
                        alt6 = 1;
                    }
                    ...
                    switch (alt6) {
                        case 1:
                            ...
                            {
                                pushFollow(
                                    FOLLOW_dataTypeSpec_in_fullDataTypeSpec213
                                );
                                ...
                                // save to a Parsed ...
                                theParsedFullDataTypeSpec.addSpec(
                                    dataTypeSpec9
                                );
                            }
                            break;
                ...
                theOncoPrintGeneDisplaySpec =
                    theParsedFullDataTypeSpec.cleanUpInput();
            }
        } catch (RecognitionException re) {
            // trees s/b all well-formed, so don't expect these
            reportError(re);
        ...
        try {
            ...
            switch (alt7) {
                case 1:
                    // ../completeOncoPrintSpecASTwalker.g:160:2: ^( DataTypeOrLevel ID )
                    {
                        match(
                            input,
                            DataTypeOrLevel,
                            FOLLOW_DataTypeOrLevel_in_dataTypeSpec242
                        );
                        ...
                        ID10 =
                            (CommonTree) match(
                                input,
                                ID,
                                FOLLOW_ID_in_dataTypeSpec244
                            );

                        match(input, Token.UP, null);

                        theDataTypeSpec =
                            ConcreteDataTypeSpec.concreteDataTypeSpecGenerator(
                                (ID10 != null ? ID10.getText() : null)
                            );
                        if (null == theDataTypeSpec) {
                            theDataTypeSpec =
                                DiscreteDataTypeSetSpec.discreteDataTypeSetSpecGeneratorByLevelName(
                                    (ID10 != null ? ID10.getText() : null)
                                );
                        }
                        if (null == theDataTypeSpec) {
                            ...
                            generateOncoError(
                                (
                                    ID10 != null
                                        ? ID10.getCharPositionInLine()
                                        : 0
                                ),
                                (ID10 != null ? ID10.getLine() : 0),
                                (ID10 != null ? ID10.getText() : null),
                                " is not a valid genetic data type or data level."
                            );
                        }
                    }
                    break;
                ...
                case 3:
                    ...
                    {
                        pushFollow(
                            FOLLOW_continuousDataTypeInequality_in_dataTypeSpec264
                        );
                        continuousDataTypeInequality12 =
                            continuousDataTypeInequality();
                ...
                case 1:
                    // ../completeOncoPrintSpecASTwalker.g:184:2: ^( DiscreteDataType type= ID COMPARISON_OP level= ID )
                    {
                        match(
                            input,
                            DiscreteDataType,
                            FOLLOW_DiscreteDataType_in_discreteDataType288
                        );
                        ...
                        type =
                            (CommonTree) match(
                                input,
                                ID,
                                FOLLOW_ID_in_discreteDataType292
                            );
                        COMPARISON_OP13 =
                            (CommonTree) match(
                                input,
                                COMPARISON_OP,
                                FOLLOW_COMPARISON_OP_in_discreteDataType294
                            );
                        level =
                            (CommonTree) match(
                                input,
                                ID,
                                FOLLOW_ID_in_discreteDataType298
                            );

                        match(input, Token.UP, null);

                        theDataTypeSpec =
                            DiscreteDataTypeSpec.discreteDataTypeSpecGenerator(
                                (type != null ? type.getText() : null),
                                (
                                    COMPARISON_OP13 != null
                                        ? COMPARISON_OP13.getText()
                                        : null
                                ),
                                (level != null ? level.getText() : null)
                            );
                ...
                case 2:
                    // ../completeOncoPrintSpecASTwalker.g:195:2: ^( DiscreteDataType ID SIGNED_INT )
                    {
                        match(
                            input,
                            DiscreteDataType,
                            FOLLOW_DiscreteDataType_in_discreteDataType311
                        );
                        ...
                        ID14 =
                            (CommonTree) match(
                                input,
                                ID,
                                FOLLOW_ID_in_discreteDataType313
                            );
                        SIGNED_INT15 =
                            (CommonTree) match(
                                input,
                                SIGNED_INT,
                                FOLLOW_SIGNED_INT_in_discreteDataType315
                            );

                        match(input, Token.UP, null);

                        theDataTypeSpec =
                            DiscreteDataTypeSetSpec.discreteDataTypeSetSpecGeneratorByLevelCode(
                                (ID14 != null ? ID14.getText() : null),
                                (
                                    SIGNED_INT15 != null
                                        ? SIGNED_INT15.getText()
                                        : null
                                )
                            );
                        if (null == theDataTypeSpec) {
                            ...
                            generateOncoError(
                                (
                                    ID14 != null
                                        ? ID14.getCharPositionInLine()
                                        : 0
                                ),
                                (ID14 != null ? ID14.getLine() : 0),
                                (ID14 != null ? ID14.getText() : null) +
                                " " +
                                (
                                    SIGNED_INT15 != null
                    ...
                    // ../completeOncoPrintSpecASTwalker.g:208:2: SIGNED_FLOAT
                    {
                        SIGNED_FLOAT16 =
                            (CommonTree) match(
                                input,
                                SIGNED_FLOAT,
                                FOLLOW_SIGNED_FLOAT_in_floatOrInt337
                            );

                        number =
                            (
                                SIGNED_FLOAT16 != null
                                    ? SIGNED_FLOAT16.getText()
                                    : null
                            );
                    }
                    break;
                    ...
                    // ../completeOncoPrintSpecASTwalker.g:212:4: SIGNED_INT
                    {
                        SIGNED_INT17 =
                            (CommonTree) match(
                                input,
                                SIGNED_INT,
                                FOLLOW_SIGNED_INT_in_floatOrInt346
                            );

                        number =
                            (
                                SIGNED_INT17 != null
                                    ? SIGNED_INT17.getText()
                                    : null
                            );
                    }
                    break;
    ...
    public final ContinuousDataTypeSpec continuousDataTypeInequality()
        throws RecognitionException {
        ...
        try {
            ...
            // ../completeOncoPrintSpecASTwalker.g:220:2: ^( ContinuousDataTypeInequality ID COMPARISON_OP floatOrInt )
            {
                match(
                    input,
                    ContinuousDataTypeInequality,
                    FOLLOW_ContinuousDataTypeInequality_in_continuousDataTypeInequality368
                );
                ...
                ID18 =
                    (CommonTree) match(
                        input,
                        ID,
                        FOLLOW_ID_in_continuousDataTypeInequality370
                    );
                COMPARISON_OP19 =
                    (CommonTree) match(
                        input,
                        COMPARISON_OP,
                        FOLLOW_COMPARISON_OP_in_continuousDataTypeInequality372
                    );
                pushFollow(
                    FOLLOW_floatOrInt_in_continuousDataTypeInequality374
                );
                ...
                theContinuousDataTypeSpec =
                    ContinuousDataTypeSpec.continuousDataTypeSpecGenerator(
                        (ID18 != null ? ID18.getText() : null),
                        (
                            COMPARISON_OP19 != null
                                ? COMPARISON_OP19.getText()
                                : null
                        ),
                        floatOrInt20
                    );
                if (null == theContinuousDataTypeSpec) {
                    generateOncoError(
                        (ID18 != null ? ID18.getCharPositionInLine() : 0),
                        (ID18 != null ? ID18.getLine() : 0),
                        (ID18 != null ? ID18.getText() : null),
                        " is not a valid genetic data type."
                    );
                }
            }
        } catch (RecognitionException re) {
    ...
    public static final BitSet FOLLOW_userGeneList_in_oncoPrintSpecification62 = new BitSet(
        new long[] { 0x00000000000001A2L }
    );
    public static final BitSet FOLLOW_UserGeneList_in_userGeneList91 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_geneList_in_userGeneList93 = new BitSet(
        new long[] { 0x0000000000000018L }
    );
    public static final BitSet FOLLOW_STRING_in_userGeneList95 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
    public static final BitSet FOLLOW_geneList_in_userGeneList106 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_individualGene_in_geneList132 = new BitSet(
        new long[] { 0x00000000000001A2L }
    );
    public static final BitSet FOLLOW_defaultDataTypeSpec_in_geneList140 = new BitSet(
        new long[] { 0x00000000000001A2L }
    );
    public static final BitSet FOLLOW_IndividualGene_in_individualGene161 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_ID_in_individualGene163 = new BitSet(
        new long[] { 0x0000000000005208L }
    );
    public static final BitSet FOLLOW_fullDataTypeSpec_in_individualGene165 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
    public static final BitSet FOLLOW_DefaultDataTypeSpec_in_defaultDataTypeSpec185 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_fullDataTypeSpec_in_defaultDataTypeSpec187 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
    public static final BitSet FOLLOW_dataTypeSpec_in_fullDataTypeSpec213 = new BitSet(
        new long[] { 0x0000000000005202L }
    );
    public static final BitSet FOLLOW_DataTypeOrLevel_in_dataTypeSpec242 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_ID_in_dataTypeSpec244 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
    public static final BitSet FOLLOW_discreteDataType_in_dataTypeSpec255 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_continuousDataTypeInequality_in_dataTypeSpec264 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_DiscreteDataType_in_discreteDataType288 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_ID_in_discreteDataType292 = new BitSet(
        new long[] { 0x0000000000000400L }
    );
    public static final BitSet FOLLOW_COMPARISON_OP_in_discreteDataType294 = new BitSet(
        new long[] { 0x0000000000000040L }
    );
    public static final BitSet FOLLOW_ID_in_discreteDataType298 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
    public static final BitSet FOLLOW_DiscreteDataType_in_discreteDataType311 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_ID_in_discreteDataType313 = new BitSet(
        new long[] { 0x0000000000000800L }
    );
    public static final BitSet FOLLOW_SIGNED_INT_in_discreteDataType315 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
    public static final BitSet FOLLOW_SIGNED_FLOAT_in_floatOrInt337 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_SIGNED_INT_in_floatOrInt346 = new BitSet(
        new long[] { 0x0000000000000002L }
    );
    public static final BitSet FOLLOW_ContinuousDataTypeInequality_in_continuousDataTypeInequality368 = new BitSet(
        new long[] { 0x0000000000000004L }
    );
    public static final BitSet FOLLOW_ID_in_continuousDataTypeInequality370 = new BitSet(
        new long[] { 0x0000000000000400L }
    );
    public static final BitSet FOLLOW_COMPARISON_OP_in_continuousDataTypeInequality372 = new BitSet(
        new long[] { 0x0000000000002800L }
    );
    public static final BitSet FOLLOW_floatOrInt_in_continuousDataTypeInequality374 = new BitSet(
        new long[] { 0x0000000000000008L }
    );
}
