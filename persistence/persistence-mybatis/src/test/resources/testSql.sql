...
INSERT INTO clinical_attribute_meta (ATTR_ID,DISPLAY_NAME,DESCRIPTION,DATATYPE,PATIENT_ATTRIBUTE,PRIORITY,CANCER_STUDY_ID) VALUES ('DAYS_TO_COLLECTION','Days to Sample Collection.','Days to sample collection.','NUMBE',0,'1',2);
