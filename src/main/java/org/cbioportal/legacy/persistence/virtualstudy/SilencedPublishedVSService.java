...
/**
 * This class is a silenced version of the VirtualStudyService.
 * It overrides the getPublishedVirtualStudies methods to return an empty list.
 * This is used to silence the published virtual studies in the application.
 */
