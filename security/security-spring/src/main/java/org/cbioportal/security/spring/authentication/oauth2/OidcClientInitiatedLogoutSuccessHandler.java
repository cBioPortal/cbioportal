...
/**
 * This class was added to allow setting a different end-session endpoint when auto-configuring 
 * the OIDC client from IDP from the .well-known discovery endpoint.
 */
public final class OidcClientInitiatedLogoutSuccessHandler extends SimpleUrlLogoutSuccessHandler {
    ...
    private URI endSessionEndpoint(ClientRegistration clientRegistration) {
        if (clientRegistration != null) {
            if (endSessionEndpoint != null) {
                return URI.create(endSessionEndpoint);
            }
