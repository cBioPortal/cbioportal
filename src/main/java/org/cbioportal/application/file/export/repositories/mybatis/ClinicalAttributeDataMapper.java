...
/**
 * Mapper interface for retrieving clinical attribute data, clinical event data, and related
...
public interface ClinicalAttributeDataMapper {
   ...
   * @return a cursor containing clinical attribute values for the specified samples
   */
  Cursor<ClinicalAttributeValue> getClinicalSampleAttributeValues(
   ...
   * @param studyId the identifier of the study
   * @param sampleIds a set of sample IDs to filter the attribute values; null set means all samples
   * @return a cursor containing clinical patient attribute values for the specified samples
   */
  Cursor<ClinicalAttributeValue> getClinicalPatientAttributeValues(
      String studyId, Set<String> sampleIds);
   ...
   * @return a cursor containing clinical event data for the specified parameters
   */
  Cursor<ClinicalEventData> getClinicalEventData(
   ...
   * @param eventType
   * @param sampleIds
   * @return a cursor containing clinical events for the specified parameters
   */
