...
public class StructuralVariant implements TableRow {
    ...
    private static final LinkedHashMap<String, Function<StructuralVariant, String>> ROW = new LinkedHashMap<>();

    static {
        ROW.put("Sample_Id", StructuralVariant::getSampleId);
        ROW.put("Site1_Entrez_Gene_Id", data -> data.getSite1EntrezGeneId() == null ? null : data.getSite1EntrezGeneId().toString());
        ...
        ROW.put("Site1_Region_Number", data -> data.getSite1RegionNumber() == null ? null : data.getSite1RegionNumber().toString());
        ROW.put("Site1_Chromosome", StructuralVariant::getSite1Chromosome);
        ROW.put("Site1_Position", data -> data.getSite1Position() == null ? null : data.getSite1Position().toString());
        ROW.put("Site1_Region", StructuralVariant::getSite1Region);
        ROW.put("Site1_Description", StructuralVariant::getSite1Description);
        ROW.put("Site2_Entrez_Gene_Id", data -> data.getSite2EntrezGeneId() == null ? null : data.getSite2EntrezGeneId().toString());
        ...
        ROW.put("Site2_Region_Number", data -> data.getSite2RegionNumber() == null ? null : data.getSite2RegionNumber().toString());
        ROW.put("Site2_Chromosome", StructuralVariant::getSite2Chromosome);
        ROW.put("Site2_Position", data -> data.getSite2Position() == null ? null : data.getSite2Position().toString());
        ...
        ROW.put("Normal_Read_Count", data -> data.getNormalReadCount() == null ? null : data.getNormalReadCount().toString());
        ROW.put("Tumor_Read_Count", data -> data.getTumorReadCount() == null ? null : data.getTumorReadCount().toString());
        ROW.put("Normal_Variant_Count", data -> data.getNormalVariantCount() == null ? null : data.getNormalVariantCount().toString());
        ROW.put("Tumor_Variant_Count", data -> data.getTumorVariantCount() == null ? null : data.getTumorVariantCount().toString());
        ROW.put("Normal_Paired_End_Read_Count", data -> data.getNormalPairedEndReadCount() == null ? null : data.getNormalPairedEndReadCount().toString());
        ROW.put("Tumor_Paired_End_Read_Count", data -> data.getTumorPairedEndReadCount() == null ? null : data.getTumorPairedEndReadCount().toString());
        ROW.put("Normal_Split_Read_Count", data -> data.getNormalSplitReadCount() == null ? null : data.getNormalSplitReadCount().toString());
        ROW.put("Tumor_Split_Read_Count", data -> data.getTumorSplitReadCount() == null ? null : data.getTumorSplitReadCount().toString());
    ...
    public SequencedMap<String, String> toRow() {
        ...
        ROW.sequencedEntrySet().forEach(entry -> {
