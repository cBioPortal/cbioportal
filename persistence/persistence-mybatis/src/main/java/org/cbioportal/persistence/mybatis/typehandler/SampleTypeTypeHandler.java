...
public class SampleTypeTypeHandler implements TypeHandler<Sample.SampleType> {
    ...
    @Override
    public Sample.SampleType getResult(ResultSet resultSet, String s)
        throws SQLException {
        return Sample.SampleType.fromString(resultSet.getString(s));
    }

    @Override
    public Sample.SampleType getResult(ResultSet resultSet, int i)
        throws SQLException {
        return Sample.SampleType.fromString(resultSet.getString(i));
    }

    @Override
    public Sample.SampleType getResult(
