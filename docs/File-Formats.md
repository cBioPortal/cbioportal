...
26. **Mutation_Status (Optional)**: Ideally "Somatic", but "Germline" is also possible and will be displayed in mutations tab. Values "None", "LOH" and "Wildtype" will not be loaded in cBioPortal.
