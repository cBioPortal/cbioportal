...
public class GetProteinArrayData {
    ...
    public static Map<String, ProteinArrayInfo> getProteinArrayInfo(
        ...
        if (geneList == null) {
            ...
            pais =
                daoPAI.getProteinArrayInfoForEntrezIds(
                    cancerStudyId,
                    entrezIds,
                    types
                );
     ...
     */
    public static Map<String, Map<String, Double>> getProteinArrayData(
        int cancerStudyId,
        Collection<String> proteinArrayIds,
        ...
        List<Integer> internalSampleIds = InternalIdUtil.getInternalSampleIds(
            cancerStudyId,
            new ArrayList<String>(sampleIds)
        );

        List<ProteinArrayData> pads = DaoProteinArrayData
            .getInstance()
            .getProteinArrayData(
                cancerStudyId,
                proteinArrayIds,
    ...
    public static String getProteinArrayInfo(
        String cancerStudyStableId,
    ...
    public static String getProteinArrayInfo(
        ...
        StringBuilder sb = new StringBuilder(
            "ARRAY_ID\tARRAY_TYPE\tGENE\t" + "RESIDUE\n"
        );
    ...
    public static String getProteinArrayData(
        String cancerStudyStableId,
