...
public class SampleMyBatisRepositoryTest {
    ...
    public void getAllSamplesInStudyIdProjection() throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesInStudy(
            "study_tcga_pub",
            "ID",
            null,
            null,
    ...
    public void getAllSamplesInStudySummaryProjection() throws Exception {
        ...
        Assert.assertEquals("TCGA-A1-A0SB-01", sample.getStableId());
        Assert.assertEquals(
            Sample.SampleType.PRIMARY_SOLID_TUMOR,
    ...
    @Test
    public void getAllSamplesInStudySummaryProjection1PageSize()
        throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    @Test
    public void getAllSamplesInStudySummaryProjectionStableIdSort()
        throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    public void getMetaSamplesInStudy() throws Exception {
        BaseMeta result = sampleMyBatisRepository.getMetaSamplesInStudy(
            "study_tcga_pub"
        );
    ...
    public void getSampleInStudyNullResult() throws Exception {
        Sample result = sampleMyBatisRepository.getSampleInStudy(
            "study_tcga_pub",
            "invalid_sample"
        );
    ...
    public void getSampleInStudy() throws Exception {
        Sample sample = sampleMyBatisRepository.getSampleInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SI-01"
        );
    ...
    public void getAllSamplesOfPatientInStudyIdProjection() throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB",
            "ID",
            null,
    ...
    @Test
    public void getAllSamplesOfPatientInStudySummaryProjection1PageSize()
        throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB",
    ...
    @Test
    public void getAllSamplesOfPatientInStudySummaryProjectionStableIdSort()
        throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB",
    ...
    public void getMetaSamplesOfPatientInStudy() throws Exception {
        BaseMeta result = sampleMyBatisRepository.getMetaSamplesOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB"
        );
    ...
    public void getAllSamplesOfPatientsInStudy() throws Exception {
        List<Sample> result = sampleMyBatisRepository.getAllSamplesOfPatientsInStudy(
            "study_tcga_pub",
            Arrays.asList("TCGA-A1-A0SB", "TCGA-A1-A0SE"),
            "SUMMARY"
        );
    ...
    public void fetchSamples() throws Exception {
        ...
        List<Sample> result = sampleMyBatisRepository.fetchSamples(
            studyIds,
            sampleIds,
            "SUMMARY"
        );
    ...
    public void fetchMetaSamples() throws Exception {
        ...
        BaseMeta result = sampleMyBatisRepository.fetchMetaSamples(
            studyIds,
            sampleIds
        );
    ...
    public void getSamplesByInternalIds() throws Exception {
        List<Sample> result = sampleMyBatisRepository.getSamplesByInternalIds(
            Arrays.asList(1, 2)
        );
    ...
    public void getSamplesByKeywordFilterByStudies() {
        List<Sample> result = sampleMyBatisRepository.getAllSamples(
            "TCGA-A1",
            Collections.singletonList("acc_tcga"),
            "SUMMARY",
            10,
            0,
            null,
    ...
    public void getMetaSamplesByKeyword() {
        BaseMeta actual = sampleMyBatisRepository.getMetaSamples(
            "TCGA-A1-A0SB",
            null
        );
        Integer expected = 3;
