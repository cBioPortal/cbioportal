...
./importProfileData.pl --data $CGDS_DATA_HOME/coadread/data_log2CNA.txt --meta $CGDS_DATA_HOME/coadread/meta_log2CNA.txt --dbmsAction clobber

# Load mRNA and RNA-Seq Data
...
./importProfileData.pl --data $CGDS_DATA_HOME/coadread/data_RNA_Seq_expression_median.txt --meta $CGDS_DATA_HOME/coadread/meta_RNA_Seq_expression_median.txt --dbmsAction clobber
./importProfileData.pl --data $CGDS_DATA_HOME/coadread/data_RNA_Seq_mRNA_median_Zscores.txt --meta $CGDS_DATA_HOME/coadread/meta_RNA_Seq_mRNA_median_Zscores.txt --dbmsAction clobber
