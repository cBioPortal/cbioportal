...
public class MolecularProfileServiceImpl implements MolecularProfileService {
    ...
    public List<MolecularProfile> getAllMolecularProfiles(
        ...
        List<MolecularProfile> molecularProfiles = molecularProfileRepository.getAllMolecularProfiles(
            projection,
            pageSize,
            pageNumber,
            sortBy,
    ...
    public MolecularProfile getMolecularProfile(String molecularProfileId)
        ...
        MolecularProfile molecularProfile = molecularProfileRepository.getMolecularProfile(
            molecularProfileId
        );
    ...
    public List<MolecularProfile> getMolecularProfiles(
        ...
        return molecularProfileRepository.getMolecularProfiles(
            molecularProfileIds,
            projection
        );
    }
    ...
    public BaseMeta getMetaMolecularProfilesInStudy(String studyId)
        ...
        return molecularProfileRepository.getMetaMolecularProfilesInStudy(
            studyId
        );
    }
    ...
    public List<MolecularProfile> getMolecularProfilesInStudies(
        ...
        return molecularProfileRepository.getMolecularProfilesInStudies(
            studyIds,
            projection
        );
    }
    ...
    public BaseMeta getMetaMolecularProfilesInStudies(List<String> studyIds) {
        return molecularProfileRepository.getMetaMolecularProfilesInStudies(
            studyIds
        );
    }

    @Override
    public List<MolecularProfile> getMolecularProfilesReferredBy(
        ...
        return molecularProfileRepository.getMolecularProfilesReferredBy(
            referringMolecularProfileId
        );
    }

    @Override
    public List<MolecularProfile> getMolecularProfilesReferringTo(
        String referredMolecularProfileId
    )
        throws MolecularProfileNotFoundException {
        //validate (throws exception if profile not found):
        this.getMolecularProfile(referredMolecularProfileId);
        return molecularProfileRepository.getMolecularProfilesReferringTo(
            referredMolecularProfileId
        );
    }

    @Override
    public List<String> getFirstMutationProfileIds(
        List<String> studyIds,
        List<String> sampleIds
    ) {
        List<String> molecularProfileIds = new ArrayList<>();
        Map<String, List<MolecularProfile>> mapByStudyId = getMolecularProfilesInStudies(
                studyIds,
                "SUMMARY"
            )
            .stream()
    ...
    @Override
    public List<String> getFirstDiscreteCNAProfileIds(
        List<String> studyIds,
        List<String> sampleIds
    ) {
        List<String> molecularProfileIds = new ArrayList<>();
