...
@Repository
public class MolecularProfileMyBatisRepository
    implements MolecularProfileRepository {
    @Autowired
    ...
    public List<MolecularProfile> getAllMolecularProfiles(
        ...
        return molecularProfileMapper.getAllMolecularProfilesInStudies(
            null,
            projection,
            pageSize,
    ...
    public MolecularProfile getMolecularProfile(String molecularProfileId) {
        return molecularProfileMapper.getMolecularProfile(
            molecularProfileId,
    ...
    public List<MolecularProfile> getMolecularProfiles(
        ...
        return molecularProfileMapper.getMolecularProfiles(
            molecularProfileIds,
            projection
        );
    }
    ...
    public BaseMeta getMetaMolecularProfiles(List<String> molecularProfileIds) {
        return molecularProfileMapper.getMetaMolecularProfiles(
            molecularProfileIds
        );
    }
    ...
    public BaseMeta getMetaMolecularProfilesInStudy(String studyId) {
        return molecularProfileMapper.getMetaMolecularProfilesInStudies(
            Arrays.asList(studyId)
        );
    }
    ...
    public List<MolecularProfile> getMolecularProfilesReferredBy(
        ...
        return molecularProfileMapper.getMolecularProfilesReferredBy(
    ...
    public List<MolecularProfile> getMolecularProfilesReferringTo(
        ...
        return molecularProfileMapper.getMolecularProfilesReferringTo(
