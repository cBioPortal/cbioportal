...
CREATE TABLE `cancer_study` (
  ...
  UNIQUE `IDX_CANCER_STUDY_CANCER_STUDY_IDENTIFIER` (`CANCER_STUDY_IDENTIFIER`),
  CONSTRAINT `IDX_CANCER_STUDY_TYPE_OF_CANCER_ID` FOREIGN KEY (`TYPE_OF_CANCER_ID`) REFERENCES `type_of_cancer` (`TYPE_OF_CANCER_ID`)
);
...
CREATE TABLE `patient` (
  ...
  CONSTRAINT `IDX_PATIENT_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `sample` (
  ...
  `TYPE_OF_CANCER_ID` varchar(63) NOT NULL,
  PRIMARY KEY (`INTERNAL_ID`),
  CONSTRAINT `IDX_SAMPLE_PATIENT_ID` FOREIGN KEY (`PATIENT_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_SAMPLE_TYPE_OF_CANCER_ID` FOREIGN KEY (`TYPE_OF_CANCER_ID`) REFERENCES `type_of_cancer` (`TYPE_OF_CANCER_ID`)
);
...
CREATE TABLE `sample_list` (
  ...
  PRIMARY KEY (`LIST_ID`),
  UNIQUE `IDX_SAMPLE_LIST_STABLE_ID` (`STABLE_ID`),
  CONSTRAINT `IDX_SAMPLE_LIST_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `sample_list_list` (
  ...
  CONSTRAINT `IDX_SAMPLE_LIST_LIST_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `gene` (
  ...
  `GENETIC_ENTITY_ID` int(11) NOT NULL UNIQUE,
  `TYPE` varchar(50),
  `CYTOBAND` varchar(64),
  `LENGTH` int(11),
  PRIMARY KEY (`ENTREZ_GENE_ID`),
  KEY `IDX_GENE_HUGO_GENE_SYMBOL` (`HUGO_GENE_SYMBOL`),
  CONSTRAINT `IDX_GENE_GENETIC_ENTITY_ID` FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`) ON DELETE CASCADE
);
...
CREATE TABLE `gene_alias` (
  ...
  CONSTRAINT `IDX_GENE_ALIAS_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
);
...
CREATE TABLE `geneset` (
  ...
  `REF_LINK` TEXT,
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `IDX_GENESET_NAME` (`NAME` ASC),
  UNIQUE INDEX `IDX_GENESET_EXTERNAL_ID` (`EXTERNAL_ID` ASC),
  CONSTRAINT `IDX_GENESET_GENETIC_ENTITY_ID` FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`) ON DELETE CASCADE
);
...
CREATE TABLE `geneset_gene` (
  ...
  CONSTRAINT `IDX_GENESET_GENE_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_GENESET_GENE_GENESET_ID` FOREIGN KEY (`GENESET_ID`) REFERENCES `geneset` (`ID`) ON DELETE CASCADE
);
...
CREATE TABLE `geneset_hierarchy_node` (
  ...
  PRIMARY KEY (`NODE_ID`),
  UNIQUE INDEX `IDX_GENESET_HIERARCHY_NODE_NODE_NAME` (`NODE_NAME` ASC, `PARENT_ID` ASC)
);
...
CREATE TABLE `geneset_hierarchy_leaf` (
  ...
  CONSTRAINT `IDX_GENESET_HIERARCHY_LEAF_NODE_ID` FOREIGN KEY (`NODE_ID`) REFERENCES `geneset_hierarchy_node` (`NODE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_GENESET_HIERARCHY_LEAF_GENESET_ID` FOREIGN KEY (`GENESET_ID`) REFERENCES `geneset` (`ID`) ON DELETE CASCADE
);
...
CREATE TABLE `uniprot_id_mapping` (
  ...
  KEY `IDX_UNIPROT_ID_MAPPING_UNIPROT_ID` (`UNIPROT_ID`),
  Key `IDX_UNIPROT_ID_MAPPING_UNIPROT_ACC` (`UNIPROT_ACC`),
  CONSTRAINT `IDX_UNIPROT_ID_MAPPING_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
);
...
CREATE TABLE `reference_genome` (
    ...
    UNIQUE INDEX `IDX_REFERENCE_GENOME_BUILD_NAME` (`BUILD_NAME` ASC)
);
...
CREATE TABLE `genetic_profile` (
  ...
  UNIQUE `IDX_GENETIC_PROFILE_STABLE_ID` (`STABLE_ID`),
  CONSTRAINT `IDX_GENETIC_PROFILE_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `genetic_profile_link` (
  ...
  CONSTRAINT `IDX_GENETIC_PROFILE_LINK_REFERRING_GENETIC_PROFILE_ID` FOREIGN KEY (`REFERRING_GENETIC_PROFILE_ID` ) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_GENETIC_PROFILE_LINK_REFERRED_GENETIC_PROFILE_ID` FOREIGN KEY (`REFERRED_GENETIC_PROFILE_ID` ) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE `genetic_alteration` (
  ...
  CONSTRAINT `IDX_GENETIC_ALTERATION_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_GENETIC_ALTERATION_GENETIC_ENTITY_ID` FOREIGN KEY (`GENETIC_ENTITY_ID`) REFERENCES `genetic_entity` (`ID`)
);

-- --------------------------------------------------------
CREATE TABLE `genetic_profile_samples` (
  `GENETIC_PROFILE_ID` int(11) NOT NULL UNIQUE,
  `ORDERED_SAMPLE_LIST` longtext NOT NULL,
  CONSTRAINT `IDX_GENETIC_PROFILE_SAMPLES_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `gene_panel` (
  ...
  `DESCRIPTION` mediumtext,
  PRIMARY KEY (`INTERNAL_ID`),
  UNIQUE `IDX_GENE_PANEL_STABLE_ID` (`STABLE_ID`)
);
...
CREATE TABLE `gene_panel_list` (
  ...
  CONSTRAINT `IDX_GENE_PANEL_LIST_INTERNAL_ID` FOREIGN KEY (`INTERNAL_ID`) REFERENCES `gene_panel` (`INTERNAL_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_GENE_PANEL_LIST_GENE_ID` FOREIGN KEY (`GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `sample_profile` (
  ...
  UNIQUE KEY `IDX_SAMPLE_PROFILE_SAMPLE_ID_GENETIC_PROFILE_ID` (`SAMPLE_ID`,`GENETIC_PROFILE_ID`), -- Constraint to allow each sample only once in each profile
  CONSTRAINT `IDX_SAMPLE_PROFILE_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_SAMPLE_PROFILE_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_SAMPLE_PROFILE_PANEL_ID` FOREIGN KEY (`PANEL_ID`) REFERENCES `gene_panel` (`INTERNAL_ID`) ON DELETE RESTRICT
);
...
CREATE TABLE `structural_variant` (
  ...
  `GENETIC_PROFILE_ID` int(11) NOT NULL,
  PRIMARY KEY (`INTERNAL_ID`),
  CONSTRAINT `IDX_STRUCTURAL_VARIANT_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_STRUCTURAL_VARIANT_SITE1_ENTREZ_GENE_ID` FOREIGN KEY (`SITE1_ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_STRUCTURAL_VARIANT_SITE2_ENTREZ_GENE_ID` FOREIGN KEY (`SITE2_ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_STRUCTURAL_VARIANT_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `mutation_event` (
  ...
  KEY `IDX_MUTATION_EVENT_KEYWORD` (`KEYWORD`),
  PRIMARY KEY (`MUTATION_EVENT_ID`),
  UNIQUE `IDX_MUTATION_EVENT_UNIQUE` (`CHR`, `START_POSITION`, `END_POSITION`, `TUMOR_SEQ_ALLELE`, `ENTREZ_GENE_ID`, `PROTEIN_CHANGE`, `MUTATION_TYPE`),
  CONSTRAINT `IDX_MUTATION_EVENT_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
...
CREATE TABLE `mutation` (
  ...
  UNIQUE KEY `IDX_MUTATION_UNIQUE` (`MUTATION_EVENT_ID`,`GENETIC_PROFILE_ID`,`SAMPLE_ID`), -- Constraint to block duplicated mutation entries
  KEY `IDX_MUTATION_GENETIC_PROFILE_ID_ENTREZ_GENE_ID` (`GENETIC_PROFILE_ID`,`ENTREZ_GENE_ID`),
  KEY `IDX_MUTATION_GENETIC_PROFILE_ID_SAMPLE_ID` (`GENETIC_PROFILE_ID`,`SAMPLE_ID`),
  CONSTRAINT `IDX_MUTATION_MUTATION_EVENT_ID` FOREIGN KEY (`MUTATION_EVENT_ID`) REFERENCES `mutation_event` (`MUTATION_EVENT_ID`),
  CONSTRAINT `IDX_MUTATION_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`),
  CONSTRAINT `IDX_MUTATION_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_MUTATION_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
...
CREATE TABLE `mutation_count_by_keyword` (
    ...
    KEY `IDX_MUTATION_COUNT_BY_KEYWORD_GENETIC_PROFILE_ID_KEYWORD` (`GENETIC_PROFILE_ID`,`KEYWORD`),
    CONSTRAINT `IDX_MUTATION_COUNT_BY_KEYWORD_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE,
    CONSTRAINT `IDX_MUTATION_COUNT_BY_KEYWORD_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `clinical_patient` (
  ...
  CONSTRAINT `IDX_CLINICAL_PATIENT_INTERNAL_ID` FOREIGN KEY (`INTERNAL_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `clinical_sample` (
  ...
  `ATTR_VALUE` varchar(255) NOT NULL,
  PRIMARY KEY (`INTERNAL_ID`,`ATTR_ID`),
  CONSTRAINT `IDX_CLINICAL_SAMPLE_INTERNAL_ID` FOREIGN KEY (`INTERNAL_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `clinical_attribute_meta` (
  ...
  CONSTRAINT `IDX_CLINICAL_ATTRIBUTE_META_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `mut_sig` (
  ...
  CONSTRAINT `IDX_MUT_SIG_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_MUT_SIG_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
);
...
CREATE TABLE `protein_array_target` (
  ...
  CONSTRAINT `IDX_PROTEIN_ARRAY_TARGET_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`),
  CONSTRAINT `IDX_PROTEIN_ARRAY_TARGET_PROTEIN_ARRAY_ID` FOREIGN KEY (`PROTEIN_ARRAY_ID`) REFERENCES `protein_array_info` (`PROTEIN_ARRAY_ID`)
);
...
CREATE TABLE `protein_array_data` (
  ...
  CONSTRAINT `IDX_PROTEIN_ARRAY_DATA_PROTEIN_ARRAY_ID` FOREIGN KEY (`PROTEIN_ARRAY_ID`) REFERENCES `protein_array_info` (`PROTEIN_ARRAY_ID`),
  CONSTRAINT `IDX_PROTEIN_ARRAY_DATA_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_PROTEIN_ARRAY_DATA_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `protein_array_cancer_study` (
  ...
  CONSTRAINT `IDX_PROTEIN_ARRAY_CANCER_STUDY_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `sanger_cancer_census` (
  ...
  CONSTRAINT `IDX_SANGER_CANCER_CENSUS_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
...
CREATE TABLE `gistic` (
  ...
  CONSTRAINT `IDX_GISTIC_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `gistic_to_gene` (
  ...
  CONSTRAINT `IDX_GISTIC_TO_GENE_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`),
  CONSTRAINT `IDX_GISTIC_TO_GENE_GISTIC_ROI_ID` FOREIGN KEY (`GISTIC_ROI_ID`) REFERENCES `gistic` (`GISTIC_ROI_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `drug` (
  ...
  PRIMARY KEY (`DRUG_ID`),
  KEY `IDX_DRUG_DRUG_NAME` (`DRUG_NAME`)
);
...
CREATE TABLE `drug_interaction` (
  ...
  CONSTRAINT `IDX_DRUG_INTERACTION_DRUG` FOREIGN KEY (`DRUG`) REFERENCES `drug` (`DRUG_ID`)
);
...
CREATE TABLE `cna_event` (
  ...
  UNIQUE `IDX_CNA_EVENT_ENTREZ_GENE_ID_ALTERATION` (`ENTREZ_GENE_ID`, `ALTERATION`),
  CONSTRAINT `IDX_CNA_EVENT_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
);
...
CREATE TABLE `sample_cna_event` (
  ...
  `SAMPLE_ID` int(11) NOT NULL,
  `GENETIC_PROFILE_ID` int(11) NOT NULL,
  KEY `IDX_SAMPLE_CNA_EVENT_GENETIC_PROFILE_ID_SAMPLE_ID` (`GENETIC_PROFILE_ID`,`SAMPLE_ID`),
  PRIMARY KEY (`CNA_EVENT_ID`, `SAMPLE_ID`, `GENETIC_PROFILE_ID`),
  CONSTRAINT `IDX_SAMPLE_CNA_EVENT_CNA_EVENT_ID` FOREIGN KEY (`CNA_EVENT_ID`) REFERENCES `cna_event` (`CNA_EVENT_ID`),
  CONSTRAINT `IDX_SAMPLE_CNA_EVENT_GENETIC_PROFILE_ID` FOREIGN KEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_SAMPLE_CNA_EVENT_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `copy_number_seg` (
  ...
  KEY `IDX_COPY_NUMBER_SEG_CANCER_STUDY_ID_SAMPLE_ID` (`CANCER_STUDY_ID`,`SAMPLE_ID`),
  PRIMARY KEY (`SEG_ID`),
  CONSTRAINT `IDX_COPY_NUMBER_SEG_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE,
  CONSTRAINT `IDX_COPY_NUMBER_SEG_SAMPLE_ID` FOREIGN KEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `copy_number_seg_file` (
  ...
  CONSTRAINT `IDX_COPY_NUMBER_SEG_FILE_CANCER_STUDY_ID` FOREIGN KEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `cosmic_mutation` (
  ...
  `KEYWORD` varchar(50) DEFAULT NULL,
  KEY `IDX_COSMIC_MUTATION_KEYWORD` (`KEYWORD`),
  PRIMARY KEY (`COSMIC_MUTATION_ID`),
  CONSTRAINT `IDX_COSMIC_MUTATION_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`)
);
...
CREATE TABLE `pdb_uniprot_alignment` (
  ...
  KEY `IDX_PDB_UNIPROT_ALIGNMENT_UNIPROT_ID` (`UNIPROT_ID`),
  KEY `IDX_PDB_UNIPROT_ALIGNMENT_PDB_ID_CHAIN` (`PDB_ID`, `CHAIN`)
);
...
CREATE TABLE `pdb_uniprot_residue_mapping` (
  ...
  `MATCH` char(1),
  KEY `IDX_PDB_UNIPROT_RESIDUE_MAPPING_ALIGNMENT_ID_UNIPROT_POSITION` (`ALIGNMENT_ID`, `UNIPROT_POSITION`),
  CONSTRAINT `IDX_PDB_UNIPROT_RESIDUE_MAPPING_ALIGNMENT_ID` FOREIGN KEY (`ALIGNMENT_ID`) REFERENCES `pdb_uniprot_alignment` (`ALIGNMENT_ID`)
);
...
CREATE TABLE `clinical_event` (
  ...
  KEY `IDX_CLINICAL_EVENT_PATIENT_ID_EVENT_TYPE` (`PATIENT_ID`, `EVENT_TYPE`),
  CONSTRAINT `IDX_CLINICAL_EVENT_PATIENT_ID` FOREIGN KEY (`PATIENT_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `clinical_event_data` (
  ...
  CONSTRAINT `IDX_CLINICAL_EVENT_DATA_CLINICAL_EVENT_ID` FOREIGN KEY (`CLINICAL_EVENT_ID`) REFERENCES `clinical_event` (`CLINICAL_EVENT_ID`) ON DELETE CASCADE
);
...
CREATE TABLE `reference_genome_gene` (
    ...
    CONSTRAINT `IDX_REFERENCE_GENOME_GENE_REFERENCE_GENOME_ID` FOREIGN KEY (`REFERENCE_GENOME_ID`) REFERENCES `reference_genome` (`REFERENCE_GENOME_ID`) ON DELETE CASCADE,
    CONSTRAINT `IDX_REFERENCE_GENOME_GENE_ENTREZ_GENE_ID` FOREIGN KEY (`ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE
);
