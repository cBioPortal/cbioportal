...
/**
 * This service class is converted from a servlet, see the information below:
 *
 *      A servlet designed to retrieve mutation data for a single mutation details table.
 *      This servlet returns a JSON object.
 *      @link MutationTableDataServlet
 *
 * @author Selcuk Onur Sumer
 * @author Arman
 */
public class MutationTableProcessor {
    private static final Logger logger = Logger.getLogger(MutationTableProcessor.class);
    private final ObjectMapper objectMapper;

    public MutationTableProcessor()
    {
        this.objectMapper = new ObjectMapper();
        this.objectMapper.configure(ACCEPT_SINGLE_VALUE_AS_ARRAY, true);
    }

    public String processMutationTable(String geneSymbol, List<ExtendedMutation> mutations)
    {
