 ...
 * against {@code cancer_study} and {@code embedding_definition}, so studies or embeddings without
 * a matching row in either table are silently excluded from the result rather than erroring.
 */
