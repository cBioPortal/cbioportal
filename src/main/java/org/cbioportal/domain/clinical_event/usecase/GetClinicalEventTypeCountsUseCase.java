...
@Profile("clickhouse")
/**
 * Use case for retrieving counts of different clinical event types.
 * This class interacts with the {@link ClinicalEventRepository} to fetch the required data.
 */
public class GetClinicalEventTypeCountsUseCase {
    ...
    /**
     * Executes the use case to retrieve counts of different clinical event types based on the study view filter context.
     *
