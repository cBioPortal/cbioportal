...
import org.cbioportal.infrastructure.repository.AbstractTestcontainers;
import org.cbioportal.infrastructure.repository.config.MyBatisConfig;
...
public class ClinicalEventMapperTest {
    private static final String STUDY_TCGA_PUB = "study_tcga_pub";

    @Autowired
    private V2ClinicalEventMapper mapper;
