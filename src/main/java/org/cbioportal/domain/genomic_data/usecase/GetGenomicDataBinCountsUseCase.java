...
@Profile("clickhouse")
/**
 * Use case for retrieving genomic data bin counts from the repository.
 * This class encapsulates the business logic for fetching genomic data
 * bin counts based on the provided study view filter context and genomic data filters.
 */
