...
public record WsiTileMetadata(
    ...
    String vendor,
    @JsonProperty("safe_min_level") @JsonInclude(JsonInclude.Include.NON_NULL) Integer safeMinLevel,
    @JsonProperty("tile_metadata_schema_version") @JsonInclude(JsonInclude.Include.NON_NULL)
        Integer tileMetadataSchemaVersion,
    @JsonProperty("decode_policy_version") @JsonInclude(JsonInclude.Include.NON_NULL)
        String decodePolicyVersion,
    @JsonProperty("max_decode_pixels") @JsonInclude(JsonInclude.Include.NON_NULL)
        Integer maxDecodePixels,
    @JsonProperty("thumbnail_max_decode_pixels") @JsonInclude(JsonInclude.Include.NON_NULL)
