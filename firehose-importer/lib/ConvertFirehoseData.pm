...
sub create_case_lists{
    ...
    my $case_list_FileProperties = {
        ...
        'cases_RNA_Seq_mRNA.txt' => {
            'FirehoseFile'          => '<CANCER>.rnaseq__illuminahiseq_rnaseq__unc_edu__Level_3__gene_expression__data.data.txt',
            'xformFunc'               => undef,
	...
	my $rnaSEQSource = '<CANCER>.rnaseq__illuminahiseq_rnaseq__unc_edu__Level_3__gene_expression__data.data.txt';
	...
	if ( defined( $fromStagingFiles)) {
	  ...
	  my $rnaSeqExpressionFile = getLastestVersionOfFile( $CancersFirehoseDataDir, "gdac.broadinstitute.org_<CANCER>.Merge_rnaseq__illuminahiseq_rnaseq__unc_edu__Level_3__gene_expression__data.Level_3.<date><version>", "<CANCER>.rnaseq__illuminahiseq_rnaseq__unc_edu__Level_3__gene_expression__data.data.txt", $cancer, $runDate );
	  if ( defined( $rnaSeqExpressionFile ) ) {
		$mrnaSource = "<CANCER>.rnaseq__illuminahiseq_rnaseq__unc_edu__Level_3__gene_expression__data.data.txt";
	  }
	}
