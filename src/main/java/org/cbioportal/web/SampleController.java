...
public class SampleController {
  ...
  public ResponseEntity<List<Sample>> getSamplesByKeyword(
    ...
    return new ResponseEntity<>(
        sampleService.getAllSamples(
            keyword, studyIds, projection.name(), pageSize, pageNumber, sort, direction.name()),
        HttpStatus.OK);
  }
  ...
  public ResponseEntity<List<Sample>> getAllSamplesInStudy(
    ...
    if (projection == Projection.META) {
      ...
      responseHeaders.add(
          HeaderKeyConstants.TOTAL_COUNT,
          sampleService.getMetaSamplesInStudy(studyId).getTotalCount().toString());
      ...
      if (interceptedSampleFilter.getSampleListIds() != null) {
        ...
        if (interceptedSampleFilter.getSampleIdentifiers() != null) {
          ...
          uniqueKeyExtractor.extractUniqueKeys(
              interceptedSampleFilter.getUniqueSampleKeys(), studyIds, sampleIds);
        }
  ...
  private void extractStudyAndSampleIds(
      SampleFilter sampleFilter, List<String> studyIds, List<String> sampleIds) {
