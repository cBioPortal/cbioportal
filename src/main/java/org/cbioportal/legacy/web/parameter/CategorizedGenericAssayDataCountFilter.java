...
public final class CategorizedGenericAssayDataCountFilter {
  ...
  private CategorizedGenericAssayDataCountFilter(Builder builder) {
    this.sampleCategoricalGenericAssayDataFilters =
        builder.sampleCategoricalGenericAssayDataFilters;
    this.sampleNumericalGenericAssayDataFilters = builder.sampleNumericalGenericAssayDataFilters;
    this.patientCategoricalGenericAssayDataFilters =
        builder.patientCategoricalGenericAssayDataFilters;
  ...
  public static class Builder {
      ...
      if (genericAssayProfilesMap.containsKey(DataSource.SAMPLE)) {
        List<String> sampleNumericalProfileTypes =
            genericAssayProfilesMap.get(DataSource.SAMPLE).stream()
                ...
                .toList();
        sampleNumericalGenericAssayDataFilters =
            studyViewFilter.getGenericAssayDataFilters().stream()
                .filter(
                    genericAssayDataFilter ->
                        sampleNumericalProfileTypes.contains(
            ...
            genericAssayProfilesMap.get(DataSource.PATIENT).stream()
                ...
                .map(
                    profile ->
                        profile.getStableId().replace(profile.getCancerStudyIdentifier() + "_", ""))
                .toList();
        patientCategoricalGenericAssayDataFilters =
            studyViewFilter.getGenericAssayDataFilters().stream()
                .filter(
                    genericAssayDataFilter ->
    ...
    public Builder setSampleCategoricalGenericAssayDataFilters(
        List<GenericAssayDataFilter> sampleCategoricalGenericAssayDataFilters) {
      this.sampleCategoricalGenericAssayDataFilters = sampleCategoricalGenericAssayDataFilters;
      return this;
    }

    public Builder setSampleNumericalGenericAssayDataFilters(
        List<GenericAssayDataFilter> sampleNumericalGenericAssayDataFilters) {
      this.sampleNumericalGenericAssayDataFilters = sampleNumericalGenericAssayDataFilters;
      return this;
    }

    public Builder setPatientCategoricalGenericAssayDataFilters(
        List<GenericAssayDataFilter> patientCategoricalGenericAssayDataFilters) {
      this.patientCategoricalGenericAssayDataFilters = patientCategoricalGenericAssayDataFilters;
      return this;
    }

    public Builder setPatientNumericalGenericAssayDataFilters(
        List<GenericAssayDataFilter> patientNumericalGenericAssayDataFilters) {
