...
public class CopyNumberSegmentServiceImplTest extends BaseServiceImplTest {
    ...
    public void getCopyNumberSegmentsInSampleInStudySampleNotFound()
        throws Exception {
        Mockito
    ...
    public void getMetaCopyNumberSegmentsInSampleInStudy() throws Exception {
        ...
        BaseMeta result = copyNumberSegmentService.getMetaCopyNumberSegmentsInSampleInStudy(
            STUDY_ID,
            SAMPLE_ID1,
            null
        );
    ...
    @Test(expected = SampleNotFoundException.class)
    public void getMetaCopyNumberSegmentsInSampleInStudySampleNotFound()
        throws Exception {
        Mockito
            .when(sampleService.getSampleInStudy(STUDY_ID, SAMPLE_ID1))
            .thenThrow(new SampleNotFoundException(STUDY_ID, SAMPLE_ID1));
    ...
    public void fetchCopyNumberSegments() throws Exception {
        ...
        List<CopyNumberSeg> result = copyNumberSegmentService.fetchCopyNumberSegments(
            Arrays.asList(STUDY_ID),
            Arrays.asList(PATIENT_ID_1),
            null,
            PROJECTION
    ...
    public void fetchMetaCopyNumberSegments() throws Exception {
        ...
        Mockito
            ...
            .thenReturn(expectedBaseMeta);
        BaseMeta result = copyNumberSegmentService.fetchMetaCopyNumberSegments(
            Arrays.asList(STUDY_ID),
            Arrays.asList(PATIENT_ID_1),
            null
        );
    ...
    public void getCopyNumberSegmentsBySampleListId() throws Exception {
        ...
        List<CopyNumberSeg> result = copyNumberSegmentService.getCopyNumberSegmentsBySampleListId(
            STUDY_ID,
            SAMPLE_LIST_ID,
            null,
            PROJECTION
