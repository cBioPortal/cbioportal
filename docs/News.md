## Dec 12, 2019
* **Enhancement**: Add Count Bubbles to Oncoprint Toolbar _Results View_ page
...
* **Enhancement**: Several enhancements to the display of gene panels in _Patient View_ page, related to [the Hyve's](https://thehyve.nl/) feature proposal [Request For Comments #45](https://docs.google.com/document/d/1X7dA_wJFtv5xJO1oHCSt8DUdTmk07RexvHUpjCJsSM4/edit#heading=h.t10nr9te3qvu)
