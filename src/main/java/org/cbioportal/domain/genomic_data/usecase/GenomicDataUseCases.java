 ...
 * and manage them.
 *
 * @param getCNACountsByGeneSpecificUseCase the use case for retrieving CNA counts by gene-specific
 *     data.
 * @param getGenomicDataBinCountsUseCase the use case for retrieving genomic data bin counts.
 * @param getMolecularProfileSampleCountsUseCase the use case for retrieving molecular profile
 *     sample counts.
