                ...
                <thead>
                    <tr valign="bottom">
                        ...
                        <th class="mut-header" alt="Variant allele read count in the tumor sample"><b>Variant Reads (T)</b></th>
                        <th class="mut-header" alt="Reference allele read count in the tumor sample"><b>Ref Reads (T)</b></th>
                        ...
                        <th class="mut-header" alt="Percentile of mRNA expression of the mutated gene in this tumor comparing to the cohort"><b>mRNA PCTL</b></th>
