...
@JsonPropertyOrder(
    { "darwinAuthResponse", "p_userName", "p_dmp_pid", "deidentification_id" }
)
public class CheckDarwinAccessServlet extends HttpServlet {
    private static Logger logger = Logger.getLogger(
        CheckDarwinAccessServlet.class
    );
    ...
    public static class CheckDarwinAccess {
        ...
        public static Pattern sampleIdRegex = Pattern.compile(
            GlobalProperties.getDarwinRegex()
        );
        ...
        public static String checkAccess(HttpServletRequest request) {
            ...
            String userName = GlobalProperties
            ...
            try {
                String[] sampleIds = request
                    ...
                    .split(",");
                if (
                    sampleIdRegex.matcher(sampleIds[0]).find() &&
                    !cisUser.equals(userName)
                ) {
        ...
        public static String getResponse(String userName, String patientId) {
            ...
            ResponseEntity<DarwinAccess> responseEntity = restTemplate.exchange(
                darwinAuthUrl,
                HttpMethod.POST,
                requestEntity,
                DarwinAccess.class
            );
            String darwinResponse = responseEntity
                .getBody()
                .getDarwinAuthResponse();
            String deidentificationId = responseEntity
                .getBody()
                .getDeidentification_Id();
        ...
        private static HttpEntity<LinkedMultiValueMap<String, Object>> getRequestEntity(
            String userName,
            String patientId
        ) {
            ...
            return new HttpEntity<LinkedMultiValueMap<String, Object>>(
                map,
                headers
            );
        }
        ...
        public static boolean existsDarwinProperties() {
            return (
                !darwinAuthUrl.isEmpty() &&
                !ddpResponseUrl.isEmpty() &&
                !cisUser.isEmpty() &&
                !GlobalProperties.getDarwinRegex().isEmpty()
            );
        }
    }
