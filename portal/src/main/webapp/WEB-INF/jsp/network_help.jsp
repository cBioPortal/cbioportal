...
<p class="regular">
	Click <a id="show_gene_legend" onclick="handleMenuEvent('show_gene_legend');">here</a> to see the gene legend.
</p>
...
<p class="regular">
	Click <a id="show_drug_legend" onclick="handleMenuEvent('show_drug_legend');">here</a> to see the drug legend.
</p>
...
<p class="regular">
	Click <a id="show_edge_legend" onclick="handleMenuEvent('show_edge_legend')">here</a> to see the color codes.
</p>
<p class="regular">
