...
public class MutationControllerTest {
    ...
    private static final String TEST_MUTATION_STATUS_1 =
        "test_mutation_status_1";
    private static final String TEST_VALIDATION_STATUS_1 =
        "test_validation_status_1";
    ...
    private static final String TEST_AMINO_ACID_CHANGE_1 =
        "test_amino_acid_change_1";
    private static final long TEST_START_POSITION_1 = 1L;
    private static final long TEST_END_POSITION_1 = 1L;
    private static final String TEST_REFERENCE_ALLELE_1 =
        "test_reference_allele_1";
    private static final String TEST_TUMOR_SEQ_ALLELE_1 =
        "test_tumor_seq_allele_1";
    ...
    private static final String TEST_FUNCTIONAL_IMPACT_SCORE_1 =
        "test_functional_impact_score_1";
    ...
    private static final String TEST_ONCOTATOR_REFSEQ_MRNA_ID_1 =
    ...
    private static final String TEST_MUTATION_STATUS_2 =
        "test_mutation_status_2";
    private static final String TEST_VALIDATION_STATUS_2 =
    ...
    private static final String TEST_AMINO_ACID_CHANGE_2 =
        "test_amino_acid_change_2";
    private static final long TEST_START_POSITION_2 = 2L;
    private static final long TEST_END_POSITION_2 = 2L;
    private static final String TEST_REFERENCE_ALLELE_2 =
        "test_reference_allele_2";
    private static final String TEST_TUMOR_SEQ_ALLELE_2 =
        "test_tumor_seq_allele_2";
    ...
    private static final String TEST_FUNCTIONAL_IMPACT_SCORE_2 =
        "test_functional_impact_score_2";
    ...
    private static final String TEST_ONCOTATOR_REFSEQ_MRNA_ID_2 =
        "test_oncotator_refseq_mrna_id_2";
    ...
    private static final String TEST_DRIVER_FILTER_ANNOTATION_1 =
        "test_driver_filter_annotation_1";
    private static final String TEST_DRIVER_TIERS_FILTER_1 =
    ...
    private static final String TEST_DRIVER_FILTER_ANNOTATION_2 =
        "test_driver_filter_annotation_2";
    private static final String TEST_DRIVER_TIERS_FILTER_2 =
        "test_driver_tiers_filter_2";
    ...
    @Test
    public void getMutationsInMolecularProfileBySampleListIdDefaultProjection()
        throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get(
                        "/molecular-profiles/test_molecular_profile_id/mutations"
                    )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].mutationStatus")
                    .value(TEST_MUTATION_STATUS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].validationStatus")
                    .value(TEST_VALIDATION_STATUS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].tumorAltCount")
                    .value(TEST_TUMOR_ALT_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].tumorRefCount")
                    .value(TEST_TUMOR_REF_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].normalAltCount")
                    .value(TEST_NORMAL_ALT_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].normalRefCount")
                    .value(TEST_NORMAL_REF_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].aminoAcidChange")
                    .value(TEST_AMINO_ACID_CHANGE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].startPosition")
                    .value((int) TEST_START_POSITION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].endPosition")
                    .value((int) TEST_END_POSITION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].referenceAllele")
                    .value(TEST_REFERENCE_ALLELE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].variantAllele")
                    .value(TEST_TUMOR_SEQ_ALLELE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].proteinChange")
                    .value(TEST_PROTEIN_CHANGE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].mutationType")
                    .value(TEST_MUTATION_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].driverFilter")
                    .value(TEST_DRIVER_FILTER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].driverFilterAnnotation")
                    .value(TEST_DRIVER_FILTER_ANNOTATION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].driverTiersFilter")
                    .value(TEST_DRIVER_TIERS_FILTER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].driverTiersFilterAnnotation")
                    .value(TEST_DRIVER_TIERS_FILTER_ANNOTATION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].functionalImpactScore")
                    .value(TEST_FUNCTIONAL_IMPACT_SCORE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].fisValue")
                    .value(TEST_FIS_VALUE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].linkXvar")
                    .value(TEST_LINK_XVAR_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].linkPdb")
                    .value(TEST_LINK_PDB_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].linkMsa")
                    .value(TEST_LINK_MSA_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].ncbiBuild")
                    .value(TEST_NCBI_BUILD_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].variantType")
                    .value(TEST_VARIANT_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].refseqMrnaId")
                    .value(TEST_ONCOTATOR_REFSEQ_MRNA_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].proteinPosStart")
                    .value(TEST_ONCOTATOR_PROTEIN_POS_START_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].proteinPosEnd")
                    .value(TEST_ONCOTATOR_PROTEIN_POS_END_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].keyword")
                    .value(TEST_KEYWORD_1)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].gene").doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].mutationStatus")
                    .value(TEST_MUTATION_STATUS_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].validationStatus")
                    .value(TEST_VALIDATION_STATUS_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].tumorAltCount")
                    .value(TEST_TUMOR_ALT_COUNT_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].tumorRefCount")
                    .value(TEST_TUMOR_REF_COUNT_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].normalAltCount")
                    .value(TEST_NORMAL_ALT_COUNT_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].normalRefCount")
                    .value(TEST_NORMAL_REF_COUNT_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].aminoAcidChange")
                    .value(TEST_AMINO_ACID_CHANGE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].startPosition")
                    .value((int) TEST_START_POSITION_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].endPosition")
                    .value((int) TEST_END_POSITION_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].referenceAllele")
                    .value(TEST_REFERENCE_ALLELE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].variantAllele")
                    .value(TEST_TUMOR_SEQ_ALLELE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].proteinChange")
                    .value(TEST_PROTEIN_CHANGE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].mutationType")
                    .value(TEST_MUTATION_TYPE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].driverFilter")
                    .value(TEST_DRIVER_FILTER_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].driverFilterAnnotation")
                    .value(TEST_DRIVER_FILTER_ANNOTATION_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].driverTiersFilter")
                    .value(TEST_DRIVER_TIERS_FILTER_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].driverTiersFilterAnnotation")
                    .value(TEST_DRIVER_TIERS_FILTER_ANNOTATION_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].functionalImpactScore")
                    .value(TEST_FUNCTIONAL_IMPACT_SCORE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].fisValue")
                    .value(TEST_FIS_VALUE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].linkXvar")
                    .value(TEST_LINK_XVAR_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].linkPdb")
                    .value(TEST_LINK_PDB_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].linkMsa")
                    .value(TEST_LINK_MSA_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].ncbiBuild")
                    .value(TEST_NCBI_BUILD_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].variantType")
                    .value(TEST_VARIANT_TYPE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].refseqMrnaId")
                    .value(TEST_ONCOTATOR_REFSEQ_MRNA_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].proteinPosStart")
                    .value(TEST_ONCOTATOR_PROTEIN_POS_START_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].proteinPosEnd")
                    .value(TEST_ONCOTATOR_PROTEIN_POS_END_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].keyword")
                    .value(TEST_KEYWORD_2)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].gene").doesNotExist()
            );
    }

    @Test
    public void getMutationsInMolecularProfileBySampleListIdDetailedProjection()
        throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].gene.entrezGeneId")
                    .value(TEST_ENTREZ_GENE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].gene.hugoGeneSymbol")
                    .value(TEST_HUGO_GENE_SYMBOL_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].gene.type")
                    .value(TEST_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath(
                        "$[0].alleleSpecificCopyNumber.ascnIntegerCopyNumber"
                    )
                    .value(TEST_ASCN_INTEGER_COPY_NUMBER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.ascnMethod")
                    .value(TEST_ASCN_METHOD_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.ccfMCopiesUpper")
                    .value(TEST_CCF_M_COPIES_UPPER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.ccfMCopies")
                    .value(TEST_CCF_M_COPIES_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.clonal")
                    .value(TEST_CLONAL_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.minorCopyNumber")
                    .value(TEST_MINOR_COPY_NUMBER_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.mutantCopies")
                    .value(TEST_MUTANT_COPIES_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alleleSpecificCopyNumber.totalCopyNumber")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].gene.entrezGeneId")
                    .value(TEST_ENTREZ_GENE_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].gene.hugoGeneSymbol")
                    .value(TEST_HUGO_GENE_SYMBOL_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].gene.type")
                    .value(TEST_TYPE_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath(
                        "$[1].alleleSpecificCopyNumber.ascnIntegerCopyNumber"
                    )
                    .value(TEST_ASCN_INTEGER_COPY_NUMBER_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.ascnMethod")
                    .value(TEST_ASCN_METHOD_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.ccfMCopiesUpper")
                    .value(TEST_CCF_M_COPIES_UPPER_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.ccfMCopies")
                    .value(TEST_CCF_M_COPIES_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.clonal")
                    .value(TEST_CLONAL_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.minorCopyNumber")
                    .value(TEST_MINOR_COPY_NUMBER_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.mutantCopies")
                    .value(TEST_MUTANT_COPIES_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alleleSpecificCopyNumber.totalCopyNumber")
                    .value(TEST_TOTAL_COPY_NUMBER_2)
            );
    }

    @Test
    public void getMutationsInMolecularProfileBySampleListIdMetaProjection()
        throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .header()
                    .string(HeaderKeyConstants.SAMPLE_COUNT, "3")
            );
    }
    ...
    public void fetchMutationsInMultipleMolecularProfiles() throws Exception {
        ...
        sampleMolecularIdentifier1.setMolecularProfileId(
            TEST_MOLECULAR_PROFILE_STABLE_ID_1
        );
        ...
        sampleMolecularIdentifier2.setMolecularProfileId(
            TEST_MOLECULAR_PROFILE_STABLE_ID_2
        );
        ...
        mutationMultipleStudyFilter.setSampleMolecularIdentifiers(
    ...
    @Test
    public void fetchMutationsInMolecularProfileDefaultProjection()
        throws Exception {
        List<Mutation> mutationList = createExampleMutations();
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post(
                        "/molecular-profiles/test_molecular_profile_id/mutations/fetch"
                    )
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void fetchMutationsInMolecularProfileDetailedProjection()
        throws Exception {
        List<Mutation> mutationList = createExampleMutationsWithGeneAndAlleleSpecificCopyNumber();
    ...
    @Test
    public void fetchMutationsInMolecularProfileMetaProjection()
        throws Exception {
        MutationMeta mutationMeta = new MutationMeta();
        mutationMeta.setTotalCount(2);
        mutationMeta.setSampleCount(3);
    ...
    public void fetchMutationCountsByPosition() throws Exception {
        ...
        mutationCountByPosition1.setProteinPosStart(
            TEST_ONCOTATOR_PROTEIN_POS_START_1
        );
        mutationCountByPosition1.setProteinPosEnd(
        ...
        mutationCountByPosition2.setProteinPosStart(
            TEST_ONCOTATOR_PROTEIN_POS_START_2
        );
        mutationCountByPosition2.setProteinPosEnd(
            TEST_ONCOTATOR_PROTEIN_POS_END_2
        );
        ...
        mutationPositionIdentifier1.setProteinPosStart(
            TEST_ONCOTATOR_PROTEIN_POS_START_1
        );
        mutationPositionIdentifier1.setProteinPosEnd(
            TEST_ONCOTATOR_PROTEIN_POS_END_1
        );
        ...
        mutationPositionIdentifier2.setProteinPosStart(
            TEST_ONCOTATOR_PROTEIN_POS_START_2
        );
        mutationPositionIdentifier2.setProteinPosEnd(
            TEST_ONCOTATOR_PROTEIN_POS_END_2
        );
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/mutation-counts-by-position/fetch")
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        objectMapper.writeValueAsString(
    ...
    private List<Mutation> createExampleMutations() {
        ...
        mutation1.setDriverTiersFilterAnnotation(
            TEST_DRIVER_TIERS_FILTER_ANNOTATION_1
        );
        ...
        mutation1.setOncotatorProteinPosStart(
            TEST_ONCOTATOR_PROTEIN_POS_START_1
        );
        ...
        mutation2.setDriverTiersFilterAnnotation(
            TEST_DRIVER_TIERS_FILTER_ANNOTATION_2
        );
        ...
        mutation2.setOncotatorProteinPosStart(
            TEST_ONCOTATOR_PROTEIN_POS_START_2
        );
    ...
    private List<Mutation> createExampleMutationsWithGeneAndAlleleSpecificCopyNumber() {
        ...
        mutationList
            .get(0)
            .setAlleleSpecificCopyNumber(alleleSpecificCopyNumber1);
        Gene gene2 = new Gene();
        ...
        mutationList
            .get(1)
            .setAlleleSpecificCopyNumber(alleleSpecificCopyNumber2);
        return mutationList;
    }
}
