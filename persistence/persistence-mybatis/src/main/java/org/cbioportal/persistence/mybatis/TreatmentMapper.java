...
public interface TreatmentMapper {
    List<Treatment> getAllTreatments(List<String> sampleIds, List<String> studyIds, TreatmentClassificationTier tier);
    ...
    Set<String> getAllUniqueTreatments(List<String> sampleIds, List<String> studyIds, TreatmentClassificationTier tier);
