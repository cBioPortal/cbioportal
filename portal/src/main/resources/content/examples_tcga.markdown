...
<br/><br/>
<a href="index.do?case_set_id=gbm_tcga_sequenced&tab_index=tab_visualize&Action=Submit&genetic_profile_ids=gbm_tcga_mutations&genetic_profile_ids=gbm_tcga_cna_rae&case_ids=&Z_SCORE_THRESHOLD=1.0&cancer_study_id=gbm_tcga&gene_list=TP53+MDM2+MDM4&gene_set_choice=user-defined_list&">TP53 and MDM2/4 alterations in GBM</a>
<br/><br/>
