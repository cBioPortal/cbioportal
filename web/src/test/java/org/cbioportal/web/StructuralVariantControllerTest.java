...
public class StructuralVariantControllerTest {
    private static final String TEST_GENETIC_PROFILE_STABLE_ID_1 =
        "test_genetic_profile_stable_id_1";
    ...
    private static final String TEST_UNIQUE_SAMPLE_KEY_1 =
        "dGVzdF9zYW1wbGVfaWRfMTp0ZXN0X3N0dWR5X2lkXzE";
    // TEST_UNIQUE_PATIENT_KEY_1 decoded: test_patient_id_1:test_study_id_1
    private static final String TEST_UNIQUE_PATIENT_KEY_1 =
        "dGVzdF9wYXRpZW50X2lkXzE6dGVzdF9zdHVkeV9pZF8x";
    private static final Integer TEST_SITE1_ENTREZ_GENE_ID_1 = 1;
    private static final String TEST_SITE1_HUGO_SYMBOL_1 =
        "test_site1_hugo_symbol_1";
    private static final String TEST_SITE1_ENSEMBL_TRANSCRIPT_ID_1 =
        "test_site1_ensembl_transcript_id_1";
    private static final Integer TEST_SITE1_EXON_1 = 1;
    private static final String TEST_SITE1_CHROMOSOME_1 =
        "test_site1_chromosome_1";
    private static final Integer TEST_SITE1_POSITION_1 = 1;
    private static final String TEST_SITE1_DESCRIPTION_1 =
        "test_site1_description_1";
    private static final Integer TEST_SITE2_ENTREZ_GENE_ID_1 = 1;
    private static final String TEST_SITE2_HUGO_SYMBOL_1 =
        "test_site2_hugo_symbol_1";
    private static final String TEST_SITE2_ENSEMBL_TRANSCRIPT_ID_1 =
        "test_site2_ensembl_transcript_id_1";
    private static final Integer TEST_SITE2_EXON_1 = 1;
    private static final String TEST_SITE2_CHROMOSOME_1 =
        "test_site2_chromosome_1";
    private static final Integer TEST_SITE2_POSITION_1 = 1;
    private static final String TEST_SITE2_DESCRIPTION_1 =
        "test_site2_description_1";
    private static final String TEST_SITE2_EFFECT_ON_FRAME_1 =
        "test_site2_effect_on_frame_1";
    ...
    private static final String TEST_BREAKPOINT_TYPE_1 =
        "test_breakpoint_type_1";
    private static final String TEST_CENTER_1 = "test_center_1";
    private static final String TEST_CONNECTION_TYPE_1 =
    ...
    private static final String TEST_EXTERNAL_ANNOTATION_1 =
        "test_external_annotation_1";
    private static final String TEST_DRIVER_FILTER_1 = "test_driver_filter_1";
    private static final String TEST_DRIVER_FILTER_ANN_1 =
        "test_driver_filter_ann_1";
    private static final String TEST_DRIVER_TIERS_FILTER_1 =
        "test_driver_tiers_filter_1";
    private static final String TEST_DRIVER_TIERS_FILTER_ANN_1 =
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    ...
                    .content(
                        objectMapper.writeValueAsString(structuralVariantFilter)
                    )
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    ...
                    .value(TEST_GENETIC_PROFILE_STABLE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].structuralVariantId")
                    .value((int) TEST_STRUCTURAL_VARIANT_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].sampleIdInternal")
                    .value(TEST_SAMPLE_ID_INTERNAL_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].sampleId")
            ...
            .andExpect(
                MockMvcResultMatchers
                    ...
                    .value(TEST_PATIENT_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].studyId")
                    .value(TEST_STUDY_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].uniqueSampleKey")
                    .value(TEST_UNIQUE_SAMPLE_KEY_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].uniquePatientKey")
                    .value(TEST_UNIQUE_PATIENT_KEY_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1EntrezGeneId")
                    .value((int) TEST_SITE1_ENTREZ_GENE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1HugoSymbol")
                    .value(TEST_SITE1_HUGO_SYMBOL_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1EnsemblTranscriptId")
                    .value(TEST_SITE1_ENSEMBL_TRANSCRIPT_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1Exon")
                    .value(TEST_SITE1_EXON_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1Chromosome")
                    .value(TEST_SITE1_CHROMOSOME_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1Position")
                    .value(TEST_SITE1_POSITION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site1Description")
                    .value(TEST_SITE1_DESCRIPTION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2EntrezGeneId")
                    .value((int) TEST_SITE2_ENTREZ_GENE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2HugoSymbol")
                    .value(TEST_SITE2_HUGO_SYMBOL_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2EnsemblTranscriptId")
                    .value(TEST_SITE2_ENSEMBL_TRANSCRIPT_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2Exon")
                    .value(TEST_SITE2_EXON_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2Chromosome")
                    .value(TEST_SITE2_CHROMOSOME_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2Position")
                    .value(TEST_SITE2_POSITION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2Description")
                    .value(TEST_SITE2_DESCRIPTION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].site2EffectOnFrame")
                    .value(TEST_SITE2_EFFECT_ON_FRAME_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].dnaSupport")
                    .value(TEST_DNA_SUPPORT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].rnaSupport")
                    .value(TEST_RNA_SUPPORT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].normalReadCount")
                    .value(TEST_NORMAL_READ_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].tumorReadCount")
                    .value(TEST_TUMOR_READ_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].normalVariantCount")
                    .value(TEST_NORMAL_VARIANT_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].tumorVariantCount")
                    .value(TEST_TUMOR_VARIANT_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].normalPairedEndReadCount")
                    .value(TEST_NORMAL_PAIRED_END_READ_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].tumorPairedEndReadCount")
                    .value(TEST_TUMOR_PAIRED_END_READ_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].normalSplitReadCount")
                    .value(TEST_NORMAL_SPLIT_READ_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].tumorSplitReadCount")
                    .value(TEST_TUMOR_SPLIT_READ_COUNT_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].annotation")
                    .value(TEST_ANNOTATION_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].breakpointType")
                    .value(TEST_BREAKPOINT_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].center")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].connectionType")
                    .value(TEST_CONNECTION_TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].eventInfo")
                    .value(TEST_EVENT_INFO_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].variantClass")
                    .value(TEST_VARIANT_CLASS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].length")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].comments")
                    .value(TEST_COMMENTS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].externalAnnotation")
                    .value(TEST_EXTERNAL_ANNOTATION_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].driverFilterAnn")
                    .value(TEST_DRIVER_FILTER_ANN_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].driverTiersFilterAnn")
                    .value(TEST_DRIVER_TIERS_FILTER_ANN_1)
            );
    }

    @Test
    public void fetchStructuralVariantsSampleMolecularIdentifier()
        throws Exception {
        List<StructuralVariant> structuralVariant = createExampleStructuralVariant();
    ...
    @Test
    public void fetchStructuralVariantsBothMolecularProfileIdAndSampleMolecularIdentifier()
        throws Exception {
        List<StructuralVariant> structuralVariant = createExampleStructuralVariant();
    ...
    private List<StructuralVariant> createExampleStructuralVariant() {
        ...
        structuralVariant1.setMolecularProfileId(
            TEST_GENETIC_PROFILE_STABLE_ID_1
        );
        ...
        structuralVariant1.setSite1EnsemblTranscriptId(
            TEST_SITE1_ENSEMBL_TRANSCRIPT_ID_1
        );
        ...
        structuralVariant1.setSite2EnsemblTranscriptId(
            TEST_SITE2_ENSEMBL_TRANSCRIPT_ID_1
        );
        ...
        structuralVariant1.setNormalPairedEndReadCount(
            TEST_NORMAL_PAIRED_END_READ_COUNT_1
        );
        structuralVariant1.setTumorPairedEndReadCount(
            TEST_TUMOR_PAIRED_END_READ_COUNT_1
        );
        structuralVariant1.setNormalSplitReadCount(
            TEST_NORMAL_SPLIT_READ_COUNT_1
        );
        structuralVariant1.setTumorSplitReadCount(
            TEST_TUMOR_SPLIT_READ_COUNT_1
        );
        ...
        structuralVariant1.setDriverTiersFilterAnn(
            TEST_DRIVER_TIERS_FILTER_ANN_1
        );
    ...
    private StructuralVariantFilter createStructuralVariantFilterSampleMolecularIdentifier() {
        ...
        structuralVariantFilter.setEntrezGeneIds(entrezGeneIds);
        structuralVariantFilter.setSampleMolecularIdentifiers(
            sampleMolecularIdentifierList
        );
        return structuralVariantFilter;
    }
