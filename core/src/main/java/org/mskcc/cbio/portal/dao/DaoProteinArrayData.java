...
public class DaoProteinArrayData {
    ...
    public ProteinArrayData getProteinArrayData(
        int cancerStudyId,
        String arrayId,
        int sampleId
    )
        throws DaoException {
        ArrayList<ProteinArrayData> list = getProteinArrayData(
            cancerStudyId,
            arrayId,
    ...
    public ArrayList<ProteinArrayData> getProteinArrayData(
        int cancerStudyId,
        String arrayId,
        Collection<Integer> sampleIds
    )
        throws DaoException {
        return getProteinArrayData(
            cancerStudyId,
     ...
     * @throws DaoException Database Error.
     */
    public ArrayList<ProteinArrayData> getAllProteinArrayData()
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            con = JdbcUtil.getDbConnection(DaoProteinArrayData.class);
            pstmt = con.prepareStatement("SELECT * FROM protein_array_data");
            rs = pstmt.executeQuery();
            return extractData(rs);
        } catch (SQLException e) {
            throw new DaoException(e);
    ...
    private ArrayList<ProteinArrayData> extractData(ResultSet rs)
        throws SQLException {
        try {
