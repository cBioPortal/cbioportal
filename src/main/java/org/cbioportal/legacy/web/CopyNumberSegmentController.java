...
public class CopyNumberSegmentController {
  ...
  public CopyNumberSegmentController(
      CopyNumberSegmentService copyNumberSegmentService, ObjectMapper objectMapper) {
  ...
  public ResponseEntity<List<CopyNumberSeg>> getCopyNumberSegmentsInSampleInStudy(
      ...
      @Parameter(required = true, description = "Sample ID e.g. TCGA-OR-A5J2-01") @PathVariable
          String sampleId,
      @Parameter(description = "Chromosome") @RequestParam(required = false) String chromosome,
      ...
      @Parameter(description = "Page size of the result list")
          ...
          @RequestParam(defaultValue = COPY_NUMBER_SEGMENT_DEFAULT_PAGE_SIZE)
          Integer pageSize,
      ...
      @Parameter(description = "Name of the property that the result list is sorted by")
          ...
          CopyNumberSegmentSortBy sortBy,
    ...
    if (projection == Projection.META) {
      ...
      responseHeaders.add(
          ...
          copyNumberSegmentService
              .getMetaCopyNumberSegmentsInSampleInStudy(studyId, sampleId, chromosome)
              .getTotalCount()
              .toString());
  ...
  public ResponseEntity<StreamingResponseBody> fetchCopyNumberSegments(
    ...
    if (projection == Projection.META) {
      ...
      responseHeaders.add(
          HeaderKeyConstants.TOTAL_COUNT,
          copyNumberSegmentService
              .fetchMetaCopyNumberSegments(studyIds, sampleIds, chromosome)
              .getTotalCount()
              .toString());
      return new ResponseEntity<>(responseHeaders, HttpStatus.OK);
    }
