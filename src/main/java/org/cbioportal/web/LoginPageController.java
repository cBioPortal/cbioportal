...
public class LoginPageController {
  ...
  public String showLoginPage(
    ...
    if (oauth2AuthenticationUrls.size() == 1
        && !logoutFailure
        && this.forceRedirectOnOneIdentityProvider) {
  ...
  private void populateModel(
      HttpServletRequest request, Model model, Map<String, String> oauth2AuthenticationUrls) {
    ...
    model.addAttribute(
        ...
        frontendPropertiesService.getFrontendProperty(
            FrontendPropertiesServiceImpl.FrontendProperty.skin_authorization_message));
    model.addAttribute(
        "skin_login_contact_html",
        frontendPropertiesService.getFrontendProperty(
            FrontendPropertiesServiceImpl.FrontendProperty.skin_login_contact_html));
    model.addAttribute(
        "skin_login_saml_registration_html",
        frontendPropertiesService.getFrontendProperty(
            FrontendPropertiesServiceImpl.FrontendProperty.skin_login_saml_registration_html));
    model.addAttribute(
        "saml_idp_metadata_entityid",
        frontendPropertiesService.getFrontendProperty(
            FrontendPropertiesServiceImpl.FrontendProperty.saml_idp_metadata_entityid));
    ...
    model.addAttribute(
        ...
        frontendPropertiesService
            .getFrontendProperty(
                FrontendPropertiesServiceImpl.FrontendProperty.authenticationMethod)
            .equals("saml"));
  }
