...
public class ReferenceGenomeGeneServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllGenesByGenomeName() throws Exception {
        ...
        Mockito
            .when(
                geneRepository.getAllGenesByGenomeName(
                    ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
                )
            )
            .thenReturn(expectedGeneList);

        List<ReferenceGenomeGene> result = geneService.fetchAllReferenceGenomeGenes(
            ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
        );
    ...
    public void getGenesByGenomeName() throws Exception {
        ...
        Mockito
            .when(
                geneRepository.getGenesByGenomeName(
                    geneIds,
                    ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
                )
            )
        ...
        List<ReferenceGenomeGene> result = geneService.fetchGenesByGenomeName(
            geneIds,
            ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
        );
    ...
    public void getReferenceGenomeGene() throws Exception {
        ...
        Mockito
            .when(
                geneRepository.getReferenceGenomeGene(
        ...
        ReferenceGenomeGene result = geneService.getReferenceGenomeGene(
            gene.getEntrezGeneId(),
            ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
        );
    ...
    public void getReferenceGenomeGeneByEntityId() throws Exception {
        ...
        Mockito
            .when(
                geneRepository.getReferenceGenomeGeneByEntityId(
                    GENETIC_ENTITY_ID_1,
                    ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
                )
            )
        ...
        ReferenceGenomeGene result = geneService.getReferenceGenomeGeneByEntityId(
            GENETIC_ENTITY_ID_1,
            ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
        );
