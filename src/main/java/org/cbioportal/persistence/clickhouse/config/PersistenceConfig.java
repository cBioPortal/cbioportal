package org.cbioportal.persistence.clickhouse.config;

import org.apache.ibatis.session.SqlSessionFactory;
import org.cbioportal.model.Sample;
import org.cbioportal.persistence.mysql.typehandler.SampleTypeTypeHandler;
...
@Configuration
@MapperScan("org.cbioportal.persistence.clickhouse.mapper")
@Profile("clickhouse")
public class PersistenceConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        Resource[] resources = new PathMatchingResourcePatternResolver()
            .getResources("classpath:org/cbioportal/persistence/clickhouse/*.xml");
