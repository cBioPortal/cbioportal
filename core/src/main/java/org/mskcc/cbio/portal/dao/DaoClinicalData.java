...
public final class DaoClinicalData {
    ...
    private static final String SAMPLE_INSERT =
        "INSERT INTO " +
        SAMPLE_TABLE +
        "(`INTERAL_ID`,`ATTR_ID`,`ATTR_VALUE` VALUES(?,?,?)";
    private static final String PATIENT_INSERT =
        "INSERT INTO " +
        PATIENT_TABLE +
        "(`INTERNAL_ID`,`ATTR_ID`,`ATTR_VALUE` VALUES(?,?,?)";
    ...
    public static int addSampleDatum(
        int internalSampleId,
        String attrId,
        String attrVal
    )
        throws DaoException {
    ...
    public static int addPatientDatum(
    ...
    public static int addDatum(
        ...
        if (MySQLbulkLoader.isBulkLoad()) {
            MySQLbulkLoader
                .getMySQLbulkLoader(tableName)
                .insertRecord(Integer.toString(internalId), attrId, attrVal);
            return 1;
        }
    ...
    public static ClinicalData getDatum(
    ...
    private static ClinicalData getDatum(
    ...
    public static List<ClinicalData> getDataByPatientId(
        int cancerStudyId,
        String patientId
    )
        throws DaoException {
        ...
        internalIds.add(
            DaoPatient
                .getPatientByCancerStudyAndPatientId(cancerStudyId, patientId)
                .getInternalId()
        );
        return getDataByInternalIds(cancerStudyId, PATIENT_TABLE, internalIds);
    }

    private static List<ClinicalData> getDataByInternalIds(
        int internalCancerStudyId,
        String table,
        List<Integer> internalIds
    )
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
    ...
    public static List<ClinicalData> getData(String cancerStudyId)
        throws DaoException {
        return getData(getInternalCancerStudyId(cancerStudyId));
    }

    public static List<ClinicalData> getData(int cancerStudyId)
        throws DaoException {
    ...
    private static List<Integer> getSampleIdsByCancerStudy(int cancerStudyId) {
        ...
        for (Patient patient : DaoPatient.getPatientsByCancerStudyId(
            ...
            for (Sample s : DaoSample.getSamplesByPatientId(
    ...
    public static List<ClinicalData> getData(
        String cancerStudyId,
    ...
    public static List<ClinicalData> getSampleAndPatientData(
        int cancerStudyId,
        ...
        for (String sampleId : sampleIds) {
            ...
            String patientIdStable = DaoPatient
                .getPatientById(patientIdInt)
                .getStableId();
            patientIdsInt.add(patientIdInt);
            Set<String> sampleIdsForPatient = mapPatientIdSampleIds.get(
                patientIdStable
            );
        ...
        List<ClinicalData> sampleClinicalData = getDataByInternalIds(
            cancerStudyId,
            SAMPLE_TABLE,
            sampleIdsInt
        );

        List<ClinicalData> patientClinicalData = getDataByInternalIds(
            cancerStudyId,
            PATIENT_TABLE,
            patientIdsInt
        );
    ...
    public static List<ClinicalData> getSampleAndPatientData(
        ...
        List<ClinicalData> sampleClinicalData = getDataByInternalIds(
            ...
            SAMPLE_TABLE,
            sampleIdsInt,
            Collections.singletonList(attr.getAttrId())
        );
    ...
    public static List<ClinicalData> getSampleData(
        int cancerStudyId,
        Collection<String> sampleIds,
        ClinicalAttribute attr
    )
    ...
    public static List<ClinicalData> getSampleData(
        ...
        for (String sampleId : sampleIds) {
            sampleIdsInt.add(
                DaoSample
                    .getSampleByCancerStudyAndSampleId(cancerStudyId, sampleId)
                    .getInternalId()
            );
        }
    ...
    public static List<ClinicalData> getDataByAttributeIds(
        int internalCancerStudyId,
        Collection<String> attributeIds
    )
        throws DaoException {
        ...
        try {
            ...
            pstmt =
                con.prepareStatement(
                    "SELECT * FROM clinical_patient WHERE" +
                    " ATTR_ID IN ('" +
                    StringUtils.join(attributeIds, "','") +
                    "') "
                );

            List<Integer> patients = getPatientIdsByCancerStudy(
                internalCancerStudyId
            );
            ...
            while (rs.next()) {
                ...
                if (patients.contains(patientId)) {
                    clinicals.add(
                        extract(PATIENT_TABLE, internalCancerStudyId, rs)
                    );
                }
            }
        } catch (SQLException e) {
    ...
    private static ClinicalData extract(
        String table,
        int internalCancerStudyId,
        ResultSet rs
    )
        throws SQLException {
        // get
        String stableId = getStableIdFromInternalId(
            table,
    ...
    private static String getStableIdFromInternalId(
        String table,
        int internalId
    ) {
     ...
     * @throws DaoException
     */
    public static List<Patient> getSurvivalData(
        int cancerStudyId,
        Collection<String> patientSet
    )
        throws DaoException {
    ...
    public static List<ClinicalParameterMap> getDataSlice(
        int cancerStudyId,
        Collection<String> attributeIds
    )
        throws DaoException {
        Map<String, Map<String, String>> mapAttrStableIdValue = new HashMap<String, Map<String, String>>();
        for (ClinicalData cd : getDataByAttributeIds(
            cancerStudyId,
            attributeIds
        )) {
            ...
            Map<String, String> mapStableIdValue = mapAttrStableIdValue.get(
                attrId
            );
        ...
        for (Map.Entry<String, Map<String, String>> entry : mapAttrStableIdValue.entrySet()) {
            maps.add(
                new ClinicalParameterMap(entry.getKey(), entry.getValue())
            );
        }
    ...
    public static HashSet<String> getDistinctParameters(int cancerStudyId)
        throws DaoException {
        HashSet<String> toReturn = new HashSet<String>();
        for (ClinicalData clinicalData : DaoClinicalData.getData(
            cancerStudyId
        )) {
    ...
    public static HashSet<String> getAllPatients(int cancerStudyId)
        throws DaoException {
        HashSet<String> toReturn = new HashSet<String>();
    ...
    public static List<ClinicalData> getDataByCancerStudy(int cancerStudyId)
        throws DaoException {
        return DaoClinicalData.getData(cancerStudyId);
    }

    public static List<ClinicalData> getDataByPatientIds(
        int cancerStudyId,
    ...
    public static List<Patient> getPatientsByAttribute(
        int cancerStudy,
        String paramName,
        String paramValue
    )
        throws DaoException {
        List<Integer> ids = getIdsByAttribute(
            cancerStudy,
            paramName,
            paramValue,
            PATIENT_TABLE
    ...
    public static List<Sample> getSamplesByAttribute(
        int cancerStudy,
        String paramName,
        String paramValue
    )
    ...
    private static List<Integer> getIdsByAttribute(
        int cancerStudyId,
        String paramName,
        String paramValue,
        String tableName
    ...
    // for given samples
    public static Map<String, Set<String>> getCancerTypeInfoBySamples(
        ...
        try {
            ...
            result.put(
                ClinicalAttribute.CANCER_TYPE_DETAILED,
                new HashSet<String>()
            );
            while (rs.next()) {
                result
                    .get(rs.getString("attributeID"))
                    .add(rs.getString("attributeValue"));
            }
