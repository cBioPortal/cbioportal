...
public class PatientControllerTest {
    ...
    public void getAllPatientsDefaultProjection() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].cancerStudyIdentifier")
                    .doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].cancerStudy")
                    .doesNotExist()
            )
            .andExpect(
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].cancerStudyIdentifier")
                    .doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].cancerStudy")
                    .doesNotExist()
            );
    }
    ...
    public void getAllPatientsMetaProjection() throws Exception {
        ...
        Mockito
            .when(patientService.getMetaPatients(Mockito.anyString()))
            .thenReturn(baseMeta);
    ...
    public void getAllPatientsInStudyDefaultProjection() throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/studies/test_study_id/patients")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
    ...
    public void getAllPatientsInStudyMetaProjection() throws Exception {
        ...
        Mockito
            .when(patientService.getMetaPatientsInStudy(Mockito.anyString()))
            .thenReturn(baseMeta);
    ...
    public void getPatientInStudyNotFound() throws Exception {
        Mockito
            .when(
                patientService.getPatientInStudy(
                    Mockito.anyString(),
                    Mockito.anyString()
                )
            )
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/studies/test_study_id/patients/test_patient_id")
                    .accept(MediaType.APPLICATION_JSON)
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.message")
                    .value(
                        "Patient not found in study test_study_id: test_patient_id"
                    )
            );
    }
    ...
    public void getPatientInStudy() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerStudyIdentifier")
                    .doesNotExist()
            );
    }
    ...
    @Test
    public void fetchPatientsByUniquePatientKeysDefaultProjection()
        throws Exception {
        List<Patient> patientList = createExamplePatients();
    ...
    public void fetchPatientsMetaProjection() throws Exception {
        ...
        Mockito
            .when(
                patientService.fetchMetaPatients(
                    Mockito.anyListOf(String.class),
                    Mockito.anyListOf(String.class)
                )
            )
