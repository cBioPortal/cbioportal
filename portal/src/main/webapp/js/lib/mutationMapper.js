...
var MainMutationView = Backbone.View.extend({
	...
	initComponents: function(mut3dVisView)
	{
        ...
        // 508 compliance: add a title to each of the checkboxes provided by ColVis library
        // As the offending checkboxes don't become visible until the button is clicked, bind it to the click event 
