...
./importClinicalData.pl $GDAC_CGDS_STAGING_HOME/gbm_tcga/gbm_tcga_clinical.txt gbm_tcga
...
# Gistic
./importGistic.pl $GDAC_CGDS_STAGING_HOME/gbm_tcga/data_GISTIC_GENE_AMPS.txt gbm_tcga
./importGistic.pl $GDAC_CGDS_STAGING_HOME/gbm_tcga/data_GISTIC_GENE_DELS.txt gbm_tcga

# Copy number segment
./importCopyNumberSegmentData.pl $GDAC_CGDS_STAGING_HOME/gbm_tcga/gbm_tcga_scna_minus_germline_cnv_hg19.seg gbm_tcga