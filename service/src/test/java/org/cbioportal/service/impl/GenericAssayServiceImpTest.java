...
public class GenericAssayServiceImpTest extends BaseServiceImplTest {
    ...
    private static final List<String> PROFILE_ID_LIST = Arrays.asList(
        PROFILE_ID
    );
    ...
    private static final String MOLECULAR_PROFILE_ID_1 =
        "molecular_profile_id_1";
    private static final String MOLECULAR_PROFILE_ID_2 =
    ...
    public void setUp() throws Exception {
        ...
        Mockito
            .when(
                geneticDataRepository.getCommaSeparatedSampleIdsOfMolecularProfiles(
                    Arrays.asList(MOLECULAR_PROFILE_ID_1)
                )
            )
        ...
        Mockito
            ...
            .thenReturn(Arrays.asList("1,2,", "1,2,"));
        ...
        geneticProfile1.setMolecularAlterationType(
        ...
        Mockito
            .when(
                geneticProfileService.getMolecularProfile(
                    MOLECULAR_PROFILE_ID_1
                )
            )
            .thenReturn(geneticProfile1);
        Mockito
            .when(
        ...
        genericAssayMolecularAlteration1.setMolecularProfileId(
            MOLECULAR_PROFILE_ID_1
        );
        ...
        genericAssayMolecularAlteration2.setMolecularProfileId(
            MOLECULAR_PROFILE_ID_1
        );
        ...
        genericAssayMolecularAlterationList1.add(
            genericAssayMolecularAlteration1
        );
        genericAssayMolecularAlterationList1.add(
            genericAssayMolecularAlteration2
        );
        ...
        genericAssayMolecularAlterationList2.add(
            genericAssayMolecularAlteration1
        );
        genericAssayMolecularAlterationList2.add(
            genericAssayMolecularAlteration2
    ...
    @Test
    public void fetchGenericAssayDataInMultipleMolecularProfiles()
        throws Exception {
        List<GenericAssayData> result = genericAssayService.fetchGenericAssayData(
    ...
    @Test
    public void getGenericAssayMetaByStableIdsAndMolecularIds()
        throws GenericAssayNotFoundException {
        Mockito
            .when(genericAssayRepository.getGenericAssayMeta(idList))
        ...
        Mockito
            .when(
                genericAssayRepository.getGeneticEntityIdByStableId(
                    GENERIC_ASSAY_ID_1
                )
            )
        ...
        Mockito
            .when(
                genericAssayRepository.getGenericAssayMetaPropertiesMap(
                    INTERNAL_ID_1
                )
            )
        ...
        List<GenericAssayMeta> result = genericAssayService.getGenericAssayMetaByStableIdsAndMolecularIds(
            idList,
            PROFILE_ID_LIST,
            PersistenceConstants.SUMMARY_PROJECTION
        );
        ...
        Assert.assertEquals(
            mockGenericAssayMetaList.get(0).getEntityType(),
            meta1.getEntityType()
        );
        Assert.assertEquals(
            mockGenericAssayMetaList.get(0).getStableId(),
            meta1.getStableId()
        );
        Assert.assertEquals(
        ...
        Assert.assertEquals(
            mockGenericAssayMetaList.get(1).getEntityType(),
            meta2.getEntityType()
        );
        Assert.assertEquals(
            mockGenericAssayMetaList.get(1).getStableId(),
            meta2.getStableId()
        );
        Assert.assertEquals(
    ...
    private static List<GenericAssayMeta> createGenericAssayMetaList() {
        ...
        GenericAssayMeta meta1 = new GenericAssayMeta(
            GENERIC_ASSAY_ID_1,
            ENTITY_TYPE
        );
        genericAssayMetaList.add(meta1);

        GenericAssayMeta meta2 = new GenericAssayMeta(
            GENERIC_ASSAY_ID_2,
            ENTITY_TYPE
        );
