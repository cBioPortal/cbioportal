...
public class NamespaceAttributeServiceImplTest extends BaseServiceImplTest {
    ...
    public void fetchNamespaceAttributes() {
        ...
        NamespaceAttribute namespaceAttribute = new NamespaceAttribute(NAMESPACE_OUTER_KEY_1, NAMESPACE_INNER_KEY_1);
        ...
        List<NamespaceAttribute> result = namespaceAttributeService.fetchNamespaceAttributes(Arrays.asList(STUDY_ID));
    ...
    public void getNamespaceAttributeCountsBySampleIds() {
        ...
        Mockito.when(namespaceRepository.getNamespaceAttributeCountsBySampleIds(sampleIds, studyIds, namespaceAttributes))
            .thenReturn(expectedNamespaceAttributeCounts);

        List<NamespaceAttributeCount> result = namespaceAttributeService.fetchNamespaceAttributeCountsBySampleIds(sampleIds, studyIds, namespaceAttributes);
