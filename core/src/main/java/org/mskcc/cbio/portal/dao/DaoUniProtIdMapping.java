...
public final class DaoUniProtIdMapping {
    ...
    public static int addUniProtIdMapping(
        ...
        if (!MySQLbulkLoader.isBulkLoad()) {
            throw new DaoException(
                "You have to turn on MySQLbulkLoader in order to insert uniprot ID mapping"
            );
        } else {
            // use this code if bulk loading
            // write to the temp file maintained by the MySQLbulkLoader
            MySQLbulkLoader
                .getMySQLbulkLoader("uniprot_id_mapping")
                .insertRecord(
                    uniprotAcc,
                    uniProtId,
        ...
        try {
            ...
            preparedStatement =
                connection.prepareStatement(
                    "select uniprot_acc from uniprot_id_mapping"
                );
    ...
    public static List<String> mapFromEntrezGeneIdToUniprotAccession(
        final int entrezGeneId
    )
        throws DaoException {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            preparedStatement =
                connection.prepareStatement(
                    "select uniprot_acc from uniprot_id_mapping where entrez_gene_id = ?"
                );
    ...
    public static String mapFromUniprotAccessionToUniprotId(
        final String uniprotAcc
    )
        throws DaoException {
        Connection connection = null;
        ...
        try {
            ...
            preparedStatement =
                connection.prepareStatement(
                    "select UNIPROT_ID from uniprot_id_mapping where UNIPROT_ACC = ?"
                );
    ...
    public static String mapFromUniprotIdToAccession(final String uniprotId)
        throws DaoException {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        try {
            ...
            preparedStatement =
                connection.prepareStatement(
                    "select UNIPROT_ACC from uniprot_id_mapping where UNIPROT_ID = ?"
                );
    ...
    public static void deleteAllRecords() throws DaoException {
        ...
        try {
            ...
            preparedStatement =
                connection.prepareStatement(
                    "truncate table uniprot_id_mapping"
                );
