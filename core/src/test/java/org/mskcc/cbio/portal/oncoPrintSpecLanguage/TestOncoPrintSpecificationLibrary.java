...
public class TestOncoPrintSpecificationLibrary {
    ...
    public void testGeneticTypeLevel() {
        Assert.assertEquals(
            ...
            GeneticTypeLevel.convertCNAcode(2)
        );
        Assert.assertEquals(
    ...
    public void testDataTypeSpec() {
        try {
            DataTypeSpec.genericFindDataType(
                "foo",
    ...
    public void testConcreteDataTypeSpec() {
        ...
        Assert.assertTrue(
            aConcreteDataTypeSpec.satisfy(GeneticDataTypes.Methylation)
        );
        Assert.assertFalse(
            aConcreteDataTypeSpec.satisfy(GeneticDataTypes.Expression)
        );
        ...
        Assert.assertTrue(
            aConcreteDataTypeSpec.equals(
                new ConcreteDataTypeSpec(GeneticDataTypes.Methylation)
            )
        );
        Assert.assertTrue(
            aConcreteDataTypeSpec.equals(new ConcreteDataTypeSpec("Methyla"))
        );
        Assert.assertFalse(aConcreteDataTypeSpec.equals(new Object()));
        Assert.assertEquals(
            null,
            ConcreteDataTypeSpec.concreteDataTypeSpecGenerator(null)
        );
        Assert.assertEquals(
            new ConcreteDataTypeSpec(GeneticDataTypes.CopyNumberAlteration),
            ConcreteDataTypeSpec.concreteDataTypeSpecGenerator("CNA")
        );
        Assert.assertEquals(
            null,
            ConcreteDataTypeSpec.concreteDataTypeSpecGenerator("foo")
        );
    ...
    public void testContinuousDataTypeSpec() {
        ...
        Assert.assertEquals(
            "Expression<1.0",
            aContinuousDataTypeSpec.toString()
        );
        ...
        ContinuousDataTypeSpec aContinuousDataTypeSpec2 = new ContinuousDataTypeSpec(
            GeneticDataTypes.Expression,
            ComparisonOp.convertCode(">="),
            1.0f
        );
        ...
        try {
            ...
            Assert.assertEquals(
                "the ContinuousDataTypeSpecs must have ComparisonOps " +
    ...
    public void testDiscreteDataTypeSetSpec() {
        ...
        Assert.assertEquals("Gained ", aDiscreteDataTypeSetSpec.toString());
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.satisfy(GeneticTypeLevel.Gained)
        );
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.equals(aDiscreteDataTypeSetSpec)
        );
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.equals(
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.equals(
                new DiscreteDataTypeSetSpec("CNA", 1)
            )
        );
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.satisfy(GeneticTypeLevel.Amplified)
        );
        Assert.assertFalse(
            aDiscreteDataTypeSetSpec.satisfy(GeneticTypeLevel.Diploid)
        );
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.equals(aDiscreteDataTypeSetSpec)
        );
        ...
        aDiscreteDataTypeSetSpec.combine(
            new DiscreteDataTypeSetSpec(
                GeneticDataTypes.CopyNumberAlteration,
                GeneticTypeLevel.HemizygouslyDeleted,
                GeneticTypeLevel.HemizygouslyDeleted,
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSetSpec.satisfy(
                GeneticTypeLevel.HemizygouslyDeleted
            )
        );
        Assert.assertFalse(
        ...
        try {
            ...
            Assert.assertEquals(
                "Mutated is not a level for CopyNumberAlteration",
                e.getMessage()
            );
        }
        ...
        try {
            ...
            Assert.assertEquals(
                "10 is invalid code for levels in CopyNumberAlteration",
                e.getMessage()
            );
        }
        Assert.assertEquals(
    ...
    private void findDiscreteDataTypeSetSpec(
        GeneticDataTypes expectedGeneticDataType,
        String name
    ) {
        Assert.assertEquals(
            expectedGeneticDataType,
            DiscreteDataTypeSetSpec.findDataType(name)
        );
    }
    ...
    public void testDiscreteDataTypeSpec() {
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSpec.satisfy(GeneticTypeLevel.Diploid)
        );
        Assert.assertFalse(
            aDiscreteDataTypeSpec.satisfy(GeneticTypeLevel.Gained)
        );
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSpec.equals(
                new DiscreteDataTypeSpec(
                    GeneticDataTypes.CopyNumberAlteration,
                    ComparisonOp.convertCode("<"),
                    GeneticTypeLevel.Gained
                )
        ...
        Assert.assertEquals(
            "CopyNumberAlteration<Gained",
            aDiscreteDataTypeSpec.toString()
        );
        ...
        for (GeneticTypeLevel aGeneticTypeLevel : GeneticTypeLevel.values()) {
            if (
                aGeneticTypeLevel
                    .getTheGeneticDataType()
                    .equals(GeneticDataTypes.CopyNumberAlteration)
            ) {
                Assert.assertEquals(
                    aGeneticTypeLevel.ordinal() <
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSpec.satisfy(GeneticTypeLevel.Normal)
        );
        Assert.assertFalse(
            aDiscreteDataTypeSpec.satisfy(GeneticTypeLevel.Amplified)
        );
        ...
        Assert.assertEquals(
            null,
            DiscreteDataTypeSpec.discreteDataTypeSpecGenerator(null, null, null)
        );
        Assert.assertEquals(
            null,
        ...
        Assert.assertEquals(
            null,
            DiscreteDataTypeSpec.discreteDataTypeSpecGenerator(null, "xx", null)
        );
        Assert.assertEquals(
            null,
            DiscreteDataTypeSpec.discreteDataTypeSpecGenerator(
    ...
    private void satisfiedDiscreteDataTypeSpec(
        ...
        Assert.assertTrue(
            aDiscreteDataTypeSpec.satisfy((GeneticTypeLevel) satisfied)
        );

        // take 'opposite' comparisonOp, and try Assert.assertFalse
        DiscreteDataTypeSpec oppositeDiscreteDataTypeSpec = new DiscreteDataTypeSpec(
            theGeneticDataType,
            comparisonOp.oppositeComparisonOp(),
            threshold
        );
        Assert.assertFalse(
            oppositeDiscreteDataTypeSpec.satisfy((GeneticTypeLevel) satisfied)
        );
    }

    private void findDiscreteDataType(
        GeneticDataTypes expectedGeneticDataType,
        String name
    ) {
        Assert.assertEquals(
            expectedGeneticDataType,
            DiscreteDataTypeSpec.findDataType(name)
        );
    }
    ...
    public void testOncoPrintGeneDisplaySpec() {
        ...
        for (GeneticDataTypes aGeneticDataType : GeneticDataTypes.values()) {
            Assert.assertFalse(
                theResultFullDataTypeSpec.satisfy(aGeneticDataType)
            );
        }
        for (GeneticDataTypes aGeneticDataType : GeneticDataTypes.values()) {
            Assert.assertFalse(
            ...
            switch (aGeneticDataType.getTheDataTypeCategory()) {
                case Continuous:
                    Assert.assertFalse(
                        theResultFullDataTypeSpec.satisfy(
                            aGeneticDataType,
                            0.0f
                        )
                    );
        ...
        Assert.assertTrue(
            theOncoPrintGeneDisplaySpec.satisfy(
                GeneticDataTypes.Expression,
                -1.0f
            )
        );
    ...
    public static OncoPrintGeneDisplaySpec createTestOncoPrintGeneDisplaySpec() {
        ...
        aParsedFullDataTypeSpec.addSpec(
            new ConcreteDataTypeSpec(GeneticDataTypes.Methylation)
        );
        aParsedFullDataTypeSpec.addSpec(
            new ContinuousDataTypeSpec(
    ...
    public void testParsedFullDataTypeSpec() {
        ...
        for (GeneticDataTypes aGeneticDataType : GeneticDataTypes.values()) {
            Assert.assertFalse(
                theOncoPrintGeneDisplaySpec.satisfy(aGeneticDataType)
            );
        }
        ...
        Assert.assertFalse(
            theOncoPrintGeneDisplaySpec.satisfy(GeneticDataTypes.Expression, 2f)
        );
        Assert.assertTrue(
            theOncoPrintGeneDisplaySpec.satisfy(GeneticDataTypes.Expression, 3f)
        );
        Assert.assertTrue(
            theOncoPrintGeneDisplaySpec.satisfy(
                GeneticDataTypes.Expression,
    ...
    public void testGeneWithSpec() {
        Assert.assertEquals(
            null,
            GeneWithSpec.geneWithSpecGenerator(null, null, null)
        );
        Assert.assertEquals(
            null,
            GeneWithSpec.geneWithSpecGenerator("name", null, null)
        );
        OncoPrintGeneDisplaySpec theResultFullDataTypeSpec = new OncoPrintGeneDisplaySpec();
        Assert.assertEquals(
            null,
        ...
        GeneWithSpec aGeneWithSpec = new GeneWithSpec(
            "name",
            theResultFullDataTypeSpec
        );
        Assert.assertEquals(
            aGeneWithSpec.toString(),
            GeneWithSpec
                .geneWithSpecGenerator("name", theResultFullDataTypeSpec, null)
                .toString()
        );
        Assert.assertEquals(
            aGeneWithSpec.toString(),
            GeneWithSpec
                .geneWithSpecGenerator("name", null, theResultFullDataTypeSpec)
                .toString()
        );
        // TODO: impl equals and hashCode for GeneWithSpec AND all its components, so this works
        Assert.assertTrue(
            aGeneWithSpec.equals(
                GeneWithSpec.geneWithSpecGenerator(
                    "name",
                    theResultFullDataTypeSpec,
                    null
    ...
    private void checkAmazin(GeneWithSpec aGeneWithSpec) {
        Assert.assertTrue(
            aGeneWithSpec
                .getTheOncoPrintGeneDisplaySpec()
                .satisfy(GeneticDataTypes.CopyNumberAlteration)
        );
        Assert.assertTrue(
            aGeneWithSpec
                .getTheOncoPrintGeneDisplaySpec()
                .satisfy(GeneticDataTypes.Mutation)
        );
        Assert.assertTrue(
            aGeneWithSpec
                .getTheOncoPrintGeneDisplaySpec()
                .satisfy(GeneticDataTypes.Expression, -2.01f)
        );
        Assert.assertFalse(
            aGeneWithSpec
                .getTheOncoPrintGeneDisplaySpec()
                .satisfy(GeneticDataTypes.Expression, -2.0f)
        );
    }

    @Test
    public void testUniqueEnumPrefix() {
        tryAnUniqueEnumPrefix(
            "Meth",
    ...
    private void tryAnUniqueEnumPrefix(
        String testInput,
        Class enumClass,
        Object enumConstant
    ) {
        try {
            ...
            System.out.println(
                "testUniqueEnumPrefix: IllegalArgumentException: " +
                e.getMessage()
            );
        }
    }
    ...
    public void testOncoPrintSpecification() {
        ...
        for (String g : genes) {
            aGeneSet.addGeneWithSpec(
                new GeneWithSpec(g, theOncoPrintGeneDisplaySpec)
            );
        }
        aOncoPrintSpecification.add(aGeneSet);
        Assert.assertEquals(
            null,
            aOncoPrintSpecification.getGeneWithSpec("geneName")
        );
        Assert.assertEquals(
            new ArrayList<String>(Arrays.asList(genes)),
            aOncoPrintSpecification.listOfGenes()
        );

        // TODO: change to .equals, when implemented
        Assert.assertEquals(
            new GeneWithSpec("GENE2", theOncoPrintGeneDisplaySpec).toString(),
    ...
    public void testGetUnionOfPossibleLevels() {
        ...
        // TODO: change to .equals, when implemented
        Assert.assertEquals(
            theOncoPrintGeneDisplaySpec.toString(),
        ...
        anOncoPrintSpecification =
            new OncoPrintSpecification(genes, theOncoPrintGeneDisplaySpec);
        // TODO: change to .equals, when implemented
        Assert.assertEquals(
            theOncoPrintGeneDisplaySpec.toString(),
            anOncoPrintSpecification.getUnionOfPossibleLevels().toString()
        ...
        //  HomozygouslyDeleted Gained Amplified   Expression<2.0 Expression>=3.0   Methylation ;
        anOncoPrintSpecification =
            new OncoPrintSpecification(
                genes,
                createTestOncoPrintGeneDisplaySpec()
            );
        Assert.assertEquals(
            createTestOncoPrintGeneDisplaySpec().toString(),
            anOncoPrintSpecification.getUnionOfPossibleLevels().toString()
        );
        ...
        theOncoPrintGeneDisplaySpec = new OncoPrintGeneDisplaySpec();
        theOncoPrintGeneDisplaySpec.setResultDataTypeSpec(
            GeneticDataTypes.Expression,
            theResultDataTypeSpec
        );
        GeneSet aGeneSet = new GeneSet();
        aGeneSet.addGeneWithSpec(
            new GeneWithSpec("foo", theOncoPrintGeneDisplaySpec)
        );
        anOncoPrintSpecification.add(aGeneSet);

        // a hack; should create the right OncoPrintGeneDisplaySpec for the expected
        Assert.assertEquals(
            "HomozygouslyDeleted Gained Amplified   Expression<=2.5 " +
            "Expression>=3.0   Methylation ;",
            anOncoPrintSpecification.getUnionOfPossibleLevels().toString()
        );

        theResultDataTypeSpec =
            new ResultDataTypeSpec(GeneticDataTypes.Mutation);
        ...
        aGeneSet.addGeneWithSpec(
            new GeneWithSpec("bar", theOncoPrintGeneDisplaySpec)
        );
        anOncoPrintSpecification.add(aGeneSet);
        // a hack; should create the right OncoPrintGeneDisplaySpec for the expected
        Assert.assertEquals(
