:warning: this is applicable since release [1.0.5](https://github.com/cBioPortal/cbioportal/releases/tag/v1.0.5) (currently in [beta testing](http://www.cbioportal.org/beta))
