...
public interface MolecularDataRepository {
  ...
  @Cacheable(
      cacheResolver = "generalRepositoryCacheResolver",
      condition =
          "@cacheEnabledConfig.getEnabled() && #entrezGeneIds != null && #entrezGeneIds.size() != 0")
  ...
  Iterable<GeneMolecularAlteration> getGeneMolecularAlterationsIterableFast(
  ...
  Iterable<GenericAssayMolecularAlteration> getGenericAssayMolecularAlterationsIterable(
      String molecularProfileId, List<String> stableIds, String projection);
}
