...
public class StudyViewServiceImpl implements StudyViewService {
    ...
    @Override
    public Map<String, List<ClinicalDataCount>> fetchGenePanelCounts(List<String> sampleIds, List<String> studyIds) {
     ...
     */
    private List<ClinicalDataCount> fetchAndCountGenePanels(List<MolecularProfileCaseIdentifier> identifiers) {
    ...
    private ClinicalDataCount toGenePanelCount(Map.Entry<String, List<GenePanelData>> e) {
