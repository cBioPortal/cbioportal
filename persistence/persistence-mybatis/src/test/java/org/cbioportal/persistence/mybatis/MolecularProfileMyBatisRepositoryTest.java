...
public class MolecularProfileMyBatisRepositoryTest {
    ...
    public void getAllMolecularProfilesIdProjection() throws Exception {
        List<MolecularProfile> result = molecularProfileMyBatisRepository.getAllMolecularProfiles(
            "ID",
            null,
            null,
            null,
        ...
        Assert.assertEquals(
            (Integer) 8,
            molecularProfile.getMolecularProfileId()
        );
        Assert.assertEquals(
            "acc_tcga_mutations",
    ...
    @Test
    public void getAllMolecularProfilesSummaryProjection1PageSize()
        throws Exception {
        List<MolecularProfile> result = molecularProfileMyBatisRepository.getAllMolecularProfiles(
            "SUMMARY",
            1,
    ...
    @Test
    public void getAllMolecularProfilesSummaryProjectionStableIdSort()
        throws Exception {
        List<MolecularProfile> result = molecularProfileMyBatisRepository.getAllMolecularProfiles(
            "SUMMARY",
            null,
        ...
        Assert.assertEquals(
            "study_tcga_pub_gistic",
            result.get(1).getStableId()
        );
        Assert.assertEquals(
            "study_tcga_pub_gsva_scores",
            result.get(2).getStableId()
        );
        Assert.assertEquals(
            "study_tcga_pub_log2CNA",
            result.get(3).getStableId()
        );
        Assert.assertEquals(
            "study_tcga_pub_methylation_hm27",
            result.get(5).getStableId()
        );
        Assert.assertEquals("study_tcga_pub_mrna", result.get(6).getStableId());
        Assert.assertEquals(
            "study_tcga_pub_mutational_signature",
            result.get(7).getStableId()
        );
        Assert.assertEquals(
            "study_tcga_pub_mutations",
            result.get(8).getStableId()
        );
        Assert.assertEquals("study_tcga_pub_sv", result.get(9).getStableId());
        Assert.assertEquals(
            "study_tcga_pub_treatment_ic50",
            result.get(10).getStableId()
        );
    }
    ...
    public void getMetaMolecularProfiles() throws Exception {
        ...
        Assert.assertEquals((Integer) 11, result.getTotalCount());
    }

    @Test
    public void getMolecularProfileNullResult() throws Exception {
        MolecularProfile result = molecularProfileMyBatisRepository.getMolecularProfile(
            "invalid_molecular_profile"
        );
    ...
    public void getMolecularProfile() throws Exception {
        MolecularProfile molecularProfile = molecularProfileMyBatisRepository.getMolecularProfile(
            "study_tcga_pub_gistic"
        );
    ...
    public void getMolecularProfiles() throws Exception {
        List<MolecularProfile> result = molecularProfileMyBatisRepository.getMolecularProfiles(
            Arrays.asList("study_tcga_pub_gistic", "study_tcga_pub_mrna"),
            "SUMMARY"
        );
    ...
    @Test
    public void getAllMolecularProfilesInStudySummaryProjection()
        throws Exception {
        List<MolecularProfile> result = molecularProfileMyBatisRepository.getAllMolecularProfilesInStudy(
            "study_tcga_pub",
            "SUMMARY",
            null,
            null,
    ...
    public void getMetaMolecularProfilesInStudy() throws Exception {
        BaseMeta result = molecularProfileMyBatisRepository.getMetaMolecularProfilesInStudy(
            "study_tcga_pub"
        );
    ...
    public void getMolecularProfilesInStudies() throws Exception {
        List<MolecularProfile> result = molecularProfileMyBatisRepository.getMolecularProfilesInStudies(
