...
public record SampleUseCases(
    FetchMetaSamplesHeadersUseCase fetchMetaSamplesHeadersUseCase,
    ...
    GetMetaSamplesHeadersUseCase getMetaSamplesHeadersUseCase,
    GetMetaSamplesInStudyHeadersUseCase getMetaSamplesInStudyHeadersUseCase,
    GetMetaSamplesInStudyUseCase getMetaSamplesInStudyUseCase,
    GetMetaSamplesOfPatientInStudyHeadersUseCase getMetaSamplesOfPatientInStudyHeadersUseCase,
