...
public class StudyServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllStudies() throws Exception {
        ...
        Mockito
            .when(cancerTypeService.getPrimarySiteMap())
            .thenReturn(new HashMap<>());

        List<CancerStudy> result = studyService.getAllStudies(
            KEYWORD,
            PROJECTION,
            PAGE_SIZE,
            PAGE_NUMBER,
    ...
    public void getMetaStudies() throws Exception {
        ...
        Mockito
            .when(studyRepository.getMetaStudies(null))
    ...
    public void getStudyNotFound() throws Exception {
        Mockito
            .when(studyRepository.getStudy(STUDY_ID, "DETAILED"))
            .thenReturn(null);
    ...
    public void getStudy() throws Exception {
        ...
        Mockito
            .when(studyRepository.getStudy(STUDY_ID, "DETAILED"))
            .thenReturn(expectedCancerStudy);
    ...
    public void fetchStudies() throws Exception {
        ...
        List<CancerStudy> result = studyService.fetchStudies(
            Arrays.asList(STUDY_ID),
            PROJECTION
        );
    ...
    public void fetchMetaStudies() throws Exception {
        ...
        Mockito
            .when(studyRepository.fetchMetaStudies(Arrays.asList(STUDY_ID)))
            .thenReturn(expectedBaseMeta);

        BaseMeta result = studyService.fetchMetaStudies(
            Arrays.asList(STUDY_ID)
        );
