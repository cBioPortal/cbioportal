...
public class StudyMyBatisRepositoryTest {
    ...
    public void getAllStudiesIdProjection() throws Exception {
        List<CancerStudy> result = studyMyBatisRepository.getAllStudies(
            null,
            "ID",
            null,
            null,
    ...
    public void getAllStudiesSummaryProjection() throws Exception {
        ...
        Assert.assertEquals(
            simpleDateFormat.parse("2011-12-18 13:17:17+00:00"),
            cancerStudy.getImportDate()
        );
    ...
    public void getAllStudiesDetailedProjection() throws Exception {
        ...
        Assert.assertEquals((Integer) 0, cancerStudy.getStatus());
        Assert.assertEquals(
            simpleDateFormat.parse("2011-12-18 13:17:17"),
            cancerStudy.getImportDate()
        );
        Assert.assertEquals((Integer) 14, cancerStudy.getAllSampleCount());
        ...
        Assert.assertEquals(
            (Integer) 1,
            cancerStudy.getMethylationHm27SampleCount()
        );
        Assert.assertEquals((Integer) 0, cancerStudy.getMiRnaSampleCount());
        Assert.assertEquals(
            (Integer) 8,
            cancerStudy.getMrnaMicroarraySampleCount()
        );
        Assert.assertEquals(
            (Integer) 0,
            cancerStudy.getMrnaRnaSeqSampleCount()
        );
        Assert.assertEquals(
            (Integer) 7,
            cancerStudy.getMrnaRnaSeqV2SampleCount()
        );
        ...
        Assert.assertEquals(
            ...
            typeOfCancer.getName()
        );
        Assert.assertEquals(
            "breast,breast invasive",
            typeOfCancer.getClinicalTrialKeywords()
        );
    ...
    @Test
    public void getAllStudiesSummaryProjectionCancerStudyIdentifierSort()
        throws Exception {
        List<CancerStudy> result = studyMyBatisRepository.getAllStudies(
            null,
            "SUMMARY",
        ...
        Assert.assertEquals(
            "acc_tcga",
            result.get(0).getCancerStudyIdentifier()
        );
        Assert.assertEquals(
            "study_tcga_pub",
            result.get(1).getCancerStudyIdentifier()
        );
    }
    ...
    public void getStudyNullResult() throws Exception {
        CancerStudy result = studyMyBatisRepository.getStudy(
            "invalid_study",
            "DETAILED"
        );
    ...
    public void getStudy() throws Exception {
        ...
        Assert.assertEquals(
            (Integer) 1,
            result.getMethylationHm27SampleCount()
        );
    ...
    public void fetchStudies() throws Exception {
        List<CancerStudy> result = studyMyBatisRepository.fetchStudies(
    ...
    public void fetchMetaStudies() throws Exception {
        BaseMeta result = studyMyBatisRepository.fetchMetaStudies(
            Arrays.asList("study_tcga_pub", "acc_tcga")
        );
    ...
    public void getTags() throws Exception {
        CancerStudyTags result = studyMyBatisRepository.getTags(
            "study_tcga_pub"
        );
    ...
    public void getMultipleTags() throws Exception {
        List<CancerStudyTags> result = studyMyBatisRepository.getTagsForMultipleStudies(
            Arrays.asList("study_tcga_pub", "acc_tcga")
        );
