...
3. Import the study by running `docker compose exec cbioportal metaImport.py -s study/my_study_id/`. Again change `my_study_id` to the study you picked in 1. This should import the study.
