...
public class GenePanelControllerTest {
    ...
    private static final String TEST_MOLECULAR_PROFILE_ID_1 =
    ...
    private static final String TEST_MOLECULAR_PROFILE_ID_2 =
    ...
    public void getAllGenePanelsDetailedProjection() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].genePanelId")
                    .value(TEST_GENE_PANEL_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].genePanelId")
                    .value(TEST_GENE_PANEL_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
    ...
    public void getGenePanelNotFound() throws Exception {
        Mockito
            .when(genePanelService.getGenePanel(Mockito.anyString()))
            .thenThrow(new GenePanelNotFoundException("test_gene_panel_id"));

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/gene-panels/test_gene_panel_id")
                    .accept(MediaType.APPLICATION_JSON)
            )
    ...
    public void getGenePanel() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.genes[0].entrezGeneId")
                    .value(TEST_ENTREZ_GENE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.genes[0].hugoGeneSymbol")
                    .value(TEST_HUGO_GENE_SYMBOL_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.genes[1].entrezGeneId")
                    .value(TEST_ENTREZ_GENE_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.genes[1].hugoGeneSymbol")
                    .value(TEST_HUGO_GENE_SYMBOL_2)
            );
    }
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    ...
                    .content(
                        objectMapper.writeValueAsString(genePanelDataFilter)
                    )
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
            ...
            .andExpect(
                MockMvcResultMatchers
                    ...
                    .value(TEST_MOLECULAR_PROFILE_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].sampleId")
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].profiled").value(true)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].molecularProfileId")
                    .value(TEST_MOLECULAR_PROFILE_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].sampleId")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].studyId")
                    .value(TEST_STUDY_ID_2)
            )
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].profiled").value(true)
            );
    }
