package org.cbioportal.alteration.usecase;

import org.apache.commons.math3.util.Pair;
import org.cbioportal.alteration.repository.AlterationRepository;
import org.cbioportal.cancerstudy.usecase.GetFilteredStudyIdsUseCase;
import org.cbioportal.generic_assay.usecase.GetFilteredMolecularProfilesByAlterationType;
...
public class AlterationCountByGeneUseCase {
    ...
    private List<MolecularProfile> getFirstMolecularProfileGroupedByStudy(StudyViewFilterContext studyViewFilterContext, AlterationType alterationType) {
        final var molecularProfiles =
                getFilteredMolecularProfilesByAlterationType.excute(studyViewFilterContext, alterationType.toString());
