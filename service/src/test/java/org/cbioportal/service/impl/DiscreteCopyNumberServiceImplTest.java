...
public class DiscreteCopyNumberServiceImplTest extends BaseServiceImplTest {
    ...
    @Test
    public void getDiscreteCopyNumbersInMolecularProfileBySampleListIdHomdelOrAmp()
        throws Exception {
        ...
        Mockito
            .when(
                discreteCopyNumberRepository.getDiscreteCopyNumbersInMolecularProfileBySampleListId(
        ...
        List<DiscreteCopyNumberData> result = discreteCopyNumberService.getDiscreteCopyNumbersInMolecularProfileBySampleListId(
            MOLECULAR_PROFILE_ID,
            SAMPLE_LIST_ID,
            Arrays.asList(ENTREZ_GENE_ID_1),
            alterationTypes,
    ...
    @Test
    public void getDiscreteCopyNumbersInMolecularProfileBySampleListIdNonHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
        ...
        Assert.assertEquals(
            (Integer) (-1),
            discreteCopyNumberData.getAlteration()
        );
        Assert.assertEquals(
            MOLECULAR_PROFILE_ID,
        ...
        Assert.assertEquals(
            ENTREZ_GENE_ID_1,
            discreteCopyNumberData.getEntrezGeneId()
        );
        Assert.assertEquals(gene, discreteCopyNumberData.getGene());
    }

    @Test
    public void getMetaDiscreteCopyNumbersInMolecularProfileBySampleListIdHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
        ...
        Mockito
            .when(
                discreteCopyNumberRepository.getMetaDiscreteCopyNumbersInMolecularProfileBySampleListId(
                    MOLECULAR_PROFILE_ID,
                    SAMPLE_LIST_ID,
                    Arrays.asList(ENTREZ_GENE_ID_1),
                    alterationTypes
    ...
    @Test
    public void getMetaDiscreteCopyNumbersInMolecularProfileBySampleListIdNonHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
    ...
    @Test
    public void fetchDiscreteCopyNumbersInMolecularProfileHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
    ...
    @Test
    public void fetchDiscreteCopyNumbersInMolecularProfileNonHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
    ...
    @Test
    public void fetchMetaDiscreteCopyNumbersInMolecularProfileHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
        ...
        Mockito
            .when(
                discreteCopyNumberRepository.fetchMetaDiscreteCopyNumbersInMolecularProfile(
                    MOLECULAR_PROFILE_ID,
                    Arrays.asList(SAMPLE_ID1),
                    Arrays.asList(ENTREZ_GENE_ID_1),
                    alterationTypes
    ...
    @Test
    public void fetchMetaDiscreteCopyNumbersInMolecularProfileNonHomdelOrAmp()
        throws Exception {
        createMolecularProfile();
    ...
    public void getSampleCountByGeneAndAlteration() throws Exception {
        ...
        expectedCopyNumberSampleCountByGeneList.add(
            new CopyNumberCountByGene()
        );

        Mockito
            .when(
                discreteCopyNumberRepository.getSampleCountByGeneAndAlterationAndSampleIds(
                    MOLECULAR_PROFILE_ID,
                    null,
                    Arrays.asList(ENTREZ_GENE_ID_1),
                    Arrays.asList(-2)
        ...
        List<CopyNumberCountByGene> result = discreteCopyNumberService.getSampleCountByGeneAndAlterationAndSampleIds(
            MOLECULAR_PROFILE_ID,
            null,
            Arrays.asList(ENTREZ_GENE_ID_1),
            Arrays.asList(-2)
    ...
    public void getPatientCountInMultipleMolecularProfiles() throws Exception {
        ...
        Mockito
            .when(
                discreteCopyNumberRepository.getPatientCountInMultipleMolecularProfiles(
                    Arrays.asList(MOLECULAR_PROFILE_ID),
                    null,
                    Arrays.asList(ENTREZ_GENE_ID_1),
                    Arrays.asList(-2)
                )
        ...
        List<CopyNumberCountByGene> result = discreteCopyNumberService.getPatientCountInMultipleMolecularProfiles(
            Arrays.asList(MOLECULAR_PROFILE_ID),
            null,
            Arrays.asList(ENTREZ_GENE_ID_1),
            Arrays.asList(-2),
    ...
    public void fetchCopyNumberCounts() throws Exception {
        ...
        Mockito
            .when(
                molecularDataService.getNumberOfSamplesInMolecularProfile(
                    MOLECULAR_PROFILE_ID
                )
            )
            .thenReturn(2);
        ...
        Mockito
            .when(
                discreteCopyNumberService.getSampleCountByGeneAndAlterationAndSampleIds(
                    MOLECULAR_PROFILE_ID,
                    null,
                    Arrays.asList(ENTREZ_GENE_ID_1),
                    Arrays.asList(-2)
            ...
            .thenReturn(copyNumberSampleCountByGeneList);

        List<CopyNumberCount> result = discreteCopyNumberService.fetchCopyNumberCounts(
            MOLECULAR_PROFILE_ID,
            Arrays.asList(ENTREZ_GENE_ID_1),
            Arrays.asList(-2)
        );
        ...
        Assert.assertEquals(
            MOLECULAR_PROFILE_ID,
            copyNumberCount.getMolecularProfileId()
        );
        Assert.assertEquals(
            ENTREZ_GENE_ID_1,
            copyNumberCount.getEntrezGeneId()
        );
        ...
        Assert.assertEquals(
            (Integer) 1,
            copyNumberCount.getNumberOfSamplesWithAlterationInGene()
        );
    }

    private void createMolecularProfile()
