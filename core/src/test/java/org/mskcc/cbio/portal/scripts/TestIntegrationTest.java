...
public class TestIntegrationTest {
    ...
    public void testLoadStudyEs0() throws Throwable {
        try {
            ...
            assertEquals("TCGA-A1-A0SB-01", genesetData.get(1).getSampleId());
            assertEquals(-0.293861251463613, Double.parseDouble(genesetData.get(1).getValue()), 0.00001);
            assertEquals("TCGA-A1-A0SH-01", genesetData.get(0).getSampleId());
            assertEquals(-0.0811115513543749, Double.parseDouble(genesetData.get(0).getValue()), 0.00001);
