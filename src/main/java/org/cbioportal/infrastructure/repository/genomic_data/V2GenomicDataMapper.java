...
/**
 * Mapper interface for retrieving genomic data from DB.
 * This interface provides methods to fetch genomic data counts, including mutation counts and CNAs,
 * based on the study view filter context and genomic data filters.
 */
public interface V2GenomicDataMapper {
