...
@Profile("clickhouse")
/**
 * A use case class responsible for retrieving mutation counts based on the provided study view filter context
...
public class GetMutationCountsUseCase {
    ...
    /**
     * Executes the use case to retrieve mutation counts based on the provided study view filter context
     * and genomic data filter.
     *
     * @param studyViewFilterContext the context containing study view filter criteria.
     *                               Must not be {@code null}.
     * @param genomicDataFilter      the filter to apply to the genomic data for retrieving mutation counts.
     *                               Must not be {@code null}.
