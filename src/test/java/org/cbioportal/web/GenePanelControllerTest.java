...
public class GenePanelControllerTest {
  ...
  public void getAllGenePanelsDetailedProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/gene-panels/").accept(MediaType.APPLICATION_JSON))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].genes[0].entrezGeneId")
                .value(TEST_ENTREZ_GENE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].genes[0].hugoGeneSymbol")
                .value(TEST_HUGO_GENE_SYMBOL_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].genes[1].entrezGeneId")
                .value(TEST_ENTREZ_GENE_ID_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].genes[1].hugoGeneSymbol")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].genes[0].entrezGeneId")
                .value(TEST_ENTREZ_GENE_ID_3))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].genes[0].hugoGeneSymbol")
                .value(TEST_HUGO_GENE_SYMBOL_3))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].genes[1].entrezGeneId")
                .value(TEST_ENTREZ_GENE_ID_4))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].genes[1].hugoGeneSymbol")
  ...
  public void getAllGenePanelsMetaProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/gene-panels/").param("projection", "META"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  public void getGenePanelNotFound() throws Exception {
    ...
    Mockito.when(genePanelService.getGenePanel(Mockito.anyString()))
        .thenThrow(new GenePanelNotFoundException("test_gene_panel_id"));

    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/gene-panels/test_gene_panel_id")
  ...
  public void getGenePanel() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.genes[0].entrezGeneId").value(TEST_ENTREZ_GENE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.genes[0].hugoGeneSymbol")
                .value(TEST_HUGO_GENE_SYMBOL_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.genes[1].entrezGeneId").value(TEST_ENTREZ_GENE_ID_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.genes[1].hugoGeneSymbol")
                .value(TEST_HUGO_GENE_SYMBOL_2));
  }
}
