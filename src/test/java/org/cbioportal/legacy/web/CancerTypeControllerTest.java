...
public class CancerTypeControllerTest {
  ...
  @MockitoBean public CancerTypeService cancerTypeService;
  ...
  public void getAllCancerTypesDefaultProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/cancer-types").accept(MediaType.APPLICATION_JSON))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].dedicatedColor").value(TEST_DEDICATED_COLOR_1))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].dedicatedColor").value(TEST_DEDICATED_COLOR_2))
  ...
  public void getAllCancerTypesMetaProjection() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/cancer-types").param("projection", "META"))
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  public void getCancerTypeNotFound() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/api/cancer-types/cancer_type_id")
