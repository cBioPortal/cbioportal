...
import org.mskcc.cbio.importer.cvr.dmp.transformer.DmpSnpTransformer;
import org.mskcc.cbio.importer.persistence.staging.TsvStagingFileHandler;
import org.mskcc.cbio.importer.persistence.staging.mutation.MutationFileHandlerImpl;


public class TestDMPMutationsTransformer {

    private final static Logger logger = Logger.getLogger(TestDMPMutationsTransformer.class);
    private final DmpSnpTransformer transformer;

    public TestDMPMutationsTransformer() {
        TsvStagingFileHandler handler = new MutationFileHandlerImpl();
        this.transformer = new DmpSnpTransformer(handler,Paths.get("/tmp/dmp"));
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            TestDMPMutationsTransformer test = new TestDMPMutationsTransformer();
