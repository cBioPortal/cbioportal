...
INSERT INTO resource_node
  (RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, ENTITY_INTERNAL_ID, DISPLAY_NAME, URL)
SELECT
  rd.RESOURCE_ID, rd.CANCER_STUDY_ID, 'PATIENT', rp.INTERNAL_ID, rd.DISPLAY_NAME, rp.URL
...
INSERT INTO resource_node
  (RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, ENTITY_INTERNAL_ID, DISPLAY_NAME, URL)
SELECT
  rd.RESOURCE_ID, rd.CANCER_STUDY_ID, 'SAMPLE', rs.INTERNAL_ID, rd.DISPLAY_NAME, rs.URL
...
INSERT INTO resource_node
  (RESOURCE_ID, CANCER_STUDY_ID, ENTITY_TYPE, ENTITY_INTERNAL_ID, DISPLAY_NAME, URL)
SELECT
  rd.RESOURCE_ID, rd.CANCER_STUDY_ID, 'STUDY', rs.INTERNAL_ID, rd.DISPLAY_NAME, rs.URL
