...
public class StudyControllerTest {
    ...
    private static final String TEST_TAGS_1 =
    ...
    private static final String TEST_TYPE_OF_CANCER_ID_2 =
    ...
    private static final String TEST_TYPE_OF_CANCER_NAME =
        "test_type_of_cancer_name";
    private static final String TEST_CLINICAL_TRIAL_KEYWORDS =
        "test_clinical_trial_keywords";
    private static final String TEST_DEDICATED_COLOR = "test_dedicated_color";
    private static final String TEST_TYPE_OF_CANCER_SHORT_NAME =
        "test_type_of_cancer_short_name";
    private static final String TEST_PARENT = "test_parent";
    private static final String TEST_TAGS_3 =
        "{\"Analyst\":{\"Name\":\"Frank\",\"Email\":\"frank@something.com\"},\"Load id\":43}";
    ...
    public void getAllStudiesDefaultProjection() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].pmid").value(TEST_PMID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].publicStudy")
                    .value(TEST_PUBLIC_STUDY_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].shortName")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].cancerTypeId")
                    .value(TEST_TYPE_OF_CANCER_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].cancerStudyId")
                    .doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].pmid").value(TEST_PMID_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].publicStudy")
                    .value(TEST_PUBLIC_STUDY_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].shortName")
                    .value(TEST_SHORT_NAME_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].status")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].cancerTypeId")
                    .value(TEST_TYPE_OF_CANCER_ID_2)
            );
    }
    ...
    public void getAllStudiesMetaProjection() throws Exception {
        ...
        Mockito
            .when(studyService.getMetaStudies(Mockito.anyString()))
            .thenReturn(baseMeta);
    ...
    public void getStudyNotFound() throws Exception {
        Mockito
            .when(studyService.getStudy(Mockito.anyString()))
            .thenThrow(new StudyNotFoundException("test_study_id"));

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/studies/test_study_id")
                    .accept(MediaType.APPLICATION_JSON)
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.message")
                    .value("Study not found: test_study_id")
            );
    }
    ...
    public void getStudy() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.cancerStudyId").doesNotExist()
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.studyId")
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.groups").value(TEST_GROUPS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.importDate")
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.pmid").value(TEST_PMID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.publicStudy")
                    .value(TEST_PUBLIC_STUDY_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.status").value(TEST_STATUS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerTypeId")
                    .value(TEST_TYPE_OF_CANCER_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerType.cancerTypeId")
                    .value(TEST_TYPE_OF_CANCER_ID_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerType.name")
                    .value(TEST_TYPE_OF_CANCER_NAME)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerType.clinicalTrialKeywords")
                    .value(TEST_CLINICAL_TRIAL_KEYWORDS)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerType.dedicatedColor")
                    .value(TEST_DEDICATED_COLOR)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerType.shortName")
                    .value(TEST_TYPE_OF_CANCER_SHORT_NAME)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.cancerType.parent")
                    .value(TEST_PARENT)
            );
    }
    ...
    public void getTags() throws Exception {
        ...
        Mockito
            .when(studyService.getTags(Mockito.anyString()))
            .thenReturn(cancerStudyTags);

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/studies/test_study_id/tags")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
    ...
    public void getAllTags() throws Exception {
        ...
        Mockito
            .when(
                studyService.getTagsForMultipleStudies(
                    Mockito.anyListOf(String.class)
                )
            )
            .thenReturn(cancerStudyTagsList);

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post("/studies/tags/fetch")
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        objectMapper.writeValueAsString(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].tags").value(TEST_TAGS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].cancerStudyId")
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].tags").value(TEST_TAGS_3)
            );
    }
