...
./importProfileData.pl --data $CGDS_DATA_HOME/ovarian/data_mutations.txt --meta $CGDS_DATA_HOME/ovarian/meta_mutations_extended.txt --dbmsAction clobber  --germlineWhiteList $CGDS_DATA_HOME/ovarian/ovarianGermlineWhiteList.txt
