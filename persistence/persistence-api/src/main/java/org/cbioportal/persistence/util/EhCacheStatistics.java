...
public class EhCacheStatistics {
    ...
    public EhCacheStatistics(javax.cache.CacheManager cacheManager) {
        if (cacheManager == null) {
            throw new RuntimeException(
                "A CacheManager needs to be set before calling this method."
            );
        }
    ...
    public void initializeStatisticsService() {
        try {
            ...
            for (String cacheName : cacheManager.getCacheNames()) {
                ...
                org.ehcache.Cache ehCache = (org.ehcache.Cache) cache.unwrap(
    ...
    public String getCacheStatistics() {
        ...
        for (String cacheName : cacheManager.getCacheNames()) {
            ...
            builder.append(
                "Allocated (heap): " +
                getAllocatedBytes(cacheName, ResourceType.Core.HEAP) +
                "\n"
            );
            builder.append(
                "Occupied (heap): " +
            ...
            builder.append(
                "Allocated (disk): " +
                getAllocatedBytes(cacheName, ResourceType.Core.DISK) +
                "\n"
            );
            builder.append(
                "Occupied (disk): " +
                getOccupiedBytes(cacheName, "Disk", ResourceType.Core.DISK) +
                "\n"
            );
            builder.append("\n");
        }
    ...
    private String getAllocatedBytes(
        String cacheName,
        ...
        try {
            ...
            return (
                getAllocatedBytes(ehCache, resourceType) +
                getAllocatedUnit(ehCache, resourceType)
            );
    ...
    private String getOccupiedBytes(
        String cacheName,
        String tier,
        ResourceType.Core resourceType
    ) {
        try {
            CacheStatistics cacheStatistics = statisticsService.getCacheStatistics(
                cacheName
            );
    ...
    private String getAllocatedUnit(
        org.ehcache.Cache ehCache,
        ResourceType.Core resourceType
    )
        throws NullPointerException {
    ...
    private String scaleOccupiedBytes(
        ...
        if (allocatedUnit.equals("MB")) {
            return String.valueOf(
                String.format("%.01f", occupiedBytes / BYTES_IN_MB) +
                "MB (" +
                occupiedBytes +
                " bytes)"
            );
            ...
            return String.valueOf(
                String.format("%.01f", occupiedBytes / BYTES_IN_GB) +
                "GB (" +
                occupiedBytes +
                " bytes)"
            );
