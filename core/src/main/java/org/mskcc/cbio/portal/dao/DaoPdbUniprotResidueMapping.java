...
public final class DaoPdbUniprotResidueMapping {
    ...
    public static int addPdbUniprotAlignment(PdbUniprotAlignment alignment) {
        ...
        MySQLbulkLoader
            .getMySQLbulkLoader("pdb_uniprot_alignment")
            .insertRecord(
    ...
    public static int addPdbUniprotResidueMapping(
        PdbUniprotResidueMapping mapping
    )
        throws DaoException {
        if (!MySQLbulkLoader.isBulkLoad()) {
            throw new IllegalStateException("only bulk load is supported");
        ...
        MySQLbulkLoader
            .getMySQLbulkLoader("pdb_uniprot_residue_mapping")
            .insertRecord(
    ...
    public static int getLargestAlignmentId() throws DaoException {
        ...
        try {
            ...
            JdbcUtil.closeAll(
                DaoPdbUniprotResidueMapping.class,
                con,
                pstmt,
                rs
            );
     ...
     * @throws DaoException
     */
    public static List<PdbUniprotAlignment> getAlignments(String uniprotId)
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            ...
            pstmt =
                con.prepareStatement(
                    "SELECT * FROM pdb_uniprot_alignment " +
                    "WHERE UNIPROT_ID=? " +
     ...
     * @throws DaoException
     */
    public static Integer getAlignmentCount(String uniprotId)
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            ...
            pstmt =
                con.prepareStatement(
                    "SELECT COUNT(*) FROM pdb_uniprot_alignment " +
                    "WHERE UNIPROT_ID=?"
                );
            pstmt.setString(1, uniprotId);
            rs = pstmt.executeQuery();
     ...
     * @throws DaoException
     */
    public static List<PdbUniprotResidueMapping> getResidueMappings(
        Integer alignmentId
    )
        throws DaoException {
        Connection con = null;
        ...
        try {
            ...
            pstmt =
                con.prepareStatement(
                    "SELECT * FROM pdb_uniprot_residue_mapping " +
                    "WHERE ALIGNMENT_ID=? " +
     ...
     * @throws DaoException
     */
    public static Map<Integer, PdbUniprotResidueMapping> mapToPdbResidues(
        int alignmentId,
    ...
    public static void deleteAllRecords() throws DaoException {
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoPdbUniprotResidueMapping.class);
            pstmt =
                con.prepareStatement("TRUNCATE TABLE pdb_uniprot_alignment");
            pstmt.executeUpdate();
            pstmt =
                con.prepareStatement(
                    "TRUNCATE TABLE pdb_uniprot_residue_mapping"
                );
            pstmt.executeUpdate();
        } catch (SQLException e) {
            throw new DaoException(e);
     ...
     * @throws SQLException
     */
    private static PdbUniprotResidueMapping extractResidueMapping(ResultSet rs)
        throws SQLException {
        ...
        return new PdbUniprotResidueMapping(
            alignmentId,
            pdbPosition,
            pdbInsertion,
            uniprotPosition,
     ...
     * @throws SQLException
     */
    private static PdbUniprotAlignment extractAlignment(ResultSet rs)
        throws SQLException {
