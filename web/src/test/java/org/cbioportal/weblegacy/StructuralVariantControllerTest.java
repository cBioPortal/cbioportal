...
public class StructuralVariantControllerTest {
    ...
    private List<StructuralVariant> getStructuralVariantDataServiceFullResponseMock() {
        ...
        structuralVariant1.setSite1Chromosome("17");
        structuralVariant1.setSite1Description("Intron of ERBB2(+): 51bp after exon 26");
        structuralVariant1.setSite1HugoSymbol("ERBB2");
        structuralVariant1.setSite1Position(37883851);
        structuralVariant1.setGene1(geneERBB2);
        structuralVariant1.setSite2Chromosome("17");
        structuralVariant1.setSite2Description("5-UTR of GRB7(+): 1Kb before coding start");
        structuralVariant1.setSite2HugoSymbol("GRB7");
        structuralVariant1.setSite2Position(37897379);
        ...
        structuralVariant2.setSite1HugoGeneSymbol("ERBB2");
        ...
        structuralVariant2.setSite2HugoGeneSymbol("GRB7");
        ...
        structuralVariant3.setSite1HugoGeneSymbol("ERBB2");
        ...
        structuralVariant3.setSite2HugoGeneSymbol("ERBB2");
