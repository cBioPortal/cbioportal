...
public class DiscreteCopyNumberControllerTest {
    ...
    private static final int TEST_NUMBER_OF_SAMPLES_WITH_ALTERATION_IN_GENE_1 =
        4;
    private static final int TEST_NUMBER_OF_SAMPLES_2 = 10;
    private static final int TEST_NUMBER_OF_SAMPLES_WITH_ALTERATION_IN_GENE_2 =
        8;
    ...
    @Test
    public void getDiscreteCopyNumbersInMolecularProfileBySampleListIdDefaultProjection()
        throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get(
                        "/molecular-profiles/test_molecular_profile_id/discrete-copy-number"
                    )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].alteration")
                    .value(TEST_ALTERATION_1)
            )
            .andExpect(
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].alteration")
                    .value(TEST_ALTERATION_2)
            )
            .andExpect(
    ...
    @Test
    public void getDiscreteCopyNumbersInMolecularProfileBySampleListIdMetaProjection()
        throws Exception {
    ...
    @Test
    public void fetchDiscreteCopyNumbersInMolecularProfileDefaultProjection()
        throws Exception {
        List<DiscreteCopyNumberData> discreteCopyNumberDataList = createExampleDiscreteCopyNumberData();
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post(
                        "/molecular-profiles/test_molecular_profile_id/discrete-copy-number/fetch"
                    )
                    .param(
                        "discreteCopyNumberEventType",
                        DiscreteCopyNumberEventType.HOMDEL_AND_AMP.name()
    ...
    @Test
    public void fetchDiscreteCopyNumbersInMolecularProfileDetailedProjection()
        throws Exception {
        List<DiscreteCopyNumberData> discreteCopyNumberDataList = createExampleDiscreteCopyNumberDataWithGenes();
    ...
    @Test
    public void fetchDiscreteCopyNumbersInMolecularProfileMetaProjection()
        throws Exception {
        BaseMeta baseMeta = new BaseMeta();
        baseMeta.setTotalCount(2);
    ...
    public void fetchCopyNumberCounts() throws Exception {
        ...
        copyNumberCount1.setMolecularProfileId(
            TEST_MOLECULAR_PROFILE_STABLE_ID_1
        );
        ...
        copyNumberCount1.setNumberOfSamplesWithAlterationInGene(
            TEST_NUMBER_OF_SAMPLES_WITH_ALTERATION_IN_GENE_1
        );
        copyNumberCountList.add(copyNumberCount1);
        CopyNumberCount copyNumberCount2 = new CopyNumberCount();
        copyNumberCount2.setMolecularProfileId(
            TEST_MOLECULAR_PROFILE_STABLE_ID_1
        );
        ...
        copyNumberCount2.setNumberOfSamplesWithAlterationInGene(
            TEST_NUMBER_OF_SAMPLES_WITH_ALTERATION_IN_GENE_2
        );
        copyNumberCountList.add(copyNumberCount2);

        Mockito
            .when(
                discreteCopyNumberService.fetchCopyNumberCounts(
                    Mockito.anyString(),
                    Mockito.anyListOf(Integer.class),
                    Mockito.anyListOf(Integer.class)
                )
            )
            .thenReturn(copyNumberCountList);
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .post(
                        "/molecular-profiles/test_molecular_profile_id/discrete-copy-number-counts/fetch"
                    )
                    .accept(MediaType.APPLICATION_JSON)
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].numberOfSamples")
                    .value(TEST_NUMBER_OF_SAMPLES_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].numberOfSamplesWithAlterationInGene")
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].numberOfSamples")
                    .value(TEST_NUMBER_OF_SAMPLES_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].numberOfSamplesWithAlterationInGene")
    ...
    private List<DiscreteCopyNumberData> createExampleDiscreteCopyNumberData() {
        ...
        discreteCopyNumberData1.setMolecularProfileId(
            TEST_MOLECULAR_PROFILE_STABLE_ID_1
        );
        ...
        discreteCopyNumberData2.setMolecularProfileId(
            TEST_MOLECULAR_PROFILE_STABLE_ID_2
        );
