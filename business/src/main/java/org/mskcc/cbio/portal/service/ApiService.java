...
public class ApiService {
  ...
  // if we make this method public again, secure it
	@Transactional
	private List<DBClinicalField> getSampleClinicalAttributesByInternalIds(List<Integer> sample_ids) {
  ...
  // if we make this method public again, secure it
	@Transactional
	private List<DBClinicalField> getPatientClinicalAttributesByInternalIds(List<Integer> patient_ids) {
