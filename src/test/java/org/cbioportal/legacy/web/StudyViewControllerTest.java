...
public class StudyViewControllerTest {
  ...
  public void fetchClinicalDataCounts() throws Exception {
    ...
    when(clinicalDataService.fetchClinicalDataCounts(anyList(), anyList(), anyList()))
  ...
  public void fetchClinicalDataBinCounts() throws Exception {
    ...
    when(clinicalDataService.fetchClinicalData(
            anyList(), anyList(), anyList(), any(String.class), any(String.class)))
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/clinical-data-bin-counts/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].specialValue").value(TEST_CLINICAL_DATA_VALUE_1))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[2].specialValue").value(TEST_CLINICAL_DATA_VALUE_2))
  ...
  public void fetchGenomicDataCounts() throws Exception {
    ...
    when(studyViewService.getCNAAlterationCountsByGeneSpecific(anyList(), anyList(), anyList()))
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].hugoGeneSymbol").value(TEST_HUGO_GENE_SYMBOL_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].profileType").value(TEST_MOLECULAR_PROFILE_TYPE))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].counts[0].label")
                .value(TEST_CNA_ALTERATION_NAME_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].counts[0].value")
                .value(TEST_CNA_ALTERATION_VALUE_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].counts[0].count").value(1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].counts[1].label")
                .value(TEST_CNA_ALTERATION_NAME_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].counts[1].value")
                .value(TEST_CNA_ALTERATION_VALUE_2))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].counts[1].count").value(1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].hugoGeneSymbol").value(TEST_HUGO_GENE_SYMBOL_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].profileType").value(TEST_MOLECULAR_PROFILE_TYPE))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].counts[0].label")
                .value(TEST_CNA_ALTERATION_NAME_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].counts[0].value")
                .value(TEST_CNA_ALTERATION_VALUE_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$[1].counts[0].count").value(1))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].counts[1].label")
                .value(TEST_CNA_ALTERATION_NAME_2))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].counts[1].value")
                .value(TEST_CNA_ALTERATION_VALUE_2))
  ...
  public void fetchClinicalDataDensityPlot() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/clinical-data-density-plot/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(studyViewFilter))
        ...
        .andExpect(MockMvcResultMatchers.jsonPath("$.bins[2].minY").value(400.0))
        .andExpect(MockMvcResultMatchers.jsonPath("$.bins[2].maxY").value(400.0))
  ...
  public void fetchClinicalDataClinicalTable() throws Exception {
    ...
    when(clinicalDataService.fetchSampleClinicalTable(
            anyList(), anyList(), anyInt(), anyInt(), anyString(), any(), anyString()))
        .thenReturn(new ImmutablePair<>(tableClinicalData, 100));
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/clinical-data-table/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(studyViewFilter)))
        ...
        .andExpect(
            MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
        .andExpect(
            MockMvcResultMatchers.jsonPath(jsonPath + "[0].clinicalAttributeId", uniqueKeySample1)
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath(jsonPath + "[0].sampleId").value(TEST_SAMPLE_ID_1))
        .andExpect(
            MockMvcResultMatchers.jsonPath(jsonPath + "[1].clinicalAttributeId")
                .value(TEST_ATTRIBUTE_ID))
        .andExpect(
            MockMvcResultMatchers.jsonPath(jsonPath + "[1].sampleId").value(TEST_SAMPLE_ID_2))
        .andExpect(
  ...
  public void fetchClinicalEventTypeCounts() throws Exception {
    List<ClinicalEventTypeCount> testEventTypeCounts =
        Arrays.asList(
            new ClinicalEventTypeCount(TEST_CLINICAL_EVENT_TYPE, TEST_CLINICAL_EVENT_TYPE_COUNT));
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].count").value(TEST_CLINICAL_EVENT_TYPE_COUNT));
  }
  ...
  public void validateStructVarFilter() throws Exception {
    ...
    final StructuralVariantFilterQuery structVarFilterQuery =
        new StructuralVariantFilterQuery(
            "A", null, "B", null, true, true, true, Select.all(), true, true, true, true);
    final StudyViewStructuralVariantFilter structuralVariantFilter =
  ...
  public void validateStructVarFilterBothNoGeneId() throws Exception {
    ...
    final StructuralVariantFilterQuery structVarFilterQuery =
        new StructuralVariantFilterQuery(
            null, null, null, null, true, true, true, Select.all(), true, true, true, true);
  ...
  public void validateStructVarFilterBothGeneIdAndSpecialValueNull() throws Exception {
    ...
    final StructuralVariantFilterQuery structVarFilterQuery =
        new StructuralVariantFilterQuery(
            null, null, "B", null, true, true, true, Select.all(), true, true, true, true);
  ...
  public void fetchMutationDataCounts() throws Exception {
    ...
    when(studyViewService.getMutationCountsByGeneSpecific(
            anyList(), anyList(), anyList(), any(AlterationFilter.class)))
        .thenReturn(genomicDataCountItems);
  ...
  public void fetchNamespaceDataCounts() throws Exception {
    ...
    when(studyViewService.fetchNamespaceDataCounts(anyList(), anyList(), anyList()))
        .thenReturn(namespaceDataCountItems);
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/namespace-data-counts/fetch")
                .with(csrf())
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].counts[0].value")
                .value(TEST_NAMESPACE_DATA_VALUE_1))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].counts[0].count").value(3))
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].counts[1].value")
                .value(TEST_NAMESPACE_DATA_VALUE_2))
        .andExpect(MockMvcResultMatchers.jsonPath("$[0].counts[1].count").value(1));
  }
}
