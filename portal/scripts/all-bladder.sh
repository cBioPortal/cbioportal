...
#rm -v $CGDS_DATA_HOME/bladder/processed_*
...
#./importProfileData.pl --data $CGDS_DATA_HOME/bladder/data_mRNA_DBCG.txt --meta $CGDS_DATA_HOME/bladder/meta_mRNA_DBCG.txt --dbmsAction clobber
#./importProfileData.pl --data $CGDS_DATA_HOME/bladder/data_mRNA_DBCG_Z.txt --meta $CGDS_DATA_HOME/bladder/meta_mRNA_DBCG_Z.txt --dbmsAction clobber
#./importProfileData.pl --data $CGDS_DATA_HOME/bladder/data_mRNA_FW_MDG.txt --meta $CGDS_DATA_HOME/bladder/meta_mRNA_FW_MDG.txt --dbmsAction clobber
#./importProfileData.pl --data $CGDS_DATA_HOME/bladder/data_mRNA_MicMa.txt --meta $CGDS_DATA_HOME/bladder/meta_mRNA_MicMa.txt --dbmsAction clobber
#./importProfileData.pl --data $CGDS_DATA_HOME/bladder/data_mRNA_ULL.txt --meta $CGDS_DATA_HOME/bladder/meta_mRNA_ULL.txt --dbmsAction clobber
