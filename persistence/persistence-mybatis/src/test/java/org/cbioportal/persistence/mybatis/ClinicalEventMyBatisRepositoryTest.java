...
public class ClinicalEventMyBatisRepositoryTest {
    ...
    @Test
    public void getAllClinicalEventsOfPatientInStudyIdProjection()
        throws Exception {
    ...
    @Test
    public void getAllClinicalEventsOfPatientInStudySummaryProjection()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB",
    ...
    @Test
    public void getAllClinicalEventsOfPatientInStudyDetailedProjection()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB",
    ...
    @Test
    public void getAllClinicalEventsOfPatientInStudySummaryProjection1PageSize()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsOfPatientInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB",
    ...
    public void getMetaPatientClinicalEvents() throws Exception {
        BaseMeta result = clinicalEventMyBatisRepository.getMetaPatientClinicalEvents(
            "study_tcga_pub",
            "TCGA-A1-A0SB"
        );
    ...
    public void getDataOfClinicalEvents() throws Exception {
        ...
        List<ClinicalEventData> result = clinicalEventMyBatisRepository.getDataOfClinicalEvents(
            clinicalEventIds
        );
    ...
    @Test
    public void getAllClinicalEventsInStudySummaryProjection()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    @Test
    public void getAllClinicalEventsInStudyDetailedProjection()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsInStudy(
            "study_tcga_pub",
            "DETAILED",
    ...
    @Test
    public void getAllClinicalEventsInStudySummaryProjection1PageSize()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    @Test
    public void getAllClinicalEventsInStudySummaryProjectionEventTypeSort()
        throws Exception {
        List<ClinicalEvent> result = clinicalEventMyBatisRepository.getAllClinicalEventsInStudy(
            "study_tcga_pub",
            "SUMMARY",
    ...
    public void getMetaClinicalEvents() throws Exception {
        BaseMeta result = clinicalEventMyBatisRepository.getMetaClinicalEvents(
            "study_tcga_pub"
        );
