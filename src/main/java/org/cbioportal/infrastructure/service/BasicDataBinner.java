    ...
    public <T extends DataBinCountFilter, S extends DataBinFilter, U extends DataBin> List<U> getDataBins(
        ...
        switch (dataBinCountFilter) {
            ...
            case ClinicalDataBinCountFilter clinicalDataBinCountFilter -> {
                unfilteredClinicalDataCounts = studyViewService.getClinicalDataCounts(partialFilter, uniqueKeys);
                filteredClinicalDataCounts = studyViewService.getClinicalDataCounts(studyViewFilter, uniqueKeys);
            ...
            case GenomicDataBinCountFilter genomicDataBinCountFilter -> {
                unfilteredClinicalDataCounts = studyViewService.getGenomicDataBinCounts(partialFilter, genomicDataBinCountFilter.getGenomicDataBinFilters());
                filteredClinicalDataCounts = studyViewService.getGenomicDataBinCounts(studyViewFilter, genomicDataBinCountFilter.getGenomicDataBinFilters());
                attributeDatatypeMap = Collections.emptyMap();
            }
            case GenericAssayDataBinCountFilter genericAssayDataBinCountFilter -> {
                unfilteredClinicalDataCounts = studyViewService.getGenericAssayDataBinCounts(partialFilter, genericAssayDataBinCountFilter.getGenericAssayDataBinFilters());
                filteredClinicalDataCounts = studyViewService.getGenericAssayDataBinCounts(studyViewFilter, genericAssayDataBinCountFilter.getGenericAssayDataBinFilters());
                attributeDatatypeMap = Collections.emptyMap();
            }
            default -> {
