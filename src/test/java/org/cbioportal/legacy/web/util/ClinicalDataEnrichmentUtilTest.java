...
public class ClinicalDataEnrichmentUtilTest {
  ...
  @InjectMocks private ClinicalDataEnrichmentUtil clinicalDataEnrichmentUtil;
  ...
  public void fetchClinicalDataEnrichemnts() {
    ...
    List<ClinicalAttribute> attributes =
        Arrays.asList(attribute1, attribute2, attribute3, attribute4);
    ...
    when(clinicalDataService.fetchClinicalDataCounts(
    ...
    List<ClinicalDataEnrichment> actualClinicalDataEnrichments =
    ...
    when(clinicalDataService.fetchClinicalDataCounts(
            ...
            Arrays.asList(CLINICAL_ATTRIBUTE_ID_1, CLINICAL_ATTRIBUTE_ID_2)))
        .thenReturn(
            Arrays.asList(group2sampleClinicalDataCountItem, group2patientClinicalDataCountItem));
  ...
  public void createEnrichmentsForNumericData() {
    ...
    when(clinicalDataService.fetchClinicalData(
            ...
            "SAMPLE",
            "SUMMARY"))
        .thenReturn(Arrays.asList(sampleClinicalData3, sampleClinicalData4, sampleClinicalData5));
    ...
    when(clinicalDataService.fetchClinicalData(
            ...
            "SUMMARY"))
        .thenReturn(
            Arrays.asList(patientClinicalData3, patientClinicalData4, patientClinicalData5));

    List<ClinicalDataEnrichment> actualClinicalDataEnrichments =
        clinicalDataEnrichmentUtil.createEnrichmentsForNumericData(attributes, groupedSamples);

    // when there is data for more than one group
    Assert.assertEquals(2, actualClinicalDataEnrichments.size());
    Assert.assertEquals(
        "0.7670968826920188", actualClinicalDataEnrichments.get(0).getpValue().toString());
    Assert.assertEquals(
        "0.08771942638231253", actualClinicalDataEnrichments.get(0).getScore().toString());
