...
public class ColumnStoreSampleController {
  ...
  public ColumnStoreSampleController(SampleUseCases sampleUseCases, StudyService studyService) {
    ...
    if (projection == ProjectionType.META) {
      ...
      List<Sample> samples =
          sampleUseCases
              ...
              .execute(keyword, studyIds, projection, pageSize, pageNumber, sort, direction.name());
  ...
  public ResponseEntity<List<SampleDTO>> fetchSamples(
      ...
      @Parameter(description = "Level of detail of the response")
          @RequestParam(defaultValue = "SUMMARY")
          ProjectionType projection) {
    SampleFilter effectiveFilter = sampleFilter;
  ...
  public ResponseEntity<List<SampleDTO>> getAllSamplesOfPatientInStudy(
    ...
    if (projection == ProjectionType.META) {
      ...
      List<Sample> samples =
          sampleUseCases
              .getAllSamplesOfPatientInStudyUseCase()
              .execute(
                  studyId,
                  patientId,
                  projection,
  ...
  private HttpHeaders fetchMetaSamplesHeaders(SampleFilter sampleFilter) {
  ...
  private HttpHeaders getMetaSamplesHeaders(String keyword, List<String> studyIds) {
    ...
    httpHeaders.add(
        ...
        sampleUseCases
            .getMetaSamplesUseCase()
            .execute(keyword, studyIds)
            .getTotalCount()
            .toString());
  ...
  private HttpHeaders getMetaSamplesOfPatientInStudyHeaders(String studyId, String patientId)
      throws StudyNotFoundException, PatientNotFoundException {
    HttpHeaders httpHeaders = new HttpHeaders();
    httpHeaders.add(
        HeaderKeyConstants.TOTAL_COUNT,
        sampleUseCases
            .getMetaSamplesOfPatientInStudyUseCase()
            .execute(studyId, patientId)
            .getTotalCount()
            .toString());
