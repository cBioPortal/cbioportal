...
public class CustomEhCachingProvider extends EhcacheCachingProvider {
        ...
        try {
            if (CacheEnabledConfig.enableCache(cacheType)) {
                ...
                XmlConfiguration xmlConfiguration = new XmlConfiguration(
                    getClass().getResource(xmlConfigurationFile)
                );
                ...
                if (!cacheType.equalsIgnoreCase(CacheEnabledConfig.DISK)) {
                    ...
                    staticRepositoryCacheOneResourcePoolsBuilder =
                        staticRepositoryCacheOneResourcePoolsBuilder.heap(
                            staticRepositoryCacheOneMaxMegaBytes,
                            MemoryUnit.MB
                        );
                }
                ...
                if (!cacheType.equalsIgnoreCase(CacheEnabledConfig.HEAP)) {
                    generalRepositoryCacheResourcePoolsBuilder =
                        generalRepositoryCacheResourcePoolsBuilder.disk(
                            generalRepositoryCacheMaxMegaBytesLocalDisk,
                            MemoryUnit.MB
                        );
                    staticRepositoryCacheOneResourcePoolsBuilder =
                        staticRepositoryCacheOneResourcePoolsBuilder.disk(
                            staticRepositoryCacheOneMaxMegaBytesLocalDisk,
                            MemoryUnit.MB
                        );
                }

                CacheConfiguration<Object, Object> generalRepositoryCacheConfiguration = xmlConfiguration
                    ...
                    .build();
                CacheConfiguration<Object, Object> staticRepositoryCacheOneConfiguration = xmlConfiguration
                    .newCacheConfigurationBuilderFromTemplate(
                        "RepositoryCacheTemplate",
                        Object.class,
                        Object.class,
                ...
                if (cacheType.equalsIgnoreCase(CacheEnabledConfig.HEAP)) {
                    ...
                    configuration =
                        new DefaultConfiguration(
                            caches,
                            this.getDefaultClassLoader(),
                            new DefaultPersistenceConfiguration(persistenceFile)
                        );
                }

                toReturn =
                    this.getCacheManager(this.getDefaultURI(), configuration);
            } else {
                ...
                CacheConfiguration<Object, Object> generalRepositoryCacheConfiguration = CacheConfigurationBuilder
                    ...
                    .build();
                CacheConfiguration<Object, Object> staticRepositoryCacheOneConfiguration = CacheConfigurationBuilder
                    .newCacheConfigurationBuilder(
                        Object.class,
                        Object.class,
                        ResourcePoolsBuilder
    ...
    public void detectCacheConfigurationErrorsAndLog() {
        String MESSAGE_PREFIX =
            "Errors detected during configuration of Ehcache:";
        ...
        if (usesDisk || usesHeap) {
            if (
                ...
                xmlConfigurationFile.trim().length() == 0
            ) {
                messages.append(
                    "\n  property ehcache.xml_configuration is required but is unset"
                );
            } else {
                URL configFileURL = getClass()
                    .getResource(xmlConfigurationFile);
                if (configFileURL == null) {
                    messages
                        ...
                        .append(
                            ") but this resource is not available to the classloader"
                        );
                } else {
                    ...
                    if (!readable) {
                        messages
                            ...
                            .append(xmlConfigurationFile)
                            .append(
                                ") but an attempt to read from this resource failed"
                            );
                    }
                }
            }
        ...
        if (usesDisk) {
            ...
            if (
                persistencePath == null || persistencePath.trim().length() == 0
            ) {
                messages.append(
                ...
                try {
                    if (
                        persistenceDirectory.isDirectory() &&
                        persistenceDirectory.canWrite()
                    ) {
                        accessible = true;
                    }
                ...
                if (!accessible) {
                    messages
                        ...
                        .append(
                            ") but this path does not exist or is not an accessible directory"
                        );
                }
            }
        }
        ...
        if (usesHeap && usesDisk) {
            if (
                generalRepositoryCacheMaxMegaBytesLocalDisk != null &&
                ...
                messages.append(
                    "property ehcache.general_repository_cache.max_mega_bytes_local_disk, however "
                );
            ...
            if (
                staticRepositoryCacheOneMaxMegaBytesLocalDisk != null &&
                ...
                messages.append(
                    "property ehcache.static_repository_cache_one.max_mega_bytes_local_disk, however "
                );
        ...
        if (messages.length() > MESSAGE_PREFIX.length()) {
            ...
            LOG.error(
                "because of Ehcache configuration errors, it is likely that an exception will be thrown during startup. Recent observed exceptions contain the string" +
