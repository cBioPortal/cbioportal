...
public class SampleListServiceImplTest extends BaseServiceImplTest {
    ...
    public void getAllSampleLists() throws Exception {
        ...
        Mockito
            .when(sampleListRepository.getSampleListSampleIds(Arrays.asList(1)))
        ...
        List<SampleList> result = sampleListService.getAllSampleLists(
            "DETAILED",
            PAGE_SIZE,
            PAGE_NUMBER,
            SORT,
        ...
        Assert.assertEquals(
            (Integer) 1,
            expectedSampleLists.get(0).getSampleCount()
        );
    }
    ...
    public void getMetaSampleLists() throws Exception {
        ...
        Mockito
            .when(sampleListRepository.getMetaSampleLists())
    ...
    public void getSampleListNotFound() throws Exception {
        Mockito
            .when(sampleListRepository.getSampleList(SAMPLE_LIST_ID))
            .thenReturn(null);
    ...
    public void getAllSampleListsInStudy() throws Exception {
        ...
        Mockito
            .when(
                sampleListRepository.getAllSampleListsInStudy(
                    STUDY_ID,
                    "DETAILED",
                    PAGE_SIZE,
                    PAGE_NUMBER,
        ...
        List<SampleList> result = sampleListService.getAllSampleListsInStudy(
            STUDY_ID,
            "DETAILED",
            PAGE_SIZE,
            PAGE_NUMBER,
    ...
    public void getMetaSampleListsInStudy() throws Exception {
        ...
        Mockito
            .when(sampleListRepository.getMetaSampleListsInStudy(STUDY_ID))
            .thenReturn(expectedBaseMeta);
    ...
    public void getAllSampleIdsInSampleList() throws Exception {
        ...
        List<String> result = sampleListService.getAllSampleIdsInSampleList(
            SAMPLE_LIST_ID
        );
    ...
    public void fetchSampleLists() throws Exception {
        ...
        Mockito
            .when(
                sampleListRepository.getSampleLists(
        ...
        List<SampleList> result = sampleListService.fetchSampleLists(
            Arrays.asList(SAMPLE_LIST_ID),
            "DETAILED"
        );
