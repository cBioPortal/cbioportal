...
public class CopyNumberSegmentMyBatisRepositoryTest {
    ...
    @Test
    public void getCopyNumberSegmentsInSampleInStudySummaryProjection()
        throws Exception {
        ...
        Assert.assertEquals(
            new BigDecimal("0.0519"),
            copyNumberSeg.getSegmentMean()
        );
    ...
    @Test
    public void getCopyNumberSegmentsInSampleInStudyDetailedProjection()
        throws Exception {
    ...
    @Test
    public void getCopyNumberSegmentsInSampleInStudySummaryProjection1PageSize()
        throws Exception {
        List<CopyNumberSeg> result = copyNumberSegmentMyBatisRepository.getCopyNumberSegmentsInSampleInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB-01",
    ...
    @Test
    public void getCopyNumberSegmentsInSampleInStudySummaryProjectionStartSort()
        throws Exception {
        List<CopyNumberSeg> result = copyNumberSegmentMyBatisRepository.getCopyNumberSegmentsInSampleInStudy(
            "study_tcga_pub",
            "TCGA-A1-A0SB-01",
    ...
    public void fetchCopyNumberSegments() throws Exception {
        ...
        Assert.assertEquals(
            "TCGA-A1-A0SB-01",
            result0.get(1).getSampleStableId()
        );
        Assert.assertEquals(
            "TCGA-A1-A0SB-01",
            result0.get(2).getSampleStableId()
        );
        ...
        Assert.assertEquals(
            "TCGA-A1-B0SO-01",
            result2.get(0).getSampleStableId()
        );
        Assert.assertEquals(
            "TCGA-A1-A0SB-01",
            result2.get(1).getSampleStableId()
        );
    ...
    public void fetchMetaCopyNumberSegments() throws Exception {
        ...
        BaseMeta result0 = copyNumberSegmentMyBatisRepository.fetchMetaCopyNumberSegments(
            studyIds,
            sampleIds,
            null
        );
        BaseMeta result1 = copyNumberSegmentMyBatisRepository.fetchMetaCopyNumberSegments(
            studyIds,
            sampleIds,
            "1"
        );
        BaseMeta result2 = copyNumberSegmentMyBatisRepository.fetchMetaCopyNumberSegments(
            studyIds,
            sampleIds,
            "2"
        );
        BaseMeta result3 = copyNumberSegmentMyBatisRepository.fetchMetaCopyNumberSegments(
            studyIds,
            sampleIds,
            "3"
        );
