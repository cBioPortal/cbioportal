(function(a,p){"object"===typeof module&&"object"===typeof module.exports?module.exports=a.document?p(a,!0):function(a){if(!a.document)throw Error("jQuery requires a window with a document");return p(a)}:p(a)})("undefined"!==typeof window?window:this,function(a,p){function g(l){var a=l.length,b=h.type(l);return"function"===b||h.isWindow(l)?!1:1===l.nodeType&&a?!0:"array"===b||0===a||"number"===typeof a&&0<a&&a-1 in l}function k(l,a,b){if(h.isFunction(a))return h.grep(l,function(l,c){return!!a.call(l,
c,l)!==b});if(a.nodeType)return h.grep(l,function(l){return l===a!==b});if("string"===typeof a){if(Uc.test(a))return h.filter(a,l,b);a=h.filter(a,l)}return h.grep(l,function(l){return 0<=h.inArray(l,a)!==b})}function e(l,a){do l=l[a];while(l&&1!==l.nodeType);return l}function m(){u.addEventListener?(u.removeEventListener("DOMContentLoaded",d,!1),a.removeEventListener("load",d,!1)):(u.detachEvent("onreadystatechange",d),a.detachEvent("onload",d))}function d(){if(u.addEventListener||"load"===event.type||
"complete"===u.readyState)m(),h.ready()}function c(l,a,b){if(void 0===b&&1===l.nodeType)if(b="data-"+a.replace(Vc,"-$1").toLowerCase(),b=l.getAttribute(b),"string"===typeof b){try{b="true"===b?!0:"false"===b?!1:"null"===b?null:+b+""===b?+b:Wc.test(b)?h.parseJSON(b):b}catch(c){}h.data(l,a,b)}else b=void 0;return b}function b(l){for(var a in l)if(!("data"===a&&h.isEmptyObject(l[a]))&&"toJSON"!==a)return!1;return!0}function f(l,a,b,c){if(h.acceptData(l)){var d=h.expando,f=l.nodeType,j=f?h.cache:l,q=
f?l[d]:l[d]&&d;if(q&&j[q]&&(c||j[q].data)||!(void 0===b&&"string"===typeof a)){q||(q=f?l[d]=$.pop()||h.guid++:d);j[q]||(j[q]=f?{}:{toJSON:h.noop});if("object"===typeof a||"function"===typeof a)c?j[q]=h.extend(j[q],a):j[q].data=h.extend(j[q].data,a);l=j[q];c||(l.data||(l.data={}),l=l.data);void 0!==b&&(l[h.camelCase(a)]=b);"string"===typeof a?(b=l[a],null==b&&(b=l[h.camelCase(a)])):b=l;return b}}}function q(l,a,c){if(h.acceptData(l)){var d,f,j=l.nodeType,q=j?h.cache:l,r=j?l[h.expando]:h.expando;if(q[r]){if(a&&
(d=c?q[r]:q[r].data)){h.isArray(a)?a=a.concat(h.map(a,h.camelCase)):a in d?a=[a]:(a=h.camelCase(a),a=a in d?[a]:a.split(" "));for(f=a.length;f--;)delete d[a[f]];if(c?!b(d):!h.isEmptyObject(d))return}if(!c&&(delete q[r].data,!b(q[r])))return;j?h.cleanData([l],!0):t.deleteExpando||q!=q.window?delete q[r]:q[r]=null}}}function s(){return!0}function j(){return!1}function r(){try{return u.activeElement}catch(l){}}function G(l){var a=Sb.split("|");l=l.createDocumentFragment();if(l.createElement)for(;a.length;)l.createElement(a.pop());
...
0,f=l.length,j=!b;d<f;d++)b=!a(l[d],d),b!==j&&c.push(l[d]);return c},map:function(l,a,b){var c,d=0,f=l.length,j=[];if(g(l))for(;d<f;d++)c=a(l[d],d,b),null!=c&&j.push(c);else for(d in l)c=a(l[d],d,b),null!=c&&j.push(c);return kc.apply([],j)},guid:1,proxy:function(l,a){var b,c;"string"===typeof a&&(c=l[a],a=l,l=c);if(h.isFunction(l))return b=aa.call(arguments,2),c=function(){return l.apply(a||this,b.concat(aa.call(arguments)))},c.guid=l.guid=l.guid||h.guid++,c},now:function(){return+new Date},support:t});
h.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(l,a){Oa["[object "+a+"]"]=a.toLowerCase()});var rb=a,y=function(l,a,b,c){var d,f,j,h,q;(a?a.ownerDocument||a:S)!==K&&ba(a);a=a||K;b=b||[];if(!l||"string"!==typeof l)return b;if(1!==(h=a.nodeType)&&9!==h)return[];if(X&&!c){if(d=fd.exec(l))if(j=d[1])if(9===h)if((f=a.getElementById(j))&&f.parentNode){if(f.id===j)return b.push(f),b}else return b;else{if(a.ownerDocument&&(f=a.ownerDocument.getElementById(j))&&Ea(a,
f)&&f.id===j)return b.push(f),b}else{if(d[2])return ca.apply(b,a.getElementsByTagName(l)),b;if((j=d[3])&&z.getElementsByClassName&&a.getElementsByClassName)return ca.apply(b,a.getElementsByClassName(j)),b}if(z.qsa&&(!O||!O.test(l))){f=d=F;j=a;q=9===h&&l;if(1===h&&"object"!==a.nodeName.toLowerCase()){h=Pa(l);(d=a.getAttribute("id"))?f=d.replace(gd,"\\$&"):a.setAttribute("id",f);f="[id='"+f+"'] ";for(j=h.length;j--;)h[j]=f+Qa(h[j]);j=sb.test(l)&&tb(a.parentNode)||a;q=h.join(",")}if(q)try{return ca.apply(b,
j.querySelectorAll(q)),b}catch(r){}finally{d||a.removeAttribute("id")}}}var e;a:{l=l.replace(Ra,"$1");f=Pa(l);if(!c&&1===f.length){d=f[0]=f[0].slice(0);if(2<d.length&&"ID"===(e=d[0]).type&&z.getById&&9===a.nodeType&&X&&v.relative[d[1].type]){a=(v.find.ID(e.matches[0].replace(da,ea),a)||[])[0];if(!a){e=b;break a}l=l.slice(d.shift().value.length)}for(h=Sa.needsContext.test(l)?0:d.length;h--;){e=d[h];if(v.relative[j=e.type])break;if(j=v.find[j])if(c=j(e.matches[0].replace(da,ea),sb.test(d[0].type)&&
...
a},nc=function(l,a){var b=a&&l,c=b&&1===l.nodeType&&1===a.nodeType&&(~a.sourceIndex||mc)-(~l.sourceIndex||mc);if(c)return c;if(b)for(;b=b.nextSibling;)if(b===a)return-1;return l?1:-1},hd=function(l){return function(a){return"input"===a.nodeName.toLowerCase()&&a.type===l}},id=function(l){return function(a){var b=a.nodeName.toLowerCase();return("input"===b||"button"===b)&&a.type===l}},na=function(l){return T(function(a){a=+a;return T(function(b,c){for(var d,f=l([],b.length,a),j=f.length;j--;)if(b[d=
f[j]])b[d]=!(c[d]=b[d])})})},tb=function(l){return l&&typeof l.getElementsByTagName!==va&&l},oc=function(){},Pa=function(l,a){var b,c,d,f,j,h,q;if(j=pc[l+" "])return a?0:j.slice(0);j=l;h=[];for(q=v.preFilter;j;){if(!b||(c=jd.exec(j)))c&&(j=j.slice(c[0].length)||j),h.push(d=[]);b=!1;if(c=kd.exec(j))b=c.shift(),d.push({value:b,type:c[0].replace(Ra," ")}),j=j.slice(b.length);for(f in v.filter)if((c=Sa[f].exec(j))&&(!q[f]||(c=q[f](c))))b=c.shift(),d.push({value:b,type:f,matches:c}),j=j.slice(b.length);
if(!b)break}return a?j.length:j?y.error(l):pc(l,h).slice(0)},Qa=function(l){for(var a=0,b=l.length,c="";a<b;a++)c+=l[a].value;return c},xb=function(l,a,b){var c=a.dir,d=b&&"parentNode"===c,f=ld++;return a.first?function(a,b,f){for(;a=a[c];)if(1===a.nodeType||d)return l(a,b,f)}:function(a,b,w){var j,C,h=[V,f];if(w)for(;a=a[c];){if((1===a.nodeType||d)&&l(a,b,w))return!0}else for(;a=a[c];)if(1===a.nodeType||d){C=a[F]||(a[F]={});if((j=C[c])&&j[0]===V&&j[1]===f)return h[2]=j[2];C[c]=h;if(h[2]=l(a,b,w))return!0}}},
yb=function(l){return 1<l.length?function(a,b,c){for(var d=l.length;d--;)if(!l[d](a,b,c))return!1;return!0}:l[0]},Ta=function(l,a,b,c,d){for(var f,j=[],h=0,q=l.length,r=null!=a;h<q;h++)if(f=l[h])if(!b||b(f,c,d))j.push(f),r&&a.push(h);return j},zb=function(l,a,b,c,d,f){c&&!c[F]&&(c=zb(c));d&&!d[F]&&(d=zb(d,f));return T(function(f,j,h,q){var r,e,g=[],k=[],s=j.length,M;if(!(M=f)){M=a||"*";for(var m=h.nodeType?[h]:h,p=[],G=0,A=m.length;G<A;G++)y(M,m[G],p);M=p}M=l&&(f||!a)?Ta(M,g,l,h,q):M;m=b?d||(f?l:
s||c)?[]:j:M;b&&b(M,m,h,q);if(c){r=Ta(m,k);c(r,[],h,q);for(h=r.length;h--;)if(e=r[h])m[k[h]]=!(M[k[h]]=e)}if(f){if(d||l){if(d){r=[];for(h=m.length;h--;)if(e=m[h])r.push(M[h]=e);d(null,m=[],r,q)}for(h=m.length;h--;)if((e=m[h])&&-1<(r=d?oa.call(f,e):g[h]))f[r]=!(j[r]=e)}}else m=Ta(m===j?m.splice(s,m.length):m),d?d(null,j,m,q):ca.apply(j,m)})},Ab=function(l){var a,b,c,d=l.length,f=v.relative[l[0].type];b=f||v.relative[" "];for(var j=f?1:0,h=xb(function(l){return l===a},b,!0),q=xb(function(l){return-1<
oa.call(a,l)},b,!0),r=[function(l,b,c){return!f&&(c||b!==Ua)||((a=b).nodeType?h(l,b,c):q(l,b,c))}];j<d;j++)if(b=v.relative[l[j].type])r=[xb(yb(r),b)];else{b=v.filter[l[j].type].apply(null,l[j].matches);if(b[F]){for(c=++j;c<d&&!v.relative[l[c].type];c++);return zb(1<j&&yb(r),1<j&&Qa(l.slice(0,j-1).concat({value:" "===l[j-2].type?"*":""})).replace(Ra,"$1"),b,j<c&&Ab(l.slice(j,c)),c<d&&Ab(l=l.slice(c)),c<d&&Qa(l))}r.push(b)}return yb(r)},wa,z,v,Va,qc,ub,Ua,fa,xa,ba,K,Z,X,O,pa,Wa,Ea,F="sizzle"+-new Date,
...
typeof a.getAttribute!==va&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=y.attr(d,a);if(null==d)return"!="===b;if(!b)return!0;d+="";return"="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1}},CHILD:function(a,b,c,d,f){var j="nth"!==a.slice(0,3),h="last"!==a.slice(-4),q="of-type"===b;return 1===d&&0===f?function(a){return!!a.parentNode}:
function(b,c,w){var C,r,e,g,k;c=j!==h?"nextSibling":"previousSibling";var s=b.parentNode,m=q&&b.nodeName.toLowerCase();w=!w&&!q;if(s){if(j){for(;c;){for(r=b;r=r[c];)if(q?r.nodeName.toLowerCase()===m:1===r.nodeType)return!1;k=c="only"===a&&!k&&"nextSibling"}return!0}k=[h?s.firstChild:s.lastChild];if(h&&w){w=s[F]||(s[F]={});C=w[a]||[];g=C[0]===V&&C[1];e=C[0]===V&&C[2];for(r=g&&s.childNodes[g];r=++g&&r&&r[c]||(e=g=0)||k.pop();)if(1===r.nodeType&&++e&&r===b){w[a]=[V,g,e];break}}else if(w&&(C=(b[F]||(b[F]=
{}))[a])&&C[0]===V)e=C[1];else for(;r=++g&&r&&r[c]||(e=g=0)||k.pop();)if((q?r.nodeName.toLowerCase()===m:1===r.nodeType)&&++e)if(w&&((r[F]||(r[F]={}))[a]=[V,e]),r===b)break;e-=f;return e===d||0===e%d&&0<=e/d}}},PSEUDO:function(a,b){var c,d=v.pseudos[a]||v.setFilters[a.toLowerCase()]||y.error("unsupported pseudo: "+a);return d[F]?d(b):1<d.length?(c=[a,a,"",b],v.setFilters.hasOwnProperty(a.toLowerCase())?T(function(a,l){for(var c,f=d(a,b),j=f.length;j--;)c=oa.call(a,f[j]),a[c]=!(l[c]=f[j])}):function(a){return d(a,
...
return a})}};v.pseudos.nth=v.pseudos.eq;for(wa in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})v.pseudos[wa]=hd(wa);for(wa in{submit:!0,reset:!0})v.pseudos[wa]=id(wa);oc.prototype=v.filters=v.pseudos;v.setFilters=new oc;ub=y.compile=function(a,b){var c,d=[],f=[],j=sc[a+" "];if(!j){b||(b=Pa(a));for(c=b.length;c--;)j=Ab(b[c]),j[F]?d.push(j):f.push(j);var h=0<d.length,q=0<f.length;c=function(a,b,l,c,j){var w,C,r,e=0,g="0",k=a&&[],s=[],m=Ua,M=a||q&&v.find.TAG("*",j),p=V+=null==m?1:Math.random()||
0.1,G=M.length;for(j&&(Ua=b!==K&&b);g!==G&&null!=(w=M[g]);g++){if(q&&w){for(C=0;r=f[C++];)if(r(w,b,l)){c.push(w);break}j&&(V=p)}h&&((w=!r&&w)&&e--,a&&k.push(w))}e+=g;if(h&&g!==e){for(C=0;r=d[C++];)r(k,s,b,l);if(a){if(0<e)for(;g--;)!k[g]&&!s[g]&&(s[g]=nd.call(c));s=Ta(s)}ca.apply(c,s);j&&(!a&&0<s.length&&1<e+d.length)&&y.uniqueSort(c)}j&&(V=p,Ua=m);return k};c=h?T(c):c;j=sc(a,c)}return j};z.sortStable=F.split("").sort(Bb).join("")===F;z.detectDuplicates=!!xa;ba();z.sortDetached=U(function(a){return a.compareDocumentPosition(K.createElement("div"))&
...
yc={};h.Callbacks=function(a){var b;if("string"===typeof a){if(!(b=yc[a])){b=a;var c=yc[b]={};h.each(b.match(Y)||[],function(a,b){c[b]=!0});b=c}}else b=h.extend({},a);a=b;var d,f,j,q,r,e,g=[],k=!a.once&&[],s=function(b){f=a.memory&&b;j=!0;r=e||0;e=0;q=g.length;for(d=!0;g&&r<q;r++)if(!1===g[r].apply(b[0],b[1])&&a.stopOnFalse){f=!1;break}d=!1;g&&(k?k.length&&s(k.shift()):f?g=[]:m.disable())},m={add:function(){if(g){var b=g.length;(function Zc(b){h.each(b,function(b,c){var d=h.type(c);"function"===d?
(!a.unique||!m.has(c))&&g.push(c):c&&(c.length&&"string"!==d)&&Zc(c)})})(arguments);d?q=g.length:f&&(e=b,s(f))}return this},remove:function(){g&&h.each(arguments,function(a,b){for(var c;-1<(c=h.inArray(b,g,c));)g.splice(c,1),d&&(c<=q&&q--,c<=r&&r--)});return this},has:function(a){return a?-1<h.inArray(a,g):!(!g||!g.length)},empty:function(){g=[];q=0;return this},disable:function(){g=k=f=void 0;return this},disabled:function(){return!g},lock:function(){k=void 0;f||m.disable();return this},locked:function(){return!k},
fireWith:function(a,b){if(g&&(!j||k))b=b||[],b=[a,b.slice?b.slice():b],d?k.push(b):s(b);return this},fire:function(){m.fireWith(this,arguments);return this},fired:function(){return!!j}};return m};h.extend({Deferred:function(a){var b=[["resolve","done",h.Callbacks("once memory"),"resolved"],["reject","fail",h.Callbacks("once memory"),"rejected"],["notify","progress",h.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){f.done(arguments).fail(arguments);return this},then:function(){var a=
arguments;return h.Deferred(function(c){h.each(b,function(b,l){var j=h.isFunction(a[b])&&a[b];f[l[1]](function(){var a=j&&j.apply(this,arguments);if(a&&h.isFunction(a.promise))a.promise().done(c.resolve).fail(c.reject).progress(c.notify);else c[l[0]+"With"](this===d?c.promise():this,j?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?h.extend(a,d):d}},f={};d.pipe=d.then;h.each(b,function(a,l){var j=l[2],h=l[3];d[l[1]]=j.add;h&&j.add(function(){c=h},b[a^1][2].disable,b[2][2].lock);
f[l[0]]=function(){f[l[0]+"With"](this===f?d:this,arguments);return this};f[l[0]+"With"]=j.fireWith});d.promise(f);a&&a.call(f,f);return f},when:function(a){var b=0,c=aa.call(arguments),d=c.length,f=1!==d||a&&h.isFunction(a.promise)?d:0,j=1===f?a:h.Deferred(),q=function(a,b,c){return function(l){b[a]=this;c[a]=1<arguments.length?aa.call(arguments):l;c===r?j.notifyWith(b,c):--f||j.resolveWith(b,c)}},r,e,g;if(1<d){r=Array(d);e=Array(d);for(g=Array(d);b<d;b++)c[b]&&h.isFunction(c[b].promise)?c[b].promise().done(q(b,
g,c)).fail(j.reject).progress(q(b,e,r)):--f}f||j.resolveWith(g,c);return j.promise()}});var Xa;h.fn.ready=function(a){h.ready.promise().done(a);return this};h.extend({isReady:!1,readyWait:1,holdReady:function(a){a?h.readyWait++:h.ready(!0)},ready:function(a){if(!(!0===a?--h.readyWait:h.isReady)){if(!u.body)return setTimeout(h.ready);h.isReady=!0;!0!==a&&0<--h.readyWait||(Xa.resolveWith(u,[h]),h.fn.trigger&&h(u).trigger("ready").off("ready"))}}});h.ready.promise=function(b){if(!Xa)if(Xa=h.Deferred(),
"complete"===u.readyState)setTimeout(h.ready);else if(u.addEventListener)u.addEventListener("DOMContentLoaded",d,!1),a.addEventListener("load",d,!1);else{u.attachEvent("onreadystatechange",d);a.attachEvent("onload",d);var c=!1;try{c=null==a.frameElement&&u.documentElement}catch(f){}c&&c.doScroll&&function E(){if(!h.isReady){try{c.doScroll("left")}catch(a){return setTimeout(E,50)}m();h.ready()}}()}return Xa.promise(b)};var R="undefined",zc;for(zc in h(t))break;t.ownLast="0"!==zc;t.inlineBlockNeedsLayout=
...
b){return q(a,b)},_data:function(a,b,c){return f(a,b,c,!0)},_removeData:function(a,b){return q(a,b,!0)}});h.fn.extend({data:function(a,b){var d,f,j,q=this[0],r=q&&q.attributes;if(void 0===a){if(this.length&&(j=h.data(q),1===q.nodeType&&!h._data(q,"parsedAttrs"))){for(d=r.length;d--;)f=r[d].name,0===f.indexOf("data-")&&(f=h.camelCase(f.slice(5)),c(q,f,j[f]));h._data(q,"parsedAttrs",!0)}return j}return"object"===typeof a?this.each(function(){h.data(this,a)}):1<arguments.length?this.each(function(){h.data(this,
a,b)}):q?c(q,a,h.data(q,a)):void 0},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({queue:function(a,b,c){var d;if(a)return b=(b||"fx")+"queue",d=h._data(a,b),c&&(!d||h.isArray(c)?d=h._data(a,b,h.makeArray(c)):d.push(c)),d||[]},dequeue:function(a,b){b=b||"fx";var c=h.queue(a,b),d=c.length,f=c.shift(),j=h._queueHooks(a,b),q=function(){h.dequeue(a,b)};"inprogress"===f&&(f=c.shift(),d--);f&&("fx"===b&&c.unshift("inprogress"),delete j.stop,f.call(a,q,j));!d&&j&&
j.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return h._data(a,c)||h._data(a,c,{empty:h.Callbacks("once memory").add(function(){h._removeData(a,b+"queue");h._removeData(a,c)})})}});h.fn.extend({queue:function(a,b){var c=2;"string"!==typeof a&&(b=a,a="fx",c--);return arguments.length<c?h.queue(this[0],a):void 0===b?this:this.each(function(){var c=h.queue(this,a,b);h._queueHooks(this,a);"fx"===a&&"inprogress"!==c[0]&&h.dequeue(this,a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,
a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var c,d=1,f=h.Deferred(),j=this,q=this.length,r=function(){--d||f.resolveWith(j,[j])};"string"!==typeof a&&(b=a,a=void 0);for(a=a||"fx";q--;)if((c=h._data(j[q],a+"queueHooks"))&&c.empty)d++,c.empty.add(r);r();return f.promise(b)}});var Ya=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ka=["Top","Right","Bottom","Left"],Ca=function(a,b){a=b||a;return"none"===h.css(a,"display")||!h.contains(a.ownerDocument,a)},qa=h.access=
function(a,b,c,d,f,j,q){var r=0,e=a.length,g=null==c;if("object"===h.type(c))for(r in f=!0,c)h.access(a,b,r,c[r],!0,j,q);else if(void 0!==d&&(f=!0,h.isFunction(d)||(q=!0),g&&(q?(b.call(a,d),b=null):(g=b,b=function(a,b,c){return g.call(h(a),c)})),b))for(;r<e;r++)b(a[r],c,q?d:d.call(a[r],r,b(a[r],c)));return f?a:g?b.call(a):e?b(a[0],c):j},kb=/^(?:checkbox|radio)$/i,Db=u.createDocumentFragment(),L=u.createElement("div"),Ha=u.createElement("input");L.setAttribute("className","t");L.innerHTML="  <link/><table></table><a href='/a'>a</a>";
...
Cc=/^([^.]*)(?:\.(.+)|)$/;h.event={global:{},add:function(a,b,c,d,f){var j,q,r,e,g,k,s,m,p;if(r=h._data(a)){c.handler&&(e=c,c=e.handler,f=e.selector);c.guid||(c.guid=h.guid++);if(!(q=r.events))q=r.events={};if(!(g=r.handle))g=r.handle=function(a){return typeof h!==R&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):void 0},g.elem=a;b=(b||"").match(Y)||[""];for(r=b.length;r--;)if(j=Cc.exec(b[r])||[],m=k=j[1],p=(j[2]||"").split(".").sort(),m){j=h.event.special[m]||{};m=(f?j.delegateType:
j.bindType)||m;j=h.event.special[m]||{};k=h.extend({type:m,origType:k,data:d,handler:c,guid:c.guid,selector:f,needsContext:f&&h.expr.match.needsContext.test(f),namespace:p.join(".")},e);if(!(s=q[m]))if(s=q[m]=[],s.delegateCount=0,!j.setup||!1===j.setup.call(a,d,p,g))a.addEventListener?a.addEventListener(m,g,!1):a.attachEvent&&a.attachEvent("on"+m,g);j.add&&(j.add.call(a,k),k.handler.guid||(k.handler.guid=c.guid));f?s.splice(s.delegateCount++,0,k):s.push(k);h.event.global[m]=!0}a=null}},remove:function(a,
b,c,d,f){var j,q,r,e,g,k,s,m,p,G,A,P=h.hasData(a)&&h._data(a);if(P&&(k=P.events)){b=(b||"").match(Y)||[""];for(g=b.length;g--;)if(r=Cc.exec(b[g])||[],p=A=r[1],G=(r[2]||"").split(".").sort(),p){s=h.event.special[p]||{};p=(d?s.delegateType:s.bindType)||p;m=k[p]||[];r=r[2]&&RegExp("(^|\\.)"+G.join("\\.(?:.*\\.|)")+"(\\.|$)");for(e=j=m.length;j--;)if(q=m[j],(f||A===q.origType)&&(!c||c.guid===q.guid)&&(!r||r.test(q.namespace))&&(!d||d===q.selector||"**"===d&&q.selector))m.splice(j,1),q.selector&&m.delegateCount--,
s.remove&&s.remove.call(a,q);e&&!m.length&&((!s.teardown||!1===s.teardown.call(a,G,P.handle))&&h.removeEvent(a,p,P.handle),delete k[p])}else for(p in k)h.event.remove(a,p+b[g],c,d,!0);h.isEmptyObject(k)&&(delete P.handle,h._removeData(a,"events"))}},trigger:function(b,c,d,f){var j,q,r,e,g,k,s=[d||u],m=ua.call(b,"type")?b.type:b;g=ua.call(b,"namespace")?b.namespace.split("."):[];r=j=d=d||u;if(!(3===d.nodeType||8===d.nodeType)&&!Bc.test(m+h.event.triggered))if(0<=m.indexOf(".")&&(g=m.split("."),m=g.shift(),
g.sort()),q=0>m.indexOf(":")&&"on"+m,b=b[h.expando]?b:new h.Event(m,"object"===typeof b&&b),b.isTrigger=f?2:3,b.namespace=g.join("."),b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=d),c=null==c?[b]:h.makeArray(c,[b]),g=h.event.special[m]||{},f||!(g.trigger&&!1===g.trigger.apply(d,c))){if(!f&&!g.noBubble&&!h.isWindow(d)){e=g.delegateType||m;Bc.test(e+m)||(r=r.parentNode);for(;r;r=r.parentNode)s.push(r),j=r;if(j===(d.ownerDocument||
u))s.push(j.defaultView||j.parentWindow||a)}for(k=0;(r=s[k++])&&!b.isPropagationStopped();)if(b.type=1<k?e:g.bindType||m,(j=(h._data(r,"events")||{})[b.type]&&h._data(r,"handle"))&&j.apply(r,c),(j=q&&r[q])&&j.apply&&h.acceptData(r))b.result=j.apply(r,c),!1===b.result&&b.preventDefault();b.type=m;if(!f&&!b.isDefaultPrevented()&&(!g._default||!1===g._default.apply(s.pop(),c))&&h.acceptData(d)&&q&&d[m]&&!h.isWindow(d)){(j=d[q])&&(d[q]=null);h.event.triggered=m;try{d[m]()}catch(p){}h.event.triggered=
void 0;j&&(d[q]=j)}return b.result}},dispatch:function(a){a=h.event.fix(a);var b,c,d,f,j=[],q=aa.call(arguments);b=(h._data(this,"events")||{})[a.type]||[];var r=h.event.special[a.type]||{};q[0]=a;a.delegateTarget=this;if(!(r.preDispatch&&!1===r.preDispatch.call(this,a))){j=h.event.handlers.call(this,a,b);for(b=0;(d=j[b++])&&!a.isPropagationStopped();){a.currentTarget=d.elem;for(f=0;(c=d.handlers[f++])&&!a.isImmediatePropagationStopped();)if(!a.namespace_re||a.namespace_re.test(c.namespace))if(a.handleObj=
c,a.data=c.data,c=((h.event.special[c.origType]||{}).handle||c.handler).apply(d.elem,q),void 0!==c&&!1===(a.result=c))a.preventDefault(),a.stopPropagation()}r.postDispatch&&r.postDispatch.call(this,a);return a.result}},handlers:function(a,b){var c,d,f,j,q=[],r=b.delegateCount,e=a.target;if(r&&e.nodeType&&(!a.button||"click"!==a.type))for(;e!=this;e=e.parentNode||this)if(1===e.nodeType&&(!0!==e.disabled||"click"!==a.type)){f=[];for(j=0;j<r;j++)d=b[j],c=d.selector+" ",void 0===f[c]&&(f[c]=d.needsContext?
0<=h(c,this).index(e):h.find(c,this,null,[e]).length),f[c]&&f.push(d);f.length&&q.push({elem:e,handlers:f})}r<b.length&&q.push({elem:this,handlers:b.slice(r)});return q},fix:function(a){if(a[h.expando])return a;var b,c,d;b=a.type;var f=a,j=this.fixHooks[b];j||(this.fixHooks[b]=j=zd.test(b)?this.mouseHooks:yd.test(b)?this.keyHooks:{});d=j.props?this.props.concat(j.props):this.props;a=new h.Event(f);for(b=d.length;b--;)c=d[b],a[c]=f[c];a.target||(a.target=f.srcElement||u);3===a.target.nodeType&&(a.target=
a.target.parentNode);a.metaKey=!!a.metaKey;return j.filter?j.filter(a,f):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode);return a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,
b){var c,d,f=b.button,j=b.fromElement;null==a.pageX&&null!=b.clientX&&(c=a.target.ownerDocument||u,d=c.documentElement,c=c.body,a.pageX=b.clientX+(d&&d.scrollLeft||c&&c.scrollLeft||0)-(d&&d.clientLeft||c&&c.clientLeft||0),a.pageY=b.clientY+(d&&d.scrollTop||c&&c.scrollTop||0)-(d&&d.clientTop||c&&c.clientTop||0));!a.relatedTarget&&j&&(a.relatedTarget=j===a.target?b.toElement:j);!a.which&&void 0!==f&&(a.which=f&1?1:f&2?3:f&4?2:0);return a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==
...
"</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:t.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},Gb=G(u).appendChild(u.createElement("div"));Q.optgroup=Q.option;Q.tbody=Q.tfoot=Q.colgroup=Q.caption=Q.thead;Q.th=Q.td;h.extend({clone:function(a,b,c){var d,f,j,q,r,e=h.contains(a.ownerDocument,a);t.html5Clone||h.isXMLDoc(a)||!Dc.test("<"+
a.nodeName+">")?j=a.cloneNode(!0):(Gb.innerHTML=a.outerHTML,Gb.removeChild(j=Gb.firstChild));if((!t.noCloneEvent||!t.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!h.isXMLDoc(a)){d=A(j);r=A(a);for(q=0;null!=(f=r[q]);++q)if(d[q]){var g=d[q],k=void 0,s=void 0,m=void 0;if(1===g.nodeType){k=g.nodeName.toLowerCase();if(!t.noCloneEvent&&g[h.expando]){m=h._data(g);for(s in m.events)h.removeEvent(g,s,m.handle);g.removeAttribute(h.expando)}if("script"===k&&g.text!==f.text)D(g).text=f.text,H(g);else if("object"===
k)g.parentNode&&(g.outerHTML=f.outerHTML),t.html5Clone&&(f.innerHTML&&!h.trim(g.innerHTML))&&(g.innerHTML=f.innerHTML);else if("input"===k&&kb.test(f.type))g.defaultChecked=g.checked=f.checked,g.value!==f.value&&(g.value=f.value);else if("option"===k)g.defaultSelected=g.selected=f.defaultSelected;else if("input"===k||"textarea"===k)g.defaultValue=f.defaultValue}}}if(b)if(c){r=r||A(a);d=d||A(j);for(q=0;null!=(f=r[q]);q++)Tb(f,d[q])}else Tb(a,j);d=A(j,"script");0<d.length&&I(d,!e&&A(a,"script"));return j},
buildFragment:function(a,b,c,d){for(var f,j,q,r,e,g,k=a.length,m=G(b),s=[],p=0;p<k;p++)if((j=a[p])||0===j)if("object"===h.type(j))h.merge(s,j.nodeType?[j]:j);else if(Bd.test(j)){q=q||m.appendChild(b.createElement("div"));r=(Fc.exec(j)||["",""])[1].toLowerCase();g=Q[r]||Q._default;q.innerHTML=g[1]+j.replace(Ec,"<$1></$2>")+g[2];for(f=g[0];f--;)q=q.lastChild;!t.leadingWhitespace&&Fb.test(j)&&s.push(b.createTextNode(Fb.exec(j)[0]));if(!t.tbody)for(f=(j="table"===r&&!Gc.test(j)?q.firstChild:"<table>"===
g[1]&&!Gc.test(j)?q:0)&&j.childNodes.length;f--;)h.nodeName(e=j.childNodes[f],"tbody")&&!e.childNodes.length&&j.removeChild(e);h.merge(s,q.childNodes);for(q.textContent="";q.firstChild;)q.removeChild(q.firstChild);q=m.lastChild}else s.push(b.createTextNode(j));q&&m.removeChild(q);t.appendChecked||h.grep(A(s,"input"),P);for(p=0;j=s[p++];)if(!(d&&-1!==h.inArray(j,d))&&(a=h.contains(j.ownerDocument,j),q=A(m.appendChild(j),"script"),a&&I(q),c))for(f=0;j=q[f++];)Hc.test(j.type||"")&&c.push(j);return m},
cleanData:function(a,b){for(var c,d,f,j,q=0,r=h.expando,e=h.cache,g=t.deleteExpando,k=h.event.special;null!=(c=a[q]);q++)if(b||h.acceptData(c))if(j=(f=c[r])&&e[f]){if(j.events)for(d in j.events)k[d]?h.event.remove(c,d):h.removeEvent(c,d,j.handle);e[f]&&(delete e[f],g?delete c[r]:typeof c.removeAttribute!==R?c.removeAttribute(r):c[r]=null,$.push(f))}}});h.fn.extend({text:function(a){return qa(this,function(a){return void 0===a?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||u).createTextNode(a))},
...
a);b=0}catch(f){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];this.domManip(arguments,function(b){a=this.parentNode;h.cleanData(A(this));a&&a.replaceChild(b,this)});return a&&(a.length||a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=kc.apply([],a);var c,d,f,j,q=0,r=this.length,e=this,g=r-1,k=a[0],s=h.isFunction(k);if(s||1<r&&"string"===typeof k&&!t.checkClone&&Dd.test(k))return this.each(function(c){var d=
e.eq(c);s&&(a[0]=k.call(this,c,d.html()));d.domManip(a,b)});if(r&&(j=h.buildFragment(a,this[0].ownerDocument,!1,this),c=j.firstChild,1===j.childNodes.length&&(j=c),c)){f=h.map(A(j,"script"),D);for(d=f.length;q<r;q++)c=j,q!==g&&(c=h.clone(c,!0,!0),d&&h.merge(f,A(c,"script"))),b.call(this[q],c,q);if(d){j=f[f.length-1].ownerDocument;h.map(f,H);for(q=0;q<d;q++)if(c=f[q],Hc.test(c.type||"")&&!h._data(c,"globalEval")&&h.contains(j,c))c.src?h._evalUrl&&h._evalUrl(c.src):h.globalEval((c.text||c.textContent||
c.innerHTML||"").replace(Ed,""))}j=c=null}return this}});h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(a){for(var c=0,d=[],f=h(a),l=f.length-1;c<=l;c++)a=c===l?this:this.clone(!0),h(f[c])[b](a),pb.apply(d,a.get());return this.pushStack(d)}});var Ba,Wb={},Ia,ab,ya=u.createElement("div");ya.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";Ia=ya.getElementsByTagName("a")[0];
...
c.innerHTML="<div></div>",c.firstChild.style.width="5px",ab=3!==c.offsetWidth);a.removeChild(b)}return ab};var Ic=/^margin/,La=RegExp("^("+Ya+")(?!px)[a-z%]+$","i"),la,ma,Fd=/^(top|right|bottom|left)$/;a.getComputedStyle?(la=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)},ma=function(a,b,c){var d,f,j=a.style;f=(c=c||la(a))?c.getPropertyValue(b)||c[b]:void 0;c&&(""===f&&!h.contains(a.ownerDocument,a)&&(f=h.style(a,b)),La.test(f)&&Ic.test(b)&&(a=j.width,b=j.minWidth,d=j.maxWidth,
j.minWidth=j.maxWidth=j.width=f,f=c.width,j.width=a,j.minWidth=b,j.maxWidth=d));return void 0===f?f:f+""}):u.documentElement.currentStyle&&(la=function(a){return a.currentStyle},ma=function(a,b,c){var d,f,j,h=a.style;j=(c=c||la(a))?c[b]:void 0;null==j&&(h&&h[b])&&(j=h[b]);if(La.test(j)&&!Fd.test(b)){c=h.left;if(f=(d=a.runtimeStyle)&&d.left)d.left=a.currentStyle.left;h.left="fontSize"===b?"1em":j;j=h.pixelLeft+"px";h.left=c;f&&(d.left=f)}return void 0===j?j:j+""||"auto"});var Jb=function(){var b,c,
...
"cssFloat":"styleFloat"},style:function(a,b,c,d){if(a&&!(3===a.nodeType||8===a.nodeType||!a.style)){var f,j,q,r=h.camelCase(b),e=a.style;b=h.cssProps[r]||(h.cssProps[r]=Yb(e,r));q=h.cssHooks[b]||h.cssHooks[r];if(void 0!==c){j=typeof c;if("string"===j&&(f=Id.exec(c)))c=(f[1]+1)*f[2]+parseFloat(h.css(a,b)),j="number";if(!(null==c||c!==c))if("number"===j&&!h.cssNumber[r]&&(c+="px"),!t.clearCloneStyle&&(""===c&&0===b.indexOf("background"))&&(e[b]="inherit"),!q||!("set"in q)||void 0!==(c=q.set(a,c,d)))try{e[b]=
"",e[b]=c}catch(g){}}else return q&&"get"in q&&void 0!==(f=q.get(a,!1,d))?f:e[b]}},css:function(a,b,c,d){var f,j;j=h.camelCase(b);b=h.cssProps[j]||(h.cssProps[j]=Yb(a.style,j));(j=h.cssHooks[b]||h.cssHooks[j])&&"get"in j&&(f=j.get(a,!0,c));void 0===f&&(f=ma(a,b,d));"normal"===f&&b in Jc&&(f=Jc[b]);return""===c||c?(a=parseFloat(f),!0===c||h.isNumeric(a)?a||0:f):f}});h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){if(c)return 0===a.offsetWidth&&Hd.test(h.css(a,"display"))?
h.swap(a,Jd,function(){return cc(a,b,d)}):cc(a,b,d)},set:function(a,c,d){var f=d&&la(a);return ac(a,c,d?bc(a,b,d,t.boxSizing()&&"border-box"===h.css(a,"boxSizing",!1,f),f):0)}}});t.opacity||(h.cssHooks.opacity={get:function(a,b){return Gd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,f=h.isNumeric(b)?"alpha(opacity="+100*b+")":"",j=d&&d.filter||c.filter||"";c.zoom=1;if((1<=b||""===b)&&""===
h.trim(j.replace(Kb,""))&&c.removeAttribute)if(c.removeAttribute("filter"),""===b||d&&!d.filter)return;c.filter=Kb.test(j)?j.replace(Kb,f):j+" "+f}});h.cssHooks.marginRight=Xb(t.reliableMarginRight,function(a,b){if(b)return h.swap(a,{display:"inline-block"},ma,[a,"marginRight"])});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){var d=0,f={};for(c="string"===typeof c?c.split(" "):[c];4>d;d++)f[a+ka[d]+b]=c[d]||c[d-2]||c[0];return f}};Ic.test(a)||(h.cssHooks[a+
...
N.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};h.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};h.fx=N.prototype.init;h.fx.step={};var ta,fb,Kd=/^(?:toggle|show|hide)$/,Kc=RegExp("^(?:([+-])=|)("+Ya+")([a-z%]*)$","i"),Ld=/queueHooks$/,Na=[function(a,b,c){var d,f,j,q,r,e,g=this,k={},s=a.style,m=a.nodeType&&Ca(a),p=h._data(a,"fxshow");c.queue||(q=h._queueHooks(a,"fx"),null==q.unqueued&&(q.unqueued=0,r=q.empty.fire,
q.empty.fire=function(){q.unqueued||r()}),q.unqueued++,g.always(function(){g.always(function(){q.unqueued--;h.queue(a,"fx").length||q.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))c.overflow=[s.overflow,s.overflowX,s.overflowY],f=h.css(a,"display"),e=Vb(a.nodeName),"none"===f&&(f=e),"inline"===f&&"none"===h.css(a,"float")&&(!t.inlineBlockNeedsLayout||"inline"===e?s.display="inline-block":s.zoom=1);c.overflow&&(s.overflow="hidden",t.shrinkWrapBlocks()||g.always(function(){s.overflow=
c.overflow[0];s.overflowX=c.overflow[1];s.overflowY=c.overflow[2]}));for(d in b)if(f=b[d],Kd.exec(f)){delete b[d];j=j||"toggle"===f;if(f===(m?"hide":"show"))if("show"===f&&p&&void 0!==p[d])m=!0;else continue;k[d]=p&&p[d]||h.style(a,d)}if(!h.isEmptyObject(k))for(d in p?"hidden"in p&&(m=p.hidden):p=h._data(a,"fxshow",{}),j&&(p.hidden=!m),m?h(a).show():g.done(function(){h(a).hide()}),g.done(function(){var b;h._removeData(a,"fxshow");for(b in k)h.style(a,b,k[b])}),k)b=ec(m?p[d]:0,d,g),d in p||(p[d]=b.start,
m&&(b.end=b.start,b.start="width"===d||"height"===d?1:0))}],Da={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),f=Kc.exec(b),j=f&&f[3]||(h.cssNumber[a]?"":"px"),q=(h.cssNumber[a]||"px"!==j&&+d)&&Kc.exec(h.css(c.elem,a)),r=1,e=20;if(q&&q[3]!==j){j=j||q[3];f=f||[];q=+d||1;do r=r||".5",q/=r,h.style(c.elem,a,q+j);while(r!==(r=c.cur()/d)&&1!==r&&--e)}f&&(q=c.start=+q||+d||0,c.unit=j,c.end=f[1]?q+(f[1]+1)*f[2]:+f[2]);return c}]};h.Animation=h.extend(fc,{tweener:function(a,b){h.isFunction(a)?(b=
...
d.complete=function(){h.isFunction(d.old)&&d.old.call(this);d.queue&&h.dequeue(this,d.queue)};return d};h.fn.extend({fadeTo:function(a,b,c,d){return this.filter(Ca).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var f=h.isEmptyObject(a),j=h.speed(b,c,d);b=function(){var b=fc(this,h.extend({},a),j);(f||h._data(this,"finish"))&&b.stop(!0)};b.finish=b;return f||!1===j.queue?this.each(b):this.queue(j.queue,b)},stop:function(a,b,c){var d=function(a){var b=a.stop;delete a.stop;
b(c)};"string"!==typeof a&&(c=b,b=a,a=void 0);b&&!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var b=!0,f=null!=a&&a+"queueHooks",j=h.timers,q=h._data(this);if(f)q[f]&&q[f].stop&&d(q[f]);else for(f in q)q[f]&&(q[f].stop&&Ld.test(f))&&d(q[f]);for(f=j.length;f--;)if(j[f].elem===this&&(null==a||j[f].queue===a))j[f].anim.stop(c),b=!1,j.splice(f,1);(b||!c)&&h.dequeue(this,a)})},finish:function(a){!1!==a&&(a=a||"fx");return this.each(function(){var b,c=h._data(this),d=c[a+"queue"];b=c[a+"queueHooks"];
var f=h.timers,j=d?d.length:0;c.finish=!0;h.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;b<j;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish})}});h.each(["toggle","show","hide"],function(a,b){var c=h.fn[b];h.fn[b]=function(a,d,f){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(Ma(b,!0),a,d,f)}});h.each({slideDown:Ma("show"),slideUp:Ma("hide"),slideToggle:Ma("toggle"),
...
c,d,f,j,q=0,r=this.length;b="string"===typeof a&&a;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Y)||[];q<r;q++)if(c=this[q],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Ob," "):" ")){for(j=0;f=b[j++];)0>d.indexOf(" "+f+" ")&&(d+=f+" ");d=h.trim(d);c.className!==d&&(c.className=d)}return this},removeClass:function(a){var b,c,d,f,j,q=0,r=this.length;b=0===arguments.length||"string"===typeof a&&a;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(Y)||[];q<r;q++)if(c=this[q],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Ob," "):"")){for(j=0;f=b[j++];)for(;0<=d.indexOf(" "+f+" ");)d=d.replace(" "+f+" "," ");d=a?h.trim(d):"";c.className!==d&&(c.className=d)}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"===typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):
this.each(function(){if("string"===c)for(var b,d=0,f=h(this),j=a.match(Y)||[];b=j[d++];)f.hasClass(b)?f.removeClass(b):f.addClass(b);else if(c===R||"boolean"===c)this.className&&h._data(this,"__className__",this.className),this.className=this.className||!1===a?"":h._data(this,"__className__")||""})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(Ob," ").indexOf(a))return!0;return!1}});h.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
...
h.ajaxSettings),b):mb(h.ajaxSettings,a)},ajaxPrefilter:gc(Oc),ajaxTransport:gc(lb),ajax:function(a,b){function c(a,b,d,f){var l,k,w,B;B=b;if(2!==D){D=2;r&&clearTimeout(r);g=void 0;q=f||"";x.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(d){w=s;for(var C=x,t,u,W,E,H=w.contents,v=w.dataTypes;"*"===v[0];)v.shift(),void 0===u&&(u=w.mimeType||C.getResponseHeader("Content-Type"));if(u)for(E in H)if(H[E]&&H[E].test(u)){v.unshift(E);break}if(v[0]in d)W=v[0];else{for(E in d){if(!v[0]||w.converters[E+" "+v[0]]){W=
...
H.unshift(w[1]));break}if(!0!==I)if(I&&d["throws"])t=I(t);else try{t=I(t)}catch(F){w={state:"parsererror",error:I?F:"No conversion from "+z+" to "+E};break a}}w={state:"success",data:t}}if(f)s.ifModified&&((B=x.getResponseHeader("Last-Modified"))&&(h.lastModified[j]=B),(B=x.getResponseHeader("etag"))&&(h.etag[j]=B)),204===a||"HEAD"===s.type?B="nocontent":304===a?B="notmodified":(B=w.state,l=w.data,k=w.error,f=!k);else if(k=B,a||!B)B="error",0>a&&(a=0);x.status=a;x.statusText=(b||B)+"";f?G.resolveWith(m,
[l,B,x]):G.rejectWith(m,[x,B,k]);x.statusCode(P);P=void 0;e&&p.trigger(f?"ajaxSuccess":"ajaxError",[x,s,f?l:k]);A.fireWith(m,[x,B]);e&&(p.trigger("ajaxComplete",[x,s]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var d,f,j,q,r,e,g,k,s=h.ajaxSetup({},b),m=s.context||s,p=s.context&&(m.nodeType||m.jquery)?h(m):h.event,G=h.Deferred(),A=h.Callbacks("once memory"),P=s.statusCode||{},B={},t={},D=0,u="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===
D){if(!k)for(k={};b=Rd.exec(q);)k[b[1].toLowerCase()]=b[2];b=k[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===D?q:null},setRequestHeader:function(a,b){var c=a.toLowerCase();D||(a=t[c]=t[c]||a,B[a]=b);return this},overrideMimeType:function(a){D||(s.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>D)for(b in a)P[b]=[P[b],a[b]];else x.always(a[x.status]);return this},abort:function(a){a=a||u;g&&g.abort(a);c(0,a);return this}};G.promise(x).complete=
...
D)return x;(e=s.global)&&0===h.active++&&h.event.trigger("ajaxStart");s.type=s.type.toUpperCase();s.hasContent=!Sd.test(s.type);j=s.url;s.hasContent||(s.data&&(j=s.url+=(Qb.test(j)?"&":"?")+s.data,delete s.data),!1===s.cache&&(s.url=Mc.test(j)?j.replace(Mc,"$1_="+Pb++):j+(Qb.test(j)?"&":"?")+"_="+Pb++));s.ifModified&&(h.lastModified[j]&&x.setRequestHeader("If-Modified-Since",h.lastModified[j]),h.etag[j]&&x.setRequestHeader("If-None-Match",h.etag[j]));(s.data&&s.hasContent&&!1!==s.contentType||b.contentType)&&
x.setRequestHeader("Content-Type",s.contentType);x.setRequestHeader("Accept",s.dataTypes[0]&&s.accepts[s.dataTypes[0]]?s.accepts[s.dataTypes[0]]+("*"!==s.dataTypes[0]?", "+Pc+"; q=0.01":""):s.accepts["*"]);for(f in s.headers)x.setRequestHeader(f,s.headers[f]);if(s.beforeSend&&(!1===s.beforeSend.call(m,x,s)||2===D))return x.abort();u="abort";for(f in{success:1,error:1,complete:1})x[f](s[f]);if(g=hc(lb,s,b,x)){x.readyState=1;e&&p.trigger("ajaxSend",[x,s]);s.async&&0<s.timeout&&(r=setTimeout(function(){x.abort("timeout")},
...
ob()||ob(1)};var Xd=0,ib={},jb=h.ajaxSettings.xhr();if(a.ActiveXObject)h(a).on("unload",function(){for(var a in ib)ib[a](void 0,!0)});t.cors=!!jb&&"withCredentials"in jb;(jb=t.ajax=!!jb)&&h.ajaxTransport(function(a){if(!a.crossDomain||t.cors){var b;return{send:function(c,d){var f,j=a.xhr(),q=++Xd;j.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(f in a.xhrFields)j[f]=a.xhrFields[f];a.mimeType&&j.overrideMimeType&&j.overrideMimeType(a.mimeType);!a.crossDomain&&!c["X-Requested-With"]&&
(c["X-Requested-With"]="XMLHttpRequest");for(f in c)void 0!==c[f]&&j.setRequestHeader(f,c[f]+"");j.send(a.hasContent&&a.data||null);b=function(c,f){var r,e,g;if(b&&(f||4===j.readyState))if(delete ib[q],b=void 0,j.onreadystatechange=h.noop,f)4!==j.readyState&&j.abort();else{g={};r=j.status;"string"===typeof j.responseText&&(g.text=j.responseText);try{e=j.statusText}catch(s){e=""}!r&&a.isLocal&&!a.crossDomain?r=g.text?200:404:1223===r&&(r=204)}g&&d(r,e,g,j.getAllResponseHeaders())};a.async?4===j.readyState?
setTimeout(b):j.onreadystatechange=ib[q]=b:b()},abort:function(){b&&b(void 0,!0)}}}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){h.globalEval(a);return a}}});h.ajaxPrefilter("script",function(a){void 0===a.cache&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});h.ajaxTransport("script",function(a){if(a.crossDomain){var b,c=u.head||h("head")[0]||
...
Rc.pop()||h.expando+"_"+Pb++;this[a]=!0;return a}});h.ajaxPrefilter("json jsonp",function(b,c,d){var f,j,q,r=!1!==b.jsonp&&(Rb.test(b.url)?"url":"string"===typeof b.data&&!(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&Rb.test(b.data)&&"data");if(r||"jsonp"===b.dataTypes[0])return f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,r?b[r]=b[r].replace(Rb,"$1"+f):!1!==b.jsonp&&(b.url+=(Qb.test(b.url)?"&":"?")+b.jsonp+"="+f),b.converters["script json"]=
function(){q||h.error(f+" was not called");return q[0]},b.dataTypes[0]="json",j=a[f],a[f]=function(){q=arguments},d.always(function(){a[f]=j;b[f]&&(b.jsonpCallback=c.jsonpCallback,Rc.push(f));q&&h.isFunction(j)&&j(q[0]);q=j=void 0}),"script"});h.parseHTML=function(a,b,c){if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(c=b,b=!1);b=b||u;var d=xc.exec(a);c=!c&&[];if(d)return[b.createElement(d[1])];d=h.buildFragment([a],b,c);c&&c.length&&h(c).remove();return h.merge([],d.childNodes)};var Sc=
h.fn.load;h.fn.load=function(a,b,c){if("string"!==typeof a&&Sc)return Sc.apply(this,arguments);var d,f,j,q=this,r=a.indexOf(" ");0<=r&&(d=a.slice(r,a.length),a=a.slice(0,r));h.isFunction(b)?(c=b,b=void 0):b&&"object"===typeof b&&(j="POST");0<q.length&&h.ajax({url:a,type:j,dataType:"html",data:b}).done(function(a){f=arguments;q.html(d?h("<div>").append(h.parseHTML(a)).find(d):a)}).complete(c&&function(a,b){q.each(c,f||[a.responseText,b,a])});return this};h.expr.filters.animated=function(a){return h.grep(h.timers,
function(b){return a===b.elem}).length};var Tc=a.document.documentElement;h.offset={setOffset:function(a,b,c){var d,f,j,q=h.css(a,"position"),r=h(a),e={};"static"===q&&(a.style.position="relative");j=r.offset();f=h.css(a,"top");d=h.css(a,"left");("absolute"===q||"fixed"===q)&&-1<h.inArray("auto",[f,d])?(d=r.position(),f=d.top,d=d.left):(f=parseFloat(f)||0,d=parseFloat(d)||0);h.isFunction(b)&&(b=b.call(a,c,j));null!=b.top&&(e.top=b.top-j.top+f);null!=b.left&&(e.left=b.left-j.left+d);"using"in b?b.using.call(a,
...
h.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c=/Y/.test(b);h.fn[a]=function(d){return qa(this,function(a,d,f){var j=jc(a);if(void 0===f)return j?b in j?j[b]:j.document.documentElement[d]:a[d];j?j.scrollTo(!c?f:h(j).scrollLeft(),c?f:h(j).scrollTop()):a[d]=f},a,d,arguments.length,null)}});h.each(["top","left"],function(a,b){h.cssHooks[b]=Xb(t.pixelPosition,function(a,c){if(c)return c=ma(a,b),La.test(c)?h(a).position()[b]+"px":c})});h.each({Height:"height",Width:"width"},
function(a,b){h.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,d){h.fn[d]=function(d,f){var j=arguments.length&&(c||"boolean"!==typeof d),q=c||(!0===d||!0===f?"margin":"border");return qa(this,function(b,c,d){return h.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(c=b.documentElement,Math.max(b.body["scroll"+a],c["scroll"+a],b.body["offset"+a],c["offset"+a],c["client"+a])):void 0===d?h.css(b,c,q):h.style(b,c,d,q)},b,j?d:void 0,j,null)}})});h.fn.size=function(){return this.length};
h.fn.andSelf=h.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return h});var Yd=a.jQuery,Zd=a.$;h.noConflict=function(b){a.$===h&&(a.$=Zd);b&&a.jQuery===h&&(a.jQuery=Yd);return h};typeof p===R&&(a.jQuery=a.$=h);return h});
(function(a){function p(a){try{return a?new window.ActiveXObject("Microsoft.XMLHTTP"):new window.XMLHttpRequest}catch(k){}}a.ajaxSettings.xhr=void 0===window.ActiveXObject?p:function(){return(this.url==document.location||0==this.url.indexOf("http")||!this.isLocal)&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&p()||p(1)};a.extend(a.support,{iecors:!!window.XDomainRequest});a.support.iecors?a.ajaxTransport(function(a){return{send:function(k,e){var m=new window.XDomainRequest;m.onload=function(){e(200,
"OK",{text:m.responseText},{"Content-Type":m.contentType})};a.xhrFields&&(m.onerror=a.xhrFields.error,m.ontimeout=a.xhrFields.timeout);m.open(a.type,a.url);m.send(a.hasContent&&a.data||null)},abort:function(){xdr.abort()}}}):(a.ajaxSetup({accepts:{binary:"text/plain; charset=x-user-defined"},responseFields:{binary:"response"}}),a.ajaxTransport("binary",function(a){var k;return{send:function(e,m){var d=a.xhr();d.open(a.type,a.url,a.async);var c=!1;try{d.hasOwnProperty("responseType")&&(d.responseType=
"arraybuffer",c=!0)}catch(b){}try{!c&&d.overrideMimeType&&d.overrideMimeType("text/plain; charset=x-user-defined")}catch(f){}!a.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(var q in e)d.setRequestHeader(q,e[q])}catch(s){}d.send(a.hasContent&&a.data||null);k=function(){var b=d.status,c="",f=d.getAllResponseHeaders(),q={};try{if(k&&4===d.readyState){k=void 0;try{q.text="string"===typeof d.responseText?d.responseText:null}catch(e){}try{q.binary=d.response}catch(s){}try{c=
d.statusText}catch(p){c=""}!b&&a.isLocal&&!a.crossDomain?b=q.text?200:404:1223===b&&(b=204);m(b,c,q,f)}}catch(H){alert(H),m(-1,H)}};a.async?4===d.readyState?setTimeout(k):d.onreadystatechange=k:k()},abort:function(){}}}))})(jQuery);
(function(a,p,g,k){function e(e,d){function c(c){a(b).each(function(){self.Jmol&&(0<=d.indexOf("mouseup")||0<=d.indexOf("touchend"))&&Jmol._setMouseOwner(null);var b=a(this);this!==c.target&&!b.has(c.target).length&&b.triggerHandler(d,[c.target,c])})}d=d||e+k;var b=a(),f=e+"."+d+"-special-event";a.event.special[d]={setup:function(){b=b.add(this);1===b.length&&a(p).bind(f,c)},teardown:function(){self.Jmol&&Jmol._setMouseOwner(null);b=b.not(this);0===b.length&&a(p).unbind(f)},add:function(a){var b=
a.handler;a.handler=function(a,c){a.target=c;b.apply(this,arguments)}}}}a.map(g.split(" "),function(a){e(a)});e("focusin","focus"+k);e("focusout","blur"+k)})(jQuery,document,"click mousemove mouseup touchmove touchend","outjsmol");"undefined"==typeof jQuery&&alert("Note -- JSmoljQuery is required for JSmol, but it's not defined.");self.Jmol||(Jmol={});
Jmol._version||(Jmol=function(a){var p=function(a){return{header:a++,rear:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,monitorZIndex:a+99999}},p={_version:"JSmol 14.2.3 July 23, 2014",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:p,_z:p(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",_fileLoadScript:";if (_loadScript = '' && defaultLoadScript == '' && _filetype == 'Pdb') { select protein or nucleic;cartoons Only;color structure; select * };",
_nciLoadScript:";n = ({molecule=1}.length < {molecule=2}.length ? 2 : 1); select molecule=n;display selected;center selected;",_pubChemLoadScript:"",_DirectDatabaseCalls:{"cactus.nci.nih.gov":"%URL","www.rcsb.org":"%URL","pdbe.org":"%URL","www.ebi.ac.uk":"%URL","wwwdev.ebi.ac.uk":"%URL","pubchem.ncbi.nlm.nih.gov":"%URL","http://www.nmrdb.org/tools/jmol/predict.php":"%URL",$:"http://cactus.nci.nih.gov/chemical/structure/%FILENCI/file?format=sdf&get3d=True",$$:"http://cactus.nci.nih.gov/chemical/structure/%FILENCI/file?format=sdf",
"=":"http://www.rcsb.org/pdb/files/%FILE.pdb","*":"http://www.ebi.ac.uk/pdbe/entry-files/download/%FILE.cif","==":"http://www.rcsb.org/pdb/files/ligand/%FILE.cif",":":"http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/%FILE/SDF?record_type=3d"},_restQueryUrl:"http://www.rcsb.org/pdb/rest/search",_restQueryXml:"<orgPdbQuery><queryType>org.pdb.query.simple.AdvancedKeywordQuery</queryType><description>Text Search</description><keywords>QUERY</keywords></orgPdbQuery>",_restReportUrl:"http://www.pdb.org/pdb/rest/customReport?pdbids=IDLIST&customReportColumns=structureId,structureTitle"},
_debugAlert:!1,_document:a,_isXHTML:!1,_lastAppletID:null,_mousePageX:null,_mouseOwner:null,_serverUrl:"http://your.server.here/jsmol.php",_syncId:(""+Math.random()).substring(3),_touching:!1,_XhtmlElement:null,_XhtmlAppendChild:!1};a=a.location.href.toLowerCase();p._httpProto=0==a.indexOf("https")?"https://":"http://";p._isFile=0==a.indexOf("file:");p._ajaxTestSite=p._httpProto+"google.com";a=p._isFile||0==a.indexOf("http://localhost")||0==a.indexOf("http://127.");p._tracker="http://"==p._httpProto&&
!a&&"http://chemapps.stolaf.edu/jmol/JmolTracker.htm?id=UA-45940799-1";p._isChrome=0<=navigator.userAgent.toLowerCase().indexOf("chrome");p._isSafari=!p._isChrome&&0<=navigator.userAgent.toLowerCase().indexOf("safari");p._isMsie=void 0!==window.ActiveXObject;p._useDataURI=!p._isSafari&&!p._isMsie;for(var g in Jmol)p[g]=Jmol[g];return p}(document,Jmol));
(function(a,p){a.$=function(a,c){null==a&&alert(c+arguments.callee.caller.toString());return p(c?"#"+a._id+"_"+c:a)};a._$=function(a){return"string"==typeof a?p("#"+a):a};a.$ajax=function(b){a._ajaxCall=b.url;b.cache="NO"!=b.cache;0==b.url.indexOf("http://pubchem.ncbi.nlm.nih")&&(b.url="https://"+b.url.substring(7));return p.ajax(b)};a._getNCIInfo=function(b,c){"name"==c&&(c="names");url="http://cactus.nci.nih.gov/chemical/structure/"+b+"/"+c;return a._getFileData(url)};a.$appEvent=function(b,c,d,
e){b=a.$(b,c);b.off(d)&&e&&b.on(d,e)};a.$resize=function(a){return p(window).resize(a)};a.$after=function(a,c){return p(a).after(c)};a.$bind=function(a,c,d){return d?p(a).bind(c,d):p(a).unbind(c)};a.$closest=function(a,c){return p(a).closest(c)};a.$get=function(a,c){return p(a).get(c)};a.$documentOff=function(a,c){return p(document).off(a,"#"+c)};a.$documentOn=function(a,c,d){return p(document).on(a,"#"+c,d)};a.$getAncestorDiv=function(a,c){return p("div."+c+":has(#"+a+")")[0]};a.$supportsIECrossDomainScripting=
function(){return p.support.iecors};a.$attr=function(b,c,d){return a._$(b).attr(c,d)};a.$css=function(b,c){return a._$(b).css(c)};a.$find=function(b,c){return a._$(b).find(c)};a.$focus=function(b){return a._$(b).focus()};a.$html=function(b,c){return a._$(b).html(c)};a.$offset=function(b){return a._$(b).offset()};a.$windowOn=function(a,c){return p(window).on(a,c)};a.$prop=function(b,c,d){var e=a._$(b);return 3==arguments.length?e.prop(c,d):e.prop(c)};a.$remove=function(b){return a._$(b).remove()};
a.$scrollTo=function(b,c){var d=a._$(b);return d.scrollTop(0>c?d[0].scrollHeight:c)};a.$setEnabled=function(b,c){return a._$(b).attr("disabled",c?null:"disabled")};a.$setSize=function(b,c,d){return a._$(b).width(c).height(d)};a.$setVisible=function(b,c){var d=a._$(b);return c?d.show():d.hide()};a.$submit=function(b){return a._$(b).submit()};a.$val=function(b,c){var d=a._$(b);return 1==arguments.length?d.val():d.val(c)};a._clearVars=function(){delete jQuery;delete p;delete a;delete SwingController;
delete J;delete JM;delete JS;delete JSV;delete JU;delete JV;delete java;delete javajs;delete Clazz;delete c$};var g=document,k=window,e={};e.ua=navigator.userAgent.toLowerCase();var m;a:{m=["linux","unix","mac","win"];for(var d=m.length;d--;)if(-1!=e.ua.indexOf(m[d])){m=m[d];break a}m="unknown"}e.os=m;e.browser=function(){for(var a=e.ua,c="konqueror webkit omniweb opera webtv icab msie mozilla".split(" "),d=0;d<c.length;d++)if(0<=a.indexOf(c[d]))return c[d];return"unknown"};e.browserName=e.browser();
e.browserVersion=parseFloat(e.ua.substring(e.ua.indexOf(e.browserName)+e.browserName.length+1));e.supportsXhr2=function(){return p.support.cors||p.support.iecors};e.allowDestroy="msie"!=e.browserName;e.allowHTML5="msie"!=e.browserName||0>navigator.appVersion.indexOf("MSIE 8");e.getDefaultLanguage=function(){return navigator.language||navigator.userLanguage||"en-US"};e._webGLtest=0;e.supportsWebGL=function(){if(!a.featureDetection._webGLtest){var b;a.featureDetection._webGLtest=k.WebGLRenderingContext&&
...
c.substring(0,1);c=c.substring(1);c.substring(0,1)==d&&0<="=$".indexOf(d)&&(c=c.substring(1));var e=a._getElement(b,"select");if(e&&e.options)for(var j=0;j<e.options.length;j++)e[j].value==d&&(e[j].selected=!0)}a.$val(a.$(b,"query"),c)}};a._search=function(b,c,d){1<arguments.length||(c=null);a._setQueryTerm(b,c);c||(c=a.$val(a.$(b,"query")));0==c.indexOf("!")?b._script(c.substring(1)):(c&&(c=c.replace(/\"/g,"")),b._showInfo(!1),a._searchMol(b,c,d,!0))};a._searchMol=function(b,c,d,e){var j;a._isDatabaseCall(c)?
(j=c.substring(0,1),c=c.substring(1)):j=b._hasOptions?a.$val(a.$(b,"select")):"$";"="==j&&3==c.length&&(c="="+c);var r=j+c;if(c&&!(0>r.indexOf("?")&&r==b._thisJmolModel)){b._thisJmolModel=r;var g;e&&null!=b._viewSet&&null!=(g=a.View.__findView(b._viewSet,{chemID:r}))?a.View.__setView(g,b,!1):("$"==j||":"==j?b._jmolFileType="MOL":"="==j&&(b._jmolFileType="PDB"),b._searchDatabase(c,j,d))}};a._searchDatabase=function(b,c,d,e){b._showInfo(!1);return 0<=c.indexOf("?")?(a._getInfoFromDatabase(b,d,c.split("?")[0]),
...
a._alertNoBinary&&!b&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=!1}return!0};a._binaryTypes=".gz .jpg .png .zip .jmol .bin .smol .spartan .mrc .pse .map .omap".split(" ");a._isBinaryUrl=function(b){for(var c=a._binaryTypes.length;0<=--c;)if(0<=b.indexOf(a._binaryTypes[c]))return!0;return!1};a._getFileData=function(b,c){var d=a._isBinaryUrl(b)?"binary":"text",e=0<=b.indexOf("pdb.gz")&&0==b.indexOf("http://www.rcsb.org/pdb/files/"),j="binary"==
d&&!a._canSyncBinary(e);j&&e&&(b=b.replace(/pdb\.gz/,"pdb"),j=!1,d="text");e=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var r=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),g=a._isDirectCall(b),k=!r&&a.$supportsIECrossDomainScripting();if(!c||j)if(k||j||!r&&!g)return a._getRawDataFromServer("_",b,c,c,j,!0);b=b.replace(/file:\/\/\/\//,"file://");var m={dataType:d,async:!!c};e?(m.type="POST",
m.url=b.split("?POST?")[0],m.data=b.split("?POST?")[1]):(m.type="GET",m.url=b);c&&(m.success=function(){c(a._xhrReturn(m.xhr))},m.error=function(){c(xhr.statusText)});m.url=m.url.replace("http://www.rcsb.org/pdb/files","api/proxy/jsmol");m.xhr=a.$ajax(m);if(!c)return a._xhrReturn(m.xhr)};a._xhrReturn=function(a){return!a.responseText||self.Clazz&&Clazz.instanceOf(a.response,self.ArrayBuffer)?a.response||a.statusText:a.responseText};a._isDirectCall=function(b){for(var c in a.db._DirectDatabaseCalls)if(0<=c.indexOf(".")&&0<=b.indexOf(c))return!0;return!1};a._cleanFileData=
...
d.indexOf("?")){d=a._checkFileName(c,d);var j=function(c){a._setData(b,d,c,e)},j=a._checkCache(c,d,j);return null==j?null:a._getFileData(d,j)}if(!a.featureDetection.hasFileReader)return b.setData("Local file reading is not enabled in your browser",null,e);c._localReader||(j='<div id="ID" style="z-index:'+a._getZ(c,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',
a.$after("#"+c._id+"_appletdiv",j.replace(/ID/g,c._id+"_localReader")),c._localReader=a.$(c,"localReader"));a.$appEvent(c,"localReader_loadfile","click");a.$appEvent(c,"localReader_loadfile","click",function(){var d=a.$(c,"localReader_files")[0].files[0],j=new FileReader;j.onloadend=function(j){j.target.readyState==FileReader.DONE&&(a.$css(a.$(c,"localReader"),{display:"none"}),a._setData(b,d.name,j.target.result,e))};j.readAsArrayBuffer(d)});a.$appEvent(c,"localReader_cancel","click");a.$appEvent(c,
...
a._getZ(b,"header")+';width:100%;height:100%;position:absolute;top:0px;left:0px;">';var j=b._height,r=b._width;if("string"!==typeof j||0>j.indexOf("%"))j+="px";if("string"!==typeof r||0>r.indexOf("%"))r+="px";d=d.replace(/IMG/,e).replace(/Hpx/g,j).replace(/Wpx/g,r)}else d='......</div>......<div id="ID_2dappletdiv" style="position:absolute;width:100%;height:100%;overflow:hidden;display:none"></div>......<div id="ID_infotablediv" style="width:100%;height:100%;position:absolute;top:0px;left:0px">.........<div id="ID_infoheaderdiv" style="height:20px;width:100%;background:yellow;display:none"><span id="ID_infoheaderspan"></span><span id="ID_infocheckboxspan" style="position:absolute;text-align:right;right:1px;"><a href="javascript:Jmol.showInfo(ID,false)">[x]</a></span></div>.........<div id="ID_infodiv" style="position:absolute;top:20px;bottom:0px;width:100%;height:100%;overflow:auto"></div>......</div>...</div>';
...
a._syncedApplets[d]._syncScript(c);return 0}};a._getElement=function(a,c){return document.getElementById(a._id+"_"+c)||{}};a._evalJSON=function(a,c){a+="";if(!a)return[];if("{"!=a.charAt(0))return 0<=a.indexOf(" | ")&&(a=a.replace(/\ \|\ /g,"\n")),a;var d=(new Function("return "+a))();return!d?null:c&&void 0!=d[c]?d[c]:d};a._sortMessages=function(a){function c(a,b){return a[0]<b[0]?1:a[0]>b[0]?-1:0}if(!a||"object"!=typeof a)return[];for(var d=[],e=a.length-1;0<=e;e--)for(var j=0,r=a[e].length;j<r;j++)d[d.length]=
a[e][j];if(0!=d.length)return d=d.sort(c)};a._setMouseOwner=function(b,c){null==b||c?a._mouseOwner=b:a._mouseOwner==b&&(a._mouseOwner=null)};a._jsGetMouseModifiers=function(a){var c=0;switch(a.button){case 0:c=16;break;case 1:c=8;break;case 2:c=4}a.shiftKey&&(c+=1);a.altKey&&(c+=8);a.ctrlKey&&(c+=2);return c};a._jsGetXY=function(b,c){if(!b.applet._ready||a._touching&&0>c.type.indexOf("touch"))return!1;c.preventDefault();var d=a.$offset(b.id),e,j=c.originalEvent;c.pageX||(c.pageX=j.pageX);c.pageY||
(c.pageY=j.pageY);a._mousePageX=c.pageX;a._mousePageY=c.pageY;j.targetTouches&&j.targetTouches[0]?(e=j.targetTouches[0].pageX-d.left,d=j.targetTouches[0].pageY-d.top):j.changedTouches?(e=j.changedTouches[0].pageX-d.left,d=j.changedTouches[0].pageY-d.top):(e=c.pageX-d.left,d=c.pageY-d.top);return void 0==e?null:[Math.round(e),Math.round(d),a._jsGetMouseModifiers(c)]};a._gestureUpdate=function(b,c){c.stopPropagation();c.preventDefault();var d=c.originalEvent;switch(c.type){case "touchstart":a._touching=
!0;break;case "touchend":a._touching=!1}if(!d.touches||2!=d.touches.length)return!1;switch(c.type){case "touchstart":b._touches=[[],[]];break;case "touchmove":var e=a.$offset(b.id),j=b._touches[0],r=b._touches[1];j.push([d.touches[0].pageX-e.left,d.touches[0].pageY-e.top]);r.push([d.touches[1].pageX-e.left,d.touches[1].pageY-e.top]);d=j.length;3<d&&(j.shift(),r.shift());2<=d&&b.applet._processGesture(b._touches)}return!0};a._jsSetMouse=function(b){a.$bind(b,"mousedown touchstart",function(c){a._setMouseOwner(b,
...
!1;var d=c.originalEvent,d=d.detail?d.detail:("mac"==a.featureDetection.os?1:-1)*d.wheelDelta;c=a._jsGetMouseModifiers(c);b.applet._processEvent(-1,[0>d?-1:1,0,c]);return!1});a.$bind(b,"contextmenu",function(){return!1});a.$bind(b,"mouseout",function(c){b.applet._applet&&b.applet._applet.startHoverWatcher(!1);a._jsGetXY(b,c);return!1});a.$bind(b,"mouseenter",function(c){b.applet._applet&&b.applet._applet.startHoverWatcher(!0);if(0===c.buttons||0===c.which){b.isDragging=!1;c=a._jsGetXY(b,c);if(!c)return!1;
b.applet._processEvent(504,c);b.applet._processEvent(502,c);return!1}});a.$bind(b,"mousemoveoutjsmol",function(c,d,e){if(b==a._mouseOwner&&b.isDragging)return a._drag(b,e)});b.applet._is2D&&a.$resize(function(){b.applet&&b.applet._resize()});a.$bind("body","mouseup touchend",function(){b.applet&&(b.isDragging=!1);a._setMouseOwner(null)})};a._jsUnsetMouse=function(b){b.applet=null;a.$bind(b,"mousedown touchstart mousemove touchmove mouseup touchend DOMMouseScroll mousewheel contextmenu mouseout mouseenter",
...
e.viewID||e.chemID);d._currentView[e.type].data=e.data;d._currentView[e.type].smiles=d._getSmiles();a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(d,"updateView");c.__setView(d._currentView,d,!1)}};c.updateFromSync=function(d,e){d._updateMsg=e;var g=a._getAttr(e,"sourceID")||a._getAttr(e,"file");if(g){var j=c.__findView(d._viewSet,{viewID:g});if(null==j)return a.updateView(d,e);j!=d._currentView&&c.__setView(j,d,!0);var r=(g=a._getAttr(e,"atoms"))&&0<=e.indexOf("selectionhalos ON")?eval("["+
g+"]"):[];setTimeout(function(){d._currentView==j&&c.updateAtomPick(d,r)},10);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(d,"updateFromSync")}};c.updateAtomPick=function(c,b){var d=c._currentView;if(null!=d){for(var j in d)"info"!=j&&d[j].applet!=c&&d[j].applet._updateAtomPick(b);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(c,"updateAtomPick")}};c.dumpViews=function(a){var d=c.sets[a];if(d){var e="View set "+a+":\n";a=c.applets[a];for(var j in a)e+="\napplet "+a[j]._id+" currentView="+
(a[j]._currentView?a[j]._currentView.info.viewID:null);for(j=d.length;0<=--j;){a=d[j];var e=e+("\n\n<b>view="+j+" viewID="+a.info.viewID+" chemID="+a.info.chemID+"</b>\n"),r,g;for(g in a)"info"!=g&&(e+="\nview="+j+" type="+g+" applet="+((r=a[g]).applet?r.applet._id:null)+" SMILES="+r.smiles+"\n atomMap="+JSON.stringify(r.atomMap)+"\n data=\n"+r.data+"\n")}return e}};c.__init=function(a){var d=a._viewSet,e=c.applets;e[d]||(e[d]={});e[d][a._viewType]=a};c.__findView=function(a,d){var e=c.sets[a];null==
e&&(e=c.sets[a]=[]);for(var j=e.length;0<=--j;){var r=e[j];if(d.viewID){if(r.info.viewID==d.viewID)return r}else{if(null!=d.chemID&&d.chemID==r.info.chemID)return r;for(var g in r)if("info"!=g&&(null!=d.data&&null!=r[g].data?d.data==r[g].data:d.type==g))return r}}return null};c.__createViewSet=function(d,e,g){c.count++;e={info:{chemID:e,viewID:g||"model_"+c.count}};for(var j in a._applets)g=a._applets[j],g._viewSet==d&&(e[g._viewType]={applet:g,data:null});c.sets[d].push(e);return e};c.__setView=
function(a,c,b){for(var d in a)if("info"!=d){var e=a[d],g=e.applet,m=b||null!=g&&"<modified>"==g._molData;if(!(null==g||g==c&&!m)){var k=null==e.data,p=null!=g._currentView;g._currentView=a;if(!p||!(a[d].data==e.data&&!k&!m))if(g._loadModelFromView(a),k)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(c){return a.Cache.fileCache[c]};a.Cache.put=function(c,d){a.Cache.fileCache[c]=d};a.Cache.setDragDrop=function(c){a.$appEvent(c,"appletdiv","dragover",function(a){a=a.originalEvent;a.stopPropagation();
a.preventDefault();a.dataTransfer.dropEffect="copy"});a.$appEvent(c,"appletdiv","drop",function(d){var e=d.originalEvent;e.stopPropagation();e.preventDefault();var g=e.dataTransfer.files[0];if(null==g)try{g=""+e.dataTransfer.getData("text"),(0==g.indexOf("file:/")||0==g.indexOf("http:/"))&&c._scriptLoad(g)}catch(j){}else e=new FileReader,e.onloadend=function(j){if(j.target.readyState==FileReader.DONE){var e="cache://DROP_"+g.name;j=a._toBytes(j.target.result);c._applet.cacheFileByName("cache://DROP_*",
!1);"JSV"==c._viewType||e.endsWith(".jdx")?a.Cache.put(e,j):c._applet.cachePut(e,j);(j=a._jsGetXY(c._canvas,d))&&(!c._applet.setStatusDragDropped||c._applet.setStatusDragDropped(0,j[0],j[1],e))&&c._applet.openFileAsyncSpecial(e,1)}},e.readAsArrayBuffer(g)})}})(Jmol,jQuery);Jmol._debugCode=!1;
(function(a){a._coreFiles=[];a.__execLog=[];a.__execStack=[];a.__execTimer=0;a.__coreSet=[];a.__coreMore=[];a.__execDelayMS=100;a.showExecLog=function(){return a.__execLog.join("\n")};a.__addExec=function(p){var g="JSmol load "+p[0]._id+" "+p[3];self.console&&console.log(g+"...");a.__execLog.push(g);a.__execStack.push(p)};a.__addCoreFile=function(p,g,k){if(!(0<=a.__coreSet.join("").indexOf(p))){a.__coreSet.push(p);a.__coreSet.sort();p=a.__coreSet.join("");a._coreFiles=[g+"/core/core"+("jmol"==p?"":
p)+".z.js"];if(k&&(k=k.split(" ")))for(p=0;p<k.length;p++)0>a.__coreMore.join("").indexOf(k[p])&&a.__coreMore.push(g+"/core/core"+k[p]+".z.js");for(p=0;p<a.__coreMore.length;p++)a._coreFiles.push(a.__coreMore[p])}};a.__nextExecution=function(p){delete a.__execTimer;for(var g=a.__execStack,k;0<g.length&&"done"==(k=g[0])[4];)g.shift();0!=g.length&&(p?(k.push("done"),p="JSmol exec "+k[0]._id+" "+k[3]+" "+k[2],self.console&&console.log(p+" -- OK"),a.__execLog.push(p),k[1](k[0],k[2])):setTimeout("Jmol.__nextExecution(true)",
10))};a.__loadClazz=function(p){a.__clazzLoaded?a.__nextExecution():(a.__clazzLoaded=!0,LoadClazz(),p._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=function(){}),LoadClazz=null,Clazz._Loader.globalLoaded=function(){Clazz._LoaderProgressMonitor.showStatus("Application loaded.",!0);if(!a._debugCode||!a.haveCore)a.haveCore=!0,a.__nextExecution()},Clazz._Loader.packageClasspath("java",null,!0))};a.__loadClass=function(p,g){Clazz._Loader.loadClass(g,function(){a.__nextExecution()})};a._Canvas2D=
function(p,g,k,e){this._uniqueId=(""+Math.random()).substring(3);this._id=p;this._is2D=!0;this._isJava=!1;this._jmolType="Jmol._Canvas2D ("+k+")";switch(k){case "Jmol":this._platform="J.awtjs2d.Platform";break;case "JSV":this._isLayered=this._isJSV=!0;this._platform="JSV.awtjs2d.Platform";break;case "Astex":this._isAstex=!0,this._platform="astex.awtjs2d.Platform"}if(e)return this;window[p]=this;this._createCanvas(p,g);if(!a._document||this._deferApplet)return this;this._init();return this};a._setAppletParams=
function(p,g,k,e){for(var m in k)if(!p||0<=p.indexOf(";"+m.toLowerCase()+";"))null==k[m]||"language"==m&&!a.featureDetection.supportsLocalization()||(e?g.put(m,!0===k[m]?Boolean.TRUE:!1===k[m]?Boolean.FALSE:k[m]):g[m]=k[m])};a._jsSetPrototype=function(p){p._init=function(){this._setupJS();this._showInfo(!0);this._disableInitialConsole&&this._showInfo(!1)};p._createCanvas=function(g,k,e){a._setObject(this,g,k);e&&(this._GLmol=e,this._GLmol.applet=this,this._GLmol.id=this._id);e=a._getWrapper(this,
!0);this._deferApplet||(a._document?(a._documentWrite(e),this._newCanvas(!1),e=""):(this._deferApplet=!0,e+='<script type="text/javascript">'+g+"._cover(false)\x3c/script>"));e+=a._getWrapper(this,!1);k.addSelectionOptions&&(e+=a._getGrabberOptions(this));a._debugAlert&&!a._document&&alert(e);this._code=a._documentWrite(e)};p._cover=function(g){if(g||!this._deferApplet)this._displayCoverImage(g);else{var k=this._coverScript?this._coverScript:"";this._coverScript="";this._deferUncover&&(k+=";refresh;javascript "+
this._id+"._displayCoverImage(false)");this._script(k,!0);this._deferUncover&&"activate 3D model"==this._coverTitle&&(a._getElement(this,"coverimage").title="3D model is loading...");this._deferApplet&&this._newCanvas(!1);this._defaultModel&&a._search(this,this._defaultModel);this._showInfo(!1);this._deferUncover||this._displayCoverImage(g);this._init&&this._init()}};p._displayCoverImage=function(g){this._coverImage&&this._isCovered!=g&&(this._isCovered=g,a._getElement(this,"coverdiv").style.display=
g?"block":"none")};p._newCanvas=function(a){this._is2D?this._createCanvas2d(a):this._GLmol.create()};p._createCanvas2d=function(){var g=a.$(this,"appletdiv");try{g[0].removeChild(this._canvas),this._canvas.frontLayer&&g[0].removeChild(this._canvas.frontLayer),this._canvas.rearLayer&&g[0].removeChild(this._canvas.rearLayer),this._canvas.imageLayer&&g[0].removeChild(this._canvas.imageLayer),a._jsUnsetMouse(this._mouseInterface)}catch(k){}var e=Math.round(g.width()),m=Math.round(g.height()),d=document.createElement("canvas");
d.applet=this;this._canvas=d;d.style.width="100%";d.style.height="100%";d.width=e;d.height=m;d.id=this._id+"_canvas2d";g.append(d);a._$(d.id).css({"z-index":a._getZ(this,"main")});if(this._isLayered){var c=document.createElement("div");d.imageLayer=c;c.id=this._id+"_imagelayer";g.append(c);a._$(c.id).css({zIndex:a._getZ(this,"image"),position:"absolute",left:"0px",top:"0px",width:"0px",height:"0px",overflow:"hidden"});this._mouseInterface=this._getLayer("front",g,e,m,!1)}else this._mouseInterface=
d;a._jsSetMouse(this._mouseInterface)};p._getLayer=function(g,k,e,m,d){var c=document.createElement("canvas");this._canvas[g+"Layer"]=c;c.style.width="100%";c.style.height="100%";c.id=this._id+"_"+g+"Layer";c.width=e;c.height=m;k.append(c);c.applet=this;a._$(c.id).css({background:d?"rgb(0,0,0,1)":"rgb(0,0,0,0.001)","z-index":a._getZ(this,g),position:"absolute",left:"0px",top:"0px",overflow:"hidden"});return c};p._setupJS=function(){window["j2s.lib"]={base:this._j2sPath+"/",alias:".",console:this._console,
monitorZIndex:a._getZ(this,"monitorZIndex")};0==a.__execStack.length&&a.__addExec([this,a.__loadClazz,null,"loadClazz"]);this._isJSV?(a.__addCoreFile("jsv",this._j2sPath,this.__Info.preloadCore),a._debugCode&&(a.__addExec([this,a.__loadClass,"JSV.appletjs.JSVApplet","load JSV"]),this._isPro&&a.__addExec([this,a.__loadClass,"JSV.appletjs.JSVAppletPro","load JSV(signed)"]))):this._isAstex?(a.__addCoreFile("astex",this._j2sPath,this.__Info.preloadCore),a._debugCode&&a.__addExec([this,a.__loadClass,"astex.MoleculeViewerAppletJS",
"load Astex"])):(a.__addCoreFile("jmol",this._j2sPath,this.__Info.preloadCore),this._is2D||a.__addExec([this,a.__loadClass,"J.export.JSExporter","load JSExporter"]),a._debugCode&&a.__addExec([this,a.__loadClass,"J.appletjs.Jmol","load Jmol"]));a.__addExec([this,this.__startAppletJS,null,"start applet"]);this._isSigned=!0;this._ready=!1;this._applet=null;this._canScript=function(){return!0};this._savedOrientations=[];a.__execTimer&&clearTimeout(a.__execTimer);a.__execTimer=setTimeout(a.__nextExecution,
a.__execDelayMS)};p.__startAppletJS=function(g){var k=new java.util.Hashtable;a._setAppletParams(g._availableParams,k,g.__Info,!0);k.put("appletReadyCallback","Jmol._readyCallback");k.put("applet",!0);k.put("name",g._id);k.put("syncId",a._syncId);g._color&&k.put("bgcolor",g._color);g._is2D?g._startupScript&&k.put("script",g._startupScript):k.put("script","set multipleBondSpacing 0.35;");a._syncedApplets.length&&k.put("synccallback","Jmol._mySyncCallback");k.put("signedApplet","true");k.put("platform",
g._platform);g._is2D&&k.put("display",g._id+"_canvas2d");k.put("documentBase",document.location.href);var e=g._j2sPath+"/";if(0>e.indexOf("://")){var m=document.location.href.split("#")[0].split("?")[0].split("/");0==e.indexOf("/")?m=[m[0],e.substring(1)]:m[m.length-1]=e;e=m.join("/")}k.put("codePath",e);a._registerApplet(g._id,g);g._applet=g._isAstex?new astex.MoleculeViewerAppletJS(k):!g._isJSV?new J.appletjs.Jmol(k):g._isPro?new JSV.appletjs.JSVAppletPro(k):new JSV.appletjs.JSVApplet(k);g._is2D||
(g._GLmol.applet=g);g._jsSetScreenDimensions();a.__nextExecution()};p._jsSetScreenDimensions=function(){if(this._applet){var g=a._getElement(this,this._is2D?"canvas2d":"canvas");this._applet.setScreenDimension(g.width,g.height)}};p._show=function(g){a.$setVisible(a.$(this,"appletdiv"),g);g&&a._repaint(this,!0)};p._canScript=function(){return!0};p._delay=function(a,k,e){this._delayID=setTimeout(function(){a.resumeEval(k,!1)},e)};p._createDomNode=function(a,k){a=this._id+"_"+a;var e=document.getElementById(a);
e&&document.body.removeChild(e);if(k){0==k.indexOf("<?")&&(k=k.substring(k.indexOf("<",1)));if(0<=k.indexOf("/>")){for(var e=k.split("/>"),m=e.length-1;0<=--m;)for(var d=e[m],c=d.lastIndexOf("<")+1,b=c,f=d.length,q="";++b<f;)if(0<=" \t\n\r".indexOf(d.charAt(b))){q=d.substring(c,b);e[m]=d+"></"+q+">";break}k=e.join("")}e=document.createElement("_xml");e.id=a;e.innerHTML=k;e.style.display="none";document.body.appendChild(e);return e}};p.equals=function(a){return this==a};p.clone=function(){return this};
p.hashCode=function(){return parseInt(this._uniqueId)};p._processGesture=function(a){return this._applet.mouse.processTwoPointGesture(a)};p._processEvent=function(a,k){this._applet.processMouseEvent(a,k[0],k[1],k[2],System.currentTimeMillis())};p._resize=function(){var g="__resizeTimeout_"+this._id;a[g]&&clearTimeout(a[g]);var k=this;a[g]=setTimeout(function(){a._repaint(k,!0);a[g]=null},100)};return p};a._repaint=function(p,g){if(p&&p._applet){var k=a.$(p,"appletdiv"),e=Math.round(k.width()),k=Math.round(k.height());
if(p._is2D&&(p._canvas.width!=e||p._canvas.height!=k))p._newCanvas(!0),p._applet.setDisplay(p._canvas);p._applet.setScreenDimension(e,k);g?setTimeout(function(){p._applet&&p._applet.update()}):p._applet.update()}};a._getHiddenCanvas=function(a,g,k,e,m){g=a._id+"_"+g;(a=document.getElementById(g))&&m&&(a=null);a||(a=document.createElement("canvas"));a.width=a.style.width=k;a.height=a.style.height=e;a.id!=g&&(a.id=g);return a};a._loadImage=function(p,g,k,e,m){var d=g[1];if(null==m)return m=new Image,
m.onload=function(){a._loadImage(p,g,null,e,m)},null!=k&&(k=J.io.Base64.getBase64(k).toString(),k=d.substring(url.lastIndexOf("/")+1),0<=k.indexOf(".png")||k.indexOf(".jpg")),m.src=d,!0;k=m.width;var c=m.height,b="echo_"+g[0],f=a._getHiddenCanvas(p.vwr.html5Applet,b,k,c,!0);f.imageWidth=k;f.imageHeight=c;f.id=b;f.image=m;a._setCanvasImage(f,k,c);e(f,d)};a._setCanvasImage=function(a,g,k){a.buf32=null;a.width=g;a.height=k;a.getContext("2d").drawImage(a.image,0,0,g,k)}})(Jmol);
(function(a,p){a._Applet=function(e,g,d){window[e]=this;this._jmolType="Jmol._Applet"+(g.isSigned?" (signed)":"");this._viewType="Jmol";this._isJava=!0;this._syncKeyword="Select:";this._availableParams=";progressbar;progresscolor;boxbgcolor;boxfgcolor;allowjavascript;boxmessage;\t\t\t\t\t\t\t\t\t;messagecallback;pickcallback;animframecallback;appletreadycallback;atommovedcallback;\t\t\t\t\t\t\t\t\t;echocallback;evalcallback;hovercallback;language;loadstructcallback;measurecallback;\t\t\t\t\t\t\t\t\t;minimizationcallback;resizecallback;scriptcallback;statusform;statustext;statustextarea;\t\t\t\t\t\t\t\t\t;synccallback;usecommandthread;syncid;appletid;startupscript;menufile;";
if(d)return this;this._isSigned=g.isSigned;this._readyFunction=g.readyFunction;this._ready=!1;this._isJava=!0;this._isInfoVisible=!1;this._applet=null;this._memoryLimit=g.memoryLimit||512;this._canScript=function(){return!0};this._savedOrientations=[];this._initialize=function(c,b){var d=!1;a._jarFile&&(b=a._jarFile);if(this._jarFile){var e=this._jarFile;0<=e.indexOf("/")?(alert("This web page URL is requesting that the applet used be "+e+". This is a possible security risk, particularly if the applet is signed, because signed applets can read and write files on your local machine or network."),
"yes"==prompt("Do you want to use applet "+e+"? ","yes or no")?(c=e.substring(0,e.lastIndexOf("/")),b=e.substring(e.lastIndexOf("/")+1)):d=!0):b=e;this_isSigned=g.isSigned=0<=b.indexOf("Signed")}this._jarPath=g.jarPath=c||".";this._jarFile=g.jarFile="string"==typeof b?b:(b?"JmolAppletSigned":"JmolApplet")+"0.jar";d&&alert("The web page URL was ignored. Continuing using "+this._jarFile+' in directory "'+this._jarPath+'"');void 0==a.controls||a.controls._onloadResetForms()};this._create(e,g);return this};
var g=a._Applet,k=a._Applet.prototype;g._get=function(e,k,d){d||(d=!1);k||(k={});a._addDefaultInfo(k,{color:"#FFFFFF",width:300,height:300,addSelectionOptions:!1,serverURL:"http://your.server.here/jsmol.php",defaultModel:"",script:null,src:null,readyFunction:null,use:"HTML5",jarPath:"java",jarFile:"JmolApplet0.jar",isSigned:!1,j2sPath:"j2s",coverImage:null,coverTitle:"",coverCommand:"",deferApplet:!1,deferUncover:!1,disableJ2SLoadMonitor:!1,disableInitialConsole:!1,debug:!1});a._debugAlert=k.debug;
a.featureDetection.allowHTML5||(k.use="JAVA");k.serverURL&&(a._serverUrl=k.serverURL);for(var c=!1,b=null,f=k.use.toUpperCase().split("#")[0].split(" "),q=0;q<f.length;q++){switch(f[q]){case "JAVA":c=!0;a.featureDetection.supportsJava()&&(b=new g(e,k,d));break;case "WEBGL":b=g._getCanvas(e,k,d,!0);break;case "HTML5":b=g._getCanvas(e,k,d,!1);break;case "IMAGE":b=new a._Image(e,k,d)}if(null!=b)break}null==b&&(d||!c?b={_jmolType:"none"}:c&&(b=new g(e,k)));return d?b:a._registerApplet(e,b)};g._getCanvas=
function(e,k,d,c){return c&&a.featureDetection.supportsWebGL()?(a._Canvas3D.prototype=a.GLmol.extendApplet(a._jsSetPrototype(new g(e,k,!0))),new a._Canvas3D(e,k,"Jmol",d)):!c?(a._Canvas2D.prototype=a._jsSetPrototype(new g(e,k,!0)),new a._Canvas2D(e,k,"Jmol",d)):null};g._noJavaMsg="Either you do not have Java applets enabled in your web<br />browser or your browser is blocking this applet.<br />\t\t\tCheck the warning message from your browser and/or enable Java applets in<br />\t\t\tyour web browser preferences, or install the Java Runtime Environment from <a href='http://www.java.com'>www.java.com</a>";
g._setCommonMethods=function(a){a._showInfo=k._showInfo;a._search=k._search;a._getName=k._getName;a._readyCallback=k._readyCallback};g._createApplet=function(e,k,d){e._initialize(k.jarPath,k.jarFile);var c=e._jarFile;a._isFile&&(c=c.replace(/0\.jar/,".jar"));var b=0<=e._containerWidth.indexOf("px")?e._containerWidth:"100%",f=0<=e._containerHeight.indexOf("px")?e._containerHeight:"100%",b=' style="width:'+b+";height:"+f+'" ',f="name='"+e._id+"_object' id='"+e._id+"_object' \n"+b+"\n";d.codebase=e._jarPath;
d.codePath=d.codebase+"/";if(0>d.codePath.indexOf("://")){var q=p.location.href.split("#")[0].split("?")[0].split("/");q[q.length-1]=d.codePath;d.codePath=q.join("/")}d.archive=c;d.mayscript="true";d.java_arguments="-Xmx"+Math.round(k.memoryLimit||e._memoryLimit)+"m";d.permissions=e._isSigned?"all-permissions":"sandbox";d.documentLocation=p.location.href;d.documentBase=p.location.href.split("#")[0].split("?")[0];d.jarPath=k.jarPath;a._syncedApplets.length&&(d.synccallback="Jmol._mySyncCallback");
e._startupScript&&(d.script=e._startupScript);var q="\n",s;for(s in d)d[s]&&(q+="  <param name='"+s+"' value='"+d[s]+"' />\n");q=a.featureDetection.useIEObject||a.featureDetection.useHtml4Object?"<object "+f+(a.featureDetection.useIEObject?" classid='clsid:8AD9C840-044E-11D1-B3E9-00805F499D93' codebase='http://java.sun.com/update/1.6.0/jinstall-6u22-windows-i586.cab'>":" type='application/x-java-applet'>")+q+"<p style='background-color:yellow;"+b.split('"')[1]+";text-align:center;vertical-align:middle;'>\n"+
g._noJavaMsg+"</p></object>\n":"<applet "+f+" code='"+d.code+"' codebase='"+e._jarPath+"' archive='"+c+"' mayscript='true'>\n"+q+"<table bgcolor='yellow'><tr><td align='center' valign='middle' "+b+">\n"+g._noJavaMsg+"</td></tr></table></applet>\n";q=a._getWrapper(e,!0)+q+a._getWrapper(e,!1)+(k.addSelectionOptions?a._getGrabberOptions(e):"");a._debugAlert&&alert(q);e._code=a._documentWrite(q)};k._create=function(e,k){a._setObject(this,e,k);var d={syncId:a._syncId,progressbar:"true",progresscolor:"blue",
boxbgcolor:this._color||"black",boxfgcolor:"white",boxmessage:"Downloading JmolApplet ...",script:this._color?'background "'+this._color+'"':"",code:"JmolApplet.class"};a._setAppletParams(this._availableParams,d,k);var c;k.inlineModel?(c=k.inlineModel,c=c.replace(/\r|\n|\r\n/g,0<=c.indexOf("|")?"\\/n":"|").replace(/'/g,"&#39;"),a._debugAlert&&alert("inline model:\n"+c)):c="";d.loadInline=c;d.appletReadyCallback="Jmol._readyCallback";a._syncedApplets.length&&(d.synccallback="Jmol._mySyncCallback");
d.java_arguments="-Xmx"+Math.round(k.memoryLimit||this._memoryLimit)+"m";this._initialize(k.jarPath,k.jarFile);g._createApplet(this,k,d)};k._readyCallback=function(e,g,d,c){d&&(a._setDestroy(this),this._ready=!0,e=this._readyScript,this._applet=c,this._defaultModel?a._search(this,this._defaultModel,e?";"+e:""):e?this._script(e):this._src&&this._script('load "'+this._src+'"'),this._showInfo(!0),this._showInfo(!1),a.Cache.setDragDrop(this),this._readyFunction&&this._readyFunction(this),a._setReady(this),
(c=this._2dapplet)&&(c._isEmbedded&&c._ready&&c.__Info.visible)&&this._show2d(!0))};k._showInfo=function(e){e&&this._2dapplet&&this._2dapplet._show(!1);a.$html(a.$(this,"infoheaderspan"),this._infoHeader);this._info&&a.$html(a.$(this,"infodiv"),this._info);if(!this._isInfoVisible!=!e){this._isInfoVisible=e;if(this._isJava){var g=e?2:"100%";a.$setSize(a.$(this,"appletdiv"),g,g)}a.$setVisible(a.$(this,"infotablediv"),e);a.$setVisible(a.$(this,"infoheaderdiv"),e);this._show(!e)}};k._show2d=function(a){this._2dapplet._show2d(a);
this._2dapplet._isEmbedded&&(this._showInfo(!1),this._show(!a))};k._getAtomCorrelation=function(a){this._loadMolData(a,"atommap = compare({1.1} {2.1} 'MAP' 'H'); zap 2.1",!0);a=jmol._evaluate("atommap");for(var g=jmol._evaluate("{*}.count"),d=[],c=[],b=0;b<a.length;b++){var f=a[b];d[f[0]+1]=f[1]-g+1;c[f[1]-g+1]=f[0]+1}return{fromJmol:d,toJmol:c}};k._show=function(e){var g=!e?2:"100%";a.$setSize(a.$(this,"object"),g,g);this._isJava||a.$setVisible(a.$(this,"appletdiv"),e)};k._clearConsole=function(){this._console==
this._id+"_infodiv"&&(this.info="");self.Clazz&&(a._setConsoleDiv(this._console),Clazz.Console.clear())};k._addScript=function(a){this._readyScript||(this.readyScript="");this._readyScript&&(this._readyScript+=";");this._readyScript+=a;return!0};k._script=function(e){if(!this._ready)return this._addScript(e);a._setConsoleDiv(this._console);this._applet.script(e)};k._syncScript=function(a){this._applet.syncScript(a)};k._scriptCheck=function(a){return this._ready&&this._applet.scriptCheck(a)};k._scriptWait=
function(a,g){var d=this._scriptWaitAsArray(a),c="";if(!g)for(var b=d.length;0<=--b;)for(var f=0,k=d[b].length;f<k;f++)c+=d[b][f]+"\n";return c};k._scriptEcho=function(a){a=this._scriptWaitAsArray(a);for(var g="",d=a.length;0<=--d;)for(var c=a[d].length;0<=--c;)"scriptEcho"==a[d][c][1]&&(g+=a[d][c][3]+"\n");return g.replace(/ \| /g,"\n")};k._scriptMessage=function(a){a=this._scriptWaitAsArray(a);for(var g="",d=a.length;0<=--d;)for(var c=a[d].length;0<=--c;)"scriptStatus"==a[d][c][1]&&(g+=a[d][c][3]+
"\n");return g.replace(/ \| /g,"\n")};k._scriptWaitOutput=function(a){var g="";try{a&&(g+=this._applet.scriptWaitOutput(a))}catch(d){}return g};k._scriptWaitAsArray=function(e){var g="";try{if(this._getStatus("scriptEcho,scriptMessage,scriptStatus,scriptError"),e&&(g+=this._applet.scriptWait(e),g=a._evalJSON(g,"jmolStatus"),"object"==typeof g))return g}catch(d){}return[[g]]};k._getStatus=function(e){return a._sortMessages(this._getPropertyAsArray("jmolStatus",e))};k._getPropertyAsArray=function(e,
g){return a._evalJSON(this._getPropertyAsJSON(e,g),e)};k._getPropertyAsString=function(a,g){void 0==g&&(g="");return this._applet.getPropertyAsString(a,g)+""};k._getPropertyAsJSON=function(a,g){void 0==g&&(g="");try{return this._applet.getPropertyAsJSON(a,g)+""}catch(d){return""}};k._getPropertyAsJavaObject=function(a,g){void 0==g&&(g="");return this._applet.getProperty(a,g)};k._evaluate=function(a){null!=a||(a="");return this._getPropertyAsArray("variableInfo",a)};k._evaluateDEPRECATED=function(a){a=
""+this._getPropertyAsJavaObject("evaluate",a);var g=a.replace(/\-*\d+/,"");if(""==g&&!isNaN(parseInt(a)))return parseInt(a);g=a.replace(/\-*\d*\.\d*/,"");return""==g&&!isNaN(parseFloat(a))?parseFloat(a):a};k._saveOrientation=function(a){return this._savedOrientations[a]=this._getPropertyAsArray("orientationInfo","info").moveTo};k._restoreOrientation=function(a){a=this._savedOrientations[a];return!a||""==a?a.replace(/1\.0/,"0"):this._scriptWait(a)};k._restoreOrientationDelayed=function(a,g){1>arguments.length&&
(g=1);var d=this._savedOrientations[a];return!d||""==d?d.replace(/1\.0/,g):this._scriptWait(d)};k._resizeApplet=function(e){function g(c,b){var d=""+c;return 0==d.length?b?"":a._allowedJmolSize[2]:d.indexOf("%")==d.length-1?d:1>=(c=parseFloat(c))&&0<c?100*c+"%":(isNaN(c=Math.floor(c))?a._allowedJmolSize[2]:c<a._allowedJmolSize[0]?a._allowedJmolSize[0]:c>a._allowedJmolSize[1]?a._allowedJmolSize[1]:c)+(b?b:"")}var d;"object"==typeof e&&null!=e?(d=e[0]||e.width,e=e[1]||e.height):d=e;d=[g(d,"px"),g(e,
"px")];e=a._getElement(this,"appletinfotablediv");e.style.width=d[0];e.style.height=d[1];this._containerWidth=d[0];this._containerHeight=d[1];this._is2D&&a._repaint(this,!0)};k._search=function(e,g){a._search(this,e,g)};k._searchDatabase=function(e,g,d){if(this._2dapplet&&this._2dapplet._isEmbedded&&a.$(this,"2dappletdiv:visible")[0])return this._2dapplet._searchDatabase(e,g,d);this._showInfo(!1);0<=e.indexOf("?")?a._getInfoFromDatabase(this,g,e.split("?")[0]):(d||(d=a._getScriptForDatabase(g)),e=
g+e,this._currentView=null,this._searchQuery=e,this._loadFile(e,d,e))};k._loadFile=function(e,g,d){this._showInfo(!1);g||(g="");this._thisJmolModel=""+Math.random();this._fileName=e;if(!this._scriptLoad(e,g)){var c=this;a._loadFileData(this,e,function(a){c.__loadModel(a,g,d)},function(){c.__loadModel(null)})}};k._scriptLoad=function(a,g){g||(g="");var d=this._isJava||!this._noscript;d&&this._script("zap;set echo middle center;echo Retrieving data...");if(!this._isSigned||null!=this._viewSet)return!1;
d?this._script('load async "'+a+'";'+g):this._applet.openFile(a);this._checkDeferred("");return!0};k.__loadModel=function(e,g,d){null!=e&&(null!=this._viewSet&&(g||(g=""),g+=";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};"),!g&&this._noscript?this._applet.loadInlineString(e,"",!1):this._loadMolData(e,g,!1),null!=this._viewSet&&a.View.updateView(this,{chemID:d,data:e}))};k._loadMolData=function(a,g,d){g||
(g="");d=d?"append":"model";this._applet.scriptWait('load DATA "'+d+'"'+a+'\nEND "'+d+'" ;'+g)};k._loadModelFromView=function(e){this._currentView=e;var g=e.Jmol;null!=g.data?this.__loadModel(g.data,null,e.info.chemID):null!=e.info.chemID?a._searchMol(this,e.info.chemID,null,!1):(g=e.JME)&&g.applet._show2d(!1,this)};k._updateView=function(){null!=this._viewSet&&this._applet&&(chemID=""+this._getPropertyAsJavaObject("variableInfo","script('show chemical inchiKey')"),chemID=36>chemID.length()?null:
chemID.substring(36).split("\n")[0],a.View.updateView(this,{chemID:chemID,data:""+this._getPropertyAsJavaObject("evaluate","extractModel","{visible}")}))};k._atomPickedCallback=function(e,g){if(!(0>g)){var d=[g+1];a.View.updateAtomPick(this,d);this._updateAtomPick(d)}};k._updateAtomPick=function(a){this._script(0==a.length?"select none":"select on visible and (@"+a.join(",@")+")")};k._isDeferred=function(){return!this._canvas&&this._cover&&this._isCovered&&this._deferApplet};k._checkDeferred=function(a){return this._isDeferred()?
(this._coverScript=a,this._cover(!1),!0):!1};k._getSmiles=function(){return this._evaluate("{visible}.find('SMILES')")};k._getMol=function(){return this._evaluate("getProperty('ExtractModel',{visible})")};k._getMol2D=function(){return jmol._evaluate("script('select visible;show chemical sdf')")};a.jmolSmiles=function(a){return a._getSmiles()}})(Jmol,document);
...
p._addScript=function(a,k){var e=p._scripts.length;p._scripts[e]=[a,k];return e};p._getIdForControl=function(a,k){return"string"==typeof a?a:!k||!a._canScript||a._canScript(k)?a._id:null};p._radio=function(a,k,e,m,d,c,b,f){var q=p._getIdForControl(a,k);if(null==q)return null;++p._radioCount;void 0!=c&&null!=c||(c="jmolRadioGroup"+(p._radioGroupCount-1));if(!k)return"";void 0!=b&&null!=b||(b="jmolRadio"+(p._radioCount-1));void 0!=e&&null!=e||(e=k.substring(0,32));d||(d="");a="</span>";p._actions[b]=
p._addScript(q,k);k='<span id="span_'+b+'"'+(f?' title="'+f+'"':"")+"><input name='"+c+"' id='"+b+"' type='radio' onclick='Jmol.controls._click(this);return true;' onmouseover='Jmol.controls._mouseOver(this);return true;' onmouseout='Jmol.controls._mouseOut()' "+(m?"checked='true' ":"")+p._radioCssText+" />";0<=e.toLowerCase().indexOf("<td>")&&(k+=a,a="");return k+('<label for="'+b+'">'+e+"</label>"+a+d)};p._scriptExecute=function(g,k){var e=a._applets[k[0]],m=k[1];if("object"==typeof m)m[0](g,m,
e);else"function"==typeof m?m(e):a.script(e,m)};p.__checkScript=function(a,k){var e=0<=k.value.indexOf("JSCONSOLE ")||""===a._scriptCheck(k.value);k.style.color=e?"black":"red";return e};p.__getCmd=function(a,k){if(k._cmds&&k._cmds.length){var e=k._cmds[k._cmdpt=(k._cmdpt+k._cmds.length+a)%k._cmds.length];setTimeout(function(){k.value=e},10);k._cmdadd=1;k._cmddir=a}};p._commandKeyPress=function(g,k,e){g=13==g?13:window.event?window.event.keyCode:g?g.keyCode||g.which:0;var m=document.getElementById(k),
d=a._applets[e];switch(g){case 13:return k=m.value,p._scriptExecute(m,[e,k]),m._cmds||(m._cmds=[],m._cmddir=0,m._cmdpt=-1,m._cmdadd=0),k&&0==m._cmdadd?(++m._cmdpt,m._cmds.splice(m._cmdpt,0,k),m._cmdadd=0,m._cmddir=0):m._cmdadd=0,m.value="",!1;case 27:return setTimeout(function(){m.value=""},20),!1;case 38:p.__getCmd(-1,m);break;case 40:p.__getCmd(1,m);break;default:m._cmdadd=0}setTimeout(function(){p.__checkScript(d,m)},20);return!0};p._click=function(a,k){p._element=a;1==arguments.length&&(k=p._actions[a.id]);
p._scriptExecute(a,p._scripts[k])};p._menuSelected=function(a){var k=a.value;if(void 0!=k)p._scriptExecute(a,p._scripts[k]);else{k=a.length;if("number"==typeof k)for(var e=0;e<k;++e)if(a[e].selected){p._click(a[e],a[e].value);return}alert("?Que? menu selected bug #8734")}};p._cbNotifyMaster=function(a){var k=!0,e=!0,m;for(m in a.chkGroup)a.chkGroup[m].checked?e=!1:k=!1;k&&(a.chkMaster.checked=!0);e&&(a.chkMaster.checked=!1);(k||e)&&p._checkboxItems[a.chkMaster.id]&&p._cbNotifyMaster(p._checkboxItems[a.chkMaster.id])};
p._cbNotifyGroup=function(a,k){for(var e in a.chkGroup){var m=a.chkGroup[e];m.checked!=k&&(m.checked=k,p._cbClick(m));p._checkboxMasters[m.id]&&p._cbNotifyGroup(p._checkboxMasters[m.id],k)}};p._cbSetCheckboxGroup=function(a,k,e){var m=a;"number"==typeof m&&(m="jmolCheckbox"+m);(a=document.getElementById(m))||alert("jmolSetCheckboxGroup: master checkbox not found: "+m);var d=p._checkboxMasters[m]={};d.chkMaster=a;d.chkGroup={};"string"==typeof k?(k=e,m=1):m=0;for(a=m;a<k.length;a++)m=k[a],"number"==
typeof m&&(m="jmolCheckbox"+m),(checkboxItem=document.getElementById(m))||alert("jmolSetCheckboxGroup: group checkbox not found: "+m),d.chkGroup[m]=checkboxItem,p._checkboxItems[m]=d};p._cbClick=function(a){p._control=a;var k=p._actions[a.id][0],e=p._actions[a.id][1];p._click(a,a.checked?k:e);p._checkboxMasters[a.id]&&p._cbNotifyGroup(p._checkboxMasters[a.id],a.checked);p._checkboxItems[a.id]&&p._cbNotifyMaster(p._checkboxItems[a.id])};p._cbOver=function(a){var k=p._actions[a.id][0],e=p._actions[a.id][1];
window.status=p._scripts[a.checked?e:k]};p._mouseOver=function(a,k){1==arguments.length&&(k=p._actions[a.id]);window.status=p._scripts[k]};p._mouseOut=function(){window.status=" ";return!0};p._onloadResetForms=function(){p._hasResetForms||(p._hasResetForms=!0,p._previousOnloadHandler=window.onload,window.onload=function(){if(0<p._buttonCount+p._checkboxCount+p._menuCount+p._radioCount+p._radioGroupCount)for(var a=document.forms,k=a.length;0<=--k;)a[k].reset();p._previousOnloadHandler&&p._previousOnloadHandler()})};
p._getButton=function(g,k,e,m,d){g=p._getIdForControl(g,k);if(null==g)return"";void 0!=m&&null!=m||(m="jmolButton"+p._buttonCount);void 0!=e&&null!=e||(e=k.substring(0,32));++p._buttonCount;p._actions[m]=p._addScript(g,k);k='<span id="span_'+m+'"'+(d?' title="'+d+'"':"")+"><input type='button' name='"+m+"' id='"+m+"' value='"+e+"' onclick='Jmol.controls._click(this)' onmouseover='Jmol.controls._mouseOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+p._buttonCssText+" /></span>";a._debugAlert&&
alert(k);return a._documentWrite(k)};p._getCheckbox=function(g,k,e,m,d,c,b){var f=p._getIdForControl(g,k);null!=f&&(f=p._getIdForControl(g,e));if(null==f)return"";void 0!=c&&null!=c||(c="jmolCheckbox"+p._checkboxCount);++p._checkboxCount;if(void 0==k||null==k||void 0==e||null==e)alert("jmolCheckbox requires two scripts");else if(void 0==m||null==m)alert("jmolCheckbox requires a label");else return p._actions[c]=[p._addScript(f,k),p._addScript(f,e)],g="</span>",d='<span id="span_'+c+'"'+(b?' title="'+
b+'"':"")+"><input type='checkbox' name='"+c+"' id='"+c+"' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+(d?"checked='true' ":"")+p._checkboxCssText+" />",0<=m.toLowerCase().indexOf("<td>")&&(d+=g,g=""),d+='<label for="'+c+'">'+m+"</label>"+g,a._debugAlert&&alert(d),a._documentWrite(d)};p._getCommandInput=function(g,k,e,m,d,c){g=p._getIdForControl(g,"x");if(null==g)return"";void 0!=m&&null!=m||(m="jmolCmd"+p._cmdCount);
void 0!=k&&null!=k||(k="Execute");void 0!=e&&!isNaN(e)||(e=60);void 0!=c||(c="help");++p._cmdCount;k='<span id="span_'+m+'"'+(d?' title="'+d+'"':"")+"><input name='"+m+"' id='"+m+"' size='"+e+"' onkeydown='return Jmol.controls._commandKeyPress(event,\""+m+'","'+g+"\")' value='"+c+"'/><input  type='button' name='"+m+"Btn' id='"+m+"Btn' value = '"+k+"' onclick='Jmol.controls._commandKeyPress(13,\""+m+'","'+g+"\")' /></span>";a._debugAlert&&alert(k);return a._documentWrite(k)};p._getLink=function(g,
k,e,m,d){g=p._getIdForControl(g,k);if(null==g)return"";void 0!=m&&null!=m||(m="jmolLink"+p._linkCount);void 0!=e&&null!=e||(e=k.substring(0,32));++p._linkCount;k=p._addScript(g,k);e='<span id="span_'+m+'"'+(d?' title="'+d+'"':"")+"><a name='"+m+"' id='"+m+"' href='javascript:Jmol.controls._click(null,"+k+");' onmouseover='Jmol.controls._mouseOver(null,"+k+");return true;' onmouseout='Jmol.controls._mouseOut()' "+p._linkCssText+">"+e+"</a></span>";a._debugAlert&&alert(e);return a._documentWrite(e)};
p._getMenu=function(g,k,e,m,d){var c=p._getIdForControl(g,null);void 0!=m&&null!=m||(m="jmolMenu"+p._menuCount);++p._menuCount;c=typeof k;if(null!=c&&"object"==c&&k.length){var b=k.length;"number"!=typeof e||1==e?e=null:0>e&&(e=b);e='<span id="span_'+m+'"'+(d?' title="'+d+'"':"")+"><select name='"+m+"' id='"+m+"' onChange='Jmol.controls._menuSelected(this)'"+(e?" size='"+e+"' ":"")+p._menuCssText+">";for(m=0;m<b;++m){var f=k[m],c=typeof f,q=null,s=d=null;"object"==c&&null!=f?(q=f[0],d=f[1],s=f[2]):
q=d=f;c=p._getIdForControl(g,q);if(null==c)return"";null==d&&(d=q);"#optgroup"==q?e+="<optgroup label='"+d+"'>":"#optgroupEnd"==q?e+="</optgroup>":(c=p._addScript(c,q),e+="<option value='"+c+(s?"' selected='true'>":"'>")+d+"</option>")}e+="</select></span>";a._debugAlert&&alert(e);return a._documentWrite(e)}};p._getRadio=function(g,k,e,m,d,c,b,f){0==p._radioGroupCount&&++p._radioGroupCount;c||(c="jmolRadioGroup"+(p._radioGroupCount-1));g=p._radio(g,k,e,m,d,c,b?b:c+"_"+p._radioCount,f?f:0);if(null==
g)return"";a._debugAlert&&alert(g);return a._documentWrite(g)};p._getRadioGroup=function(g,k,e,m,d,c){var b=typeof k;if("object"!=b||null==b||!k.length)alert("invalid arrayOfRadioButtons");else{void 0!=e&&null!=e||(e="&#xa0; ");var f=k.length;++p._radioGroupCount;m||(m="jmolRadioGroup"+(p._radioGroupCount-1));for(var q="<span id='"+(d?d:m)+"'>",s=0;s<f;++s){s==f-1&&(e="");var j=k[s],b=typeof j,r=null,q="object"==b?q+(r=p._radio(g,j[0],j[1],j[2],e,m,3<j.length?j[3]:(d?d:m)+"_"+s,4<j.length?j[4]:0,
c)):q+(r=p._radio(g,j,null,null,e,m,(d?d:m)+"_"+s,c));if(null==r)return""}q+="</span>";a._debugAlert&&alert(q);return a._documentWrite(q)}}})(Jmol);
(function(a){var p=function(a){a="&"+a+"=";return decodeURI(("&"+document.location.search.substring(1)+a).split(a)[1].split("&")[0])};a._j2sPath=p("_J2S");a._jarFile=p("_JAR");a._use=p("_USE");a.getVersion=function(){return a._jmolInfo.version};a.getApplet=function(g,k,e){return a._Applet._get(g,k,e)};a.getJMEApplet=function(g,k,e,m){return a._JMEApplet._get(g,k,e,m)};a.getJSVApplet=function(g,k,e){return a._JSVApplet._get(g,k,e)};a.loadFile=function(a,k,e){a._loadFile(k,e)};a.script=function(a,k){a._checkDeferred(k)||
...
a.jmolButton=function(g,k,e,m,d){return a.controls._getButton(g,k,e,m,d)};a.jmolCheckbox=function(g,k,e,m,d,c,b){return a.controls._getCheckbox(g,k,e,m,d,c,b)};a.jmolCommandInput=function(g,k,e,m,d,c){return a.controls._getCommandInput(g,k,e,m,d,c)};a.jmolHtml=function(g){return a._documentWrite(g)};a.jmolLink=function(g,k,e,m,d){return a.controls._getLink(g,k,e,m,d)};a.jmolMenu=function(g,k,e,m,d){return a.controls._getMenu(g,k,e,m,d)};a.jmolRadio=function(g,k,e,m,d,c,b,f){return a.controls._getRadio(g,
k,e,m,d,c,b,f)};a.jmolRadioGroup=function(g,k,e,m,d,c){return a.controls._getRadioGroup(g,k,e,m,d,c)};a.setCheckboxGroup=function(g,k){a.controls._cbSetCheckboxGroup(g,k,arguments)};a.setDocument=function(g){a._document=g};a.setXHTML=function(g){a._isXHTML=!0;a._XhtmlElement=null;a._XhtmlAppendChild=!1;g&&(a._XhtmlElement=document.getElementById(g),a._XhtmlAppendChild=!0)};a.setAppletCss=function(g,k){null!=g&&(a.controls._appletCssClass=g);a.controls._appletCssText=k?k+" ":g?'class="'+g+'" ':""};
a.setButtonCss=function(g,k){null!=g&&(a.controls._buttonCssClass=g);a.controls._buttonCssText=k?k+" ":g?'class="'+g+'" ':""};a.setCheckboxCss=function(g,k){null!=g&&(a.controls._checkboxCssClass=g);a.controls._checkboxCssText=k?k+" ":g?'class="'+g+'" ':""};a.setRadioCss=function(g,k){null!=g&&(a.controls._radioCssClass=g);a.controls._radioCssText=k?k+" ":g?'class="'+g+'" ':""};a.setLinkCss=function(g,k){null!=g&&(a.controls._linkCssClass=g);a.controls._linkCssText=k?k+" ":g?'class="'+g+'" ':""};
a.setMenuCss=function(g,k){null!=g&&(a.controls._menuCssClass=g);a.controls._menuCssText=k?k+" ":g?'class="'+g+'" ':""};a.setAppletSync=function(g,k,e){a._syncedApplets=g;a._syncedCommands=k;a._syncedReady={};a._isJmolJSVSync=e};a.setGrabberOptions=function(g){a._grabberOptions=g};a.setAppletHtml=function(g,k){g._code&&(a.$html(k,g._code),g._init&&!g._deferApplet&&g._init())};a.coverApplet=function(a,k){a._cover&&a._cover(k)};a.setFileCaching=function(g,k){g?g._cacheFiles=k:a.fileCache=k?{}:null};
a.updateView=function(a,k,e){a._updateView(k,e)};a.getChemicalInfo=function(g,k,e){k||(k="name");"string"!=typeof applet_or_Identifier&&(g=g._getSmiles());return a._getNCIInfo(g,k,e)};a.saveImage=function(a){switch(a._viewType){case "Jmol":a._script('write PNGJ "'+a._id+'.png"');break;case "JSV":a._script("write PDF");break;case "JME":a._script("print")}}})(Jmol);
...
function(a,c,b,f){return f?a[c]=b:a[c]};a.addProto=function(d,c,b){a.getSignature(d,c,b,!0)};var p=a._O.prototype;a.addProto(p,"equals",function(a){return this==a});a.addProto(p,"hashCode",function(){try{return this.toString().hashCode()}catch(a){var c=":",b;for(b in this)c+=b+":";return c.hashCode()}});a.addProto(p,"getClass",function(){return a.getClass(this)});a.addProto(p,"clone",function(){return a.clone(this)});a.clone=function(a){var c=new a.constructor,b;for(b in a)c[b]=a[b];return c};a.addProto(p,
"finalize",function(){});a.addProto(p,"notify",function(){});a.addProto(p,"notifyAll",function(){});a.addProto(p,"wait",function(){});a.addProto(p,"to$tring",Object.prototype.toString);a.addProto(p,"toString",function(){return null!=this.__CLASS_NAME__?"["+this.__CLASS_NAME__+" object]":this.to$tring.apply(this,arguments)});a._extendedObjectMethods="equals hashCode getClass clone finalize notify notifyAll wait to$tring toString".split(" ");a.extendJO=function(d,c){c&&(d.__CLASS_NAME__=d.prototype.__CLASS_NAME__=
...
e)return e+1}return-1};a.getInheritedLevel=function(d,c){if(d===c)return 0;var b="string"==typeof d,f="string"==typeof c;if(b&&("void"==d||"unknown"==d)||f&&("void"==c||"unknown"==c))return-1;if((b&&"NullObject"==d||NullObject===d)&&c!==Number&&c!==Boolean&&c!==NullObject)return 0;b&&(d=a.evalType(d));f&&(c=a.evalType(c));if(null==c||null==d)return-1;b=0;for(f=d;f!==c&&10>b;){if(null!=f.implementz)for(var e=f.implementz,g=0;g<e.length;g++){var j=a.equalsOrExtendsLevel(e[g],c);if(0<=j)return b+j+1}f=
f.superClazz;if(null==f)return c===Object||c===a._O?b+1.5:-1;b++}return b};a.instanceOf=function(d,c){if(null==d)return!1==c;if(null==c)return!1;if(d instanceof c)return!0;var b=a.getClassName(d);return 0<=a.getInheritedLevel(b,c)};a.superCall=function(d,c,b,f){var e=null,g=-1,j=d[b];if(null!=j)if(null!=j.claxxOwner)j.claxxOwner!==c&&(e=j);else if(null==j.stacks&&!(null!=j.lastClaxxRef&&null!=j.lastClaxxRef.prototype[b]&&null!=j.lastClaxxRef.prototype[b].stacks))e=j;else{var r=j.stacks;null==r&&(r=
j.lastClaxxRef.prototype[b].stacks);for(g=r.length-1;0<=g;g--)if(c===r[g]){0<g?(g--,e=r[g].prototype[b]):e=r[0].prototype[b]["\\unknown"];break}else if(0<a.getInheritedLevel(c,r[g])){e=r[g].prototype[b];break}}if(null!=e)return 0==g&&"construct"==b&&(g=j.stacks,null!=g&&(null==g[0].superClazz&&null!=g[0].con$truct)&&g[0].con$truct.apply(d,[])),a.tracingCalling?(g=arguments.callee.caller,g===a.superConstructor&&(g=g.arguments.callee.caller),a.pu$hCalling(new a.callingStack(g,c)),e=e.apply(d,null==
...
!0);b.typeString="\\"+b.join("\\");return b};a.searchAndExecuteMethod=function(d,c,b,f){var e=d[b],g=a.getParamsType(f);a._profile&&a.addProfile(c,b,g);if(e.lastParams==g.typeString&&e.lastClaxxRef===c){c=null;if(g.hasCastedNull){c=[];for(g=0;g<f.length;g++)c[g]=f[g]instanceof a.CastedNull?null:f[g]}else c=f;if(null!=e.lastMethod)return e.lastMethod.apply(d,c)}else{e.lastParams=g.typeString;e.lastClaxxRef=c;var j=e.stacks;null==j&&(j=c.prototype[b].stacks);for(var r=!1,k=j.length-1;-1<k;k--)if(r||
j[k]===c){r=a.tryToSearchAndExecute(b,d,j[k].prototype[b],g,f,e);if(!(r instanceof a.MethodException))return r;r=!0}if("construct"!=b)throw new a.MethodNotFoundException(d,c,b,g.typeString);}};a.tracingCalling=!1;a.tryToSearchAndExecute=function(d,c,b,f,e,g){var j=[],r=!0,k;for(k in b)if(92==k.charCodeAt(0)){var m=k.substring(1).split("\\");m.length==f.length&&(j[j.length]=m);r=!1}else if(r&&"funParams"==k&&null!=b.funParams){k=b.funParams;m=k.substring(1).split("\\");m.length==f.length&&(j[0]=m);
break}if(0==j.length)return new a.MethodException;k=a.searchMethod(j,f);if(null!=k){j=null;j=r?b:b["\\"+k];r=null;if(f.hasCastedNull){r=[];for(k=0;k<e.length;k++)r[k]=e[k]instanceof a.CastedNull?null:e[k]}else r=e;if(a.tracingCalling){m=arguments.callee.caller;m=m=m.arguments.callee.caller;if(k="construct"==j.exName&&0<=a.getInheritedLevel(j.exClazz,Throwable)&&!a._initializingException){a._initializingException=!0;var p=m.arguments.callee.caller.arguments.callee.caller,B=p.arguments.callee,D=B.claxxReference;
null==D&&(D=B.exClazz);null==D&&(D=B.claxxOwner);a.pu$hCalling(new a.callingStack(p,D))}if(p=m!==a.instantialize&&m!==a.superCall)B=m.arguments.callee,D=B.claxxReference,null==D&&(D=B.exClazz),null==D&&(D=B.claxxOwner),a.pu$hCalling(new a.callingStack(m,D));g.lastMethod=j;j=j.apply(c,r);p&&a.p0pCalling();k&&a.p0pCalling();return j}g.lastMethod=j;return j.apply(c,r)}return new a.MethodException};a._initializingException=!1;a.searchMethod=function(d,c){for(var b=[],f=0;f<d.length;f++){for(var e=[],
g=!0,j=0;j<d[f].length;j++)if(e[j]=a.getInheritedLevel(c[j],d[f][j]),0>e[j]){g=!1;break}g&&(e[c.length]=f,b[b.length]=e)}if(0==b.length)return null;e=b[0];for(f=1;f<b.length;f++){g=!0;for(j=0;j<c.length;j++)if(e[j]<b[f][j]){g=!1;break}g&&(e=b[f])}return d[e[c.length]].join("\\")};a.generateDelegatingMethod=function(a,c){var b=function(){var a=arguments;return SAEM(this,a.callee.claxxReference,a.callee.methodName,a)};b.methodName=c;b.claxxReference=a;return b};SAEM=a.searchAndExecuteMethod;a.expExpandParameters=
...
1);if(null!=g[e])return g[e];g[e]=c}else{if(null!=window[d])return window[d];a.setGlobal(d,c)}a.decorateAsType(c,d,b,f);d=a._innerFunctions;c.defineMethod=d.defineMethod;c.defineStaticMethod=d.defineStaticMethod;c.makeConstructor=d.makeConstructor;return c};a.isSafari=-1!=navigator.userAgent.indexOf("Safari");a.isSafari4Plus=!1;if(a.isSafari){var p=navigator.userAgent,g=p.indexOf("Version/");-1!=g&&(p=p.substring(g+8),p=parseFloat(p),a.isSafari4Plus=4<=p)}a.instantialize=function(d,c){if(!(null!=
...
e=b.length,e=b.charAt(e-1);"/"!=e&&(b+="/");c.url=b+d.substring(1)}else{if(null!=this.base)b=this.base;else if(null!=a._Loader)if(b=a._Loader.getClasspathFor(f),e=b.lastIndexOf(f.replace(/\./g,"/")),-1!=e)b=b.substring(0,e);else if(e=-1,b.indexOf(".z.js")==b.length-5&&-1!=(e=b.lastIndexOf("/")))for(var b=b.substring(0,e+1),e=f.split(/\./),g=1;g<e.length;g++){for(var j="/",r=0;r<g;r++)j+=e[r]+"/";if(j.length>b.length)break;if(b.indexOf(j)==b.length-j.length){b=b.substring(0,b.length-j.length+1);break}}else b=
...
1))};a.currentPath="";a.declareInterface=function(d,c,b){var f=function(){};a.decorateFunction(f,d,c,"Clazz.declareInterface");null!=b&&a.implementOf(f,b);return f};a.decorateAsClass=function(d,c,b,f,e,g,j){var r=null;null!=c&&(r=c.__PKG_NAME__,null==r&&(r=c.__CLASS_NAME__));r=a.unloadedClasses[(null==r?"":r+".")+b];null!=r&&(d=r);a.decorateFunction(d,c,b,j+"...Clazz.decorateAsClass");null!=g?a.inheritClass(d,f,g):null!=f&&a.inheritClass(d,f);null!=e&&a.implementOf(d,e);return d};a.declareType=function(d,
...
a.declared$Fields)for(var g=0;g<a.declared$Fields.length;g++)e[g]=a.declared$Fields[g];a.declared$Fields=e;if(0<b&&1==b%2){e=a.declared$Fields;for(g=1;g<=(b-1)/2;g++){for(var k={name:c[g+g-1],type:c[g+g]},j=!1,r=0;r<e.length;r++)if(e[r].name==k.name){e[r].type=k.type;j=!0;break}j||(e[e.length]=k)}}};a.getMixedCallerMethod=function(d){var c={};d=d.callee.caller;if(null==d||d!==a.tryToSearchAndExecute&&(d=d.arguments.callee.caller,null==d)||d!==a.tryToSearchAndExecute)return null;d=d.arguments.callee.caller;
...
a.name||a.status>=b.STATUS_OPTIONALS_LOADED)c.destroyClassNode(a);else{var d=!1;if(null==a.musts||0==a.musts.length||null==a.declaration)d=!0;else for(var d=!0,e=a.musts.length,f=e-1;0<=f;f--){var g=a.musts[f];g.requiredBy=a;if(g.status<b.STATUS_DECLARED){if(c.isClassDefined(g.name)){var k=[];g.status=b.STATUS_OPTIONALS_LOADED;c.destroyClassNode(g);if(null!=g.declaration&&null!=g.declaration.clazzList){for(var m=g.declaration.clazzList,p=0;p<m.length;p++){var q=c.findClass(m[p]);q.status!=b.STATUS_OPTIONALS_LOADED&&
q!==g&&(q.status=g.status,q.declaration=null,c.destroyClassNode(q),null!=q.optionalsLoaded&&(k[k.length]=q))}g.declaration=null}null!=g.optionalsLoaded&&(k[k.length]=g);for(p=0;p<k.length;p++)g=k[p].optionalsLoaded,null!=g&&(k[p].optionalsLoaded=null,g())}else g.status==b.STATUS_CONTENT_LOADED&&c.updateNode(g),g.status<b.STATUS_DECLARED&&(d=!1);a.musts.length!=e&&(f=e=a.musts.length,d=!0)}}if(d){if(a.status<b.STATUS_DECLARED&&(f=a.declaration,null!=f&&(!1==f.executed?(f(),f.executed=!0):f()),a.status=
...
if(d instanceof Array){c.unwrapArray(d);for(var g=0;g<d.length;g++)c.load(a,d[g],e,f,d)}else{"$"==d.charAt(0)&&(d="org.eclipse.s"+d.substring(1));var k=c.mapPath2ClassNode["#"+d];if(null==k){var m=c.findClass(d),k=null!=m?m:new b;k.name=d;g=c.classpathMap["#"+d];null==g&&(g="unknown");k.path=g;c.mappingPathNameNode(k.path,d,k);k.status=b.STATUS_KNOWN;c.addChildClassNode(c.clazzTreeRoot,k,-1)}if(null!=a&&0!=a.length){c.unwrapArray(a);for(g=0;g<a.length;g++)if(m=a[g],!(null==m||0==m.length)&&!c.isClassDefined(m)&&
!c.isClassExcluded(m))m=c.findClass(m),null==m&&(m=new b,m.name=a[g],m.status=b.STATUS_KNOWN),m.requiredBy=k,c.addChildClassNode(k,m,1)}5==arguments.length&&null!=f&&(f.status=k.status,f.clazzList=arguments[4]);k.declaration=f;null!=f&&(k.status=b.STATUS_CONTENT_LOADED);if(null!=e&&0!=e.length){c.unwrapArray(e);for(g=0;g<e.length;g++)if(m=e[g],!(null==m||0==m.length)&&!c.isClassDefined(m)&&!c.isClassExcluded(m))m=c.findClass(m),null==m&&(m=new b,m.name=e[g],m.status=b.STATUS_KNOWN),c.addChildClassNode(k,
...
if(null!=e)return e;e=d.indexOf("java/lang/ClassLoader.js");if(-1!=e)return d.substring(0,e)}return null};c.J2SLibBase=null;c.fastGetJ2SLibBase=function(){null==c.J2SLibBase&&(c.J2SLibBase=c.getJ2SLibBase());return c.J2SLibBase};c.assurePackageClasspath=function(a){var b=window[a+".registered"];!1!=b&&(!0!=b&&null==c.classpathMap["@"+a])&&(window[a+".registered"]=!1,b=c.fastGetJ2SLibBase(),null==b&&(b="j2s"),c.packageClasspath(a,b,!0))};c.loadClass=function(e,f,g,k){if("boolean"==typeof f)return a.evalType(e);
c.assurePackageClasspath("java");c.assurePackageClasspath("core");(0==e.indexOf("org.eclipse.swt")||0==e.indexOf("$wt"))&&c.assurePackageClasspath("org.eclipse.swt");0==e.indexOf("junit")&&c.assurePackageClasspath("junit");c.keepOnLoading=!0;if(!g&&(0!=c.pkgRefCount&&e.lastIndexOf(".package")!=e.length-8||!c.isClassDefined(c.runtimeKeyClass)&&0!=e.indexOf("java.")))k=c.queueBe4KeyClazz,k[k.length]=[e,f];else if(!c.isClassDefined(e)&&!c.isClassExcluded(e)){var m=c.getClasspathFor(e),p=c.loadedScripts[m];
k=c.classQueue;if(!p)for(g=k.length-1;0<=g;g--)if(k[g].path==m||k[g].name==e)p=!0;if(p){if(null!=f&&(p=c.findClass(e),null!=p))if(null==p.optionalsLoaded)p.optionalsLoaded=f;else if(f!=p.optionalsLoaded){var q=p.optionalsLoaded;p.optionalsLoaded=function(){q();f()}}}else{p=null;null!=a.unloadedClasses[e]&&(p=c.findClass(e));null==p&&(p=new b);p.name=e;p.path=m;c.mappingPathNameNode(m,e,p);p.optionalsLoaded=f;p.status=b.STATUS_KNOWN;var s=!1;for(g=k.length-1;0<=g;g--)if(k[g].status!=b.STATUS_OPTIONALS_LOADED){s=
!0;break}if(m.lastIndexOf("package.js")==m.length-10){m=!1;for(g=k.length-1;0<=g;g--){e=k[g].name;if(e.lastIndexOf("package.js")==e.length-10){k[g+1]=p;m=!0;break}k[g+1]=k[g]}m||(k[0]=p)}else s&&(k[k.length]=p);s||(e=!1,null!=f&&(e=c.isLoadingEntryClass,c.isLoadingEntryClass=!0),c.addChildClassNode(c.clazzTreeRoot,p,1),c.loadScript(p.path),null!=f&&(c.isLoadingEntryClass=e))}}else if(null!=f&&c.isClassDefined(e)&&(e=c.findClass(e),null==e||e.status>=b.STATUS_OPTIONALS_LOADED))k?window.setTimeout(f,
25):f()};c.loadJ2SApp=function(b,e,f){if(null!=b){var g=b;"$"==b.charAt(0)&&(g="org.eclipse.s"+b.substring(1));var k=-1;if(-1!=(k=g.indexOf("@")))b=g.substring(k+1),c.setPrimaryFolder(b),g=g.substring(0,k),k=g.lastIndexOf("."),-1!=k&&(k=g.substring(0,k),c.packageClasspath(k,b));if(null==e||!(e instanceof Array))e=[];if(null==f){var m=g,p=e;f=function(){a.evalType(m).main(p)}}else f=f(g,e);c.loadClass(g,f)}};c.loadJUnit=function(b,e){c.loadJ2SApp(b,e,function(b){return function(){c.loadClass("junit.textui.TestRunner",
...
function(a){e.showStatus("Class "+a+" is reloaded.",!0)},p=navigator.userAgent.toLowerCase(),-1!=p.indexOf("msie")&&-1==p.indexOf("opera")&&ClazzLoader.setLoadingMode("script",5));var m=a.Console;m.maxTotalLines=1E4;m.setMaxTotalLines=function(a){m.maxTotalLines=0>=a?999999:a};m.maxLatency=40;m.setMaxLatency=function(a){m.maxLatency=0>=a?40:a};m.pinning=!1;m.enablePinning=function(a){m.pinning=a};m.linesCount=0;m.metLineBreak=!1;m.splitNeedFixed=2!="\n".split(/\n/).length;m.splitIntoLineByR=function(a){for(var c=
[],b=0,e=-1;;)if(b=a.indexOf("\r",e+1),-1!=b){if(c[c.length]=a.substring(e+1,b),e=b,e+1==a.length){c[c.length]="";break}}else{c[c.length]=a.substring(e+1);break}return c};m.splitIntoLines=function(a){var c=[];if(null==a)return c;for(var b=0,e=-1;;){var b=a.indexOf("\n",e+1),g=null;-1!=b?(g=0<b&&"\r"==a.charAt(b-1)?a.substring(e+1,b-1):a.substring(e+1,b),e=b):g=a.substring(e+1);for(var g=m.splitIntoLineByR(g),k=0;k<g.length;k++)c[c.length]=g[k];if(-1==b)break;else if(e+1==a.length){c[c.length]="";
break}}return c};m.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};m.consoleOutput=function(a,c){var b=window["j2s.lib"];(b=b&&b.console)&&"string"==typeof b&&(b=document.getElementById(b));if(!b)return!1;if(m.linesCount>m.maxTotalLines){for(var e=0;e<m.linesCount-m.maxTotalLines;e++)null!=b&&0<b.childNodes.length&&b.removeChild(b.childNodes[0]);m.linesCount=m.maxTotalLines}var g=
!1;a="undefined"==typeof a?"":null==a?"null":""+a;0<a.length&&(e=a.charAt(a.length-1),"\n"==e?(a=1<a.length?"\r"==a.charAt(a.length-2)?a.substring(0,a.length-2):a.substring(0,a.length-1):"",g=!0):"\r"==e&&(a=a.substring(0,a.length-1),g=!0));var k=null;a=a.replace(/\t/g,m.c160);if(m.splitNeedFixed)try{k=m.splitIntoLines(a)}catch(j){window.popup(j.message)}else k=a.split(/\r\n|\r|\n/g);for(e=0;e<k.length;e++){var p=null;if(m.metLineBreak||0==m.linesCount||1>b.childNodes.length)p=document.createElement("DIV"),
b.appendChild(p),p.style.whiteSpace="nowrap",m.linesCount++;else try{p=b.childNodes[b.childNodes.length-1]}catch(G){p=document.createElement("DIV"),b.appendChild(p),p.style.whiteSpace="nowrap",m.linesCount++}var A=document.createElement("SPAN");p.appendChild(A);A.style.whiteSpace="nowrap";null!=c&&(A.style.color=c);0==k[e].length&&(k[e]=String.fromCharCode(160));A.appendChild(document.createTextNode(k[e]));m.pinning||(b.scrollTop+=100);m.metLineBreak=e!=k.length-1?!0:g}g=b.parentNode.className;!m.pinning&&
(null!=g&&-1!=g.indexOf("composite"))&&(b.parentNode.scrollTop=b.parentNode.scrollHeight);m.lastOutputTime=(new Date).getTime()};m.clear=function(){try{m.metLineBreak=!0;var a=window["j2s.lib"],c=a&&a.console;if(c&&(c=document.getElementById(c))){for(var b=c.childNodes,e=b.length-1;0<=e;e--)c.removeChild(b[e]);m.linesCount=0}}catch(g){}};a.alert=function(a){m.consoleOutput(a+"\r\n")};m.c160=String.fromCharCode(160);m.c160+=m.c160+m.c160+m.c160;System.out.print=function(a){m.consoleOutput(a)};System.out.println=
function(a){m.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};System.out.write=function(a,c,b){System.out.print(String.instantialize(a).substring(c,c+b))};System.err.__CLASS_NAME__="java.io.PrintStream";System.err.print=function(a){m.consoleOutput(a,"red")};System.err.println=function(a){m.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};System.err.write=function(a,c,b){System.err.print(String.instantialize(a).substring(c,c+b))};a.setConsoleDiv=
function(a){window["j2s.lib"]&&(window["j2s.lib"].console=a)};a.binaryFolders=a._Loader.binaryFolders=[a._Loader.getJ2SLibBase()]}(Clazz))};___JmolDate="$Date: 2014-08-03 08:56:51 -0500 (Sun, 03 Aug 2014) $";___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";___JmolVersion="14.2.4_2014.08.03";
