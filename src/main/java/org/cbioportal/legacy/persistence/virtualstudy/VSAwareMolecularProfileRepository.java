...
public class VSAwareMolecularProfileRepository implements MolecularProfileRepository {
    ...
    public List<MolecularProfile> getAllMolecularProfiles(String projection, Integer pageSize, Integer pageNumber, String sortBy, String direction) {
        ...
        List<MolecularProfile> virtualMolecularProfiles = getAllVirtualMolecularProfiles(molecularProfiles);
    ...
    private Comparator<MolecularProfile> composeComparator(String sortBy, String direction) {
        ...
        Comparator<MolecularProfile> result = switch (mp) {
            case molecularProfileId -> Comparator.comparing(MolecularProfile::getStableId);
            case molecularAlterationType -> Comparator.comparing(MolecularProfile::getMolecularAlterationType);
            ...
            case showProfileInAnalysisTab -> Comparator.comparing(MolecularProfile::getShowProfileInAnalysisTab);
        };
        if (direction == null) {
            return result;
        } else {
    ...
    public List<MolecularProfile> getAllVirtualMolecularProfiles(List<MolecularProfile> molecularProfiles) {
        ...
        return virtualStudyService.getPublishedVirtualStudies().stream().flatMap(virtualStudy -> {
            ...
            return studyIds.stream().flatMap(studyId ->
                molecularProfilesByStudyId.get(studyId).stream().map(molecularProfile -> {
                    ...
                    virtualMolecularProfile.setCancerStudy(virtualStudyService.toCancerStudy(virtualStudy));
    ...
    public BaseMeta getMetaMolecularProfiles() {
        ...
        meta.setTotalCount(getAllMolecularProfiles(Projection.ID.name(), null, null, null, null).size());
        return meta;
    }
    ...
    public BaseMeta getMetaMolecularProfilesInStudy(String studyId) {
        BaseMeta meta = new BaseMeta();
        meta.setTotalCount(getAllMolecularProfilesInStudy(studyId, Projection.ID.name(), null, null, null, null).size());
        return meta;
    }
