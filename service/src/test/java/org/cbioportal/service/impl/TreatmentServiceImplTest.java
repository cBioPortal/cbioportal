...
//        Mockito.when(treatmentRepository.getTreatmentsByPatientId(Mockito.any(), Mockito.any(), tier))
...
//        Mockito.when(treatmentRepository.getAllUniqueTreatments(Mockito.any(), Mockito.any(), tier))
