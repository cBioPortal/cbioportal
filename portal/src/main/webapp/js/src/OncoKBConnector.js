...
var OncoKB = (function(_, $) {
    ...
    self.str = (function() {
        ...
        function getOncogenicityFooterStr() {
            return '<div class="oncokb"><i>The information above is intended for research purposes only and should not be used as a substitute for professional diagnosis and treatment.</i></div><br/><div class="oncokb"><button class="oncokbFeedback-btn" style="margin-top: 0">Feedback</button><span style="float: right;">  <img src="images/oncokb.png" height="14px" style="margin-bottom: 5px"> <i class="fa fa-chevron-right oncokb_footer_moreInfo"></i><i class="fa fa-chevron-down oncokb_footer_lessInfo" style="display: none;"></i></span>' +
