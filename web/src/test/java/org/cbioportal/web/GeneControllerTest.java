...
public class GeneControllerTest {
    ...
    public void getAllGenesDefaultProjection() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[0].type").value(TYPE_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$[1].type").value(TYPE_2)
            );
    }
    ...
    public void getAllGenesMetaProjection() throws Exception {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders.get("/genes").param("projection", "META")
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
                MockMvcResultMatchers
    ...
    public void getGeneNotFound() throws Exception {
        Mockito
            .when(geneService.getGene(Mockito.anyString()))
            .thenThrow(new GeneNotFoundException("test_gene_id"));

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/genes/test_gene_id")
                    .accept(MediaType.APPLICATION_JSON)
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.message")
                    .value("Gene not found: test_gene_id")
            );
    }
    ...
    public void getAliasesOfGene() throws Exception {
        ...
        Mockito
            .when(geneService.getAliasesOfGene(Mockito.anyString()))
            .thenReturn(aliasList);

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/genes/test_gene_id/aliases")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(
