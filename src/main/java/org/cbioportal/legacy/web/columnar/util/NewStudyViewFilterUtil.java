...
public abstract class NewStudyViewFilterUtil {
  ...
  public static void removeClinicalDataFilter(
      String attributeId, List<ClinicalDataFilter> dataFilterList) {
    if (dataFilterList != null) {
      dataFilterList.removeIf(f -> f.getAttributeId().equals(attributeId));
    }
  }

  public static void removeSelfFromGenomicDataFilter(
  ...
  public static void removeSelfFromGenericAssayFilter(
      String stableId, StudyViewFilter studyViewFilter) {
  ...
  public static void removeSelfFromMutationDataFilter(
