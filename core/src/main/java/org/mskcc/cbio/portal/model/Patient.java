...
public class Patient {
    ...
    public Patient(CancerStudy cancerStudy, String stableId, int internalId) {
        this(
            ...
            stableId,
            internalId,
            new HashMap<String, ClinicalData>()
        );
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (
            this.cancerStudy.getInternalId() !=
            anotherPatient.getCancerStudy().getInternalId()
        ) {
            return false;
        }
    ...
    private Double getDoubleValue(String attribute) {
        ...
        try {
            ...
            logger.warn(
                "Can't handle clinical attribute of patient: " + stableId
            );
            return null;
        }
    }
