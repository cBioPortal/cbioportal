...
public class GeneController {
    ...
    public ResponseEntity<List<? extends GeneSummary>> getAllGenes(@RequestParam(defaultValue = "SUMMARY") Projection projection,
    ...
    public ResponseEntity<GeneSummary> getGene(@PathVariable String entrezGeneId) {
