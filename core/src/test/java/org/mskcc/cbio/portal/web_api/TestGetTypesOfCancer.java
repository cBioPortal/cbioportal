...
public class TestGetTypesOfCancer {
    public static final String DESCRIPTION =
        "<a href=\"http://cancergenome.nih.gov/\">The Cancer Genome Atlas (TCGA)" +
     ...
     */
    @Test
    public void testGetTypesOfCancerEmpty()
        throws DaoException, IOException, ProtocolException {
    ...
    @Test
    public void testGetTypesOfCancer()
        throws DaoException, IOException, ProtocolException {
     ...
     */
    @Test
    public void testGetCancerStudiesEmpty()
        throws DaoException, IOException, ProtocolException {
    ...
    @Test
    public void testGetCancerStudies()
        throws DaoException, IOException, ProtocolException {
        //remove study and all cancer types:
        DaoCancerStudy.deleteCancerStudy("study_tcga_pub");
        DaoTypeOfCancer.deleteAllTypesOfCancer();
        ...
        //  Verify data
        assertEquals(
            "study_tcga_pub_testapi2\tBreast Invasive Carcinoma (TCGA, Nature 2012)\t" +
            DESCRIPTION,
            lines[1].trim()
        );
    }
