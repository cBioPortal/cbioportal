...
public class DataBinHelper {
  ...
  public List<DataBin> initDataBins(List<BigDecimal> values, List<BigDecimal> intervals) {
  ...
  public void calcCounts(List<DataBin> dataBins, List<BigDecimal> values) {
    Map<Range<BigDecimal>, DataBin> rangeMap =
        dataBins.stream().collect(Collectors.toMap(this::calcRange, b -> b));
  ...
  public Set<BigDecimal> findDistinctValues(
  ...
  public Set<Range<BigDecimal>> findDistinctSpecialRanges(
  ...
  public List<DataBin> convertToDistinctBins(
    ...
    for (DataBin bin : dataBins) {
      ...
      if (distinctRanges.size() == 0
          ...
          && this.areAllIntegers(distinctValues)) {
  ...
  public List<BigDecimal> generateBins(
