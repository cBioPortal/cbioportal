...
public class CancerTypeControllerTest {
    ...
    private static final String TEST_CLINICAL_TRIAL_KEYWORDS_1 =
        "test_clinical_trial_keywords_1";
    private static final String TEST_DEDICATED_COLOR_1 =
        "test_dedicated_color_1";
    private static final String TEST_SHORT_NAME_1 =
        "test_type_of_cancer_short_name_1";
    ...
    private static final String TEST_CLINICAL_TRIAL_KEYWORDS_2 =
        "test_clinical_trial_keywords_2";
    private static final String TEST_DEDICATED_COLOR_2 =
        "test_dedicated_color_2";
    private static final String TEST_SHORT_NAME_2 =
        "test_type_of_cancer_short_name_2";
    ...
    public void getAllCancerTypesDefaultProjection() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].clinicalTrialKeywords")
                    .value(TEST_CLINICAL_TRIAL_KEYWORDS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[0].dedicatedColor")
                    .value(TEST_DEDICATED_COLOR_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].clinicalTrialKeywords")
                    .value(TEST_CLINICAL_TRIAL_KEYWORDS_2)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$[1].dedicatedColor")
                    .value(TEST_DEDICATED_COLOR_2)
            )
            .andExpect(
                MockMvcResultMatchers
    ...
    public void getAllCancerTypesMetaProjection() throws Exception {
        ...
        Mockito
            .when(cancerTypeService.getMetaCancerTypes())
            .thenReturn(baseMeta);
    ...
    public void getCancerTypeNotFound() throws Exception {
        Mockito
            .when(cancerTypeService.getCancerType(Mockito.anyString()))
            .thenThrow(new CancerTypeNotFoundException("cancer_type_id"));

        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .get("/cancer-types/cancer_type_id")
                    .accept(MediaType.APPLICATION_JSON)
            )
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.message")
                    .value("Cancer type not found: cancer_type_id")
            );
    }
    ...
    public void getCancerType() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.clinicalTrialKeywords")
                    .value(TEST_CLINICAL_TRIAL_KEYWORDS_1)
            )
            .andExpect(
                MockMvcResultMatchers
                    .jsonPath("$.dedicatedColor")
                    .value(TEST_DEDICATED_COLOR_1)
            )
            .andExpect(
                MockMvcResultMatchers
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.parent").value(TEST_PARENT_1)
            );
    }
}
