...
public class ClinicalDataMyBatisRepositoryTest {
    ...
    public void getAllClinicalDataOfSampleInStudyEmptyResult()
        throws Exception {
        List<ClinicalData> result = clinicalDataMyBatisRepository.getAllClinicalDataOfSampleInStudy(
            "invalid_study",
            null,
            null,
            "ID",
    ...
    public void getAllClinicalDataOfSampleInStudyWithAttributeSummaryProjection()
        ...
        Assert.assertEquals(
            "5C631CE8-F96A-4C35-A459-556FC4AB21E1",
            data.getAttrValue()
        );
        Assert.assertEquals((Integer) 1, data.getInternalId());
        Assert.assertNull(data.getClinicalAttribute());
    ...
    public void getMetaSampleClinicalDataZeroCount() throws Exception {
        BaseMeta result = clinicalDataMyBatisRepository.getMetaSampleClinicalData(
            "invalid_study",
            null,
            null
        );
    ...
    public void getAllClinicalDataOfPatientInStudyEmptyResult()
        throws Exception {
        List<ClinicalData> result = clinicalDataMyBatisRepository.getAllClinicalDataOfPatientInStudy(
            "invalid_study",
            null,
            null,
            "ID",
    ...
    public void getAllClinicalDataOfPatientInStudyWithAttributeSummaryProjection()
        ...
        Assert.assertEquals(
            "286CF147-B7F7-4A05-8E41-7FBD3717AD71",
            data.getAttrValue()
        );
        Assert.assertEquals((Integer) 1, data.getInternalId());
        Assert.assertNull(data.getClinicalAttribute());
    ...
    public void getAllClinicalDataOfPatientInStudyNullAttributeSummaryProjectionAttrIdSort()
        ...
        Assert.assertEquals(
            ...
            result.get(2).getAttrId()
        );
    }

    @Test
    public void getMetaPatientClinicalDataZeroCount() throws Exception {
        BaseMeta result = clinicalDataMyBatisRepository.getMetaPatientClinicalData(
            "invalid_study",
            null,
            null
        );
    ...
    public void getAllClinicalDataInStudyEmptyResult() throws Exception {
        List<ClinicalData> result = clinicalDataMyBatisRepository.getAllClinicalDataInStudy(
            "invalid_study",
            null,
    ...
    public void getMetaAllClinicalDataZeroCount() throws Exception {
        BaseMeta result = clinicalDataMyBatisRepository.getMetaAllClinicalData(
            "invalid_study",
            null,
            PersistenceConstants.SAMPLE_CLINICAL_DATA_TYPE
        );
    ...
    public void fetchAllClinicalDataInStudy() throws Exception {
        ...
        List<ClinicalData> result = clinicalDataMyBatisRepository.fetchAllClinicalDataInStudy(
            "study_tcga_pub",
            sampleIds,
            null,
            PersistenceConstants.SAMPLE_CLINICAL_DATA_TYPE,
    ...
    public void fetchMetaClinicalDataInStudy() throws Exception {
        ...
        sampleIds.add("TCGA-A1-A0SB-01");
        sampleIds.add("TCGA-A1-A0SD-01");
        BaseMeta result = clinicalDataMyBatisRepository.fetchMetaClinicalDataInStudy(
            "study_tcga_pub",
            sampleIds,
            null,
            PersistenceConstants.SAMPLE_CLINICAL_DATA_TYPE
    ...
    public void fetchClinicalDataNullAttributeSummaryProjection()
        ...
        sampleIds.add("TCGA-A1-A0SB-01");
        sampleIds.add("TCGA-A1-A0SD-01");
        List<ClinicalData> result = clinicalDataMyBatisRepository.fetchClinicalData(
            studyIds,
            sampleIds,
            null,
            PersistenceConstants.SAMPLE_CLINICAL_DATA_TYPE,
    ...
    public void fetchMetaClinicalDataNullAttribute() throws Exception {
        ...
        sampleIds.add("TCGA-A1-A0SB-01");
        sampleIds.add("TCGA-A1-A0SD-01");
        BaseMeta result = clinicalDataMyBatisRepository.fetchMetaClinicalData(
            studyIds,
            sampleIds,
            null,
            PersistenceConstants.SAMPLE_CLINICAL_DATA_TYPE
    ...
    public void fetchClinicalDataCounts() throws Exception {
        List<ClinicalDataCount> result = clinicalDataMyBatisRepository.fetchClinicalDataCounts(
        ...
        Assert.assertEquals(
            "DAYS_TO_COLLECTION",
            clinicalDataCount1.getAttributeId()
        );
        ...
        Assert.assertEquals(
            "OTHER_SAMPLE_ID",
            clinicalDataCount2.getAttributeId()
        );
        Assert.assertEquals(
            "91E7F41C-17B3-4724-96EF-D3C207B964E1",
            clinicalDataCount2.getValue()
        );
