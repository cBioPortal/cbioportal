...
public interface ClinicalFieldMapper {
	...
	List<DBClinicalField> getSampleClinicalFieldsBySampleInternalIds(@Param("sample_ids") List<Integer> sample_ids);
	List<DBClinicalField> getPatientClinicalFieldsByPatientInternalIds(@Param("patient_ids") List<Integer> patient_ids);
