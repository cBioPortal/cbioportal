...
public class GenesetDataControllerTest {
  ...
  @MockitoBean private GenesetDataService genesetDataService;
  ...
  public void fetchGeneticDataItemsWithSampleIds() throws Exception {
    ...
    Mockito.when(genesetDataService.fetchGenesetData(geneticProfileId, sampleIds, genesetIds))
  ...
  public void fetchGeneticDataItemsWithSampleListId() throws Exception {
    ...
    Mockito.when(genesetDataService.fetchGenesetData(geneticProfileId, sampleListId, genesetIds))
        .thenReturn(genesetDataItems);
