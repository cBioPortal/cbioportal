...
public final class DaoMutation {
    ...
    public static int addMutation(
        ExtendedMutation mutation,
        boolean newMutationEvent
    )
        throws DaoException {
    ...
    public static int addMutationEvent(ExtendedMutation.MutationEvent event)
        throws DaoException {
        // use this code if bulk loading
        // write to the temp file maintained by the MySQLbulkLoader
        String keyword = MutationKeywordUtils.guessOncotatorMutationKeyword(
            event.getProteinChange(),
            event.getMutationType()
        );
        MySQLbulkLoader
            .getMySQLbulkLoader("mutation_event")
            .insertRecord(
                ...
                keyword == null
                    ? "\\N"
                    : (
                        event.getGene().getHugoGeneSymbolAllCaps() +
                        " " +
                        keyword
                    )
            );
    ...
    public static void createMutationCountClinicalData(
    ...
    public static int calculateMutationCountByKeyword(int profileId)
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
     ...
     */
    @Deprecated
    public static ArrayList<ExtendedMutation> getMutations(
        int geneticProfileId,
        Collection<Integer> targetSampleList,
        long entrezGeneId
    )
        throws DaoException {
        Connection con = null;
     ...
     */
    @Deprecated
    public static HashMap getSimplifiedMutations(
        int geneticProfileId,
        Collection<Integer> targetSampleList,
        ...
        try {
            ...
            rs = pstmt.executeQuery();
            while (rs.next()) {
                String tmpStr = new StringBuilder()
                    .append(Integer.toString(rs.getInt("SAMPLE_ID")))
                    .append(Integer.toString(rs.getInt("ENTREZ_GENE_ID")))
                    .toString();
                hm.put(tmpStr, "");
            }
        } catch (SQLException e) {
     ...
     */
    public static Set<CanonicalGene> getGenesInProfile(int geneticProfileId)
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
     ...
     */
    @Deprecated
    public static ArrayList<ExtendedMutation> getMutations(long entrezGeneId)
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public static ArrayList<ExtendedMutation> getMutations(
        ...
        return getMutations(
            geneticProfileId,
            Arrays.asList(new Integer(sampleId))
        );
    }
        ...
        try {
            ...
            pstmt =
                con.prepareStatement(
                    "SELECT * FROM mutation " +
                    "INNER JOIN mutation_event ON mutation.MUTATION_EVENT_ID=mutation_event.MUTATION_EVENT_ID " +
                    "WHERE GENETIC_PROFILE_ID = ? AND SAMPLE_ID in ('" +
     ...
     */
    @Deprecated
    public static boolean hasAlleleFrequencyData(
        int geneticProfileId,
        int sampleId
    )
        throws DaoException {
    ...
    public static ArrayList<ExtendedMutation> getAllMutations()
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
     ...
     */
    @Deprecated
    public static Set<ExtendedMutation.MutationEvent> getAllMutationEvents()
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
     ...
     */
    public static ExtendedMutation.MutationEvent getMutationEvent(
        ExtendedMutation.MutationEvent event
    )
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
    ...
    private static ExtendedMutation extractMutation(ResultSet rs)
        throws SQLException, DaoException {
        try {
            ExtendedMutation mutation = new ExtendedMutation(
                extractMutationEvent(rs)
            );
            ...
            mutation.setMatchedNormSampleBarcode(
                rs.getString("MATCHED_NORM_SAMPLE_BARCODE")
            );
            mutation.setMatchNormSeqAllele1(
                rs.getString("MATCH_NORM_SEQ_ALLELE1")
            );
            mutation.setMatchNormSeqAllele2(
                rs.getString("MATCH_NORM_SEQ_ALLELE2")
            );
            mutation.setTumorValidationAllele1(
                rs.getString("TUMOR_VALIDATION_ALLELE1")
            );
            mutation.setTumorValidationAllele2(
                rs.getString("TUMOR_VALIDATION_ALLELE2")
            );
            mutation.setMatchNormValidationAllele1(
                rs.getString("MATCH_NORM_VALIDATION_ALLELE1")
            );
            mutation.setMatchNormValidationAllele2(
                rs.getString("MATCH_NORM_VALIDATION_ALLELE2")
            );
    ...
    private static ExtendedMutation.MutationEvent extractMutationEvent(
        ResultSet rs
    )
        throws SQLException, DaoException {
     ...
     */
    @Deprecated
    public static Map<Long, Map<String, String>> getSMGs(
        int profileId,
        Collection<Long> entrezGeneIds,
        int thresholdRecurrence,
        int thresholdNumGenes,
        Collection<Integer> selectedCaseIds
    )
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            rs = pstmt.executeQuery();
            String sql =
                "SELECT mutation.ENTREZ_GENE_ID, GROUP_CONCAT(mutation.SAMPLE_ID), COUNT(*), COUNT(*)/`LENGTH` AS count_per_nt" +
                " FROM mutation, gene" +
                " WHERE mutation.ENTREZ_GENE_ID=gene.ENTREZ_GENE_ID" +
                " AND GENETIC_PROFILE_ID=" +
                profileId +
                (
                    entrezGeneIds == null
                        ? ""
                ...
                (
                    selectedCaseIds == null
                        ...
                        : (
                            ...
                            StringUtils.join(selectedCaseIds, ",") +
                            ")"
                        )
                ) +
                " GROUP BY mutation.ENTREZ_GENE_ID" +
                (
                    thresholdRecurrence > 0
    ...
    public static int countMutationEvents(int profileId) throws DaoException {
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT count(DISTINCT `SAMPLE_ID`, `MUTATION_EVENT_ID`) FROM mutation" +
     ...
     */
    @Deprecated
    public static Map<Integer, Set<Long>> getSamplesWithMutations(
    ...
    public static Map<Integer, Set<Long>> getSamplesWithMutations(
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT `SAMPLE_ID`, `MUTATION_EVENT_ID` FROM mutation" +
    ...
    public static Map<Sample, Set<Long>> getSimilarSamplesWithMutationsByKeywords(
        ...
        throws DaoException {
        return getSimilarSamplesWithMutationsByKeywords(
    ...
    public static Map<Sample, Set<Long>> getSimilarSamplesWithMutationsByKeywords(
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT `SAMPLE_ID`, `GENETIC_PROFILE_ID`, me1.`MUTATION_EVENT_ID`" +
                " FROM mutation cme, mutation_event me1, mutation_event me2" +
                " WHERE me1.`MUTATION_EVENT_ID` IN (" +
                concatEventIds +
                ")" +
     ...
     */
    @Deprecated
    public static Map<Long, Integer> countSamplesWithMutationEvents(
        Collection<Long> eventIds,
        int profileId
    )
        throws DaoException {
        return countSamplesWithMutationEvents(
            StringUtils.join(eventIds, ","),
            profileId
        );
    }
    ...
    public static Map<Long, Integer> countSamplesWithMutationEvents(
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT `MUTATION_EVENT_ID`, count(DISTINCT `SAMPLE_ID`) FROM mutation" +
                " WHERE `GENETIC_PROFILE_ID`=" +
                profileId +
     ...
     */
    @Deprecated
    public static Map<Long, Integer> countSamplesWithMutatedGenes(
        Collection<Long> entrezGeneIds,
        int profileId
    )
        throws DaoException {
        return countSamplesWithMutatedGenes(
            StringUtils.join(entrezGeneIds, ","),
            profileId
        );
    }
    ...
    public static Map<Long, Integer> countSamplesWithMutatedGenes(
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT ENTREZ_GENE_ID, count(DISTINCT SAMPLE_ID)" +
                " FROM mutation" +
                " WHERE GENETIC_PROFILE_ID=" +
                profileId +
     ...
     */
    @Deprecated
    public static Map<String, Integer> countSamplesWithKeywords(
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT KEYWORD, count(DISTINCT SAMPLE_ID)" +
     ...
     */
    public static Collection<Map<String, Object>> countSamplesWithKeywords(
        Collection<String> keywords,
        Collection<Integer> internalProfileIds
    )
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT KEYWORD, GENETIC_PROFILE_ID, mutation.ENTREZ_GENE_ID, count(DISTINCT SAMPLE_ID) FROM mutation, mutation_event " +
                "WHERE GENETIC_PROFILE_ID IN (" +
                StringUtils.join(internalProfileIds, ",") +
                ") " +
                "AND mutation.MUTATION_EVENT_ID=mutation_event.MUTATION_EVENT_ID " +
                "AND KEYWORD IN ('" +
                StringUtils.join(keywords, "','") +
     ...
     * @author Gideon Dresdner <dresdnerg@cbio.mskcc.org>
     */
    public static Collection<Map<String, Object>> countSamplesWithGenes(
        Collection<String> hugos,
        Collection<Integer> internalProfileIds
    )
        throws DaoException {
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "select mutation.ENTREZ_GENE_ID, mutation.GENETIC_PROFILE_ID, count(distinct SAMPLE_ID) from mutation, mutation_event\n" +
                "where GENETIC_PROFILE_ID in (" +
                StringUtils.join(internalProfileIds, ",") +
                ")\n" +
                "and mutation.ENTREZ_GENE_ID in (" +
                StringUtils.join(entrezs, ",") +
                ")\n" +
                "and mutation.MUTATION_EVENT_ID=mutation_event.MUTATION_EVENT_ID\n" +
    ...
    public static Collection<Map<String, Object>> countSamplesWithProteinChanges(
        Collection<String> proteinChanges,
        Collection<Integer> internalProfileIds
    )
        throws DaoException {
        Connection con = null;
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT PROTEIN_CHANGE, GENETIC_PROFILE_ID, mutation.ENTREZ_GENE_ID, count(DISTINCT SAMPLE_ID) FROM mutation, mutation_event " +
                "WHERE GENETIC_PROFILE_ID IN (" +
                StringUtils.join(internalProfileIds, ",") +
                ") " +
                "AND mutation.MUTATION_EVENT_ID=mutation_event.MUTATION_EVENT_ID " +
                "AND PROTEIN_CHANGE IN ('" +
                StringUtils.join(proteinChanges, "','") +
                "') " +
    ...
    public static Collection<Map<String, Object>> countSamplesWithProteinPosStarts(
        Collection<String> proteinPosStarts,
        Collection<Integer> internalProfileIds
    )
        throws DaoException {
        Connection con = null;
        ...
        if (
            geneIdSet.size() == 0 || internalProfileIds.size() == 0
        ) return new ArrayList<Map<String, Object>>(); //empty IN() clause would be a SQL error below
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT ONCOTATOR_PROTEIN_POS_START, GENETIC_PROFILE_ID, mutation.ENTREZ_GENE_ID, count(DISTINCT SAMPLE_ID) " +
                "FROM mutation INNER JOIN mutation_event ON mutation.MUTATION_EVENT_ID=mutation_event.MUTATION_EVENT_ID " +
                "WHERE mutation.ENTREZ_GENE_ID IN (" +
                StringUtils.join(geneIdSet, ",") +
                ") " +
                "AND GENETIC_PROFILE_ID IN (" +
                StringUtils.join(internalProfileIds, ",") +
                ") " +
                "AND (mutation.ENTREZ_GENE_ID, ONCOTATOR_PROTEIN_POS_START) IN (" +
                StringUtils.join(proteinPosStarts, ",") +
                ") " +
    ...
    public static Set<Long> getGenesOfMutations(
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT DISTINCT ENTREZ_GENE_ID FROM mutation_event " +
                "WHERE MUTATION_EVENT_ID in (" +
                concatEventIds +
                ")";
            pstmt = con.prepareStatement(sql);
     ...
     */
    @Deprecated
    public static Set<String> getKeywordsOfMutations(
        String concatEventIds,
        int profileId
    )
        throws DaoException {
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoMutation.class);
            String sql =
                "SELECT DISTINCT KEYWORD FROM mutation_event " +
                "WHERE MUTATION_EVENT_ID in (" +
                concatEventIds +
                ")";
            pstmt = con.prepareStatement(sql);
     ...
     */
    @Deprecated
    public static void deleteAllRecordsInGeneticProfile(long geneticProfileId)
        throws DaoException {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            ...
            pstmt =
                con.prepareStatement(
                    "DELETE from mutation WHERE GENETIC_PROFILE_ID=?"
                );
     ...
     * @throws DaoException Database Error.
     */
    public static List<String> getTiers(String _cancerStudyStableIds)
        throws DaoException {
        ...
        for (String cancerStudyStableId : cancerStudyStableIds) {
            geneticProfiles.addAll(
                DaoGeneticProfile.getAllGeneticProfiles(
                    DaoCancerStudy
                        .getCancerStudyByStableId(cancerStudyStableId)
                        .getInternalId()
                )
            );
        }
     ...
     * @throws DaoException Database Error.
     */
    public static int numTiers(String _cancerStudyStableIds)
        throws DaoException {
     ...
     * @throws DaoException Database Error.
     */
    public static boolean hasDriverAnnotations(String _cancerStudyStableIds)
        throws DaoException {
        String[] cancerStudyStableIds = _cancerStudyStableIds.split(",");
        Connection con = null;
        PreparedStatement pstmt = null;
    ...
    public static boolean hasDuplicateMutationEvents() throws DaoException {
        ...
        if (sqlQueryResult == -1) {
            throw new DaoException(
                "Error occurred while executing SQL query to detect duplicate records in `mutation_event`"
            );
        }
