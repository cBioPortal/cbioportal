...
public class CosmicCountControllerTest {
  ...
  @MockBean private CosmicCountService cosmicCountService;
  ...
  public void fetchCosmicCounts() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/cosmic-counts/fetch")
                .with(csrf())
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].cosmicMutationId")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].cosmicMutationId")
