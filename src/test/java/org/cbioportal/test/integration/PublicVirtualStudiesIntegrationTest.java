...
public class PublicVirtualStudiesIntegrationTest extends ContainerConfig {
  ...
  static final HttpHeaders jsonContentType =
      new HttpHeaders() {
        {
  ...
  static final HttpHeaders invalidKeyContainingHeaders =
      new HttpHeaders() {
        {
  ...
  static final HttpHeaders validKeyContainingHeaders =
      new HttpHeaders() {
        {
  ...
  static final ParameterizedTypeReference<List<VirtualStudy>> typeRef =
  ...
  public void test1NoPublicVirtualStudiesAtTheBeginning() {
    ResponseEntity<List<VirtualStudy>> response1 =
        restTemplate.exchange(
            CBIO_URL + "/api/public_virtual_studies", HttpMethod.GET, null, typeRef);
  ...
  public void test2CreateVirtualStudy() {
    ...
    ResponseEntity<VirtualStudy> response2 =
        restTemplate.exchange(
  ...
  public void test3PublishVirtualStudy() {
    String url =
        CBIO_URL
            ...
            + virtualStudyId
            + "?typeOfCancerId=acc&pmid=12345";
    ResponseEntity<Void> response3 = restTemplate.exchange(url, HttpMethod.POST, null, Void.class);
    assertThat(response3.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);

    response3 =
        restTemplate.exchange(
            url, HttpMethod.POST, new HttpEntity<>(null, invalidKeyContainingHeaders), Void.class);
    assertThat(response3.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);

    response3 =
        restTemplate.exchange(
            url, HttpMethod.POST, new HttpEntity<>(null, validKeyContainingHeaders), Void.class);
    assertThat(response3.getStatusCode().is2xxSuccessful()).isTrue();
  }

  @Test
  public void test4ListJustPublishedStudy() {
    ResponseEntity<List<VirtualStudy>> response4 =
        restTemplate.exchange(
            CBIO_URL + "/api/public_virtual_studies", HttpMethod.GET, null, typeRef);
  ...
  public void test6NoPublicVirtualStudiesAfterRemoval() {
    ResponseEntity<List<VirtualStudy>> response6 =
        restTemplate.exchange(
            CBIO_URL + "/api/public_virtual_studies", HttpMethod.GET, null, typeRef);
  ...
  public void test7UnpublishedVirtualStudyExists() {
    ResponseEntity<VirtualStudy> response =
        restTemplate.exchange(
  ...
  static VirtualStudyData createTestVsData() {
    ...
    Set<VirtualStudySamples> studies = Set.of(study1, study2);
