...
public class ReferenceGenomeGeneMyBatisRepositoryTest {
    ...
    public void getAllGenesByGenomeName() throws Exception {
        List<ReferenceGenomeGene> result = refGeneMyBatisRepository.getAllGenesByGenomeName(
            ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
        );
        ReferenceGenomeGene refGene = result.get(0);
        Gene gene = geneMyBatisRepository.getGeneByEntrezGeneId(
    ...
    public void getReferenceGenomeGeneByEntityId() throws Exception {
        ReferenceGenomeGene refGene = refGeneMyBatisRepository.getReferenceGenomeGeneByEntityId(
            (Integer) 2,
            "hg38"
        );
        Gene gene = geneMyBatisRepository.getGeneByEntrezGeneId(
    ...
    public void getGenesByGenomeName() throws Exception {
        ...
        List<ReferenceGenomeGene> result = refGeneMyBatisRepository.getGenesByGenomeName(
            geneIds,
            ReferenceGenome.HOMO_SAPIENS_DEFAULT_GENOME_NAME
        );
