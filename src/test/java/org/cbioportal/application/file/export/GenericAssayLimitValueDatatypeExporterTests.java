...
public class GenericAssayLimitValueDatatypeExporterTests {
    ...
    public void testExport() {
        ...
        assertEquals(Set.of("meta_generic_assay_limit-value_generic_assay_stable_id.txt", "data_generic_assay_limit-value_generic_assay_stable_id.txt"), fileContents.keySet());
