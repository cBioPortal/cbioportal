...
public class ColumnarStoreStudyViewController {
    ...
    public ColumnarStoreStudyViewController(StudyViewService studyViewService, BasicDataBinner basicDataBinner, ClinicalDataBinner clinicalDataBinner, ClinicalDataDensityPlotService clinicalDataDensityPlotService, ViolinPlotService violinPlotService, CustomDataService customDataService, CustomDataFilterUtil customDataFilterUtil) {
