...
@Repository
public class GenesetHierarchyMyBatisRepository
    implements GenesetHierarchyRepository {
    @Autowired
    private GenesetHierarchyMapper genesetHierarchyMapper;

    @Override
    public List<GenesetHierarchyInfo> getGenesetHierarchyParents(
    ...
    @Override
    public List<GenesetHierarchyInfo> getGenesetHierarchySuperNodes(
        List<String> genesetIds
    ) {
