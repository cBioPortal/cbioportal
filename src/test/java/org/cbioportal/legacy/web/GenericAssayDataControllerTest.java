...
public class GenericAssayDataControllerTest {
  ...
  public void testGenericAssayDataFetch() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/generic_assay_data/" + PROF_ID + "/fetch")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[0].genericAssayStableId")
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$[1].genericAssayStableId")
