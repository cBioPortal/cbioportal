...
public class GetGenericAssayDataCountsUseCase {
   ...
   *     {@code null}.
   * @param genericAssayDataFilters a list of filters to apply to the generic assay data. Must not
   *     be {@code null}.
   * @return a list of {@link GenericAssayDataCountItem} objects representing the counts of generic
  ...
  public List<GenericAssayDataCountItem> execute(
    ...
    return genericAssayRepository.getGenericAssayDataCounts(
        studyViewFilterContext, genericAssayDataFilters);
  }
}
