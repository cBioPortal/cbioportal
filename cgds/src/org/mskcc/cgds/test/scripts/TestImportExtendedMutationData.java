...
public class TestImportExtendedMutationData extends TestCase {
    ...
    public void testImportExtendedMutationData() {
        ...
        try {
            ...
            File file = new File("testData/data_mutations_extended.txt");
            ...
            try {
                parser = new ImportExtendedMutationData(file, 1, pMonitor, true, "testData/test_germline_white_list_file2.txt",
            ...
            loadGenes();
            parser = new ImportExtendedMutationData(file, 1, pMonitor, false, "testData/test_germline_white_list_file2.txt"); // put on: CLEC7A
            parser.importData();
            checkBasicFilteringRules();
            checkGermlineMutations();
            ...
            loadGenes();
            parser = new ImportExtendedMutationData(file, 1, pMonitor, false, "testData/test_germline_white_list_file2.txt",
                    "testData/somatic_whitelist1.txt");  // put on: SLC38A2
            parser.importData();
            checkBasicFilteringRules();
            checkGermlineMutations();
            rejectEverythingElse();
            ...
            loadGenes();
            parser = new ImportExtendedMutationData(file, 1, pMonitor, false, "testData/test_germline_white_list_file2.txt",
                    "testData/somatic_whitelist1.txt", "testData/somatic_whitelist2.txt"); // put on somatic_whitelist2.txt: SP1
            parser.importData();
            checkBasicFilteringRules();
            checkGermlineMutations();
            rejectEverythingElse();
