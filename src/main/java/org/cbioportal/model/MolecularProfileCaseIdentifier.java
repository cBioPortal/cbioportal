...
public class MolecularProfileCaseIdentifier
    implements Serializable, Comparable<MolecularProfileCaseIdentifier> {

  @NotNull private String molecularProfileId;
  @NotNull private String caseId;
  ...
  public boolean equals(Object obj) {
    ...
    if (molecularProfileId == null) {
      if (other.molecularProfileId != null) return false;
    } else if (!molecularProfileId.equals(other.molecularProfileId)) return false;
    return true;
  }
